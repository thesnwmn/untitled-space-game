...
You received ${S.reward} CR.${T}`,confirmLabel:"OKAY",onConfirm:()=>{this.closeModal(),this.onHub()}}))}}}activateCurrent(){const n=this.items;if(n.length===0||this.cursorIdx===-1)return;const t=n[this.cursorIdx];if(!t.disabled){if(this.fuelItemIdx!==null&&this.cursorIdx===this.fuelItemIdx){this.activated=!0;const r=$().fuel.pricePerLitre,i=this.player.fuelCapacityL-this.player.fuelL,o=Math.floor(this.player.credits/r),s=Math.min(i,o);this.openModal(new ln({title:"BUY FUEL",field:{label:"Litres",initialValue:s,min:0,max:s},derivedRows:[{label:"Cost",compute:a=>`${a*r} CR`}],confirmLabel:"BUY",onConfirm:a=>{this.closeModal(),a>0&&this.onRefuel(a*r,a)},onCancel:()=>{this.closeModal(),this.activated=!1}}));return}this.activated=!0,t.action()}}handleNavAction(n){(n==="BACK"||n==="NAV_1")&&!this.activated&&(this.activated=!0,this.onShip())}handleNavTap(n){n==="undock"&&!this.activated&&(this.activated=!0,this.onShip())}}class qi extends ne{constructor(n,t,r,i,o,s,a,l,c,h){var m;const p=((m=G(i).npcs.trader)==null?void 0:m.toUpperCase())??"TRADER",u=[{label:"BUY",items:[]},{label:"SELL",items:[]}];super(p,[],[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],n,t,r,[],u,h),this.traderStock=o,this.onBuy=s,this.onSell=a,this.onHub=l,this.onUndock=c,this.syncItems(),this.clampCursor()}buildBuyItems(){return this.traderStock.length===0?[{label:"NO STOCK AVAILABLE",disabled:!0,action:()=>{}}]:this.traderStock.flatMap(n=>{const t=se(n.commodityId);if(!t)return[];const r=this.player.credits>=t.basePrice;return[{label:`${t.name} (x${n.qty})`,info:`${t.basePrice} CR`,disabled:!r,action:()=>{const i=Math.floor(this.player.credits/t.basePrice),o=Math.min(n.qty,i);this.openModal(new ln({title:t.name.toUpperCase(),field:{label:"Quantity",initialValue:o,min:0,max:o},derivedRows:[{label:"Total",compute:s=>`${s*t.basePrice} CR`}],confirmLabel:"BUY",onConfirm:s=>{s>0&&this.onBuy(n.commodityId,s),this.syncItems(),this.clampCursor(),this.closeModal()},onCancel:()=>this.closeModal()}))}}]})}buildSellItems(){const n=this.player.cargoHold;return n.length===0?[{label:"CARGO HOLD EMPTY",disabled:!0,action:()=>{}}]:[...n].flatMap(t=>{const r=se(t.commodityId);return r?[{label:`${r.name} (x${t.qty})`,info:`${r.basePrice} CR`,action:()=>{this.openModal(new ln({title:r.name.toUpperCase(),field:{label:"Quantity",initialValue:t.qty,min:0,max:t.qty},derivedRows:[{label:"Total",compute:i=>`${i*r.basePrice} CR`}],confirmLabel:"SELL",onConfirm:i=>{i>0&&this.onSell(t.commodityId,i),this.syncItems(),this.clampCursor(),this.closeModal()},onCancel:()=>this.closeModal()}))}}]:[]})}syncItems(){this.tabs&&(this.tabs[0].items=this.buildBuyItems(),this.tabs[1].items=this.buildSellItems())}clampCursor(){var t;const n=this.items;(this.cursorIdx<0||this.cursorIdx>=n.length||(t=n[this.cursorIdx])!=null&&t.disabled)&&(this.cursorIdx=n.findIndex(r=>!r.disabled))}activateCurrent(){const n=this.items;if(n.length===0||this.cursorIdx<0||this.cursorIdx>=n.length)return;const t=n[this.cursorIdx];t.disabled||t.action()}handleNavAction(n){(n==="BACK"||n==="NAV_2")&&!this.activated?(this.activated=!0,this.onHub()):n==="NAV_1"&&!this.activated&&(this.activated=!0,this.onUndock())}handleNavTap(n){n==="hub"&&!this.activated?(this.activated=!0,this.onHub()):n==="undock"&&!this.activated&&(this.activated=!0,this.onUndock())}render(n){this.syncItems(),super.render(n);const t=n.length,r=`HOLD: ${this.player.cargoWeightKg}/${this.player.cargoCapacity}KG`,i=xt(t,!0)-2;f(n,i,2,r,"bright-black","black")}}const Vi={delivery:"[D] ",supply:"[S] "};class zi extends ne{constructor(n,t,r,i,o,s,a,l,c){G(i);const h=o();let d;h.length===0?d=[{label:"NO MISSIONS AVAILABLE",disabled:!0,action:()=>{}}]:d=h.map(p=>{const u=p.giverFactionId?(()=>{const m=N().factions.find(g=>g.id===p.giverFactionId);return m?[`For: ${m.name}`]:[]})():[];return{label:p.title,icon:Vi[p.type],iconFg:"bright-yellow",info:`${p.reward} CR`,infoFg:"bright-green",details:u,detailsFg:"bright-black",action:()=>s(p)}}),super("MISSION BOARD",d,[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],n,t,r,[],null,c),this.onHub=a,this.onUndock=l}handleNavAction(n){(n==="BACK"||n==="NAV_2")&&!this.activated?(this.activated=!0,this.onHub()):n==="NAV_1"&&!this.activated&&(this.activated=!0,this.onUndock())}handleNavTap(n){n==="hub"&&!this.activated?(this.activated=!0,this.onHub()):n==="undock"&&!this.activated&&(this.activated=!0,this.onUndock())}}const Qi={delivery:"[D]",supply:"[S]"},Ln=16;class Xi extends ne{constructor(n,t,r,i,o,s,a,l){const c=Ni(r,i),h=i.type==="delivery"&&i.pickupDestinationId===i.issuingDestinationId,d=c.ok?{label:"ACCEPT MISSION",action:()=>o(h)}:{label:"ACCEPT MISSION",disabled:!0,details:c.reason?[c.reason]:[],action:()=>{}},p={label:"BACK",action:()=>s()},u=Array.from({length:Ln},()=>"");super("MISSION BOARD",[d,p],[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],n,t,r,u),this.spec=i,this.onBack=s,this.onHub=a,this.onUndock=l}destColor(n){if(n===this.player.destinationId)return"bright-green";const t=G(n);return t&&t.system===this.player.systemId?"bright-yellow":"white"}writeDestRow(n,t,r,i,o,s){f(n,t,2,r,"white","black"),f(n,t,2+r.length,i.slice(0,s-r.length),this.destColor(o),"black")}handleNavAction(n){this.activated||(n==="NAV_1"?(this.activated=!0,this.onUndock()):n==="NAV_2"?(this.activated=!0,this.onHub()):n==="BACK"&&(this.activated=!0,this.onBack()))}handleNavTap(n){this.activated||(n==="undock"?(this.activated=!0,this.onUndock()):n==="hub"&&(this.activated=!0,this.onHub()))}renderContent(n,t,r){super.renderContent(n,t,r),this.renderDetail(n,t-Ln)}renderDetail(n,t){const i=n.length>0?n[0].length:40,o=i-4,s=this.lastContentTop-1;let a=t;const l=(u,m,g)=>{u<=s&&f(n,u,2,m.slice(0,o),g,"black")};l(a,`${Qi[this.spec.type]} ${this.spec.title}`,"bright-yellow"),a++;const c=N(),h=this.spec.giverFactionId?c.factions.find(u=>u.id===this.spec.giverFactionId):null,d=h?` [${h.name}]`:"";if(l(a,`    ${this.spec.giverName}${d}`,"bright-black"),a++,a++,this.spec.type==="delivery"){const u=G(this.spec.pickupDestinationId),m=G(this.spec.deliveryDestinationId);if(a<=s&&this.writeDestRow(n,a,"Pickup:  ",(u==null?void 0:u.name)??this.spec.pickupDestinationId,this.spec.pickupDestinationId,o),a++,a<=s&&this.writeDestRow(n,a,"Deliver: ",(m==null?void 0:m.name)??this.spec.deliveryDestinationId,this.spec.deliveryDestinationId,o),a++,a<=s){const g=this.player.cargoCapacity-this.player.cargoWeightKg,b=this.spec.itemWeightKg,k=g>=b,E=`Weight:  ${b} kg  (Free: ${g} kg)`;f(n,a,2,E,"white","black");const x=k?"bright-green":"red",A=2+E.length+1;A<i&&f(n,a,A,k?"✓":"✗",x,"black")}a++}else{const u=G(this.spec.deliveryDestinationId);a<=s&&this.writeDestRow(n,a,"Deliver to: ",(u==null?void 0:u.name)??this.spec.deliveryDestinationId,this.spec.deliveryDestinationId,o),a++;for(const m of this.spec.requirements){if(a>s)break;const g=se(m.commodityId);l(a,`  ${m.qty}x ${(g==null?void 0:g.name)??m.commodityId}`,"white"),a++}}a++;const p=We(this.spec.description,o);for(const u of p){if(a>s)break;l(a,u,"white"),a++}if(a++,!(a>s)&&(l(a,`REWARD: ${this.spec.reward} CR`,"bright-green"),a++,this.spec.giverFactionId)){if(a++,a>s)return;const u=N(),m=u.factions.find(g=>g.id===this.spec.giverFactionId);if(m){const g=$(),b=this.spec.reward;let k;b>=g.reputation.missionTierLargeReward?k=g.reputation.missionDeltaLarge:b>=g.reputation.missionTierMediumReward?k=g.reputation.missionDeltaMedium:k=g.reputation.missionDeltaSmall;const E=mn(m,k,u.factions),x=[];for(const[A,v]of E){const _=u.factions.find(y=>y.id===A);_&&x.push({id:A,name:_.name,delta:v})}if(x.sort((A,v)=>A.delta!==v.delta?v.delta-A.delta:A.name.localeCompare(v.name)),x.length>0){a<=s&&(l(a,"REPUTATION IMPACT","bright-cyan"),a++);for(const A of x){if(a>s)break;const v=pn(A.delta),_=A.delta>0?"bright-green":"red",y=o-v.length-2,C=A.name.slice(0,y),R=" ".repeat(Math.max(0,o-C.length-v.length));l(a,`  ${C}${R}${v}`,_),a++}}x.length>0&&a++}}}}const Ji=[18,10,5],Zi=[".","*","+"],Nn=[4e3,2e3,800],er=[9e3,5e3,2500],nr=[null,"bright-black","white"],tr=["bright-black","white","bright-white"],ir=["white","bright-white","bright-cyan"],Re=3,Fn=25,Le=2,On=37,Dn=2*Math.PI;function rr(e){let n=e>>>0;return()=>(n=Math.imul(n,1664525)+1013904223>>>0,n/4294967296)}class or{constructor(n=42){this.boundsSet=!1,this.rand=rr(n),this.stars=[];for(let t=0;t<3;t++)for(let r=0;r<Ji[t];r++){const i=Le+Math.floor(this.rand()*(On-Le+1)),o=Re+Math.floor(this.rand()*(Fn-Re+1)),s=this.rand()*Dn,a=Nn[t]+this.rand()*(er[t]-Nn[t]);this.stars.push({col:i,row:o,layer:t,twinklePhase:s,twinklePeriod:a})}}update(n){for(const t of this.stars)t.twinklePhase+=Dn/t.twinklePeriod*n}render(n,t,r,i,o){if(!this.boundsSet){this.boundsSet=!0;const s=Fn-Re,a=On-Le;{const l=(r-t)/s,c=(o-i)/a;for(const h of this.stars)h.row=Math.round(t+(h.row-Re)*l),h.col=Math.round(i+(h.col-Le)*c)}}for(const s of this.stars){const{row:a,col:l,layer:c}=s;if(a<t||a>r||l<i||l>o)continue;const h=Math.sin(s.twinklePhase);let d;h>=.5?d=ir[c]:h>=-.5?d=tr[c]:d=nr[c],d!==null&&(n[a][l]={char:Zi[c],fg:d,bg:"black"})}}getStars(){return this.stars}}const sr=6,Ze=6,ar=23,lr=23,en=10,cr=0,dr=4,hr=18,ur=21,pr=35,mr=39,Pn=12,fr=11,ie=13,be=27,nn=28,gr=12,tn=40,Un=200,rn=["> SYSTEM STATUS: ALL CLEAR","> DRIVE EFFICIENCY: 97%","> BEACON SIGNAL DETECTED ON 14.7 MHz","> TRADE ROUTE UPDATE: ELYSIUM CORRIDOR STABLE","> WARNING: DEBRIS FIELD DELTA-9 ACTIVE","> COMMS RELAY SIGNAL NOMINAL","> FUEL RESERVES OPTIMAL","> SECTOR SCAN COMPLETE — NO HOSTILES","> GRAVITATIONAL ANOMALY LOGGED AT BEARING 227","> TRANSPONDER HANDSHAKE: ACCEPTED"],yr="#",Bn=["green","cyan","white","yellow"],Hn=["*",".","+","x"];function $n(e){let n=e>>>0;return()=>(n=Math.imul(n,1664525)+1013904223>>>0,n/4294967296)}function br(e,n,t){return{col:n,row:t,char:yr,color:Bn[Math.floor(e()*Bn.length)],phase:e()*2e4,period:1e4+e()*1e4,active:e()>.2}}function _e(e,n,t,r){const i=[];for(const o of r)for(let s=n;s<=t;s++)i.push(br(e,s,o));return i}class _r extends fe{constructor(n,t,r,i,o,s,a){super(n,t,r,{navOptions:[],onMenu:a}),this.cursorIdx=0,this.h=30,this.blinkPhase=0,this.msgIdx=0,this.tickerScroll=0,this.tickerAccum=0,this.tickerPause=0,this.onTravel=i,this.onDock=o,this.onCargo=s,this.starfield=new or(42),this.inSpace=r.destinationId===null;const l=$n(99);this.gaugeBtns=[..._e(l,cr,dr,[3,4]),..._e(l,hr,ur,[3,4]),..._e(l,pr,mr,[3,4])],this.leftBtns=_e(l,0,fr,[0,1,2,3]),this.rightBtns=_e(l,nn,39,[0,1,2,3]);const c=$n(77),h=3+Math.floor(c()*4);this.radarContacts=Array.from({length:h},()=>({x:c()*(be-ie-1),y:c()*4,vx:(c()-.5)*2,vy:(c()-.5)*1.5,char:Hn[Math.floor(c()*Hn.length)]}))}navCount(){return this.inSpace?1:2}handleAction(n){n==="CARGO"?(this.activated=!0,this.onCargo()):n==="UP"?this.cursorIdx=(this.cursorIdx-1+this.navCount())%this.navCount():n==="DOWN"?this.cursorIdx=(this.cursorIdx+1)%this.navCount():n==="SELECT"&&(this.cursorIdx===0?(this.activated=!0,this.onTravel()):this.inSpace||(this.activated=!0,this.onDock()))}handleTap(n,t){const r=this.h;(t===3||t===4)&&n>=Ze&&n<Ze+1+en?(this.activated=!0,this.onCargo()):t===r-3&&n<Pn?(this.activated=!0,this.onTravel()):t===r-3&&n>=nn&&!this.inSpace&&(this.activated=!0,this.onDock())}update(n){this.starfield.update(n),this.blinkPhase=(this.blinkPhase+n)%1e3;for(const i of[...this.gaugeBtns,...this.leftBtns,...this.rightBtns])i.phase+=n,i.phase>=i.period&&(i.phase-=i.period,i.active=!i.active);const t=be-ie,r=5;for(const i of this.radarContacts)i.x+=i.vx*n/1e3,i.y+=i.vy*n/1e3,i.x<0&&(i.x=-i.x,i.vx=-i.vx),i.x>t-1&&(i.x=2*(t-1)-i.x,i.vx=-i.vx),i.y<0&&(i.y=-i.y,i.vy=-i.vy),i.y>r-1&&(i.y=2*(r-1)-i.y,i.vy=-i.vy);if(this.tickerPause>0)this.tickerPause=Math.max(0,this.tickerPause-n);else for(this.tickerAccum+=n;this.tickerAccum>=Un;){this.tickerAccum-=Un,this.tickerScroll++;const i=rn[this.msgIdx];if(this.tickerScroll>=i.length+tn-1){this.tickerScroll=0,this.msgIdx=(this.msgIdx+1)%rn.length,this.tickerPause=500,this.tickerAccum=0;break}}}renderContent(n,t,r){const i=n.length,o=i>0?n[0].length:0;this.h=i;const s=t+2,a=i-8,l=i-7,c=i-3,h=i-2;this.renderGaugeStrip(n,t),this.starfield.render(n,s,a,0,39);for(let d=0;d<o;d++)n[s][d]={char:"-",fg:"white",bg:"black"},n[a][d]={char:"-",fg:"white",bg:"black"};this.renderHUD(n,s+1),this.renderCrosshair(n,s+1,a-1),this.renderBottomPanels(n,l,c),this.renderTicker(n,h)}renderGaugeStrip(n,t){for(const s of this.gaugeBtns){const a=t+s.row-3,l=s.active?s.color:"bright-black";a>=0&&a<n.length&&(n[a][s.col]={char:s.char,fg:l,bg:"black"})}const r=this.player.fuelL/this.player.fuelCapacityL,i=this.player.cargoWeightKg/this.player.cargoCapacity,o=this.blinkPhase<500;this.renderGauge(n,t,sr,"F",r,"yellow",o),this.renderGauge(n,t+1,Ze,"C",i,"blue",o),this.renderGauge(n,t,ar,"S",1,"cyan",o),this.renderGauge(n,t+1,lr,"H",1,"green",o)}renderGauge(n,t,r,i,o,s,a){if(t<0||t>=n.length)return;n[t][r]={char:i,fg:s,bg:"black"};const l=Math.round(Math.min(1,Math.max(0,o))*en),c=o<=.2;for(let h=0;h<en;h++){const d=r+1+h;if(h<l){const p=c&&!a?"bright-black":s;n[t][d]={char:" ",fg:"black",bg:p}}else n[t][d]={char:" ",fg:"black",bg:"bright-black"}}}renderHUD(n,t){f(n,t,1,"VEL:----","bright-black","black"),f(n,t,16,"ATT:---°","bright-black","black"),f(n,t,30,"ROT:--°","bright-black","black")}renderCrosshair(n,t,r){var a;const i=Math.floor((t+r)/2),o=20;n[i][o]={char:"+",fg:"bright-green",bg:"black"};const s=[[i-3,o-5],[i-3,o+5],[i+3,o-5],[i+3,o+5]];for(const[l,c]of s){const h=((a=n[0])==null?void 0:a.length)??40;l>=t&&l<=r&&c>=0&&c<h&&(n[l][c]={char:"+",fg:"bright-green",bg:"black"})}}renderBottomPanels(n,t,r){for(let c=t;c<=r;c++)for(let h=ie;h<be;h++)n[c][h]={char:" ",fg:"black",bg:"bright-black"};this.renderRadar(n,t,r-t+1);for(const c of this.leftBtns){const h=t+c.row;if(h<r){const d=c.active?c.color:"bright-black";n[h][c.col]={char:c.char,fg:d,bg:"black"}}}for(const c of this.rightBtns){const h=t+c.row;if(h<r){const d=c.active?c.color:"bright-black";n[h][c.col]={char:c.char,fg:d,bg:"black"}}}const i=this.cursorIdx===0?"bright-yellow":"yellow";f(n,r,0,this.centerPad("TRAVEL",Pn),"black",i);let o,s;this.inSpace?(o="bright-black",s="bright-black"):(o=this.cursorIdx===1?"bright-cyan":"cyan",s="black"),f(n,r,nn,this.centerPad("DOCK",gr),s,o);const a=be-ie,l="<)) "+"-".repeat(a-4);f(n,r,ie,l,"white","bright-black")}renderRadar(n,t,r){for(const i of this.radarContacts){const o=Math.min(be-ie-1,Math.max(0,Math.floor(i.x))),s=Math.min(r-1,Math.max(0,Math.floor(i.y)));n[t+s][ie+o]={char:i.char,fg:"white",bg:"bright-black"}}}renderTicker(n,t){const r=rn[this.msgIdx];for(let i=0;i<tn;i++){const o=this.tickerScroll-tn+1+i,s=o>=0&&o<r.length?r[o]:" ";n[t][i]={char:s,fg:"white",bg:"black"}}}centerPad(n,t){if(n.length>=t)return n.slice(0,t);const r=t-n.length,i=Math.floor(r/2);return" ".repeat(i)+n+" ".repeat(r-i)}}class vr extends fe{constructor(n,t,r,i,o){super(n,t,r,{title:"CARGO HOLD",tabs:["COMMODITIES","MISSION GOODS"],navOptions:[{id:"back",label:"BACK"}],onMenu:o}),this.onBack=i}handleNavTap(n){n==="back"&&(this.activated=!0,this.onBack())}handleAction(n){(n==="BACK"||n==="CARGO")&&(this.activated=!0,this.onBack())}renderContent(n,t,r){const o=n.length>0?n[0].length:0,s=this.player.cargoHold,a=this.player.missionItems,l=this.player.cargoCapacity,c=this.player.cargoWeightKg,h=r-1;this.activeTabIdx===0?this.renderCommoditiesTab(n,t,h,o,s):this.renderMissionGoodsTab(n,t,h,o,a);const d=`TOTAL: ${c}/${l}KG`;f(n,h,2,d,"bright-black","black")}renderCommoditiesTab(n,t,r,i,o){if(o.length===0){f(n,t,2,"NO COMMODITIES","bright-black","black");return}let s=t;for(const a of o){if(s>=r-1)break;const l=se(a.commodityId);if(!l)continue;const c=a.qty*l.weightKg,h=`  x${a.qty}  ${l.basePrice}CR  ${c}KG`,d=Math.max(6,i-4-h.length),p=l.name,u=p.length>d?p.slice(0,d):p;f(n,s,2,`${u}${h}`,"white","black"),s++}}renderMissionGoodsTab(n,t,r,i,o){if(o.length===0){f(n,t,2,"NO MISSION GOODS","bright-black","black");return}let s=t;for(const a of o){if(s>=r-1)break;const l=`  ${a.weightKg}KG`,c=Math.max(6,i-4-l.length),h=a.itemName.length>c?a.itemName.slice(0,c):a.itemName;f(n,s,2,`${h}${l}`,"white","black"),s++}}}class Gn extends ne{constructor(n,t,r,i,o,s,a,l,c=()=>{}){const h=Ue(r.systemId),d=wt(r.driveId),p=[...h.destinations.map(b=>({label:G(b).name.toUpperCase(),disabled:b===r.destinationId,action:()=>i(b)})),{label:"FLY INTO SPACE",disabled:r.destinationId===null,action:s}],m=[...un(r.systemId).map(b=>{const k=b.from===r.systemId?b.to:b.from,E=Ue(k),x=b.stability.toUpperCase(),A=Math.ceil($().fuel.consumptionPerLy*b.distance*d.fuelEfficiency);return{label:`${E.name.toUpperCase()}  ${b.distance}LY  [${x}]`.slice(0,36),disabled:A>r.fuelL,action:()=>o(k)}}),{label:"GALAXY MAP...",action:l}],g=[{label:"DESTINATIONS",items:p},{label:"JUMPS",items:m}];super("TRAVEL",[],[{id:"ship",label:"SHIP"}],n,t,r,[],g,c),this.onShip=a}handleNavAction(n){(n==="BACK"||n==="NAV_1")&&!this.activated&&(this.activated=!0,this.onShip())}handleNavTap(n){n==="ship"&&!this.activated&&(this.activated=!0,this.onShip())}}function Wn(e,n){if(e===n)return[e];const t=[[e]],r=new Set([e]);for(;t.length>0;){const i=t.shift(),o=i[i.length-1];for(const s of un(o)){const a=s.from===o?s.to:s.from;if(a===n)return[...i,a];r.has(a)||(r.add(a),t.push([...i,a]))}}return null}const wr=0,kr=4,xr=8,Cr=9,jn=10,Kn=15,Tr=16,Ar=2,Sr=10,Ir=12,Ne=13,Fe=12,Mr=25,Er=26,Rr=10,Yn=18;function Lr(e,n){return e.length>=n?e.slice(0,n):e+" ".repeat(n-e.length)}function ve(e,n){return"["+Lr(e.toUpperCase(),n-2)+"]"}class Nr extends fe{constructor(n,t,r,i,o=()=>{}){super(n,t,r,{title:"GALAXY MAP",tabs:["MAP","ROUTE"],navOptions:[{id:"back",label:"BACK"}],onMenu:o}),this.mapCursorIdx=0,this.routeDestIdx=0,this.searchText="",this.lastTop=we+5,this.onBack=i,this.publicSystems=Si().sort((s,a)=>s.distanceFromSol-a.distanceFromSol),this.otherSystems=this.publicSystems.filter(s=>s.id!==r.systemId),this.mapBrowsingSystemId=r.systemId}onTabChange(n){this.searchText=""}handleCharInput(n){if(this.activeTabIdx!==0)return;const t=n.charCodeAt(0);n==="\b"||n===""?this.searchText=this.searchText.slice(0,-1):t>=32&&t<127&&(this.searchText+=n.toUpperCase(),this.mapCursorIdx=0)}handleAction(n){if(n==="BACK"){if(this.searchText.length>0){this.searchText="";return}this.activated=!0,this.onBack();return}this.activeTabIdx===0?this.handleMapAction(n):this.handleRouteAction(n)}handleNavTap(n){n==="back"&&(this.searchText="",this.activated=!0,this.onBack())}handleTap(n,t){const r=this.lastTop,i=r+jn,o=r+Kn;if(this.activeTabIdx===0&&t>=i&&t<o){const s=this.getMapNeighbors(),a=t-i;a>=0&&a<s.length&&(this.mapBrowsingSystemId=s[a].id,this.mapCursorIdx=0,this.searchText="")}else if(this.activeTabIdx===1){const s=r+3,a=r+9;if(t>=s&&t<=a){const l=t-s;l>=0&&l<this.otherSystems.length&&(this.routeDestIdx=l)}}}getMapNeighbors(){const t=un(this.mapBrowsingSystemId).map(r=>{const i=r.from===this.mapBrowsingSystemId?r.to:r.from,o=this.publicSystems.find(a=>a.id===i),s=r.distance;return o?{sys:o,dist:s}:null}).filter(r=>r!==null).sort((r,i)=>r.dist-i.dist).map(r=>r.sys);return this.searchText.length===0?t:t.filter(r=>r.name.toUpperCase().includes(this.searchText))}handleMapAction(n){const t=this.getMapNeighbors(),r=Math.min(this.mapCursorIdx,Math.max(0,t.length-1));if(n==="UP")this.mapCursorIdx=Math.max(0,r-1);else if(n==="DOWN")this.mapCursorIdx=Math.min(t.length-1,r+1);else if(n==="SELECT"){const i=t[r];if(!i)return;this.mapBrowsingSystemId=i.id,this.mapCursorIdx=0,this.searchText=""}}handleRouteAction(n){n==="UP"?this.routeDestIdx=Math.max(0,this.routeDestIdx-1):n==="DOWN"&&(this.routeDestIdx=Math.min(this.otherSystems.length-1,this.routeDestIdx+1))}computeRoute(){const n=this.otherSystems[this.routeDestIdx];return n?Wn(this.player.systemId,n.id):null}renderContent(n,t,r){this.lastTop=t;const i=n.length>0?n[0].length:0;this.activeTabIdx===0?this.renderMapTab(n,t,r,i):this.renderRouteTab(n,t,r,i)}renderMapTab(n,t,r,i){const o=this.publicSystems.find(p=>p.id===this.mapBrowsingSystemId)??this.publicSystems[0];if(!o)return;const s=t+Cr,a=t+jn,l=t+Kn,c=t+Tr;this.renderChart(n,o,t),Ee(n,s,i);const h=this.getMapNeighbors(),d=Math.min(this.mapCursorIdx,Math.max(0,h.length-1));this.renderNeighborList(n,i,o,h,d,a,l),Ee(n,l,i),this.renderInfo(n,i,o,h[d]??null,c),this.searchText.length>0&&f(n,c+4,2,`/${this.searchText}_`,"bright-yellow","black")}renderChart(n,t,r){var h;const i=this.getMapNeighbors(),o=r+wr,s=r+kr,a=r+xr,l=t.id===this.player.systemId?"bright-yellow":"bright-cyan";if(f(n,s,Ne,ve(t.name,Fe),l,"black"),t.id===this.player.systemId){const d=Ne+Fe,p=((h=n[0])==null?void 0:h.length)??40;d<p&&(n[s][d]={char:"*",fg:"bright-yellow",bg:"black"})}const c=["left","right","top","bottom"];for(let d=0;d<Math.min(i.length,4);d++){const p=i[d],u=c[d],m=p.id===this.player.systemId?"bright-yellow":"white";if(u==="left")f(n,s,Ar,ve(p.name,Sr),m,"black"),n[s][Ir]={char:"-",fg:"bright-black",bg:"black"};else if(u==="right")f(n,s,Er,ve(p.name,Rr),m,"black"),n[s][Mr]={char:"-",fg:"bright-black",bg:"black"};else if(u==="top"){f(n,o,Ne,ve(p.name,Fe),m,"black");for(let g=o+1;g<s;g++)n[g][Yn]={char:"|",fg:"bright-black",bg:"black"}}else{f(n,a,Ne,ve(p.name,Fe),m,"black");for(let g=s+1;g<a;g++)n[g][Yn]={char:"|",fg:"bright-black",bg:"black"}}}}renderNeighborList(n,t,r,i,o,s,a){for(let l=0;l<i.length&&l<a-s;l++){const c=i[l],h=s+l,d=l===o,u=c.id===this.player.systemId?"bright-yellow":d?"bright-cyan":"white",m=d?"> ":"  ",g=Oe(r.id,c.id),b=g?`${g.distance}LY  ${g.stability}`:"",k=t-4-b.length;f(n,h,2,m+c.name.toUpperCase().slice(0,k-2),u,"black"),b&&f(n,h,t-2-b.length,b,"bright-black","black")}}renderInfo(n,t,r,i,o){const a=r.id===this.player.systemId?"* Current location":r.name.toUpperCase();if(f(n,o,2,`Zone: ${r.zone}  Sec: ${r.security}  ${a}`.slice(0,t-4),"bright-black","black"),!i)return;const l=Oe(r.id,i.id);if(!l)return;const c=Wn(this.player.systemId,i.id),h=c?c.length===1?"(your location)":`${c.length-1} hop${c.length-1!==1?"s":""} from you`:"(unreachable)";f(n,o+1,2,`${i.name.toUpperCase()}  ${l.distance}LY  ${h}`.slice(0,t-4),"bright-black","black")}renderRouteTab(n,t,r,i){var k,E;const o=t,s=t+2,a=t+3,l=7,c=a+l,h=c+1,d=h+6,p=this.publicSystems.find(x=>x.id===this.player.systemId);f(n,o,2,"FROM:","bright-black","black"),f(n,o,8,(p==null?void 0:p.name.toUpperCase())??this.player.systemId.toUpperCase(),"bright-yellow","black"),f(n,s,2,"TO:","bright-black","black");const u=Math.max(0,Math.min(this.routeDestIdx,this.otherSystems.length-l));for(let x=0;x<l;x++){const A=u+x;if(A>=this.otherSystems.length)break;const v=this.otherSystems[A],_=A===this.routeDestIdx,y=_?"bright-cyan":"white",C=_?"> ":"  ";f(n,a+x,2,C+v.name.toUpperCase(),y,"black")}Ee(n,c,i),Ee(n,d,i);const m=this.computeRoute();if(!this.otherSystems[this.routeDestIdx])return;if(!m){f(n,h,2,"No route found","bright-red","black");return}const b=m.length-1;f(n,h,2,`Route: ${b} hop${b!==1?"s":""}`,"bright-white","black");for(let x=0;x<b;x++){const A=Oe(m[x],m[x+1]);if(!A)continue;const v=h+1+x;if(v>=d)break;const _=(((k=this.publicSystems.find(C=>C.id===m[x]))==null?void 0:k.name)??m[x]).toUpperCase().slice(0,9),y=(((E=this.publicSystems.find(C=>C.id===m[x+1]))==null?void 0:E.name)??m[x+1]).toUpperCase().slice(0,9);f(n,v,4,`${_} -> ${y}  ${A.distance}LY  ${A.stability}`.slice(0,i-6),"white","black")}}}class te extends fe{constructor(n,t,r,i){const o={onAction:()=>{}};super(o,t,n,{navOptions:[]}),this.elapsed=0,this.arrived=!1,this.duration=r,this.onComplete=i}update(n){this.arrived||(this.elapsed+=n,this.elapsed>=this.duration&&(this.arrived=!0,this.onComplete()))}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[]}}}const Fr=["[. . .]","[: : :]","[* * *]"],qn=5e3;class Or extends te{constructor(n,t,r){super(n,t,qn,r)}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[],systemLabel:"IN TRANSIT",destinationLabel:null}}renderContent(n,t,r){const i=n.length,o=Math.floor(i/2),s=Math.floor(this.elapsed/500)%3,a=Math.ceil((qn-this.elapsed)/1e3),l=Math.max(1,Math.min(5,a)),c=Ue(this.player.systemId),h=c?c.name.toUpperCase():this.player.systemId.toUpperCase();I(n,o-3,"[ JUMP DRIVE ENGAGED ]","bright-cyan","black"),I(n,o-1,"DESTINATION:","bright-black","black"),I(n,o,h,"bright-white","black"),I(n,o+2,Fr[s],"bright-black","black"),I(n,o+4,`ARRIVING IN ${l}S`,"bright-black","black")}}const Vn=2e3,Dr=["[ —   ]","[  —  ]","[   — ]"];class zn extends te{constructor(n,t,r,i){super(n,t,Vn,r),this.targetLabel=i}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[],destinationLabel:"IN TRANSIT"}}renderContent(n,t,r){const i=n.length,o=Math.floor(i/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((Vn-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a)),c=this.targetLabel!==void 0?this.targetLabel.toUpperCase():(()=>{const h=this.player.destinationId?G(this.player.destinationId):null;return h?h.name.toUpperCase():"UNKNOWN"})();I(n,o-3,"[ THRUSTERS ENGAGED ]","bright-yellow","black"),I(n,o-1,"HEADING TO:","bright-black","black"),I(n,o,c,"bright-white","black"),I(n,o+2,Dr[s],"bright-black","black"),I(n,o+4,`ARRIVING IN ${l}S`,"bright-black","black")}}const Qn=2500,Pr=["v","vv","vvv"];class Ur extends te{constructor(n,t,r){super(n,t,Qn,r)}renderContent(n,t,r){const i=n.length,o=Math.floor(i/2),s=Math.floor(this.elapsed/400)%3,a=Math.ceil((Qn-this.elapsed)/1e3),l=Math.max(1,Math.min(3,a));I(n,o-3,"[ LANDING SEQUENCE ]","bright-green","black"),I(n,o+2,Pr[s],"bright-black","black"),I(n,o+4,`TOUCHDOWN IN ${l}S`,"bright-black","black")}}const Xn=2500,Br=[">",">>",">>>"];class Hr extends te{constructor(n,t,r){super(n,t,Xn,r)}renderContent(n,t,r){const i=n.length,o=Math.floor(i/2),s=Math.floor(this.elapsed/400)%3,a=Math.ceil((Xn-this.elapsed)/1e3),l=Math.max(1,Math.min(3,a));I(n,o-3,"[ APPROACH LOCKED ]","bright-yellow","black"),I(n,o+2,Br[s],"bright-black","black"),I(n,o+4,`CLAMPING IN ${l}S`,"bright-black","black")}}const Jn=1500,$r=["^","^^","^^^"];class Gr extends te{constructor(n,t,r){super(n,t,Jn,r)}renderContent(n,t,r){const i=n.length,o=Math.floor(i/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((Jn-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));I(n,o-3,"[ LIFTOFF SEQUENCE ]","bright-green","black"),I(n,o+2,$r[s],"bright-black","black"),I(n,o+4,`CLEAR IN ${l}S`,"bright-black","black")}}const Zn=1500,Wr=["<","<<","<<<"];class jr extends te{constructor(n,t,r){super(n,t,Zn,r)}renderContent(n,t,r){const i=n.length,o=Math.floor(i/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((Zn-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));I(n,o-3,"[ RELEASING CLAMPS ]","bright-yellow","black"),I(n,o+2,Wr[s],"bright-black","black"),I(n,o+4,`DEPARTING IN ${l}S`,"bright-black","black")}}const et=1500,Kr=["→","→→","→→→"];class Yr extends te{constructor(n,t,r){super(n,t,et,r)}renderContent(n,t,r){const i=n.length,o=Math.floor(i/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((et-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));I(n,o-3,"[ DOCKING SEQUENCE ]","bright-cyan","black"),I(n,o+2,Kr[s],"bright-black","black"),I(n,o+4,`DOCKING IN ${l}S`,"bright-black","black")}}const nt=1500,qr=["←","←←","←←←"];class Vr extends te{constructor(n,t,r){super(n,t,nt,r)}renderContent(n,t,r){const i=n.length,o=Math.floor(i/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((nt-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));I(n,o-3,"[ DEPARTING BERTH ]","bright-cyan","black"),I(n,o+2,qr[s],"bright-black","black"),I(n,o+4,`CLEAR IN ${l}S`,"bright-black","black")}}function zr(e){let n=e>>>0;return()=>(n=Math.imul(n,1664525)+1013904223>>>0,n/4294967296)}function Qr(e,n){return Math.floor(e()*n)}function ue(e,n){return n[Qr(e,n.length)]}function Ct(e,n){const{special:t,firstNames:r,lastNames:i}=n.npcNames;if(e()<$().npc.specialNameChance&&t.length>0)return{giverName:ue(e,t)};const o=r.length>0?ue(e,r):"Unknown",s=i.length>0?ue(e,i):"Agent";return{giverName:`${o} ${s}`}}function Xr(e,n){return n.destinations.filter(t=>t.id!==e.id)}function Jr(e){return e.commodities.filter(n=>n.legal)}function Zr(e,n,t,r){var m;const i=t.deliveryItems;if(i.length===0)return null;const o=Xr(n,t);if(o.length===0)return null;const s=ue(e,i),a=ue(e,o),l=Ct(e,t),{deliveryBaseReward:c,deliveryRandomReward:h}=$().missions,d=Math.floor(s.weightKg*1.5),p=c+d+Math.floor(e()*h),u=n.owningFactionId?(m=N().factions.find(g=>g.id===n.owningFactionId&&je(g)))==null?void 0:m.id:void 0;return{...l,giverFactionId:u,id:r,type:"delivery",title:s.name,description:`A package needs transporting. Pick up the ${s.name} from ${n.name} and deliver it to ${a.name}. Handle with care.`,reward:p,issuingDestinationId:n.id,itemName:s.name,itemWeightKg:s.weightKg,pickupDestinationId:n.id,deliveryDestinationId:a.id}}function eo(e,n,t,r){var v;const i=Jr(t);if(i.length===0)return null;const o=n.goodsBias.map(_=>_.toLowerCase()),s=[];for(const _ of i){const y=o.some(C=>_.category.includes(C)||_.id.includes(C)||C.includes(_.category));s.push(_),y&&s.push(_)}const{supplyRequirementsMin:a,supplyRequirementsMax:l,supplyQtyMin:c,supplyQtyMax:h}=$().missions,d=a+Math.floor(e()*(l-a+1)),p=[],u=new Set;for(let _=0;_<d;_++){let y=0;for(;y<10;){const C=ue(e,s);if(!u.has(C.id)){u.add(C.id);const R=c+Math.floor(e()*(h-c+1));p.push({commodityId:C.id,qty:R});break}y++}}if(p.length===0)return null;const m=p.reduce((_,y)=>{const C=t.commodities.find(R=>R.id===y.commodityId);return _+((C==null?void 0:C.basePrice)??100)*y.qty},0),{supplyRewardMargin:g,supplyRandomReward:b}=$().missions,k=Math.floor(m*g)+Math.floor(e()*b),E=Ct(e,t),x=p.map(_=>{const y=t.commodities.find(C=>C.id===_.commodityId);return`${_.qty}× ${(y==null?void 0:y.name)??_.commodityId}`}).join(", "),A=n.owningFactionId?(v=N().factions.find(_=>_.id===n.owningFactionId&&je(_)))==null?void 0:v.id:void 0;return{...E,giverFactionId:A,id:r,type:"supply",title:n.name,description:`${n.name} needs supplies. Deliver ${x} to fulfil the contract.`,reward:k,issuingDestinationId:n.id,requirements:p,deliveryDestinationId:n.id}}function no(e,n,t){const r=zr(t),{boardCountMin:i,boardCountMax:o,deliveryChance:s}=$().missions,a=i+Math.floor(r()*(o-i+1)),l=[];for(let c=0;c<a;c++){const h=`m-${(t>>>0).toString(16)}-${c}`,p=r()<s?Zr(r,e,n,h):eo(r,e,n,h);p&&l.push(p)}return l}const to=100;class io{constructor(n,t,r){this.sceneBeforeMenu=null,this.traderStockCache=new Map,this.missionBoardCache=new Map,this.renderer=n,this.input=t,this.context=r;const i=Ti(),o=kt(i.startingShip);this.player=new Fi({shipId:i.startingShip,driveId:o.defaultJumpDrive,credits:i.player.startingCredits,systemId:i.startingLocation.system,destinationId:i.startingLocation.destination}),this.currentScene=new In(this.input,this.context,this.player,()=>this.goToStory())}tick(n){const t=Math.min(n,to),r=this.makeBuffer();this.currentScene.update(t),this.currentScene.render(r),this.renderer.drawBuffer(r)}makeBuffer(){const n=this.renderer.getWidth(),t=this.renderer.getHeight();return Array.from({length:t},()=>Array.from({length:n},()=>({char:" ",fg:"black",bg:"black"})))}getOrCreateTraderStock(n){const t=Date.now(),r=this.traderStockCache.get(n),i=$();if(r&&t-r.generatedAt<i.trading.stockTtlMs)return r.entries;const o=Ai(),{stockCountMin:s,stockCountMax:a,stockQtyMin:l,stockQtyMax:c}=i.trading,h=s+Math.floor(Math.random()*(a-s+1)),d=[...o];for(let u=d.length-1;u>0;u--){const m=Math.floor(Math.random()*(u+1));[d[u],d[m]]=[d[m],d[u]]}const p=d.slice(0,h).map(u=>({commodityId:u.id,qty:l+Math.floor(Math.random()*(c-l+1))}));return this.traderStockCache.set(n,{entries:p,generatedAt:t}),p}getOrCreateMissionBoard(n){const t=Date.now(),r=this.missionBoardCache.get(n);if(r&&t-r.generatedAt<$().missions.missionTtlMs)return r.specs;const i=G(n),o=N(),s=Math.floor(Math.random()*4294967295),a=no(i,o,s);return this.missionBoardCache.set(n,{specs:a,generatedAt:t}),a}onBuy(n,t,r){if(t<=0)return;const i=r.findIndex(c=>c.commodityId===n);if(i<0)return;const o=r[i];if(t>o.qty)return;const s=se(n);if(!s)return;const a=t*s.basePrice;this.player.credits<a||this.player.cargoWeightKg+t*s.weightKg>this.player.cargoCapacity||(this.player.spendCredits(a),this.player.addCargo(n,t),o.qty-=t,o.qty<=0&&r.splice(i,1))}onSell(n,t,r){if(t<=0)return;const i=this.player.cargoHold.find(l=>l.commodityId===n);if(!i||i.qty<t)return;const o=se(n);if(!o)return;const s=t*o.basePrice;this.player.addCredits(s),this.player.removeCargo(n,t);const a=r.find(l=>l.commodityId===n);a?a.qty+=t:r.push({commodityId:n,qty:t})}goToMainMenu(){this.currentScene=new In(this.input,this.context,this.player,()=>this.goToStory())}goToStory(){this.currentScene=new ji(this.input,this.context,this.player,()=>this.goToStation())}goToStation(){this.currentScene=new Yi(this.input,this.context,this.player,this.player.destinationId,(n,t)=>{this.player.spendCredits(n),this.player.addFuel(t),this.goToStation()},()=>this.goToTrader(),()=>this.goToMissionBoard(),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToLandOrDock(){var t;const n=(t=G(this.player.destinationId))==null?void 0:t.locationType;n==="surface"?this.currentScene=new Ur(this.player,this.context,()=>this.goToStation()):n==="asteroid"?this.currentScene=new Hr(this.player,this.context,()=>this.goToStation()):this.currentScene=new Yr(this.player,this.context,()=>this.goToStation())}goToTakeOffOrUndock(){var t;const n=(t=G(this.player.destinationId))==null?void 0:t.locationType;n==="surface"?this.currentScene=new Gr(this.player,this.context,()=>this.goToShip()):n==="asteroid"?this.currentScene=new jr(this.player,this.context,()=>this.goToShip()):this.currentScene=new Vr(this.player,this.context,()=>this.goToShip())}goToTrader(){const n=this.player.destinationId,t=this.getOrCreateTraderStock(n);this.currentScene=new qi(this.input,this.context,this.player,n,t,(r,i)=>this.onBuy(r,i,t),(r,i)=>this.onSell(r,i,t),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToMissionBoard(){const n=this.player.destinationId;this.currentScene=new zi(this.input,this.context,this.player,n,()=>this.getOrCreateMissionBoard(n),t=>this.goToMissionDetail(t,n),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToMissionDetail(n,t){this.currentScene=new Xi(this.input,this.context,this.player,n,r=>this.onMissionAccepted(n,r,t),()=>this.goToMissionBoard(),()=>this.goToStation(),()=>this.goToTakeOffOrUndock())}onMissionAccepted(n,t,r){const i=this.missionBoardCache.get(r);if(i){const o=i.specs.findIndex(s=>s.id===n.id);o>=0&&i.specs.splice(o,1)}this.player.acceptMission(n,t),this.goToMissionBoard()}goToShip(){this.currentScene=new _r(this.input,this.context,this.player,()=>this.goToTravelMenu(),()=>this.goToLandOrDock(),()=>this.goToCargo(),()=>this.goToGlobalMenu())}goToCargo(){this.currentScene=new vr(this.input,this.context,this.player,()=>this.goToShip(),()=>this.goToGlobalMenu())}buildMenuEntries(){return[{label:"MISSIONS",action:()=>this.goToMissionLog()},{label:"REPUTATION",action:()=>this.goToReputation()}]}goToMissionLog(){this.currentScene=new Ui(this.input,this.context,this.player,()=>this.goToGlobalMenuFromSubScene(),()=>this.returnFromMenu())}goToReputation(){this.currentScene=new Wi(this.input,this.context,this.player,()=>this.goToGlobalMenuFromSubScene(),()=>this.returnFromMenu())}goToGlobalMenuFromSubScene(){this.currentScene=new En(this.input,this.context,this.player,this.buildMenuEntries(),()=>this.returnFromMenu())}goToGlobalMenu(){this.sceneBeforeMenu=this.currentScene,"suspend"in this.currentScene&&this.currentScene.suspend(),this.currentScene=new En(this.input,this.context,this.player,this.buildMenuEntries(),()=>this.returnFromMenu())}returnFromMenu(){const n=this.sceneBeforeMenu;this.sceneBeforeMenu=null,n!==null?("resume"in n&&n.resume(),this.currentScene=n):this.goToShip()}goToTravelMenu(){this.currentScene=new Gn(this.input,this.context,this.player,n=>this.onDestinationSelected(n),n=>this.onJumpSelected(n),()=>this.goToFlyIntoSpace(),()=>this.goToShip(),()=>this.goToGalaxyMap(),()=>this.goToGlobalMenu())}goToArrival(){this.currentScene=new Gn(this.input,this.context,this.player,n=>this.onDestinationSelected(n),n=>this.onJumpSelected(n),()=>this.goToFlyIntoSpace(),()=>this.goToShip(),()=>this.goToGalaxyMap(),()=>this.goToGlobalMenu())}goToGalaxyMap(){this.currentScene=new Nr(this.input,this.context,this.player,()=>this.goToTravelMenu(),()=>this.goToGlobalMenu())}goToFlyIntoSpace(){this.player.undock(),this.currentScene=new zn(this.player,this.context,()=>this.goToShip(),"OPEN SPACE")}onDestinationSelected(n){this.player.dock(n),this.currentScene=new zn(this.player,this.context,()=>this.goToShip())}onJumpSelected(n){const t=Oe(this.player.systemId,n),r=wt(this.player.driveId),i=Math.ceil($().fuel.consumptionPerLy*t.distance*r.fuelEfficiency);this.player.consumeFuel(i),this.player.jumpTo(n),this.currentScene=new Or(this.player,this.context,()=>this.goToArrival())}}const ro=`---
commodities:
...
Adventure here is fraught with inconsistent communications and unreliable star charts.`,Do=`---
routes:
...
Long range engines for faster than light travel between systems.`,Go=`---
id: freighter
...
`;var F={},Ce={},Y={};function Tt(e){return typeof e>"u"||e===null}function rs(e){return typeof e=="object"&&e!==null}function os(e){return Array.isArray(e)?e:Tt(e)?[]:[e]}function ss(e,n){var t,r,i,o;if(n)for(o=Object.keys(n),t=0,r=o.length;t<r;t+=1)i=o[t],e[i]=n[i];return e}function as(e,n){var t="",r;for(r=0;r<n;r+=1)t+=e;return t}function ls(e){return e===0&&Number.NEGATIVE_INFINITY===1/e}Y.isNothing=Tt;Y.isObject=rs;Y.toArray=os;Y.repeat=as;Y.isNegativeZero=ls;Y.extend=ss;function ke(e,n){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=n,this.message=(this.reason||"(unknown reason)")+(this.mark?" "+this.mark.toString():""),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}ke.prototype=Object.create(Error.prototype);ke.prototype.constructor=ke;ke.prototype.toString=function(n){var t=this.name+": ";return t+=this.reason||"(unknown reason)",!n&&this.mark&&(t+=" "+this.mark.toString()),t};var Te=ke,tt=Y;function yn(e,n,t,r,i){this.name=e,this.buffer=n,this.position=t,this.line=r,this.column=i}yn.prototype.getSnippet=function(n,t){var r,i,o,s,a;if(!this.buffer)return null;for(n=n||4,t=t||75,r="",i=this.position;i>0&&`\0\r
...
`+t)),r};var cs=yn,it=Te,ds=["kind","resolve","construct","instanceOf","predicate","represent","defaultStyle","styleAliases"],hs=["scalar","sequence","mapping"];function us(e){var n={};return e!==null&&Object.keys(e).forEach(function(t){e[t].forEach(function(r){n[String(r)]=t})}),n}function ps(e,n){if(n=n||{},Object.keys(n).forEach(function(t){if(ds.indexOf(t)===-1)throw new it('Unknown option "'+t+'" is met in definition of "'+e+'" YAML type.')}),this.tag=e,this.kind=n.kind||null,this.resolve=n.resolve||function(){return!0},this.construct=n.construct||function(t){return t},this.instanceOf=n.instanceOf||null,this.predicate=n.predicate||null,this.represent=n.represent||null,this.defaultStyle=n.defaultStyle||null,this.styleAliases=us(n.styleAliases||null),hs.indexOf(this.kind)===-1)throw new it('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')}var P=ps,rt=Y,De=Te,ms=P;function cn(e,n,t){var r=[];return e.include.forEach(function(i){t=cn(i,n,t)}),e[n].forEach(function(i){t.forEach(function(o,s){o.tag===i.tag&&o.kind===i.kind&&r.push(s)}),t.push(i)}),t.filter(function(i,o){return r.indexOf(o)===-1})}function fs(){var e={scalar:{},sequence:{},mapping:{},fallback:{}},n,t;function r(i){e[i.kind][i.tag]=e.fallback[i.tag]=i}for(n=0,t=arguments.length;n<t;n+=1)arguments[n].forEach(r);return e}function ce(e){this.include=e.include||[],this.implicit=e.implicit||[],this.explicit=e.explicit||[],this.implicit.forEach(function(n){if(n.loadKind&&n.loadKind!=="scalar")throw new De("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.")}),this.compiledImplicit=cn(this,"implicit",[]),this.compiledExplicit=cn(this,"explicit",[]),this.compiledTypeMap=fs(this.compiledImplicit,this.compiledExplicit)}ce.DEFAULT=null;ce.create=function(){var n,t;switch(arguments.length){case 1:n=ce.DEFAULT,t=arguments[0];break;case 2:n=arguments[0],t=arguments[1];break;default:throw new De("Wrong number of arguments for Schema.create function")}if(n=rt.toArray(n),t=rt.toArray(t),!n.every(function(r){return r instanceof ce}))throw new De("Specified list of super schemas (or a single Schema object) contains a non-Schema object.");if(!t.every(function(r){return r instanceof ms}))throw new De("Specified list of YAML types (or a single Type object) contains a non-Type object.");return new ce({include:n,explicit:t})};var ge=ce,gs=P,ys=new gs("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return e!==null?e:""}}),bs=P,_s=new bs("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return e!==null?e:[]}}),vs=P,ws=new vs("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return e!==null?e:{}}}),ks=ge,bn=new ks({explicit:[ys,_s,ws]}),xs=P;function Cs(e){if(e===null)return!0;var n=e.length;return n===1&&e==="~"||n===4&&(e==="null"||e==="Null"||e==="NULL")}function Ts(){return null}function As(e){return e===null}var Ss=new xs("tag:yaml.org,2002:null",{kind:"scalar",resolve:Cs,construct:Ts,predicate:As,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"}},defaultStyle:"lowercase"}),Is=P;function Ms(e){if(e===null)return!1;var n=e.length;return n===4&&(e==="true"||e==="True"||e==="TRUE")||n===5&&(e==="false"||e==="False"||e==="FALSE")}function Es(e){return e==="true"||e==="True"||e==="TRUE"}function Rs(e){return Object.prototype.toString.call(e)==="[object Boolean]"}var Ls=new Is("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Ms,construct:Es,predicate:Rs,represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"}),Ns=Y,Fs=P;function Os(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function Ds(e){return 48<=e&&e<=55}function Ps(e){return 48<=e&&e<=57}function Us(e){if(e===null)return!1;var n=e.length,t=0,r=!1,i;if(!n)return!1;if(i=e[t],(i==="-"||i==="+")&&(i=e[++t]),i==="0"){if(t+1===n)return!0;if(i=e[++t],i==="b"){for(t++;t<n;t++)if(i=e[t],i!=="_"){if(i!=="0"&&i!=="1")return!1;r=!0}return r&&i!=="_"}if(i==="x"){for(t++;t<n;t++)if(i=e[t],i!=="_"){if(!Os(e.charCodeAt(t)))return!1;r=!0}return r&&i!=="_"}for(;t<n;t++)if(i=e[t],i!=="_"){if(!Ds(e.charCodeAt(t)))return!1;r=!0}return r&&i!=="_"}if(i==="_")return!1;for(;t<n;t++)if(i=e[t],i!=="_"){if(i===":")break;if(!Ps(e.charCodeAt(t)))return!1;r=!0}return!r||i==="_"?!1:i!==":"?!0:/^(:[0-5]?[0-9])+$/.test(e.slice(t))}function Bs(e){var n=e,t=1,r,i,o=[];return n.indexOf("_")!==-1&&(n=n.replace(/_/g,"")),r=n[0],(r==="-"||r==="+")&&(r==="-"&&(t=-1),n=n.slice(1),r=n[0]),n==="0"?0:r==="0"?n[1]==="b"?t*parseInt(n.slice(2),2):n[1]==="x"?t*parseInt(n,16):t*parseInt(n,8):n.indexOf(":")!==-1?(n.split(":").forEach(function(s){o.unshift(parseInt(s,10))}),n=0,i=1,o.forEach(function(s){n+=s*i,i*=60}),t*n):t*parseInt(n,10)}function Hs(e){return Object.prototype.toString.call(e)==="[object Number]"&&e%1===0&&!Ns.isNegativeZero(e)}var $s=new Fs("tag:yaml.org,2002:int",{kind:"scalar",resolve:Us,construct:Bs,predicate:Hs,represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0"+e.toString(8):"-0"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),At=Y,Gs=P,Ws=new RegExp("^(?:[-+]?(?:0|[1-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function js(e){return!(e===null||!Ws.test(e)||e[e.length-1]==="_")}function Ks(e){var n,t,r,i;return n=e.replace(/_/g,"").toLowerCase(),t=n[0]==="-"?-1:1,i=[],"+-".indexOf(n[0])>=0&&(n=n.slice(1)),n===".inf"?t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:n===".nan"?NaN:n.indexOf(":")>=0?(n.split(":").forEach(function(o){i.unshift(parseFloat(o,10))}),n=0,r=1,i.forEach(function(o){n+=o*r,r*=60}),t*n):t*parseFloat(n,10)}var Ys=/^[-+]?[0-9]+e/;function qs(e,n){var t;if(isNaN(e))switch(n){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(n){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(n){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(At.isNegativeZero(e))return"-0.0";return t=e.toString(10),Ys.test(t)?t.replace("e",".e"):t}function Vs(e){return Object.prototype.toString.call(e)==="[object Number]"&&(e%1!==0||At.isNegativeZero(e))}var zs=new Gs("tag:yaml.org,2002:float",{kind:"scalar",resolve:js,construct:Ks,predicate:Vs,represent:qs,defaultStyle:"lowercase"}),Qs=ge,St=new Qs({include:[bn],implicit:[Ss,Ls,$s,zs]}),Xs=ge,It=new Xs({include:[St]}),Js=P,Mt=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),Et=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Zs(e){return e===null?!1:Mt.exec(e)!==null||Et.exec(e)!==null}function ea(e){var n,t,r,i,o,s,a,l=0,c=null,h,d,p;if(n=Mt.exec(e),n===null&&(n=Et.exec(e)),n===null)throw new Error("Date resolve error");if(t=+n[1],r=+n[2]-1,i=+n[3],!n[4])return new Date(Date.UTC(t,r,i));if(o=+n[4],s=+n[5],a=+n[6],n[7]){for(l=n[7].slice(0,3);l.length<3;)l+="0";l=+l}return n[9]&&(h=+n[10],d=+(n[11]||0),c=(h*60+d)*6e4,n[9]==="-"&&(c=-c)),p=new Date(Date.UTC(t,r,i,o,s,a,l)),c&&p.setTime(p.getTime()-c),p}function na(e){return e.toISOString()}var ta=new Js("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Zs,construct:ea,instanceOf:Date,represent:na}),ia=P;function ra(e){return e==="<<"||e===null}var oa=new ia("tag:yaml.org,2002:merge",{kind:"scalar",resolve:ra});function Rt(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var re;try{var sa=Rt;re=sa("buffer").Buffer}catch{}var aa=P,_n=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function la(e){if(e===null)return!1;var n,t,r=0,i=e.length,o=_n;for(t=0;t<i;t++)if(n=o.indexOf(e.charAt(t)),!(n>64)){if(n<0)return!1;r+=6}return r%8===0}function ca(e){var n,t,r=e.replace(/[\r\n=]/g,""),i=r.length,o=_n,s=0,a=[];for(n=0;n<i;n++)n%4===0&&n&&(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)),s=s<<6|o.indexOf(r.charAt(n));return t=i%4*6,t===0?(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)):t===18?(a.push(s>>10&255),a.push(s>>2&255)):t===12&&a.push(s>>4&255),re?re.from?re.from(a):new re(a):a}function da(e){var n="",t=0,r,i,o=e.length,s=_n;for(r=0;r<o;r++)r%3===0&&r&&(n+=s[t>>18&63],n+=s[t>>12&63],n+=s[t>>6&63],n+=s[t&63]),t=(t<<8)+e[r];return i=o%3,i===0?(n+=s[t>>18&63],n+=s[t>>12&63],n+=s[t>>6&63],n+=s[t&63]):i===2?(n+=s[t>>10&63],n+=s[t>>4&63],n+=s[t<<2&63],n+=s[64]):i===1&&(n+=s[t>>2&63],n+=s[t<<4&63],n+=s[64],n+=s[64]),n}function ha(e){return re&&re.isBuffer(e)}var ua=new aa("tag:yaml.org,2002:binary",{kind:"scalar",resolve:la,construct:ca,predicate:ha,represent:da}),pa=P,ma=Object.prototype.hasOwnProperty,fa=Object.prototype.toString;function ga(e){if(e===null)return!0;var n=[],t,r,i,o,s,a=e;for(t=0,r=a.length;t<r;t+=1){if(i=a[t],s=!1,fa.call(i)!=="[object Object]")return!1;for(o in i)if(ma.call(i,o))if(!s)s=!0;else return!1;if(!s)return!1;if(n.indexOf(o)===-1)n.push(o);else return!1}return!0}function ya(e){return e!==null?e:[]}var ba=new pa("tag:yaml.org,2002:omap",{kind:"sequence",resolve:ga,construct:ya}),_a=P,va=Object.prototype.toString;function wa(e){if(e===null)return!0;var n,t,r,i,o,s=e;for(o=new Array(s.length),n=0,t=s.length;n<t;n+=1){if(r=s[n],va.call(r)!=="[object Object]"||(i=Object.keys(r),i.length!==1))return!1;o[n]=[i[0],r[i[0]]]}return!0}function ka(e){if(e===null)return[];var n,t,r,i,o,s=e;for(o=new Array(s.length),n=0,t=s.length;n<t;n+=1)r=s[n],i=Object.keys(r),o[n]=[i[0],r[i[0]]];return o}var xa=new _a("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:wa,construct:ka}),Ca=P,Ta=Object.prototype.hasOwnProperty;function Aa(e){if(e===null)return!0;var n,t=e;for(n in t)if(Ta.call(t,n)&&t[n]!==null)return!1;return!0}function Sa(e){return e!==null?e:{}}var Ia=new Ca("tag:yaml.org,2002:set",{kind:"mapping",resolve:Aa,construct:Sa}),Ma=ge,Ae=new Ma({include:[It],implicit:[ta,oa],explicit:[ua,ba,xa,Ia]}),Ea=P;function Ra(){return!0}function La(){}function Na(){return""}function Fa(e){return typeof e>"u"}var Oa=new Ea("tag:yaml.org,2002:js/undefined",{kind:"scalar",resolve:Ra,construct:La,predicate:Fa,represent:Na}),Da=P;function Pa(e){if(e===null||e.length===0)return!1;var n=e,t=/\/([gim]*)$/.exec(e),r="";return!(n[0]==="/"&&(t&&(r=t[1]),r.length>3||n[n.length-r.length-1]!=="/"))}function Ua(e){var n=e,t=/\/([gim]*)$/.exec(e),r="";return n[0]==="/"&&(t&&(r=t[1]),n=n.slice(1,n.length-r.length-1)),new RegExp(n,r)}function Ba(e){var n="/"+e.source+"/";return e.global&&(n+="g"),e.multiline&&(n+="m"),e.ignoreCase&&(n+="i"),n}function Ha(e){return Object.prototype.toString.call(e)==="[object RegExp]"}var $a=new Da("tag:yaml.org,2002:js/regexp",{kind:"scalar",resolve:Pa,construct:Ua,predicate:Ha,represent:Ba}),Be;try{var Ga=Rt;Be=Ga("esprima")}catch{typeof window<"u"&&(Be=window.esprima)}var Wa=P;function ja(e){if(e===null)return!1;try{var n="("+e+")",t=Be.parse(n,{range:!0});return!(t.type!=="Program"||t.body.length!==1||t.body[0].type!=="ExpressionStatement"||t.body[0].expression.type!=="ArrowFunctionExpression"&&t.body[0].expression.type!=="FunctionExpression")}catch{return!1}}function Ka(e){var n="("+e+")",t=Be.parse(n,{range:!0}),r=[],i;if(t.type!=="Program"||t.body.length!==1||t.body[0].type!=="ExpressionStatement"||t.body[0].expression.type!=="ArrowFunctionExpression"&&t.body[0].expression.type!=="FunctionExpression")throw new Error("Failed to resolve function");return t.body[0].expression.params.forEach(function(o){r.push(o.name)}),i=t.body[0].expression.body.range,t.body[0].expression.body.type==="BlockStatement"?new Function(r,n.slice(i[0]+1,i[1]-1)):new Function(r,"return "+n.slice(i[0],i[1]))}function Ya(e){return e.toString()}function qa(e){return Object.prototype.toString.call(e)==="[object Function]"}var Va=new Wa("tag:yaml.org,2002:js/function",{kind:"scalar",resolve:ja,construct:Ka,predicate:qa,represent:Ya}),ot=ge,Ke=ot.DEFAULT=new ot({include:[Ae],explicit:[Oa,$a,Va]}),J=Y,Lt=Te,za=cs,Nt=Ae,Qa=Ke,ee=Object.prototype.hasOwnProperty,He=1,Ft=2,Ot=3,$e=4,on=1,Xa=2,st=3,Ja=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Za=/[\x85\u2028\u2029]/,el=/[,\[\]\{\}]/,Dt=/^(?:!|!!|![a-z\-]+!)$/i,Pt=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function at(e){return Object.prototype.toString.call(e)}function Q(e){return e===10||e===13}function oe(e){return e===9||e===32}function W(e){return e===9||e===32||e===10||e===13}function de(e){return e===44||e===91||e===93||e===123||e===125}function nl(e){var n;return 48<=e&&e<=57?e-48:(n=e|32,97<=n&&n<=102?n-97+10:-1)}function tl(e){return e===120?2:e===117?4:e===85?8:0}function il(e){return 48<=e&&e<=57?e-48:-1}function lt(e){return e===48?"\0":e===97?"\x07":e===98?"\b":e===116||e===9?"	":e===110?`
`:e===118?"\v":e===102?"\f":e===114?"\r":e===101?"\x1B":e===32?" ":e===34?'"':e===47?"/":e===92?"\\":e===78?"":e===95?" ":e===76?"\u2028":e===80?"\u2029":""}function rl(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function Ut(e,n,t){n==="__proto__"?Object.defineProperty(e,n,{configurable:!0,enumerable:!0,writable:!0,value:t}):e[n]=t}var Bt=new Array(256),Ht=new Array(256);for(var le=0;le<256;le++)Bt[le]=lt(le)?1:0,Ht[le]=lt(le);function ol(e,n){this.input=e,this.filename=n.filename||null,this.schema=n.schema||Qa,this.onWarning=n.onWarning||null,this.legacy=n.legacy||!1,this.json=n.json||!1,this.listener=n.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.documents=[]}function $t(e,n){return new Lt(n,new za(e.filename,e.input,e.position,e.line,e.position-e.lineStart))}function w(e,n){throw $t(e,n)}function Ge(e,n){e.onWarning&&e.onWarning.call(null,$t(e,n))}var ct={YAML:function(n,t,r){var i,o,s;n.version!==null&&w(n,"duplication of %YAML directive"),r.length!==1&&w(n,"YAML directive accepts exactly one argument"),i=/^([0-9]+)\.([0-9]+)$/.exec(r[0]),i===null&&w(n,"ill-formed argument of the YAML directive"),o=parseInt(i[1],10),s=parseInt(i[2],10),o!==1&&w(n,"unacceptable YAML version of the document"),n.version=r[0],n.checkLineBreaks=s<2,s!==1&&s!==2&&Ge(n,"unsupported YAML version of the document")},TAG:function(n,t,r){var i,o;r.length!==2&&w(n,"TAG directive accepts exactly two arguments"),i=r[0],o=r[1],Dt.test(i)||w(n,"ill-formed tag handle (first argument) of the TAG directive"),ee.call(n.tagMap,i)&&w(n,'there is a previously declared suffix for "'+i+'" tag handle'),Pt.test(o)||w(n,"ill-formed tag prefix (second argument) of the TAG directive"),n.tagMap[i]=o}};function Z(e,n,t,r){var i,o,s,a;if(n<t){if(a=e.input.slice(n,t),r)for(i=0,o=a.length;i<o;i+=1)s=a.charCodeAt(i),s===9||32<=s&&s<=1114111||w(e,"expected valid JSON character");else Ja.test(a)&&w(e,"the stream contains non-printable characters");e.result+=a}}function dt(e,n,t,r){var i,o,s,a;for(J.isObject(t)||w(e,"cannot merge mappings; the provided source object is unacceptable"),i=Object.keys(t),s=0,a=i.length;s<a;s+=1)o=i[s],ee.call(n,o)||(Ut(n,o,t[o]),r[o]=!0)}function he(e,n,t,r,i,o,s,a){var l,c;if(Array.isArray(i))for(i=Array.prototype.slice.call(i),l=0,c=i.length;l<c;l+=1)Array.isArray(i[l])&&w(e,"nested arrays are not supported inside keys"),typeof i=="object"&&at(i[l])==="[object Object]"&&(i[l]="[object Object]");if(typeof i=="object"&&at(i)==="[object Object]"&&(i="[object Object]"),i=String(i),n===null&&(n={}),r==="tag:yaml.org,2002:merge")if(Array.isArray(o))for(l=0,c=o.length;l<c;l+=1)dt(e,n,o[l],t);else dt(e,n,o,t);else!e.json&&!ee.call(t,i)&&ee.call(n,i)&&(e.line=s||e.line,e.position=a||e.position,w(e,"duplicated mapping key")),Ut(n,i,o),delete t[i];return n}function vn(e){var n;n=e.input.charCodeAt(e.position),n===10?e.position++:n===13?(e.position++,e.input.charCodeAt(e.position)===10&&e.position++):w(e,"a line break is expected"),e.line+=1,e.lineStart=e.position}function O(e,n,t){for(var r=0,i=e.input.charCodeAt(e.position);i!==0;){for(;oe(i);)i=e.input.charCodeAt(++e.position);if(n&&i===35)do i=e.input.charCodeAt(++e.position);while(i!==10&&i!==13&&i!==0);if(Q(i))for(vn(e),i=e.input.charCodeAt(e.position),r++,e.lineIndent=0;i===32;)e.lineIndent++,i=e.input.charCodeAt(++e.position);else break}return t!==-1&&r!==0&&e.lineIndent<t&&Ge(e,"deficient indentation"),r}function Ye(e){var n=e.position,t;return t=e.input.charCodeAt(n),!!((t===45||t===46)&&t===e.input.charCodeAt(n+1)&&t===e.input.charCodeAt(n+2)&&(n+=3,t=e.input.charCodeAt(n),t===0||W(t)))}function wn(e,n){n===1?e.result+=" ":n>1&&(e.result+=J.repeat(`
`,n-1))}function sl(e,n,t){var r,i,o,s,a,l,c,h,d=e.kind,p=e.result,u;if(u=e.input.charCodeAt(e.position),W(u)||de(u)||u===35||u===38||u===42||u===33||u===124||u===62||u===39||u===34||u===37||u===64||u===96||(u===63||u===45)&&(i=e.input.charCodeAt(e.position+1),W(i)||t&&de(i)))return!1;for(e.kind="scalar",e.result="",o=s=e.position,a=!1;u!==0;){if(u===58){if(i=e.input.charCodeAt(e.position+1),W(i)||t&&de(i))break}else if(u===35){if(r=e.input.charCodeAt(e.position-1),W(r))break}else{if(e.position===e.lineStart&&Ye(e)||t&&de(u))break;if(Q(u))if(l=e.line,c=e.lineStart,h=e.lineIndent,O(e,!1,-1),e.lineIndent>=n){a=!0,u=e.input.charCodeAt(e.position);continue}else{e.position=s,e.line=l,e.lineStart=c,e.lineIndent=h;break}}a&&(Z(e,o,s,!1),wn(e,e.line-l),o=s=e.position,a=!1),oe(u)||(s=e.position+1),u=e.input.charCodeAt(++e.position)}return Z(e,o,s,!1),e.result?!0:(e.kind=d,e.result=p,!1)}function al(e,n){var t,r,i;if(t=e.input.charCodeAt(e.position),t!==39)return!1;for(e.kind="scalar",e.result="",e.position++,r=i=e.position;(t=e.input.charCodeAt(e.position))!==0;)if(t===39)if(Z(e,r,e.position,!0),t=e.input.charCodeAt(++e.position),t===39)r=e.position,e.position++,i=e.position;else return!0;else Q(t)?(Z(e,r,i,!0),wn(e,O(e,!1,n)),r=i=e.position):e.position===e.lineStart&&Ye(e)?w(e,"unexpected end of the document within a single quoted scalar"):(e.position++,i=e.position);w(e,"unexpected end of the stream within a single quoted scalar")}function ll(e,n){var t,r,i,o,s,a;if(a=e.input.charCodeAt(e.position),a!==34)return!1;for(e.kind="scalar",e.result="",e.position++,t=r=e.position;(a=e.input.charCodeAt(e.position))!==0;){if(a===34)return Z(e,t,e.position,!0),e.position++,!0;if(a===92){if(Z(e,t,e.position,!0),a=e.input.charCodeAt(++e.position),Q(a))O(e,!1,n);else if(a<256&&Bt[a])e.result+=Ht[a],e.position++;else if((s=tl(a))>0){for(i=s,o=0;i>0;i--)a=e.input.charCodeAt(++e.position),(s=nl(a))>=0?o=(o<<4)+s:w(e,"expected hexadecimal character");e.result+=rl(o),e.position++}else w(e,"unknown escape sequence");t=r=e.position}else Q(a)?(Z(e,t,r,!0),wn(e,O(e,!1,n)),t=r=e.position):e.position===e.lineStart&&Ye(e)?w(e,"unexpected end of the document within a double quoted scalar"):(e.position++,r=e.position)}w(e,"unexpected end of the stream within a double quoted scalar")}function cl(e,n){var t=!0,r,i=e.tag,o,s=e.anchor,a,l,c,h,d,p={},u,m,g,b;if(b=e.input.charCodeAt(e.position),b===91)l=93,d=!1,o=[];else if(b===123)l=125,d=!0,o={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),b=e.input.charCodeAt(++e.position);b!==0;){if(O(e,!0,n),b=e.input.charCodeAt(e.position),b===l)return e.position++,e.tag=i,e.anchor=s,e.kind=d?"mapping":"sequence",e.result=o,!0;t||w(e,"missed comma between flow collection entries"),m=u=g=null,c=h=!1,b===63&&(a=e.input.charCodeAt(e.position+1),W(a)&&(c=h=!0,e.position++,O(e,!0,n))),r=e.line,pe(e,n,He,!1,!0),m=e.tag,u=e.result,O(e,!0,n),b=e.input.charCodeAt(e.position),(h||e.line===r)&&b===58&&(c=!0,b=e.input.charCodeAt(++e.position),O(e,!0,n),pe(e,n,He,!1,!0),g=e.result),d?he(e,o,p,m,u,g):c?o.push(he(e,null,p,m,u,g)):o.push(u),O(e,!0,n),b=e.input.charCodeAt(e.position),b===44?(t=!0,b=e.input.charCodeAt(++e.position)):t=!1}w(e,"unexpected end of the stream within a flow collection")}function dl(e,n){var t,r,i=on,o=!1,s=!1,a=n,l=0,c=!1,h,d;if(d=e.input.charCodeAt(e.position),d===124)r=!1;else if(d===62)r=!0;else return!1;for(e.kind="scalar",e.result="";d!==0;)if(d=e.input.charCodeAt(++e.position),d===43||d===45)on===i?i=d===43?st:Xa:w(e,"repeat of a chomping mode identifier");else if((h=il(d))>=0)h===0?w(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):s?w(e,"repeat of an indentation width identifier"):(a=n+h-1,s=!0);else break;if(oe(d)){do d=e.input.charCodeAt(++e.position);while(oe(d));if(d===35)do d=e.input.charCodeAt(++e.position);while(!Q(d)&&d!==0)}for(;d!==0;){for(vn(e),e.lineIndent=0,d=e.input.charCodeAt(e.position);(!s||e.lineIndent<a)&&d===32;)e.lineIndent++,d=e.input.charCodeAt(++e.position);if(!s&&e.lineIndent>a&&(a=e.lineIndent),Q(d)){l++;continue}if(e.lineIndent<a){i===st?e.result+=J.repeat(`
`,o?1+l:l):i===on&&o&&(e.result+=`
`);break}for(r?oe(d)?(c=!0,e.result+=J.repeat(`
`,o?1+l:l)):c?(c=!1,e.result+=J.repeat(`
`,l+1)):l===0?o&&(e.result+=" "):e.result+=J.repeat(`
`,l):e.result+=J.repeat(`
`,o?1+l:l),o=!0,s=!0,l=0,t=e.position;!Q(d)&&d!==0;)d=e.input.charCodeAt(++e.position);Z(e,t,e.position,!1)}return!0}function ht(e,n){var t,r=e.tag,i=e.anchor,o=[],s,a=!1,l;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),l=e.input.charCodeAt(e.position);l!==0&&!(l!==45||(s=e.input.charCodeAt(e.position+1),!W(s)));){if(a=!0,e.position++,O(e,!0,-1)&&e.lineIndent<=n){o.push(null),l=e.input.charCodeAt(e.position);continue}if(t=e.line,pe(e,n,Ot,!1,!0),o.push(e.result),O(e,!0,-1),l=e.input.charCodeAt(e.position),(e.line===t||e.lineIndent>n)&&l!==0)w(e,"bad indentation of a sequence entry");else if(e.lineIndent<n)break}return a?(e.tag=r,e.anchor=i,e.kind="sequence",e.result=o,!0):!1}function hl(e,n,t){var r,i,o,s,a=e.tag,l=e.anchor,c={},h={},d=null,p=null,u=null,m=!1,g=!1,b;for(e.anchor!==null&&(e.anchorMap[e.anchor]=c),b=e.input.charCodeAt(e.position);b!==0;){if(r=e.input.charCodeAt(e.position+1),o=e.line,s=e.position,(b===63||b===58)&&W(r))b===63?(m&&(he(e,c,h,d,p,null),d=p=u=null),g=!0,m=!0,i=!0):m?(m=!1,i=!0):w(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,b=r;else if(pe(e,t,Ft,!1,!0))if(e.line===o){for(b=e.input.charCodeAt(e.position);oe(b);)b=e.input.charCodeAt(++e.position);if(b===58)b=e.input.charCodeAt(++e.position),W(b)||w(e,"a whitespace character is expected after the key-value separator within a block mapping"),m&&(he(e,c,h,d,p,null),d=p=u=null),g=!0,m=!1,i=!1,d=e.tag,p=e.result;else if(g)w(e,"can not read an implicit mapping pair; a colon is missed");else return e.tag=a,e.anchor=l,!0}else if(g)w(e,"can not read a block mapping entry; a multiline key may not be an implicit key");else return e.tag=a,e.anchor=l,!0;else break;if((e.line===o||e.lineIndent>n)&&(pe(e,n,$e,!0,i)&&(m?p=e.result:u=e.result),m||(he(e,c,h,d,p,u,o,s),d=p=u=null),O(e,!0,-1),b=e.input.charCodeAt(e.position)),e.lineIndent>n&&b!==0)w(e,"bad indentation of a mapping entry");else if(e.lineIndent<n)break}return m&&he(e,c,h,d,p,null),g&&(e.tag=a,e.anchor=l,e.kind="mapping",e.result=c),g}function ul(e){var n,t=!1,r=!1,i,o,s;if(s=e.input.charCodeAt(e.position),s!==33)return!1;if(e.tag!==null&&w(e,"duplication of a tag property"),s=e.input.charCodeAt(++e.position),s===60?(t=!0,s=e.input.charCodeAt(++e.position)):s===33?(r=!0,i="!!",s=e.input.charCodeAt(++e.position)):i="!",n=e.position,t){do s=e.input.charCodeAt(++e.position);while(s!==0&&s!==62);e.position<e.length?(o=e.input.slice(n,e.position),s=e.input.charCodeAt(++e.position)):w(e,"unexpected end of the stream within a verbatim tag")}else{for(;s!==0&&!W(s);)s===33&&(r?w(e,"tag suffix cannot contain exclamation marks"):(i=e.input.slice(n-1,e.position+1),Dt.test(i)||w(e,"named tag handle cannot contain such characters"),r=!0,n=e.position+1)),s=e.input.charCodeAt(++e.position);o=e.input.slice(n,e.position),el.test(o)&&w(e,"tag suffix cannot contain flow indicator characters")}return o&&!Pt.test(o)&&w(e,"tag name cannot contain such characters: "+o),t?e.tag=o:ee.call(e.tagMap,i)?e.tag=e.tagMap[i]+o:i==="!"?e.tag="!"+o:i==="!!"?e.tag="tag:yaml.org,2002:"+o:w(e,'undeclared tag handle "'+i+'"'),!0}function pl(e){var n,t;if(t=e.input.charCodeAt(e.position),t!==38)return!1;for(e.anchor!==null&&w(e,"duplication of an anchor property"),t=e.input.charCodeAt(++e.position),n=e.position;t!==0&&!W(t)&&!de(t);)t=e.input.charCodeAt(++e.position);return e.position===n&&w(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(n,e.position),!0}function ml(e){var n,t,r;if(r=e.input.charCodeAt(e.position),r!==42)return!1;for(r=e.input.charCodeAt(++e.position),n=e.position;r!==0&&!W(r)&&!de(r);)r=e.input.charCodeAt(++e.position);return e.position===n&&w(e,"name of an alias node must contain at least one character"),t=e.input.slice(n,e.position),ee.call(e.anchorMap,t)||w(e,'unidentified alias "'+t+'"'),e.result=e.anchorMap[t],O(e,!0,-1),!0}function pe(e,n,t,r,i){var o,s,a,l=1,c=!1,h=!1,d,p,u,m,g;if(e.listener!==null&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,o=s=a=$e===t||Ot===t,r&&O(e,!0,-1)&&(c=!0,e.lineIndent>n?l=1:e.lineIndent===n?l=0:e.lineIndent<n&&(l=-1)),l===1)for(;ul(e)||pl(e);)O(e,!0,-1)?(c=!0,a=o,e.lineIndent>n?l=1:e.lineIndent===n?l=0:e.lineIndent<n&&(l=-1)):a=!1;if(a&&(a=c||i),(l===1||$e===t)&&(He===t||Ft===t?m=n:m=n+1,g=e.position-e.lineStart,l===1?a&&(ht(e,g)||hl(e,g,m))||cl(e,m)?h=!0:(s&&dl(e,m)||al(e,m)||ll(e,m)?h=!0:ml(e)?(h=!0,(e.tag!==null||e.anchor!==null)&&w(e,"alias node should not have any properties")):sl(e,m,He===t)&&(h=!0,e.tag===null&&(e.tag="?")),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):l===0&&(h=a&&ht(e,g))),e.tag!==null&&e.tag!=="!")if(e.tag==="?"){for(e.result!==null&&e.kind!=="scalar"&&w(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),d=0,p=e.implicitTypes.length;d<p;d+=1)if(u=e.implicitTypes[d],u.resolve(e.result)){e.result=u.construct(e.result),e.tag=u.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else ee.call(e.typeMap[e.kind||"fallback"],e.tag)?(u=e.typeMap[e.kind||"fallback"][e.tag],e.result!==null&&u.kind!==e.kind&&w(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+u.kind+'", not "'+e.kind+'"'),u.resolve(e.result)?(e.result=u.construct(e.result),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):w(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")):w(e,"unknown tag !<"+e.tag+">");return e.listener!==null&&e.listener("close",e),e.tag!==null||e.anchor!==null||h}function fl(e){var n=e.position,t,r,i,o=!1,s;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap={},e.anchorMap={};(s=e.input.charCodeAt(e.position))!==0&&(O(e,!0,-1),s=e.input.charCodeAt(e.position),!(e.lineIndent>0||s!==37));){for(o=!0,s=e.input.charCodeAt(++e.position),t=e.position;s!==0&&!W(s);)s=e.input.charCodeAt(++e.position);for(r=e.input.slice(t,e.position),i=[],r.length<1&&w(e,"directive name must not be less than one character in length");s!==0;){for(;oe(s);)s=e.input.charCodeAt(++e.position);if(s===35){do s=e.input.charCodeAt(++e.position);while(s!==0&&!Q(s));break}if(Q(s))break;for(t=e.position;s!==0&&!W(s);)s=e.input.charCodeAt(++e.position);i.push(e.input.slice(t,e.position))}s!==0&&vn(e),ee.call(ct,r)?ct[r](e,r,i):Ge(e,'unknown document directive "'+r+'"')}if(O(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,O(e,!0,-1)):o&&w(e,"directives end mark is expected"),pe(e,e.lineIndent-1,$e,!1,!0),O(e,!0,-1),e.checkLineBreaks&&Za.test(e.input.slice(n,e.position))&&Ge(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&Ye(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,O(e,!0,-1));return}if(e.position<e.length-1)w(e,"end of the stream or a document separator is expected");else return}function Gt(e,n){e=String(e),n=n||{},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var t=new ol(e,n),r=e.indexOf("\0");for(r!==-1&&(t.position=r,w(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)fl(t);return t.documents}function Wt(e,n,t){n!==null&&typeof n=="object"&&typeof t>"u"&&(t=n,n=null);var r=Gt(e,t);if(typeof n!="function")return r;for(var i=0,o=r.length;i<o;i+=1)n(r[i])}function jt(e,n){var t=Gt(e,n);if(t.length!==0){if(t.length===1)return t[0];throw new Lt("expected a single document in the stream, but found more")}}function gl(e,n,t){return typeof n=="object"&&n!==null&&typeof t>"u"&&(t=n,n=null),Wt(e,n,J.extend({schema:Nt},t))}function yl(e,n){return jt(e,J.extend({schema:Nt},n))}Ce.loadAll=Wt;Ce.load=jt;Ce.safeLoadAll=gl;Ce.safeLoad=yl;var kn={},Se=Y,Ie=Te,bl=Ke,_l=Ae,Kt=Object.prototype.toString,Yt=Object.prototype.hasOwnProperty,vl=9,xe=10,wl=13,kl=32,xl=33,Cl=34,qt=35,Tl=37,Al=38,Sl=39,Il=42,Vt=44,Ml=45,zt=58,El=61,Rl=62,Ll=63,Nl=64,Qt=91,Xt=93,Fl=96,Jt=123,Ol=124,Zt=125,B={};B[0]="\\0";B[7]="\\a";B[8]="\\b";B[9]="\\t";B[10]="\\n";B[11]="\\v";B[12]="\\f";B[13]="\\r";B[27]="\\e";B[34]='\\"';B[92]="\\\\";B[133]="\\N";B[160]="\\_";B[8232]="\\L";B[8233]="\\P";var Dl=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"];function Pl(e,n){var t,r,i,o,s,a,l;if(n===null)return{};for(t={},r=Object.keys(n),i=0,o=r.length;i<o;i+=1)s=r[i],a=String(n[s]),s.slice(0,2)==="!!"&&(s="tag:yaml.org,2002:"+s.slice(2)),l=e.compiledTypeMap.fallback[s],l&&Yt.call(l.styleAliases,a)&&(a=l.styleAliases[a]),t[s]=a;return t}function ut(e){var n,t,r;if(n=e.toString(16).toUpperCase(),e<=255)t="x",r=2;else if(e<=65535)t="u",r=4;else if(e<=4294967295)t="U",r=8;else throw new Ie("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+Se.repeat("0",r-n.length)+n}function Ul(e){this.schema=e.schema||bl,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=Se.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=Pl(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function pt(e,n){for(var t=Se.repeat(" ",n),r=0,i=-1,o="",s,a=e.length;r<a;)i=e.indexOf(`
`,r),i===-1?(s=e.slice(r),r=a):(s=e.slice(r,i+1),r=i+1),s.length&&s!==`
`&&(o+=t),o+=s;return o}function dn(e,n){return`
`+Se.repeat(" ",e.indent*n)}function Bl(e,n){var t,r,i;for(t=0,r=e.implicitTypes.length;t<r;t+=1)if(i=e.implicitTypes[t],i.resolve(n))return!0;return!1}function xn(e){return e===kl||e===vl}function me(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==65279||65536<=e&&e<=1114111}function Hl(e){return me(e)&&!xn(e)&&e!==65279&&e!==wl&&e!==xe}function mt(e,n){return me(e)&&e!==65279&&e!==Vt&&e!==Qt&&e!==Xt&&e!==Jt&&e!==Zt&&e!==zt&&(e!==qt||n&&Hl(n))}function $l(e){return me(e)&&e!==65279&&!xn(e)&&e!==Ml&&e!==Ll&&e!==zt&&e!==Vt&&e!==Qt&&e!==Xt&&e!==Jt&&e!==Zt&&e!==qt&&e!==Al&&e!==Il&&e!==xl&&e!==Ol&&e!==El&&e!==Rl&&e!==Sl&&e!==Cl&&e!==Tl&&e!==Nl&&e!==Fl}function ei(e){var n=/^\n* /;return n.test(e)}var ni=1,ti=2,ii=3,ri=4,Pe=5;function Gl(e,n,t,r,i){var o,s,a,l=!1,c=!1,h=r!==-1,d=-1,p=$l(e.charCodeAt(0))&&!xn(e.charCodeAt(e.length-1));if(n)for(o=0;o<e.length;o++){if(s=e.charCodeAt(o),!me(s))return Pe;a=o>0?e.charCodeAt(o-1):null,p=p&&mt(s,a)}else{for(o=0;o<e.length;o++){if(s=e.charCodeAt(o),s===xe)l=!0,h&&(c=c||o-d-1>r&&e[d+1]!==" ",d=o);else if(!me(s))return Pe;a=o>0?e.charCodeAt(o-1):null,p=p&&mt(s,a)}c=c||h&&o-d-1>r&&e[d+1]!==" "}return!l&&!c?p&&!i(e)?ni:ti:t>9&&ei(e)?Pe:c?ri:ii}function Wl(e,n,t,r){e.dump=function(){if(n.length===0)return"''";if(!e.noCompatMode&&Dl.indexOf(n)!==-1)return"'"+n+"'";var i=e.indent*Math.max(1,t),o=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-i),s=r||e.flowLevel>-1&&t>=e.flowLevel;function a(l){return Bl(e,l)}switch(Gl(n,s,e.indent,o,a)){case ni:return n;case ti:return"'"+n.replace(/'/g,"''")+"'";case ii:return"|"+ft(n,e.indent)+gt(pt(n,i));case ri:return">"+ft(n,e.indent)+gt(pt(jl(n,o),i));case Pe:return'"'+Kl(n)+'"';default:throw new Ie("impossible error: invalid scalar style")}}()}function ft(e,n){var t=ei(e)?String(n):"",r=e[e.length-1]===`
`,i=r&&(e[e.length-2]===`
`||e===`
`),o=i?"+":r?"":"-";return t+o+`
`}function gt(e){return e[e.length-1]===`
`?e.slice(0,-1):e}function jl(e,n){for(var t=/(\n+)([^\n]*)/g,r=function(){var c=e.indexOf(`
...
`+e.slice(s+1):l+=e.slice(i),l.slice(1)}function Kl(e){for(var n="",t,r,i,o=0;o<e.length;o++){if(t=e.charCodeAt(o),t>=55296&&t<=56319&&(r=e.charCodeAt(o+1),r>=56320&&r<=57343)){n+=ut((t-55296)*1024+r-56320+65536),o++;continue}i=B[t],n+=!i&&me(t)?e[o]:i||ut(t)}return n}function Yl(e,n,t){var r="",i=e.tag,o,s;for(o=0,s=t.length;o<s;o+=1)ae(e,n,t[o],!1,!1)&&(o!==0&&(r+=","+(e.condenseFlow?"":" ")),r+=e.dump);e.tag=i,e.dump="["+r+"]"}function ql(e,n,t,r){var i="",o=e.tag,s,a;for(s=0,a=t.length;s<a;s+=1)ae(e,n+1,t[s],!0,!0)&&((!r||s!==0)&&(i+=dn(e,n)),e.dump&&xe===e.dump.charCodeAt(0)?i+="-":i+="- ",i+=e.dump);e.tag=o,e.dump=i||"[]"}function Vl(e,n,t){var r="",i=e.tag,o=Object.keys(t),s,a,l,c,h;for(s=0,a=o.length;s<a;s+=1)h="",s!==0&&(h+=", "),e.condenseFlow&&(h+='"'),l=o[s],c=t[l],ae(e,n,l,!1,!1)&&(e.dump.length>1024&&(h+="? "),h+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),ae(e,n,c,!1,!1)&&(h+=e.dump,r+=h));e.tag=i,e.dump="{"+r+"}"}function zl(e,n,t,r){var i="",o=e.tag,s=Object.keys(t),a,l,c,h,d,p;if(e.sortKeys===!0)s.sort();else if(typeof e.sortKeys=="function")s.sort(e.sortKeys);else if(e.sortKeys)throw new Ie("sortKeys must be a boolean or a function");for(a=0,l=s.length;a<l;a+=1)p="",(!r||a!==0)&&(p+=dn(e,n)),c=s[a],h=t[c],ae(e,n+1,c,!0,!0,!0)&&(d=e.tag!==null&&e.tag!=="?"||e.dump&&e.dump.length>1024,d&&(e.dump&&xe===e.dump.charCodeAt(0)?p+="?":p+="? "),p+=e.dump,d&&(p+=dn(e,n)),ae(e,n+1,h,!0,d)&&(e.dump&&xe===e.dump.charCodeAt(0)?p+=":":p+=": ",p+=e.dump,i+=p));e.tag=o,e.dump=i||"{}"}function bt(e,n,t){var r,i,o,s,a,l;for(i=t?e.explicitTypes:e.implicitTypes,o=0,s=i.length;o<s;o+=1)if(a=i[o],(a.instanceOf||a.predicate)&&(!a.instanceOf||typeof n=="object"&&n instanceof a.instanceOf)&&(!a.predicate||a.predicate(n))){if(e.tag=t?a.tag:"?",a.represent){if(l=e.styleMap[a.tag]||a.defaultStyle,Kt.call(a.represent)==="[object Function]")r=a.represent(n,l);else if(Yt.call(a.represent,l))r=a.represent[l](n,l);else throw new Ie("!<"+a.tag+'> tag resolver accepts not "'+l+'" style');e.dump=r}return!0}return!1}function ae(e,n,t,r,i,o){e.tag=null,e.dump=t,bt(e,t,!1)||bt(e,t,!0);var s=Kt.call(e.dump);r&&(r=e.flowLevel<0||e.flowLevel>n);var a=s==="[object Object]"||s==="[object Array]",l,c;if(a&&(l=e.duplicates.indexOf(t),c=l!==-1),(e.tag!==null&&e.tag!=="?"||c||e.indent!==2&&n>0)&&(i=!1),c&&e.usedDuplicates[l])e.dump="*ref_"+l;else{if(a&&c&&!e.usedDuplicates[l]&&(e.usedDuplicates[l]=!0),s==="[object Object]")r&&Object.keys(e.dump).length!==0?(zl(e,n,e.dump,i),c&&(e.dump="&ref_"+l+e.dump)):(Vl(e,n,e.dump),c&&(e.dump="&ref_"+l+" "+e.dump));else if(s==="[object Array]"){var h=e.noArrayIndent&&n>0?n-1:n;r&&e.dump.length!==0?(ql(e,h,e.dump,i),c&&(e.dump="&ref_"+l+e.dump)):(Yl(e,h,e.dump),c&&(e.dump="&ref_"+l+" "+e.dump))}else if(s==="[object String]")e.tag!=="?"&&Wl(e,e.dump,n,o);else{if(e.skipInvalid)return!1;throw new Ie("unacceptable kind of an object to dump "+s)}e.tag!==null&&e.tag!=="?"&&(e.dump="!<"+e.tag+"> "+e.dump)}return!0}function Ql(e,n){var t=[],r=[],i,o;for(hn(e,t,r),i=0,o=r.length;i<o;i+=1)n.duplicates.push(t[r[i]]);n.usedDuplicates=new Array(o)}function hn(e,n,t){var r,i,o;if(e!==null&&typeof e=="object")if(i=n.indexOf(e),i!==-1)t.indexOf(i)===-1&&t.push(i);else if(n.push(e),Array.isArray(e))for(i=0,o=e.length;i<o;i+=1)hn(e[i],n,t);else for(r=Object.keys(e),i=0,o=r.length;i<o;i+=1)hn(e[r[i]],n,t)}function oi(e,n){n=n||{};var t=new Ul(n);return t.noRefs||Ql(e,t),ae(t,0,e,!0,!0)?t.dump+`
`:""}function Xl(e,n){return oi(e,Se.extend({schema:_l},n))}kn.dump=oi;kn.safeDump=Xl;var qe=Ce,si=kn;function Ve(e){return function(){throw new Error("Function "+e+" is deprecated and cannot be used.")}}F.Type=P;F.Schema=ge;F.FAILSAFE_SCHEMA=bn;F.JSON_SCHEMA=St;F.CORE_SCHEMA=It;F.DEFAULT_SAFE_SCHEMA=Ae;F.DEFAULT_FULL_SCHEMA=Ke;F.load=qe.load;F.loadAll=qe.loadAll;F.safeLoad=qe.safeLoad;F.safeLoadAll=qe.safeLoadAll;F.dump=si.dump;F.safeDump=si.safeDump;F.YAMLException=Te;F.MINIMAL_SCHEMA=bn;F.SAFE_SCHEMA=Ae;F.DEFAULT_SCHEMA=Ke;F.scan=Ve("scan");F.parse=Ve("parse");F.compose=Ve("compose");F.addConstructor=Ve("addConstructor");var Jl=F,Zl=Jl;function ec(e){if(!e.startsWith(`---
`))return{data:{},content:e};const n=e.indexOf(`
---`,4);if(n===-1)return{data:{},content:e};const t=e.slice(4,n),r=e.slice(n+4),i=r.startsWith(`
`)?r.slice(1):r;return{data:Zl.safeLoad(t)??{},content:i}}const ai={npc:{specialNameChance:.3},missions:{boardCountMin:3,boardCountMax:6,missionTtlMs:9e5,deliveryChance:.6,deliveryBaseReward:200,deliveryRandomReward:200,supplyRewardMargin:.4,supplyRandomReward:150,supplyRequirementsMin:1,supplyRequirementsMax:2,supplyQtyMin:1,supplyQtyMax:4},trading:{stockCountMin:4,stockCountMax:6,stockQtyMin:1,stockQtyMax:8,stockTtlMs:12e4},fuel:{pricePerLitre:10,consumptionPerLy:5},reputation:{levelUnfriendlyMin:-300,levelNeutralMin:-100,levelFriendlyMin:100,levelLikedMin:300,levelReveredMin:600,pointsMin:-600,pointsMax:1e3,missionDeltaSmall:25,missionDeltaMedium:75,missionDeltaLarge:200,missionTierMediumReward:300,missionTierLargeReward:600,tradeModifierHated:1.2,tradeModifierUnfriendly:1.1,tradeModifierNeutral:1,tradeModifierFriendly:.92,tradeModifierLiked:.85,tradeModifierRevered:.8,repPerCredit:.01,maxRepPerVisit:10}};function nc(e){const n={settings:{player:{name:"Captain",startingCredits:0},startingLocation:{system:"",destination:""},startingShip:""},balance:{...ai},systems:[],destinations:[],routes:[],drives:[],ships:[],factions:[],commodities:[],storyBeats:[],deliveryItems:[],npcNames:{special:[],firstNames:[],lastNames:[]}};for(const[t,r]of Object.entries(e)){const i=t.split("/").pop()??"";if(i==="_template.md"||i===".gitkeep")continue;const{data:o,content:s}=ec(r);/^systems\/[^/]+\.md$/.test(t)?n.systems.push(tc(o,s)):/^destinations\/[^/]+\.md$/.test(t)?n.destinations.push(ic(o,s)):/^factions\/[^/]+\.md$/.test(t)?n.factions.push(rc(o,s)):/^ships\/[^/]+\.md$/.test(t)?n.ships.push(oc(o,s)):t==="ships/components/jump-drives.md"?n.drives=sc(o):t==="navigation/jump-routes.md"?n.routes=ac(o):t==="commodities.md"?n.commodities=lc(o):/^story\/[^/]+\.md$/.test(t)?n.storyBeats.push(cc(o,s)):t==="settings/new-game.md"?n.settings=dc(o):t==="settings/balance.md"?n.balance=pc(o):t==="delivery-items.md"?n.deliveryItems=hc(o):t==="npc-names.md"&&(n.npcNames=uc(o))}return n}function ze(e){const n=[];let t=!1;for(const r of e.split(`
`)){const i=r.trim();if(!i.startsWith("#"))if(i===""){if(t)break}else t=!0,n.push(i)}return n.join(" ")}function tc(e,n){return{id:e.id,name:e.name,starType:e.star_type,distanceFromSol:e.distance_from_sol,zone:e.zone,security:e.security,population:e.population,dangerLevel:e.danger_level,playerKnowledge:e.player_knowledge,economy:e.economy??[],majorFactions:e.major_factions??[],destinations:e.destinations??[],tags:e.tags??[],description:ze(n)}}function ic(e,n){const t=e.amenities??{},r={trader:t.trader??!1,missionBoard:t.mission_board??!1,shipRepair:t.ship_repair??!1,fuel:t.fuel??!1,shipDealer:t.ship_dealer??!1};return{id:e.id,name:e.name,system:e.system,locationType:e.location_type,type:e.type,amenities:r,npcs:e.npcs??{},goodsBias:e.goods_bias??[],dangerLevel:e.danger_level,tags:e.tags??[],description:ze(n),owningFactionId:e.owning_faction}}function rc(e,n){return{id:e.id,name:e.name,type:e.type,homeSystem:e.home_system,size:e.size,influence:e.influence??[],tags:e.tags??[],description:ze(n),rivals:e.rivals??[],allies:e.allies??[]}}function oc(e,n){return{id:e.id,name:e.name,class:e.class,cost:e.cost,cargoCapacityKg:e.cargo_capacity_kg,fuelCapacityL:e.fuel_capacity_l,hullPoints:e.hull_points,defaultJumpDrive:e.default_jump_drive,tags:e.tags??[],description:ze(n)}}function sc(e){return(e.drives??[]).map(t=>({id:t.id,name:t.name,maxDistanceLy:t.max_distance_ly,fuelEfficiency:t.fuel_efficiency,cost:t.cost}))}function ac(e){return(e.routes??[]).map(t=>({from:t.from,to:t.to,distance:t.distance,stability:t.stability,security:t.security}))}function lc(e){return(e.commodities??[]).map(t=>({id:t.id,name:t.name,basePrice:t.base_price,category:t.category,legal:t.legal,weightKg:t.weight_kg,description:t.description??""}))}function cc(e,n){return{id:e.id,title:e.title,trigger:e.trigger,type:e.type,location:e.location,skippable:e.skippable,playerKnowledge:e.player_knowledge,text:n.trim()}}function dc(e){var n,t,r,i;return{player:{name:((n=e.player)==null?void 0:n.name)??"Captain",startingCredits:((t=e.player)==null?void 0:t.starting_credits)??0},startingLocation:{system:((r=e.starting_location)==null?void 0:r.system)??"",destination:((i=e.starting_location)==null?void 0:i.destination)??""},startingShip:e.starting_ship??""}}function hc(e){return(e.delivery_items??[]).map(t=>({id:t.id,name:t.name,weightKg:t.weight_kg}))}function uc(e){const n=e.npc_names??{};return{special:n.special??[],firstNames:n.first_names??[],lastNames:n.last_names??[]}}function pc(e){const n=ai,t=e.npc??{},r=e.missions??{},i=e.trading??{},o=e.fuel??{},s=e.reputation??{};return{npc:{specialNameChance:t.special_name_chance??n.npc.specialNameChance},missions:{boardCountMin:r.board_count_min??n.missions.boardCountMin,boardCountMax:r.board_count_max??n.missions.boardCountMax,missionTtlMs:r.mission_ttl_ms??n.missions.missionTtlMs,deliveryChance:r.delivery_chance??n.missions.deliveryChance,deliveryBaseReward:r.delivery_base_reward??n.missions.deliveryBaseReward,deliveryRandomReward:r.delivery_random_reward??n.missions.deliveryRandomReward,supplyRewardMargin:r.supply_reward_margin??n.missions.supplyRewardMargin,supplyRandomReward:r.supply_random_reward??n.missions.supplyRandomReward,supplyRequirementsMin:r.supply_requirements_min??n.missions.supplyRequirementsMin,supplyRequirementsMax:r.supply_requirements_max??n.missions.supplyRequirementsMax,supplyQtyMin:r.supply_qty_min??n.missions.supplyQtyMin,supplyQtyMax:r.supply_qty_max??n.missions.supplyQtyMax},trading:{stockCountMin:i.stock_count_min??n.trading.stockCountMin,stockCountMax:i.stock_count_max??n.trading.stockCountMax,stockQtyMin:i.stock_qty_min??n.trading.stockQtyMin,stockQtyMax:i.stock_qty_max??n.trading.stockQtyMax,stockTtlMs:i.stock_ttl_ms??n.trading.stockTtlMs},fuel:{pricePerLitre:o.price_per_litre??n.fuel.pricePerLitre,consumptionPerLy:o.consumption_per_ly??n.fuel.consumptionPerLy},reputation:{levelUnfriendlyMin:s.level_unfriendly_min??n.reputation.levelUnfriendlyMin,levelNeutralMin:s.level_neutral_min??n.reputation.levelNeutralMin,levelFriendlyMin:s.level_friendly_min??n.reputation.levelFriendlyMin,levelLikedMin:s.level_liked_min??n.reputation.levelLikedMin,levelReveredMin:s.level_revered_min??n.reputation.levelReveredMin,pointsMin:s.points_min??n.reputation.pointsMin,pointsMax:s.points_max??n.reputation.pointsMax,missionDeltaSmall:s.mission_delta_small??n.reputation.missionDeltaSmall,missionDeltaMedium:s.mission_delta_medium??n.reputation.missionDeltaMedium,missionDeltaLarge:s.mission_delta_large??n.reputation.missionDeltaLarge,missionTierMediumReward:s.mission_tier_medium_reward??n.reputation.missionTierMediumReward,missionTierLargeReward:s.mission_tier_large_reward??n.reputation.missionTierLargeReward,tradeModifierHated:s.trade_modifier_hated??n.reputation.tradeModifierHated,tradeModifierUnfriendly:s.trade_modifier_unfriendly??n.reputation.tradeModifierUnfriendly,tradeModifierNeutral:s.trade_modifier_neutral??n.reputation.tradeModifierNeutral,tradeModifierFriendly:s.trade_modifier_friendly??n.reputation.tradeModifierFriendly,tradeModifierLiked:s.trade_modifier_liked??n.reputation.tradeModifierLiked,tradeModifierRevered:s.trade_modifier_revered??n.reputation.tradeModifierRevered,repPerCredit:s.rep_per_credit??n.reputation.repPerCredit,maxRepPerVisit:s.max_rep_per_visit??n.reputation.maxRepPerVisit}}}function mc(){const e=Object.assign({"/docs/world/commodities.md":ro,"/docs/world/delivery-items.md":oo,"/docs/world/destinations/_template.md":so,"/docs/world/destinations/blackwake-yard.md":ao,"/docs/world/destinations/ceti-landfall.md":lo,"/docs/world/destinations/drift-market.md":co,"/docs/world/destinations/elysium-station.md":ho,"/docs/world/destinations/eridani-anchorage.md":uo,"/docs/world/destinations/foundries-platform.md":po,"/docs/world/destinations/galileo-transfer.md":mo,"/docs/world/destinations/hestia-ring.md":fo,"/docs/world/destinations/keelhaul-station.md":go,"/docs/world/destinations/kepler-yard.md":yo,"/docs/world/destinations/mars-anchor.md":bo,"/docs/world/destinations/meridian-station.md":_o,"/docs/world/destinations/new-horizon-port.md":vo,"/docs/world/destinations/orrery-anchorage.md":wo,"/docs/world/destinations/redline-station.md":ko,"/docs/world/destinations/tycho-orbital.md":xo,"/docs/world/destinations/veil-station.md":Co,"/docs/world/destinations/waypoint-ceti.md":To,"/docs/world/factions/_template.md":Ao,"/docs/world/factions/centauri-trade-league.md":So,"/docs/world/factions/eridani-colonial-council.md":Io,"/docs/world/factions/free-captains.md":Mo,"/docs/world/factions/grey-market-cartel.md":Eo,"/docs/world/factions/helios-directorate.md":Ro,"/docs/world/factions/independent-miners-guild.md":Lo,"/docs/world/factions/procyon-institute.md":No,"/docs/world/factions/terran-union.md":Fo,"/docs/world/galaxy-map.md":Oo,"/docs/world/navigation/jump-routes.md":Do,"/docs/world/npc-names.md":Po,"/docs/world/settings/balance.md":Uo,"/docs/world/settings/new-game.md":Bo,"/docs/world/ships/_template.md":Ho,"/docs/world/ships/components/jump-drives.md":$o,"/docs/world/ships/freighter.md":Go,"/docs/world/ships/hauler.md":Wo,"/docs/world/ships/scout.md":jo,"/docs/world/story/_template.md":Ko,"/docs/world/story/enter-wolf-359.md":Yo,"/docs/world/story/first-jump.md":qo,"/docs/world/story/opening-arrival.md":Vo,"/docs/world/systems/_template.md":zo,"/docs/world/systems/alpha-centauri.md":Qo,"/docs/world/systems/barnards-star.md":Xo,"/docs/world/systems/epsilon-eridani.md":Jo,"/docs/world/systems/procyon.md":Zo,"/docs/world/systems/sirius.md":es,"/docs/world/systems/sol.md":ns,"/docs/world/systems/tau-ceti.md":ts,"/docs/world/systems/wolf-359.md":is}),n={};for(const[t,r]of Object.entries(e)){const i=t.replace("/docs/world/","");n[i]=r}return nc(n)}xi(mc());const fc=navigator.maxTouchPoints>0?"touch":"keyboard",gc=new URLSearchParams(window.location.search).has("debug"),li={environment:"browser",primaryInput:fc,debug:gc},yc=new mi,ci=new bi(li);ci.connect();const bc=new io(yc,ci,li);let _t=0;function di(e){bc.tick(e-_t),_t=e,requestAnimationFrame(di)}requestAnimationFrame(di);
