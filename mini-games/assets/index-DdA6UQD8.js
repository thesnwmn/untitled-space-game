...
You received ${C.reward} CR.${sn}`,confirmLabel:"OKAY",onConfirm:()=>{this.closeModal(),this.onHub()}}))}}}effectiveFuelPrice(){const e=P(),t=e.fuel.pricePerLitre;if(!this.eligibleFactionId)return t;const i=Ae(this.player.getFactionReputation(this.eligibleFactionId),e);return Math.round(t*$n(i,e))}activateCurrent(){const e=this.items;if(e.length===0||this.cursorIdx===-1)return;const t=e[this.cursorIdx];if(!t.disabled){if(this.fuelItemIdx!==null&&this.cursorIdx===this.fuelItemIdx){this.activated=!0;const i=this.effectiveFuelPrice(),r=this.player.fuelCapacityL-this.player.fuelL,o=Math.floor(this.player.credits/i),s=Math.min(r,o);this.openModal(new bn({title:"BUY FUEL",field:{label:"Litres",initialValue:s,min:0,max:s},derivedRows:[{label:"Cost",compute:a=>`${a*i} CR`}],confirmLabel:"BUY",onConfirm:a=>{this.closeModal(),a>0&&this.onRefuel(a*i,a)},onCancel:()=>{this.closeModal(),this.activated=!1}}));return}this.activated=!0,t.action()}}handleNavAction(e){(e==="BACK"||e==="NAV_1")&&!this.activated&&(this.activated=!0,this.onShip())}handleNavTap(e){e==="undock"&&!this.activated&&(this.activated=!0,this.onShip())}}class lr extends he{constructor(e,t,i,r,o,s,a,l,c,h){var g;const d=N(r),p=((g=d.npcs.trader)==null?void 0:g.toUpperCase())??"TRADER",u=[{label:"BUY",items:[]},{label:"SELL",items:[]}];super(p,[],[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,t,i,[],u,h),this.repGainedThisVisit=0,this.traderStock=o,this.onBuy=s,this.onSell=a,this.onHub=l,this.onUndock=c;const m=d.owningFactionId;if(m){const y=Ut(m);this.eligibleFactionId=y&&de(y)?m:null}else this.eligibleFactionId=null;this.syncItems(),this.clampCursor()}buyPrice(e,t){return Math.round(e*t)}sellPrice(e,t){return Math.round(e*t)}buildBuyItems(){return this.traderStock.length===0?[{label:"NO STOCK AVAILABLE",disabled:!0,action:()=>{}}]:this.traderStock.flatMap(e=>{const t=ae(e.commodityId);if(!t)return[];const i=e.effectiveFactor??1,r=this.buyPrice(t.basePrice,i),o=this.player.credits>=r;return[{label:`${t.name} (x${e.qty})`,info:`${r} CR`,disabled:!o,action:()=>{const s=Math.floor(this.player.credits/r),a=Math.min(e.qty,s);this.openModal(new bn({title:t.name.toUpperCase(),field:{label:"Quantity",initialValue:a,min:0,max:a},derivedRows:[{label:"Total",compute:l=>`${l*r} CR`}],confirmLabel:"BUY",onConfirm:l=>{l>0&&(this.onBuy(e.commodityId,l,r),this.accrueReputation(l*r)),this.syncItems(),this.clampCursor(),this.closeModal()},onCancel:()=>this.closeModal()}))}}]})}buildSellItems(){const e=this.player.cargoHold;return e.length===0?[{label:"CARGO HOLD EMPTY",disabled:!0,action:()=>{}}]:[...e].flatMap(t=>{const i=ae(t.commodityId);if(!i)return[];const r=N(this.player.destinationId??""),o=ee(r.system),s=Ve(t.commodityId,o),a=this.sellPrice(i.basePrice,s);return[{label:`${i.name} (x${t.qty})`,info:`${a} CR`,action:()=>{this.openModal(new bn({title:i.name.toUpperCase(),field:{label:"Quantity",initialValue:t.qty,min:0,max:t.qty},derivedRows:[{label:"Total",compute:l=>`${l*a} CR`}],confirmLabel:"SELL",onConfirm:l=>{l>0&&this.onSell(t.commodityId,l,a),this.syncItems(),this.clampCursor(),this.closeModal()},onCancel:()=>this.closeModal()}))}}]})}accrueReputation(e){if(!this.eligibleFactionId)return;const t=P(),i=t.reputation.maxRepPerVisit-this.repGainedThisVisit;if(i<=0)return;const r=Math.min(i,e*t.reputation.repPerCredit);r<=0||(this.repGainedThisVisit+=r,this.player.modifyFactionReputation(this.eligibleFactionId,r,t))}syncItems(){this.tabs&&(this.tabs[0].items=this.buildBuyItems(),this.tabs[1].items=this.buildSellItems())}clampCursor(){var t;const e=this.items;(this.cursorIdx<0||this.cursorIdx>=e.length||(t=e[this.cursorIdx])!=null&&t.disabled)&&(this.cursorIdx=e.findIndex(i=>!i.disabled))}activateCurrent(){const e=this.items;if(e.length===0||this.cursorIdx<0||this.cursorIdx>=e.length)return;const t=e[this.cursorIdx];t.disabled||t.action()}handleNavAction(e){(e==="BACK"||e==="NAV_2")&&!this.activated?(this.activated=!0,this.onHub()):e==="NAV_1"&&!this.activated&&(this.activated=!0,this.onUndock())}handleNavTap(e){e==="hub"&&!this.activated?(this.activated=!0,this.onHub()):e==="undock"&&!this.activated&&(this.activated=!0,this.onUndock())}render(e){if(this.syncItems(),super.render(e),this.eligibleFactionId){const r=P(),o=this.player.getFactionReputation(this.eligibleFactionId),s=Ae(o,r),l=`STANDING: ${Gt(s)}`;f(e,le+2,2,l,"bright-black","black")}const t=e.length,i=Cn(t,!0)-2;f(e,i,2,`HOLD: ${this.player.cargoWeightKg}/${this.player.cargoCapacity}KG`,"bright-black","black")}}const cr={delivery:"[D] ",supply:"[S] "};class me extends he{constructor(e,t,i,r,o,s,a,l,c){N(r);let h;o.length===0?h=[{label:"NO MISSIONS AVAILABLE",disabled:!0,action:()=>{}}]:h=me.sortMissions(o).map(p=>me.buildMenuItem(p,i,s)),super("MISSION BOARD",h,[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,t,i,[],null,c),this.onHub=a,this.onUndock=l}handleNavAction(e){(e==="BACK"||e==="NAV_2")&&!this.activated?(this.activated=!0,this.onHub()):e==="NAV_1"&&!this.activated&&(this.activated=!0,this.onUndock())}handleNavTap(e){e==="hub"&&!this.activated?(this.activated=!0,this.onHub()):e==="undock"&&!this.activated&&(this.activated=!0,this.onUndock())}static sortMissions(e){return[...e].sort((t,i)=>{var l,c;const r=((l=N(t.deliveryDestinationId))==null?void 0:l.name)??t.deliveryDestinationId,o=((c=N(i.deliveryDestinationId))==null?void 0:c.name)??i.deliveryDestinationId,s=r.localeCompare(o);if(s!==0)return s;const a={delivery:0,supply:1};return a[t.type]-a[i.type]})}static destColor(e,t){if(e===t.destinationId)return"bright-green";const i=N(e);return i&&i.system===t.systemId?"bright-yellow":"white"}static buildMenuItem(e,t,i){const r=N(e.deliveryDestinationId),o=(r==null?void 0:r.name)??e.deliveryDestinationId,s=[];if(s.push(`Dest: ${o}`),e.giverFactionId){const l=F().factions.find(c=>c.id===e.giverFactionId);l&&s.push(`For: ${l.name}`)}e.type!=="supply"&&s.push("");const a=e.type==="supply"?me.buildSupplyDetails(e,t):[];return{label:e.title,icon:cr[e.type],iconFg:"bright-yellow",info:`${e.reward} CR`,infoFg:"bright-green",details:s,detailsFg:me.destColor(e.deliveryDestinationId,t),detailsColored:a,action:()=>i(e)}}static buildSupplyDetails(e,t){if(e.type!=="supply")return[];const i=e.requirements.map(r=>{const o=F().commodities.find(h=>h.id===r.commodityId),s=(o==null?void 0:o.name)??r.commodityId,a=t.cargoHold.find(h=>h.commodityId===r.commodityId),l=(a==null?void 0:a.qty)??0,c=l>=r.qty;return{left:[{text:`${r.qty}x ${s} `,fg:"white"},{text:`(have: ${l})`,fg:c?"bright-green":"bright-black"}]}});return i.push({left:[]}),i}}class hr extends X{constructor(e,t,i,r,o,s,a){super(o,s,a,{navOptions:r,title:e}),this.cursorIdx=-1,this.lastChoicesStartRow=0,this._choices=t,this._onBack=i,this.resetCursor()}preHandleAction(e){return e==="BACK"?(this.activated=!0,this._onBack(),!0):!1}handleAction(e){e==="UP"?this.moveCursor(-1):e==="DOWN"?this.moveCursor(1):e==="SELECT"&&this.activateCurrent()}handleTap(e,t){const i=this.rowToChoiceIndex(t);i!==null&&!this._choices[i].disabled&&(this.cursorIdx=i,this.activateCurrent())}moveCursor(e){const t=this._choices,i=t.length;if(i===0)return;const r=this.cursorIdx===-1?e>0?i-1:0:this.cursorIdx;for(let o=0;o<i;o++){const s=((r+e*(o+1))%i+i)%i;if(!t[s].disabled){this.cursorIdx=s;return}}}activateCurrent(){if(this._choices.length===0||this.cursorIdx===-1)return;const e=this._choices[this.cursorIdx];e.disabled||(this.activated=!0,e.action())}resetCursor(){const e=this._choices;for(let t=0;t<e.length;t++)if(!e[t].disabled){this.cursorIdx=t;return}this.cursorIdx=-1}computeChoicesHeight(){var t;let e=0;for(const i of this._choices)e+=1+(((t=i.details)==null?void 0:t.length)??0);return e}rowToChoiceIndex(e){var i;if(e<this.lastChoicesStartRow)return null;let t=this.lastChoicesStartRow;for(let r=0;r<this._choices.length;r++){const o=1+(((i=this._choices[r].details)==null?void 0:i.length)??0);if(e>=t&&e<t+o)return r;t+=o}return null}render(e){const t=e.length,i=t>0?e[0].length:0;for(let m=0;m<t;m++)for(let g=0;g<i;g++)e[m][g]={char:" ",fg:"black",bg:"black"};const r=this.buildChromeConfig();this.chrome.render(e,r);const o=!0,s=le,a=Cn(t,o),l=this.opts.title;l!==void 0&&(f(e,s,2,l,"bright-white","black"),f(e,s+1,2,"'".repeat(l.length),"bright-black","black"));const c=s+2,h=this.computeChoicesHeight(),d=a-h-1,p=d-1;this.renderContent(e,c,p),d>=0&&d<t&&pe(e,d,i);let u=d+1;this.lastChoicesStartRow=u;for(let m=0;m<this._choices.length;m++){const g=this._choices[m],y=m===this.cursorIdx,T=y?">":" ",S=g.disabled?"bright-black":y?"bright-green":"white";if(u<t&&(f(e,u,2,T,S,"black"),f(e,u,3,g.label,S,"black")),u++,g.details)for(const b of g.details)u<t&&f(e,u,4,b.slice(0,i-4),"bright-black","black"),u++}}}const dr={delivery:"[D]",supply:"[S]"};class ur extends hr{constructor(e,t,i,r,o,s,a,l){const c=zi(i,r),h=r.type==="delivery"&&r.pickupDestinationId===r.issuingDestinationId,d=c.ok?{label:"ACCEPT MISSION",action:()=>o(h)}:{label:"ACCEPT MISSION",disabled:!0,details:c.reason?[c.reason]:[],action:()=>{}},p={label:"BACK",action:()=>s()};super("MISSION BOARD",[d,p],s,[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,t,i),this.spec=r,this.onHub=a,this.onUndock=l}destColor(e){if(e===this.player.destinationId)return"bright-green";const t=N(e);return t&&t.system===this.player.systemId?"bright-yellow":"white"}writeDestRow(e,t,i,r,o,s){f(e,t,2,i,"white","black"),f(e,t,2+i.length,r.slice(0,s-i.length),this.destColor(o),"black")}handleAction(e){e==="NAV_1"?(this.activated=!0,this.onUndock()):e==="NAV_2"?(this.activated=!0,this.onHub()):super.handleAction(e)}handleNavTap(e){this.activated||(e==="undock"?(this.activated=!0,this.onUndock()):e==="hub"&&(this.activated=!0,this.onHub()))}renderContent(e,t,i){this.renderDetail(e,t,i)}renderDetail(e,t,i){const o=e.length>0?e[0].length:40,s=o-4;let a=t;const l=(u,m,g)=>{u<=i&&f(e,u,2,m.slice(0,s),g,"black")};l(a,`${dr[this.spec.type]} ${this.spec.title}`,"bright-yellow"),a++;const c=F(),h=this.spec.giverFactionId?c.factions.find(u=>u.id===this.spec.giverFactionId):null,d=h?` [${h.name}]`:"";if(l(a,`    ${this.spec.giverName}${d}`,"bright-black"),a++,a++,this.spec.type==="delivery"){const u=N(this.spec.pickupDestinationId),m=N(this.spec.deliveryDestinationId);if(a<=i&&this.writeDestRow(e,a,"Pickup:  ",(u==null?void 0:u.name)??this.spec.pickupDestinationId,this.spec.pickupDestinationId,s),a++,a<=i&&this.writeDestRow(e,a,"Deliver: ",(m==null?void 0:m.name)??this.spec.deliveryDestinationId,this.spec.deliveryDestinationId,s),a++,a<=i){const g=this.player.cargoCapacity-this.player.cargoWeightKg,y=this.spec.itemWeightKg,T=g>=y,S=`Weight:  ${y} kg  (Free: ${g} kg)`;f(e,a,2,S,"white","black");const b=T?"bright-green":"red",M=2+S.length+1;M<o&&f(e,a,M,T?"✓":"✗",b,"black")}a++}else{const u=N(this.spec.deliveryDestinationId);a<=i&&this.writeDestRow(e,a,"Deliver to: ",(u==null?void 0:u.name)??this.spec.deliveryDestinationId,this.spec.deliveryDestinationId,s),a++;for(const m of this.spec.requirements){if(a>i)break;const g=ae(m.commodityId);l(a,`  ${m.qty}x ${(g==null?void 0:g.name)??m.commodityId}`,"white"),a++}}a++;const p=Ze(this.spec.description,s);for(const u of p){if(a>i)break;l(a,u,"white"),a++}if(a++,!(a>i)&&(l(a,`REWARD: ${this.spec.reward} CR`,"bright-green"),a++,this.spec.type==="delivery"&&this.spec.deposit>0&&(a<=i&&l(a,`DEPOSIT: ${this.spec.deposit} CR`,"bright-yellow"),a++),this.spec.giverFactionId)){const u=c.factions.find(m=>m.id===this.spec.giverFactionId);if(u){const m=P(),g=this.spec.reward;let y;g>=m.reputation.missionTierLargeReward?y=m.reputation.missionDeltaLarge:g>=m.reputation.missionTierMediumReward?y=m.reputation.missionDeltaMedium:y=m.reputation.missionDeltaSmall;const T=Mn(u,y,c.factions),S=[];for(const[b,M]of T){const v=c.factions.find(x=>x.id===b);v&&S.push({id:b,name:v.name,delta:M})}if(S.sort((b,M)=>b.delta!==M.delta?M.delta-b.delta:b.name.localeCompare(M.name)),S.length>0){if(a++,a>i)return;const b=i-1;a<=b&&(l(a,"REPUTATION IMPACT","bright-cyan"),a++);for(const M of S){if(a>b)break;const v=Tn(M.delta),x=M.delta>0?"bright-green":"red",_=s-v.length-2,w=M.name.slice(0,_),D=" ".repeat(Math.max(0,s-w.length-v.length-2));l(a,`  ${w}${D}${v}`,x),a++}}}}}}function pr(n){if(n.length===0)return 2166136261;let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619)>>>0;return e===0?1:e}const mr=[30,10,5],fr=[".","*","+"],Yn=[4e3,2e3,800],gr=[9e3,5e3,2500],yr=[null,"bright-black","white"],_r=["bright-black","white","bright-white"],br=["white","bright-white","bright-cyan"],He=3,Kn=25,Ue=2,jn=37,qn=2*Math.PI;function vr(n){let e=n>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}class wr{constructor(e=42){this.boundsSet=!1,this.rand=vr(e),this.stars=[];for(let t=0;t<3;t++)for(let i=0;i<mr[t];i++){const r=Ue+Math.floor(this.rand()*(jn-Ue+1)),o=He+Math.floor(this.rand()*(Kn-He+1)),s=this.rand()*qn,a=Yn[t]+this.rand()*(gr[t]-Yn[t]);this.stars.push({col:r,row:o,layer:t,twinklePhase:s,twinklePeriod:a})}}update(e){for(const t of this.stars)t.twinklePhase+=qn/t.twinklePeriod*e}render(e,t,i,r,o){if(!this.boundsSet){this.boundsSet=!0;const s=Kn-He,a=jn-Ue;{const l=(i-t)/s,c=(o-r)/a;for(const h of this.stars)h.row=Math.round(t+(h.row-He)*l),h.col=Math.round(r+(h.col-Ue)*c)}}for(const s of this.stars){const{row:a,col:l,layer:c}=s;if(a<t||a>i||l<r||l>o)continue;const h=Math.sin(s.twinklePhase);let d;h>=.5?d=br[c]:h>=-.5?d=_r[c]:d=yr[c],d!==null&&(e[a][l]={char:fr[c],fg:d,bg:"black"})}}getStars(){return this.stars}}const kr=2,xr=3,Cr=2*Math.PI/9e3,Tr=2*Math.PI/12e3,Mr=Math.PI/3;function Vn(n,e,t){return Math.max(e,Math.min(t,n))}class Ir{constructor(e,t,i,r,o,s=.5,a=.6){this.time=0,this.glyph=e,this.intRowStart=t,this.intRowEnd=i,this.intColStart=r,this.intColEnd=o,this.glyphHeight=e.rows.length,this.glyphWidth=Math.max(...e.rows.map(l=>l.length)),this.anchorRow=t+Math.floor((i-t)*s)-Math.floor(this.glyphHeight/2),this.anchorCol=r+Math.floor((o-r)*a)-Math.floor(this.glyphWidth/2)}update(e){this.time+=e}getDisplayPosition(){const e=Math.round(kr*Math.sin(this.time*Cr)),t=Math.round(xr*Math.sin(this.time*Tr+Mr)),i=Vn(this.anchorRow+e,this.intRowStart,this.intRowEnd-this.glyphHeight+1),r=Vn(this.anchorCol+t,this.intColStart,this.intColEnd-this.glyphWidth+1);return{row:i,col:r}}render(e){const{row:t,col:i}=this.getDisplayPosition(),r=this.glyph.fg;for(let o=0;o<this.glyph.rows.length;o++){const s=this.glyph.rows[o];let a=-1,l=-1;for(let c=0;c<s.length;c++)s[c]!==" "&&(a===-1&&(a=c),l=c);if(a!==-1)for(let c=a;c<=l;c++){const h=s[c],d=t+o,p=i+c;d>=0&&d<e.length&&p>=0&&p<e[d].length&&(e[d][p]=h===" "?{char:" ",fg:"black",bg:"black"}:{char:h,fg:r,bg:"black"})}}}}const zn=[{rows:[">---<"," |*| ","  |  "],fg:"bright-white"},{rows:["/-\\","|O|","\\-/"],fg:"cyan"},{rows:["  *  ","--+--"," [H] ","  |  ","  *  "],fg:"bright-white"}],Xn=[{rows:[" /\\/\\","< ** >"," \\__/"],fg:"yellow"},{rows:["  ___"," /   \\","|  .  |"," \\___/"],fg:"yellow"},{rows:[" _/\\_","/  . \\","\\____/"],fg:"yellow"}],Qn=[{rows:["  .--."," / .. \\","| .... |"," \\ .. /","  `--'"],fg:"blue"},{rows:["  .--."," / ~~ \\","| ~~~~ |"," \\ ~~ /","  `--'"],fg:"bright-yellow"},{rows:["  .--."," /====\\","|======|"," \\====/","  `--'"],fg:"bright-cyan"}];function Ar(n,e){return n==="orbital"||n==="deep-space"?zn[e%zn.length]:n==="asteroid"?Xn[e%Xn.length]:n==="surface"?Qn[e%Qn.length]:null}const Sr=6,cn=6,Er=23,Rr=23,hn=10,Lr=0,Fr=4,Dr=18,Nr=21,Or=35,Pr=39,Jn=12,Br=11,re=13,xe=27,dn=28,Hr=12,un=40,Zn=200,pn=["> SYSTEM STATUS: ALL CLEAR","> DRIVE EFFICIENCY: 97%","> BEACON SIGNAL DETECTED ON 14.7 MHz","> TRADE ROUTE UPDATE: ELYSIUM CORRIDOR STABLE","> WARNING: DEBRIS FIELD DELTA-9 ACTIVE","> COMMS RELAY SIGNAL NOMINAL","> FUEL RESERVES OPTIMAL","> SECTOR SCAN COMPLETE — NO HOSTILES","> GRAVITATIONAL ANOMALY LOGGED AT BEARING 227","> TRANSPONDER HANDSHAKE: ACCEPTED"],Ur="#",et=["green","cyan","white","yellow"],nt=["*",".","+","x"];function Gr(n){return n>=.8?"bright-green":n>=.5?"yellow":"red"}function tt(n){let e=n>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}function $r(n,e,t){return{col:e,row:t,char:Ur,color:et[Math.floor(n()*et.length)],phase:n()*2e4,period:1e4+n()*1e4,active:n()>.2}}function Ce(n,e,t,i){const r=[];for(const o of i)for(let s=e;s<=t;s++)r.push($r(n,s,o));return r}class Wr extends X{constructor(e,t,i,r,o,s,a){var u;super(e,t,i,{navOptions:[],onMenu:a}),this.cursorIdx=0,this.h=30,this.destObject=null,this.blinkPhase=0,this.msgIdx=0,this.tickerScroll=0,this.tickerAccum=0,this.tickerPause=0,this.onTravel=r,this.onDock=o,this.onCargo=s;const l=pr(i.destinationId??"");this.starfield=new wr(l),this.inSpace=i.destinationId===null;const c=i.destinationId!=null?(u=N(i.destinationId))==null?void 0:u.locationType:void 0;this.destGlyph=Ar(c,l),this.destRowFrac=.15+Math.random()*.7,this.destColFrac=.15+Math.random()*.7;const h=tt(99);this.gaugeBtns=[...Ce(h,Lr,Fr,[3,4]),...Ce(h,Dr,Nr,[3,4]),...Ce(h,Or,Pr,[3,4])],this.leftBtns=Ce(h,0,Br,[0,1,2,3]),this.rightBtns=Ce(h,dn,39,[0,1,2,3]);const d=tt(77),p=3+Math.floor(d()*4);this.radarContacts=Array.from({length:p},()=>({x:d()*(xe-re-1),y:d()*4,vx:(d()-.5)*2,vy:(d()-.5)*1.5,char:nt[Math.floor(d()*nt.length)]}))}navCount(){return this.inSpace?1:2}handleAction(e){e==="CARGO"?(this.activated=!0,this.onCargo()):e==="UP"?this.cursorIdx=(this.cursorIdx-1+this.navCount())%this.navCount():e==="DOWN"?this.cursorIdx=(this.cursorIdx+1)%this.navCount():e==="SELECT"&&(this.cursorIdx===0?(this.activated=!0,this.onTravel()):this.inSpace||(this.activated=!0,this.onDock()))}handleTap(e,t){const i=this.h;(t===3||t===4)&&e>=cn&&e<cn+1+hn?(this.activated=!0,this.onCargo()):t===i-3&&e<Jn?(this.activated=!0,this.onTravel()):t===i-3&&e>=dn&&!this.inSpace&&(this.activated=!0,this.onDock())}update(e){var r;this.starfield.update(e),(r=this.destObject)==null||r.update(e),this.blinkPhase=(this.blinkPhase+e)%1e3;for(const o of[...this.gaugeBtns,...this.leftBtns,...this.rightBtns])o.phase+=e,o.phase>=o.period&&(o.phase-=o.period,o.active=!o.active);const t=xe-re,i=5;for(const o of this.radarContacts)o.x+=o.vx*e/1e3,o.y+=o.vy*e/1e3,o.x<0&&(o.x=-o.x,o.vx=-o.vx),o.x>t-1&&(o.x=2*(t-1)-o.x,o.vx=-o.vx),o.y<0&&(o.y=-o.y,o.vy=-o.vy),o.y>i-1&&(o.y=2*(i-1)-o.y,o.vy=-o.vy);if(this.tickerPause>0)this.tickerPause=Math.max(0,this.tickerPause-e);else for(this.tickerAccum+=e;this.tickerAccum>=Zn;){this.tickerAccum-=Zn,this.tickerScroll++;const o=pn[this.msgIdx];if(this.tickerScroll>=o.length+un-1){this.tickerScroll=0,this.msgIdx=(this.msgIdx+1)%pn.length,this.tickerPause=500,this.tickerAccum=0;break}}}renderContent(e,t,i){var d;const r=e.length,o=r>0?e[0].length:0;this.h=r;const s=t+2,a=r-8,l=r-7,c=r-3,h=r-2;this.renderGaugeStrip(e,t),this.starfield.render(e,s,a,0,39),!this.destObject&&this.destGlyph&&(this.destObject=new Ir(this.destGlyph,s+1,a-1,0,39,this.destRowFrac,this.destColFrac)),(d=this.destObject)==null||d.render(e);for(let p=0;p<o;p++)e[s][p]={char:"-",fg:"white",bg:"black"},e[a][p]={char:"-",fg:"white",bg:"black"};this.renderHUD(e,s+1),this.renderCrosshair(e,s+1,a-1),this.renderBottomPanels(e,l,c),this.renderTicker(e,h)}renderGaugeStrip(e,t){for(const a of this.gaugeBtns){const l=t+a.row-3,c=a.active?a.color:"bright-black";l>=0&&l<e.length&&(e[l][a.col]={char:a.char,fg:c,bg:"black"})}const i=this.player.fuelL/this.player.fuelCapacityL,r=this.player.cargoWeightKg/this.player.cargoCapacity,o=this.blinkPhase<500,s=Gr(this.player.hullIntegrity);this.renderGauge(e,t,Sr,"F",i,"yellow",o),this.renderGauge(e,t+1,cn,"C",r,"blue",o),this.renderGauge(e,t,Er,"S",1,"cyan",o),this.renderGauge(e,t+1,Rr,"H",this.player.hullIntegrity,s,o)}renderGauge(e,t,i,r,o,s,a){if(t<0||t>=e.length)return;e[t][i]={char:r,fg:s,bg:"black"};const l=Math.round(Math.min(1,Math.max(0,o))*hn),c=o<=.2;for(let h=0;h<hn;h++){const d=i+1+h;if(h<l){const p=c&&!a?"bright-black":s;e[t][d]={char:" ",fg:"black",bg:p}}else e[t][d]={char:" ",fg:"black",bg:"bright-black"}}}renderHUD(e,t){f(e,t,1,"VEL:----","bright-black","black"),f(e,t,16,"ATT:---°","bright-black","black"),f(e,t,30,"ROT:--°","bright-black","black")}renderCrosshair(e,t,i){var a;const r=Math.floor((t+i)/2),o=20;e[r][o]={char:"+",fg:"bright-green",bg:"black"};const s=[[r-3,o-5],[r-3,o+5],[r+3,o-5],[r+3,o+5]];for(const[l,c]of s){const h=((a=e[0])==null?void 0:a.length)??40;l>=t&&l<=i&&c>=0&&c<h&&(e[l][c]={char:"+",fg:"bright-green",bg:"black"})}}renderBottomPanels(e,t,i){for(let c=t;c<=i;c++)for(let h=re;h<xe;h++)e[c][h]={char:" ",fg:"black",bg:"bright-black"};this.renderRadar(e,t,i-t+1);for(const c of this.leftBtns){const h=t+c.row;if(h<i){const d=c.active?c.color:"bright-black";e[h][c.col]={char:c.char,fg:d,bg:"black"}}}for(const c of this.rightBtns){const h=t+c.row;if(h<i){const d=c.active?c.color:"bright-black";e[h][c.col]={char:c.char,fg:d,bg:"black"}}}const r=this.cursorIdx===0?"bright-yellow":"yellow";f(e,i,0,this.centerPad("TRAVEL",Jn),"black",r);let o,s;this.inSpace?(o="bright-black",s="bright-black"):(o=this.cursorIdx===1?"bright-cyan":"cyan",s="black"),f(e,i,dn,this.centerPad("DOCK",Hr),s,o);const a=xe-re,l="<)) "+"-".repeat(a-4);f(e,i,re,l,"white","bright-black")}renderRadar(e,t,i){for(const r of this.radarContacts){const o=Math.min(xe-re-1,Math.max(0,Math.floor(r.x))),s=Math.min(i-1,Math.max(0,Math.floor(r.y)));e[t+s][re+o]={char:r.char,fg:"white",bg:"bright-black"}}}renderTicker(e,t){const i=pn[this.msgIdx];for(let r=0;r<un;r++){const o=this.tickerScroll-un+1+r,s=o>=0&&o<i.length?i[o]:" ";e[t][r]={char:s,fg:"white",bg:"black"}}}centerPad(e,t){if(e.length>=t)return e.slice(0,t);const i=t-e.length,r=Math.floor(i/2);return" ".repeat(r)+e+" ".repeat(i-r)}}class Yr extends X{constructor(e,t,i,r,o){super(e,t,i,{title:"CARGO HOLD",tabs:["COMMODITIES","MISSION GOODS"],navOptions:[{id:"back",label:"BACK"}],onMenu:o}),this.onBack=r}handleNavTap(e){e==="back"&&(this.activated=!0,this.onBack())}handleAction(e){(e==="BACK"||e==="CARGO")&&(this.activated=!0,this.onBack())}renderContent(e,t,i){const o=e.length>0?e[0].length:0,s=this.player.cargoHold,a=this.player.missionItems,l=this.player.cargoCapacity,c=this.player.cargoWeightKg,h=i-1;this.activeTabIdx===0?this.renderCommoditiesTab(e,t,h,o,s):this.renderMissionGoodsTab(e,t,h,o,a);const d=`CARGO: ${c}/${l}KG`,p=`FUEL: ${this.player.fuelL}/${this.player.fuelCapacityL}L`;f(e,h,2,d,"bright-black","black"),f(e,h,o-p.length-2,p,"bright-black","black")}renderCommoditiesTab(e,t,i,r,o){if(o.length===0){f(e,t,2,"NO COMMODITIES","bright-black","black");return}let s=t;for(const a of o){if(s>=i-1)break;const l=ae(a.commodityId);if(!l)continue;const c=a.qty*l.weightKg,h=`  x${a.qty}  ${l.basePrice}CR  ${c}KG`,d=Math.max(6,r-4-h.length),p=l.name,u=p.length>d?p.slice(0,d):p;f(e,s,2,`${u}${h}`,"white","black"),s++}}renderMissionGoodsTab(e,t,i,r,o){if(o.length===0){f(e,t,2,"NO MISSION GOODS","bright-black","black");return}let s=t;for(const a of o){if(s>=i-1)break;const l=`  ${a.weightKg}KG`,c=Math.max(6,r-4-l.length),h=a.itemName.length>c?a.itemName.slice(0,c):a.itemName;f(e,s,2,`${h}${l}`,"white","black"),s++}}}class it extends he{constructor(e,t,i,r,o,s,a,l,c=()=>{},h){const d=ee(i.systemId),p=Bt(i.driveId),u=i.getInSystemHopCost(),m=i.fuelL<u,g=[...d.destinations.map(b=>({label:`${N(b).name.toUpperCase()}  [${u}L]`,disabled:b===i.destinationId||m,action:()=>r(b)})),{label:`FLY INTO SPACE  [${u}L]`,disabled:i.destinationId===null||m,action:s}];m&&h&&g.push({label:"[EMERGENCY]",disabled:!1,action:h});const T=[...xn(i.systemId).map(b=>{const M=b.from===i.systemId?b.to:b.from,v=ee(M),x=Math.ceil(P().fuel.consumptionPerLy*b.distance*p.fuelEfficiency);return{label:`${v.name.toUpperCase()}  ${b.distance}LY  [${x}L]`,disabled:x>i.fuelL,action:()=>o(M)}}),{label:"GALAXY MAP...",action:l}],S=[{label:"DESTINATIONS",items:g},{label:"JUMPS",items:T}];super("TRAVEL",[],[{id:"ship",label:"SHIP"}],e,t,i,[],S,c),this.onShip=a}handleNavAction(e){(e==="BACK"||e==="NAV_1")&&!this.activated&&(this.activated=!0,this.onShip())}handleNavTap(e){e==="ship"&&!this.activated&&(this.activated=!0,this.onShip())}}class Kr extends X{constructor(e,t,i,r,o,s){super(e,t,i,{navOptions:[],title:"EMERGENCY RESCUE"}),this.cursorIdx=0,this.onBack=s;const a=ee(i.systemId),l=P();if(this.options=[],this.fuelDestId=a.destinations.find(c=>{var h;return((h=N(c))==null?void 0:h.amenities.fuel)===!0}),this.fuelDestId){const c=N(this.fuelDestId);this.options.push({label:`TOW TO ${c.name.toUpperCase()}`,fee:l.emergencyRescue.towFee,action:()=>r(this.fuelDestId)})}this.options.push({label:"EMERGENCY FUEL DROP",fee:l.emergencyRescue.fuelDropFee,action:o}),this.options.push({label:"BACK",fee:0,action:s})}preHandleAction(e){return e==="BACK"?(this.activated=!0,this.onBack(),!0):!1}handleAction(e){e==="UP"?this.cursorIdx=(this.cursorIdx-1+this.options.length)%this.options.length:e==="DOWN"?this.cursorIdx=(this.cursorIdx+1)%this.options.length:e==="SELECT"&&this.cursorIdx>=0&&this.cursorIdx<this.options.length&&(this.activated=!0,this.options[this.cursorIdx].action())}handleTap(e,t){this.cursorIdx>=0&&this.cursorIdx<this.options.length&&(this.activated=!0,this.options[this.cursorIdx].action())}renderContent(e,t,i){const r=e.length,o=r>0?e[0].length:0,s=ee(this.player.systemId);let a;this.player.destinationId===null?a=`STRANDED IN SPACE NEAR ${s.name.toUpperCase()}`:a=`STRANDED AT ${N(this.player.destinationId).name.toUpperCase()}`,f(e,t,2,a,"bright-yellow","black");const l=t+2;pe(e,l,o);let c=l+1;for(let h=0;h<this.options.length;h++){const d=this.options[h],p=h===this.cursorIdx,u=p?">":" ",m=p?"bright-green":"white";if(c<r)if(f(e,c,2,u,m,"black"),d.fee===0)f(e,c,3,d.label,m,"black");else{f(e,c,3,d.label,m,"black");const g=this.player.credits-d.fee,y=`${d.fee} CR  (BALANCE: ${g>=0?"":"-"}${Math.abs(g)} CR)`,T=g<0?"bright-red":m;c+1<r&&f(e,c+1,4,y,T,"black"),c++}c++}}}function rt(n,e){if(n===e)return[n];const t=[[n]],i=new Set([n]);for(;t.length>0;){const r=t.shift(),o=r[r.length-1];for(const s of xn(o)){const a=s.from===o?s.to:s.from;if(a===e)return[...r,a];i.has(a)||(i.add(a),t.push([...r,a]))}}return null}const jr=0,qr=4,Vr=8,zr=9,ot=10,st=15,Xr=16,Qr=2,Jr=10,Zr=12,Ge=13,$e=12,eo=25,no=26,to=10,at=18;function io(n,e){return n.length>=e?n.slice(0,e):n+" ".repeat(e-n.length)}function Te(n,e){return"["+io(n.toUpperCase(),e-2)+"]"}class lt extends X{constructor(e,t,i,r,o=()=>{},s){const a=s?[{id:"game",label:"GAME"},{id:"menu",label:"MENU"}]:[{id:"back",label:"BACK"}];super(e,t,i,{title:"GALAXY MAP",tabs:["MAP","ROUTE"],navOptions:a,onMenu:o}),this.mapCursorIdx=0,this.routeDestIdx=0,this.searchText="",this.lastTop=le+5,this.onBack=r,this.onGame=s,this.publicSystems=Yi().sort((l,c)=>l.distanceFromSol-c.distanceFromSol),this.otherSystems=this.publicSystems.filter(l=>l.id!==i.systemId),this.mapBrowsingSystemId=i.systemId}onTabChange(e){this.searchText=""}handleCharInput(e){if(this.activeTabIdx!==0)return;const t=e.charCodeAt(0);e==="\b"||e===""?this.searchText=this.searchText.slice(0,-1):t>=32&&t<127&&(this.searchText+=e.toUpperCase(),this.mapCursorIdx=0)}handleAction(e){if(e==="BACK"){if(this.searchText.length>0){this.searchText="";return}this.activated=!0,this.onBack();return}if(e==="NAV_1"){this.onGame&&(this.activated=!0,this.onGame());return}if(e==="NAV_2"){this.onGame&&(this.searchText="",this.activated=!0,this.onBack());return}this.activeTabIdx===0?this.handleMapAction(e):this.handleRouteAction(e)}handleNavTap(e){e==="back"?(this.searchText="",this.activated=!0,this.onBack()):e==="game"&&this.onGame?(this.activated=!0,this.onGame()):e==="menu"&&(this.searchText="",this.activated=!0,this.onBack())}handleTap(e,t){const i=this.lastTop,r=i+ot,o=i+st;if(this.activeTabIdx===0&&t>=r&&t<o){const s=this.getMapNeighbors(),a=t-r;a>=0&&a<s.length&&(this.mapBrowsingSystemId=s[a].id,this.mapCursorIdx=0,this.searchText="")}else if(this.activeTabIdx===1){const s=i+3,a=i+9;if(t>=s&&t<=a){const l=t-s;l>=0&&l<this.otherSystems.length&&(this.routeDestIdx=l)}}}getMapNeighbors(){const t=xn(this.mapBrowsingSystemId).map(i=>{const r=i.from===this.mapBrowsingSystemId?i.to:i.from,o=this.publicSystems.find(a=>a.id===r),s=i.distance;return o?{sys:o,dist:s}:null}).filter(i=>i!==null).sort((i,r)=>i.dist-r.dist).map(i=>i.sys);return this.searchText.length===0?t:t.filter(i=>i.name.toUpperCase().includes(this.searchText))}handleMapAction(e){const t=this.getMapNeighbors(),i=Math.min(this.mapCursorIdx,Math.max(0,t.length-1));if(e==="UP")this.mapCursorIdx=Math.max(0,i-1);else if(e==="DOWN")this.mapCursorIdx=Math.min(t.length-1,i+1);else if(e==="SELECT"){const r=t[i];if(!r)return;this.mapBrowsingSystemId=r.id,this.mapCursorIdx=0,this.searchText=""}}handleRouteAction(e){e==="UP"?this.routeDestIdx=Math.max(0,this.routeDestIdx-1):e==="DOWN"&&(this.routeDestIdx=Math.min(this.otherSystems.length-1,this.routeDestIdx+1))}computeRoute(){const e=this.otherSystems[this.routeDestIdx];return e?rt(this.player.systemId,e.id):null}renderContent(e,t,i){this.lastTop=t;const r=e.length>0?e[0].length:0;this.activeTabIdx===0?this.renderMapTab(e,t,i,r):this.renderRouteTab(e,t,i,r)}renderMapTab(e,t,i,r){const o=this.publicSystems.find(p=>p.id===this.mapBrowsingSystemId)??this.publicSystems[0];if(!o)return;const s=t+zr,a=t+ot,l=t+st,c=t+Xr;this.renderChart(e,o,t),pe(e,s,r);const h=this.getMapNeighbors(),d=Math.min(this.mapCursorIdx,Math.max(0,h.length-1));this.renderNeighborList(e,r,o,h,d,a,l),pe(e,l,r),this.renderInfo(e,r,o,h[d]??null,c),this.searchText.length>0&&f(e,c+4,2,`/${this.searchText}_`,"bright-yellow","black")}renderChart(e,t,i){var h;const r=this.getMapNeighbors(),o=i+jr,s=i+qr,a=i+Vr,l=t.id===this.player.systemId?"bright-yellow":"bright-cyan";if(f(e,s,Ge,Te(t.name,$e),l,"black"),t.id===this.player.systemId){const d=Ge+$e,p=((h=e[0])==null?void 0:h.length)??40;d<p&&(e[s][d]={char:"*",fg:"bright-yellow",bg:"black"})}const c=["left","right","top","bottom"];for(let d=0;d<Math.min(r.length,4);d++){const p=r[d],u=c[d],m=p.id===this.player.systemId?"bright-yellow":"white";if(u==="left")f(e,s,Qr,Te(p.name,Jr),m,"black"),e[s][Zr]={char:"-",fg:"bright-black",bg:"black"};else if(u==="right")f(e,s,no,Te(p.name,to),m,"black"),e[s][eo]={char:"-",fg:"bright-black",bg:"black"};else if(u==="top"){f(e,o,Ge,Te(p.name,$e),m,"black");for(let g=o+1;g<s;g++)e[g][at]={char:"|",fg:"bright-black",bg:"black"}}else{f(e,a,Ge,Te(p.name,$e),m,"black");for(let g=s+1;g<a;g++)e[g][at]={char:"|",fg:"bright-black",bg:"black"}}}}renderNeighborList(e,t,i,r,o,s,a){for(let l=0;l<r.length&&l<a-s;l++){const c=r[l],h=s+l,d=l===o,u=c.id===this.player.systemId?"bright-yellow":d?"bright-cyan":"white",m=d?"> ":"  ",g=Ke(i.id,c.id),y=g?`${g.distance}LY  ${g.stability}`:"",T=t-4-y.length;f(e,h,2,m+c.name.toUpperCase().slice(0,T-2),u,"black"),y&&f(e,h,t-2-y.length,y,"bright-black","black")}}renderInfo(e,t,i,r,o){const a=i.id===this.player.systemId?"* Current location":i.name.toUpperCase();if(f(e,o,2,`Zone: ${i.zone}  Sec: ${i.security}  ${a}`.slice(0,t-4),"bright-black","black"),!r)return;const l=Ke(i.id,r.id);if(!l)return;const c=rt(this.player.systemId,r.id),h=c?c.length===1?"(your location)":`${c.length-1} hop${c.length-1!==1?"s":""} from you`:"(unreachable)";f(e,o+1,2,`${r.name.toUpperCase()}  ${l.distance}LY  ${h}`.slice(0,t-4),"bright-black","black")}renderRouteTab(e,t,i,r){var T,S;const o=t,s=t+2,a=t+3,l=7,c=a+l,h=c+1,d=h+6,p=this.publicSystems.find(b=>b.id===this.player.systemId);f(e,o,2,"FROM:","bright-black","black"),f(e,o,8,(p==null?void 0:p.name.toUpperCase())??this.player.systemId.toUpperCase(),"bright-yellow","black"),f(e,s,2,"TO:","bright-black","black");const u=Math.max(0,Math.min(this.routeDestIdx,this.otherSystems.length-l));for(let b=0;b<l;b++){const M=u+b;if(M>=this.otherSystems.length)break;const v=this.otherSystems[M],x=M===this.routeDestIdx,_=x?"bright-cyan":"white",w=x?"> ":"  ";f(e,a+b,2,w+v.name.toUpperCase(),_,"black")}pe(e,c,r),pe(e,d,r);const m=this.computeRoute();if(!this.otherSystems[this.routeDestIdx])return;if(!m){f(e,h,2,"No route found","bright-red","black");return}const y=m.length-1;f(e,h,2,`Route: ${y} hop${y!==1?"s":""}`,"bright-white","black");for(let b=0;b<y;b++){const M=Ke(m[b],m[b+1]);if(!M)continue;const v=h+1+b;if(v>=d)break;const x=(((T=this.publicSystems.find(w=>w.id===m[b]))==null?void 0:T.name)??m[b]).toUpperCase().slice(0,9),_=(((S=this.publicSystems.find(w=>w.id===m[b+1]))==null?void 0:S.name)??m[b+1]).toUpperCase().slice(0,9);f(e,v,4,`${x} -> ${_}  ${M.distance}LY  ${M.stability}`.slice(0,r-6),"white","black")}}}class ie extends X{constructor(e,t,i,r){const o={onAction:()=>{}};super(o,t,e,{navOptions:[]}),this.elapsed=0,this.arrived=!1,this.duration=i,this.onComplete=r}update(e){this.arrived||(this.elapsed+=e,this.elapsed>=this.duration&&(this.arrived=!0,this.onComplete()))}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[]}}}const ro=["[. . .]","[: : :]","[* * *]"],ct=5e3;class oo extends ie{constructor(e,t,i){super(e,t,ct,i)}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[],systemLabel:"IN TRANSIT",destinationLabel:null}}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/500)%3,a=Math.ceil((ct-this.elapsed)/1e3),l=Math.max(1,Math.min(5,a)),c=ee(this.player.systemId),h=c?c.name.toUpperCase():this.player.systemId.toUpperCase();L(e,o-3,"[ JUMP DRIVE ENGAGED ]","bright-cyan","black"),L(e,o-1,"DESTINATION:","bright-black","black"),L(e,o,h,"bright-white","black"),L(e,o+2,ro[s],"bright-black","black"),L(e,o+4,`ARRIVING IN ${l}S`,"bright-black","black")}}const ht=2e3,so=["[ —   ]","[  —  ]","[   — ]"];class mn extends ie{constructor(e,t,i,r){super(e,t,ht,i),this.targetLabel=r}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[],destinationLabel:"IN TRANSIT"}}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((ht-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a)),c=this.targetLabel!==void 0?this.targetLabel.toUpperCase():(()=>{const h=this.player.destinationId?N(this.player.destinationId):null;return h?h.name.toUpperCase():"UNKNOWN"})();L(e,o-3,"[ THRUSTERS ENGAGED ]","bright-yellow","black"),L(e,o-1,"HEADING TO:","bright-black","black"),L(e,o,c,"bright-white","black"),L(e,o+2,so[s],"bright-black","black"),L(e,o+4,`ARRIVING IN ${l}S`,"bright-black","black")}}const dt=2500,ao=["v","vv","vvv"];class lo extends ie{constructor(e,t,i){super(e,t,dt,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/400)%3,a=Math.ceil((dt-this.elapsed)/1e3),l=Math.max(1,Math.min(3,a));L(e,o-3,"[ LANDING SEQUENCE ]","bright-green","black"),L(e,o+2,ao[s],"bright-black","black"),L(e,o+4,`TOUCHDOWN IN ${l}S`,"bright-black","black")}}const ut=2500,co=[">",">>",">>>"];class ho extends ie{constructor(e,t,i){super(e,t,ut,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/400)%3,a=Math.ceil((ut-this.elapsed)/1e3),l=Math.max(1,Math.min(3,a));L(e,o-3,"[ APPROACH LOCKED ]","bright-yellow","black"),L(e,o+2,co[s],"bright-black","black"),L(e,o+4,`CLAMPING IN ${l}S`,"bright-black","black")}}const pt=1500,uo=["^","^^","^^^"];class po extends ie{constructor(e,t,i){super(e,t,pt,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((pt-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));L(e,o-3,"[ LIFTOFF SEQUENCE ]","bright-green","black"),L(e,o+2,uo[s],"bright-black","black"),L(e,o+4,`CLEAR IN ${l}S`,"bright-black","black")}}const mt=1500,mo=["<","<<","<<<"];class fo extends ie{constructor(e,t,i){super(e,t,mt,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((mt-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));L(e,o-3,"[ RELEASING CLAMPS ]","bright-yellow","black"),L(e,o+2,mo[s],"bright-black","black"),L(e,o+4,`DEPARTING IN ${l}S`,"bright-black","black")}}const ft=1500,go=["→","→→","→→→"];class yo extends ie{constructor(e,t,i){super(e,t,ft,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((ft-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));L(e,o-3,"[ DOCKING SEQUENCE ]","bright-cyan","black"),L(e,o+2,go[s],"bright-black","black"),L(e,o+4,`DOCKING IN ${l}S`,"bright-black","black")}}const gt=1500,_o=["←","←←","←←←"];class bo extends ie{constructor(e,t,i){super(e,t,gt,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((gt-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));L(e,o-3,"[ DEPARTING BERTH ]","bright-cyan","black"),L(e,o+2,_o[s],"bright-black","black"),L(e,o+4,`CLEAR IN ${l}S`,"bright-black","black")}}const vo=3e3;class wo extends X{constructor(e,t,i,r,o,s,a){super(e,i,t,{navOptions:[]}),this.outcomeLabel=r,this.score=o,this.damageFraction=s,this.onComplete=a,this.elapsed=0,this.arrived=!1,this.duration=vo,this.lastContentTop=4,this.lastContentBottom=26,this.buttonRow=0,this.buttonCol=0,e.onTap&&e.onTap((l,c)=>this.handleTapCustom(l,c)),e.onAction(l=>{!this.arrived&&l==="SELECT"&&(this.arrived=!0,this.onComplete())})}handleTapCustom(e,t){Math.abs(t-this.buttonRow)<=0&&e>=this.buttonCol&&e<this.buttonCol+"[continue]".length&&(this.arrived=!0,this.onComplete())}update(e){super.update(e),!this.arrived&&(this.elapsed+=e)}renderContent(e,t,i){var p;this.lastContentTop=t,this.lastContentBottom=i;const r=Math.floor((t+i)/2),o=((p=e[0])==null?void 0:p.length)??40,s=this.getOutcomeColor();L(e,r-2,this.outcomeLabel,s,"black"),this.score!==null&&L(e,r,`SCORE: ${this.score} / 100`,"white","black");const a=Math.round(this.damageFraction*100),l=a===0?"bright-green":"yellow";L(e,r+2,`HULL DAMAGE: ${a}%`,l,"black");const c="[continue]",h=r+5,d=Math.floor((o-c.length)/2);this.buttonRow=h,this.buttonCol=d,L(e,h,c,"bright-green","black")}getOutcomeColor(){return this.score===null||this.score<40?"red":this.score<70?"yellow":"bright-green"}}class ko extends X{constructor(e,t,i,r){super(e,t,i,{navOptions:r.navOptions,title:r.title}),this._completed=!1,this._onComplete=r.onComplete,this._canvasWidth=r.canvasWidth,this._canvasHeight=r.canvasHeight}renderContent(e,t,i){var u;const r=((u=e[0])==null?void 0:u.length)??0,o=e.length,s=i-t,a=this._canvasWidth??r,l=this._canvasHeight??s;let c=Math.floor((r-a)/2),h=t+Math.floor((s-l)/2);const d=Math.max(0,r-a),p=Math.max(0,o-l);c=Math.max(0,Math.min(c,d)),h=Math.max(0,Math.min(h,p)),this.renderGame(e,{top:h,left:c,width:a,height:l})}complete(e){var t;this._completed||(this._completed=!0,(t=this._onComplete)==null||t.call(this,e))}}function xo(n){if(n.length===0)return 2166136261;let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619)>>>0;return e===0?1:e}function Co(n){let e=n>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}class To extends ko{constructor(e,t,i,r){const o=i.destinationId??"";super(e,t,i,{navOptions:[],title:"DOCKING",canvasWidth:32,canvasHeight:18,onComplete:r}),this.heldKeys=new Set,this.lastActionTime=0,this.actionTimeoutMs=200,this.canvasWidth=32,this.canvasHeight=18,this.countdownSeconds=15,this.thrustForce=8,this.maxVelocity=6,this.driftIntervalMs=3e3,this.driftMaxDistanceChars=4,this.driftSpeedCharsPerSec=.8,this.perfectRadiusChars=5,this.airlockWidth=5,this.airlockHeight=3,this.lastViewport={top:0,left:0,width:32,height:18},this.rand=Co(xo(o));const s=(this.canvasWidth-1)/2,a=(this.canvasHeight-1)/2;this.state={shipX:s,shipY:a,shipVelX:0,shipVelY:0,airlockX:s,airlockY:a,driftTargetX:s,driftTargetY:a,driftTimer:this.driftIntervalMs*(.8+.4*this.rand()),timeRemaining:this.countdownSeconds,completed:!1}}renderContent(e,t,i){var u;const r=((u=e[0])==null?void 0:u.length)??0,o=e.length,s=i-t,a=this.canvasWidth,l=this.canvasHeight+3;let c=Math.floor((r-a)/2),h=t+Math.floor((s-l)/2);const d=Math.max(0,r-this.canvasWidth),p=Math.max(0,o-this.canvasHeight);c=Math.max(0,Math.min(c,d)),h=Math.max(0,Math.min(h,p)),this.renderGame(e,{top:h,left:c,width:this.canvasWidth,height:this.canvasHeight})}handleAction(e){if(super.handleAction(e),e==="MENU"){this.state.completed||(this.state.completed=!0,this.complete({outcome:"skipped"}));return}(e==="UP"||e==="DOWN"||e==="LEFT"||e==="RIGHT")&&(this.heldKeys.add(e),this.lastActionTime=performance.now())}handleTap(e,t){if(this.state.completed){super.handleTap(e,t);return}const{top:i,left:r,width:o,height:s}=this.lastViewport,a=r+Math.floor(o/2),l=i+s,c=l+1,h=l+3,d=a-5,p=a+3,u=a;t===c&&e>=u-1&&e<=u+1?this.handleAction("UP"):t===h&&e>=u-1&&e<=u+1?this.handleAction("DOWN"):e>=d&&e<=d+2&&t===c+1?this.handleAction("LEFT"):e>=p&&e<=p+2&&t===c+1?this.handleAction("RIGHT"):super.handleTap(e,t)}update(e){super.update(e);const t=e/1e3;if(!this.state.completed&&(this.clearExpiredActions(),this.updateMovement(t),this.updateAirlockDrift(t),this.updateCountdown(t),this.state.timeRemaining<=0)){const i=Math.hypot(this.state.shipX-this.state.airlockX,this.state.shipY-this.state.airlockY),r=1.5,o=i<=r?100:Math.round(Math.max(0,Math.min(1,1/(1+(i-r)/this.perfectRadiusChars)))*100);this.state.completed=!0,this.complete({outcome:"completed",result:{score:o}})}}updateMovement(e){const t=this.state;this.heldKeys.has("UP")&&(t.shipVelY-=this.thrustForce*e),this.heldKeys.has("DOWN")&&(t.shipVelY+=this.thrustForce*e),this.heldKeys.has("LEFT")&&(t.shipVelX-=this.thrustForce*e),this.heldKeys.has("RIGHT")&&(t.shipVelX+=this.thrustForce*e),t.shipVelX=Math.max(-this.maxVelocity,Math.min(this.maxVelocity,t.shipVelX)),t.shipVelY=Math.max(-this.maxVelocity,Math.min(this.maxVelocity,t.shipVelY)),t.shipX+=t.shipVelX*e,t.shipY+=t.shipVelY*e;const i=.5;t.shipX=Math.max(i,Math.min(this.canvasWidth-1-i,t.shipX)),t.shipY=Math.max(i,Math.min(this.canvasHeight-1-i,t.shipY))}updateAirlockDrift(e){const t=this.state,i=t.driftTargetX-t.airlockX,r=t.driftTargetY-t.airlockY,o=Math.hypot(i,r);if(o<.1){const s=this.rand()*2*Math.PI,a=this.rand()*this.driftMaxDistanceChars,l=(this.canvasWidth-1)/2,c=(this.canvasHeight-1)/2;t.driftTargetX=l+Math.cos(s)*a,t.driftTargetY=c+Math.sin(s)*a,t.driftTimer=this.driftIntervalMs*(.8+.4*this.rand())}else{const s=this.driftSpeedCharsPerSec*e,a=Math.min(1,s/o);t.airlockX+=i*a,t.airlockY+=r*a}}updateCountdown(e){this.state.timeRemaining=Math.max(0,this.state.timeRemaining-e)}clearExpiredActions(){performance.now()-this.lastActionTime>this.actionTimeoutMs&&this.heldKeys.clear()}renderGame(e,t){const{top:i,left:r,width:o,height:s}=t;this.lastViewport={top:i,left:r,width:o,height:s},this.drawBorder(e,i,r,o,s),this.drawAirlock(e,i,r),this.drawShip(e,i,r),this.drawCountdown(e,i,r,o),this.drawDistance(e,i,r,s),this.drawControlButtons(e,i,r,o,s)}drawBorder(e,t,i,r,o){const s=i+r-1,a=t+o-1;for(let l=i;l<=s;l++)t<e.length&&l<e[t].length&&(e[t][l]={char:"+",fg:"white",bg:"black"}),a<e.length&&l<e[a].length&&(e[a][l]={char:"+",fg:"white",bg:"black"});for(let l=t+1;l<a;l++)l<e.length&&(i<e[l].length&&(e[l][i]={char:"|",fg:"white",bg:"black"}),s<e[l].length&&(e[l][s]={char:"|",fg:"white",bg:"black"}))}drawAirlock(e,t,i){const r=i+1+Math.round(this.state.airlockX),o=t+1+Math.round(this.state.airlockY),s=r-Math.floor(this.airlockWidth/2),a=o-Math.floor(this.airlockHeight/2),l=[["+","-","+","-","+"],["|"," ","+"," ","|"],["+","-","+","-","+"]];for(let c=0;c<this.airlockHeight;c++)for(let h=0;h<this.airlockWidth;h++){const d=a+c,p=s+h;if(d>=t&&d<t+this.canvasHeight&&p>=i&&p<i+this.canvasWidth&&d<e.length&&p<e[d].length){const u=l[c][h];e[d][p]={char:u,fg:"bright-yellow",bg:"black"}}}}drawShip(e,t,i){const r=i+1+Math.round(this.state.shipX),o=t+1+Math.round(this.state.shipY);r>=i&&r<i+this.canvasWidth&&o>=t&&o<t+this.canvasHeight&&(o<e.length&&r<e[o].length&&(e[o][r]={char:"(",fg:"bright-green",bg:"black"}),r+1<i+this.canvasWidth&&o<e.length&&r+1<e[o].length&&(e[o][r+1]={char:"+",fg:"bright-green",bg:"black"}),r+2<i+this.canvasWidth&&o<e.length&&r+2<e[o].length&&(e[o][r+2]={char:")",fg:"bright-green",bg:"black"}))}drawCountdown(e,t,i,r){const o=`T: ${Math.ceil(this.state.timeRemaining)}`,s=i+r-1-o.length,a=t+1;f(e,a,s,o,"white","black")}drawDistance(e,t,i,r){const s=`DIST: ${Math.hypot(this.state.shipX-this.state.airlockX,this.state.shipY-this.state.airlockY).toFixed(1)}`,a=t+r-1;f(e,a,i+2,s,"white","black")}drawControlButtons(e,t,i,r,o){const s=e.length,a=s>0?e[0].length:0,l=t+o,c=i+Math.floor(r/2),h=this.heldKeys.has("UP"),d=this.heldKeys.has("DOWN"),p=this.heldKeys.has("LEFT"),u=this.heldKeys.has("RIGHT"),m="bright-green",g="bright-black",y=x=>`[${x}]`,T=l+1,S=l+2,b=l+3,M=c-5,v=c+3;if(T<s&&c-1>=0&&c+1<a){const x=y("^"),_=c-1;for(let w=0;w<x.length;w++)_+w>=0&&_+w<a&&(e[T][_+w]={char:x[w],fg:h?m:g,bg:"black"})}if(S<s){const x=y("<");for(let w=0;w<x.length;w++)M+w>=0&&M+w<a&&(e[S][M+w]={char:x[w],fg:p?m:g,bg:"black"});const _=y(">");for(let w=0;w<_.length;w++)v+w>=0&&v+w<a&&(e[S][v+w]={char:_[w],fg:u?m:g,bg:"black"})}if(b<s&&c-1>=0&&c+1<a){const x=y("v"),_=c-1;for(let w=0;w<x.length;w++)_+w>=0&&_+w<a&&(e[b][_+w]={char:x[w],fg:d?m:g,bg:"black"})}}}const Mo=[{id:"docking",name:"Docking Mini-Game",description:"Align the ship crosshair with the airlock target before countdown expires",variants:[{id:"orbital",label:"Orbital Station",params:{locationType:"orbital"}},{id:"deep-space",label:"Deep Space",params:{locationType:"deep-space"}}]}],Io=[{meta:Mo[0],factory:(n,e,t,i,r)=>new To(n,e,t,r)}];function Ao(n){let e=n>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}function So(n,e){return Math.floor(n()*e)}function Ie(n,e){return e[So(n,e.length)]}function $t(n,e){const{special:t,firstNames:i,lastNames:r}=e.npcNames;if(n()<P().npc.specialNameChance&&t.length>0)return{giverName:Ie(n,t)};const o=i.length>0?Ie(n,i):"Unknown",s=r.length>0?Ie(n,r):"Agent";return{giverName:`${o} ${s}`}}function Eo(n,e){return e.destinations.filter(t=>t.id!==n.id)}function Ro(n){return n.commodities.filter(e=>e.legal)}function Lo(n,e){const t=e.reduce((r,o)=>r+o.weightKg,0);if(t===0)return e[0];let i=n()*t;for(const r of e)if(i-=r.weightKg,i<0)return r;return e[e.length-1]}function yt(n,e,t,i){var y;const r=t.deliveryItems;if(r.length===0)return null;const o=Eo(e,t);if(o.length===0)return null;const s=Lo(n,r),a=Ie(n,o),l=$t(n,t),{deliveryBaseReward:c,deliveryRandomReward:h,deliveryDepositFraction:d}=P().missions,p=Math.floor(s.weightKg*1.5),u=c+p+Math.floor(n()*h),m=Math.floor(u*d),g=e.owningFactionId?(y=F().factions.find(T=>T.id===e.owningFactionId&&de(T)))==null?void 0:y.id:void 0;return{...l,giverFactionId:g,id:i,type:"delivery",title:s.name,description:`A package needs transporting. Pick up the ${s.name} from ${e.name} and deliver it to ${a.name}. Handle with care.`,reward:u,issuingDestinationId:e.id,itemName:s.name,itemWeightKg:s.weightKg,pickupDestinationId:e.id,deliveryDestinationId:a.id,deposit:m}}function _t(n,e,t,i){var G;const r=Ro(t);if(r.length===0)return null;const o=ee(e.system),s=[],a=[];for(const k of r)(o?Ve(k.id,o):1)>1&&a.push(k),s.push(k);const l=a.length>0?a:r;for(const k of l)s.push(k);const{supplyRequirementsMin:c,supplyRequirementsMax:h,supplyQtyMin:d,supplyQtyMax:p}=P().missions,u=c+Math.floor(n()*(h-c+1)),m=[],g=new Set;for(let k=0;k<u;k++){let E=0;for(;E<10;){const R=Ie(n,s);if(!g.has(R.id)){g.add(R.id);const A=d+Math.floor(n()*(p-d+1));m.push({commodityId:R.id,qty:A});break}E++}}if(m.length===0)return null;const y=m.reduce((k,E)=>{const R=t.commodities.find(A=>A.id===E.commodityId);return k+((R==null?void 0:R.basePrice)??100)*E.qty},0),T=m.reduce((k,E)=>{const R=t.commodities.find(A=>A.id===E.commodityId);return k+((R==null?void 0:R.weightKg)??1)*E.qty},0),{supplyRewardMultiplierMin:S,supplyRewardMultiplierMax:b}=P().missions,M=Math.min(1,T/500),v=n(),x=v+M*(1-v)*.15,_=S+x*(b-S),w=Math.floor(y*_),D=$t(n,t),Y=m.map(k=>{const E=t.commodities.find(R=>R.id===k.commodityId);return`${k.qty}× ${(E==null?void 0:E.name)??k.commodityId}`}).join(", "),O=e.owningFactionId?(G=F().factions.find(k=>k.id===e.owningFactionId&&de(k)))==null?void 0:G.id:void 0;return{...D,giverFactionId:O,id:i,type:"supply",title:e.name,description:`${e.name} needs supplies. Deliver ${Y} to fulfil the contract.`,reward:w,issuingDestinationId:e.id,requirements:m,deliveryDestinationId:e.id}}function Fo(n){let e=0;for(let t=0;t<n.length;t++)e=(e<<5)-e^n.charCodeAt(t);return e>>>0}function Do(n,e,t){const i=P();let r;{const c=i.missions.missionTtlMs,h=Date.now(),d=Math.floor(h/c);r=Fo(n.id)^d}const o=Ao(r),{boardMaxCount:s,deliveryChance:a}=i.missions,l=[];for(let c=0;c<n.minMissions&&l.length<s;c++){const h=`m-${(r>>>0).toString(16)}-${l.length}`,p=o()<a?yt(o,n,e,h):_t(o,n,e,h);p&&l.push(p)}for(;l.length<s&&o()<n.missionChance;){const c=`m-${(r>>>0).toString(16)}-${l.length}`,d=o()<a?yt(o,n,e,c):_t(o,n,e,c);d&&l.push(d)}return l}const No=100,Oo={orbital:"docking","deep-space":"docking",surface:"surface-landing",asteroid:"asteroid-landing"};function Po(n,e,t){if(n.outcome==="skipped")return{damageFraction:t.abandonDamageFraction*e,score:null};const i=n.result.score;return i>=t.noDamageThreshold?{damageFraction:0,score:i}:{damageFraction:t.maxHullDamageFraction*(1-i/t.noDamageThreshold)*e,score:i}}function Bo(n,e){const t=n==="docking";return e===null?"ABORTED":e<40?t?"COLLISION":"CRASH":e<70?t?"ROUGH DOCK":"HARD LANDING":e<90?t?"DOCKED":"LANDED":t?"PERFECT DOCK":"PERFECT LANDING"}function We(n,e,t){return Math.max(e,Math.min(t,n))}function Ho(n,e,t,i){const{stockCountMin:r,stockCountMax:o,stockQtyMin:s,stockQtyMax:a,stockRepCountBonusPerLevel:l,stockRepCountBonusMin:c,stockRepCountBonusMax:h,stockRepQtyBonusPerLevel:d,stockRepQtyBonusMin:p,stockRepQtyBonusMax:u}=t.trading,m=We(e*l,c,h),g=We(e*d,p,u),y=n.length,T=We(r+m,1,y),S=We(o+m,1,y),b=T+Math.floor(Math.random()*(S-T+1)),M=[];if(i)for(const k of n){const R=1/Ve(k.id,i),A=Math.ceil(R*10);for(let C=0;C<A;C++)M.push(k)}else M.push(...n);const v=[...M];for(let k=v.length-1;k>0;k--){const E=Math.floor(Math.random()*(k+1));[v[k],v[E]]=[v[E],v[k]]}const x=s+g,_=a+g,w=n.map(k=>Math.log(k.basePrice*k.weightKg)),D=Math.min(...w),O=Math.max(...w)-D,G=new Map;for(const k of v.slice(0,b)){if(G.has(k.id))continue;const E=x+Math.floor(Math.random()*(_-x+1));let R=1;O>0&&(R=1.5-(Math.log(k.basePrice*k.weightKg)-D)/O);const A=i?Ve(k.id,i):1;G.set(k.id,{commodityId:k.id,qty:Math.max(1,Math.floor(E*R)),effectiveFactor:A})}return Array.from(G.values())}class Uo{constructor(e,t,i){this.sceneBeforeMenu=null,this.traderStockCache=new Map,this.renderer=e,this.input=t,this.context=i;const r=Ht(),o=Ye(r.startingShip);this.player=new In({shipId:r.startingShip,driveId:o.defaultJumpDrive,credits:r.player.startingCredits,systemId:r.startingLocation.system,destinationId:r.startingLocation.destination}),this.currentScene=new Hn(this.input,this.context,this.player,()=>this.goToStory())}tick(e){const t=Math.min(e,No),i=this.makeBuffer();this.currentScene.update(t),this.currentScene.render(i),this.renderer.drawBuffer(i)}makeBuffer(){const e=this.renderer.getWidth(),t=this.renderer.getHeight();return Array.from({length:t},()=>Array.from({length:e},()=>({char:" ",fg:"black",bg:"black"})))}getOrCreateTraderStock(e,t){const i=Date.now(),r=this.traderStockCache.get(e),o=P();if(r&&r.repLevel===t&&i-r.generatedAt<o.trading.stockTtlMs)return r.entries;const s=N(e),a=s?ee(s.system):void 0,l=Ho(Wi(),t,o,a);return this.traderStockCache.set(e,{entries:l,generatedAt:i,repLevel:t}),l}refreshDestinationMissions(e){const t=N(e),i=F(),r=Do(t,i);this.player.refreshDestinationMissions(e,r)}onBuy(e,t,i,r){if(t<=0)return;const o=r.findIndex(h=>h.commodityId===e);if(o<0)return;const s=r[o];if(t>s.qty)return;const a=ae(e);if(!a)return;const l=t*i;this.player.credits<l||this.player.cargoWeightKg+t*a.weightKg>this.player.cargoCapacity||(this.player.spendCredits(l),this.player.addCargo(e,t),s.qty-=t,s.qty<=0&&r.splice(o,1))}onSell(e,t,i,r){if(t<=0)return;const o=this.player.cargoHold.find(c=>c.commodityId===e);if(!o||o.qty<t||!ae(e))return;const a=t*i;this.player.addCredits(a),this.player.removeCargo(e,t);const l=r.find(c=>c.commodityId===e);l?l.qty+=t:r.push({commodityId:e,qty:t})}goToMainMenu(){this.currentScene=new Hn(this.input,this.context,this.player,()=>this.goToStory())}goToStory(){this.currentScene=new or(this.input,this.context,this.player,()=>this.goToStation())}goToStation(){const e=this.player.destinationId;this.refreshDestinationMissions(e),this.currentScene=new ar(this.input,this.context,this.player,e,(t,i)=>{this.player.spendCredits(t),this.player.addFuel(i),this.goToStation()},()=>this.goToTrader(),()=>this.goToMissionBoard(),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToLandOrDock(){const e=N(this.player.destinationId),t=e==null?void 0:e.locationType,i=t?Oo[t]:void 0,r=i?Io.find(o=>o.meta.id===i):void 0;if(i&&r){const o=(e==null?void 0:e.difficultyMultiplier)??1,s=P();this.currentScene=r.factory(this.input,this.context,this.player,{},a=>{const{damageFraction:l,score:c}=Po(a,o,s.miniGames);l>0&&this.player.applyHullDamage(l);const h=Bo(i,c);this.currentScene=new wo(this.input,this.player,this.context,h,c,l,()=>this.goToStation())})}else t==="surface"?this.currentScene=new lo(this.player,this.context,()=>this.goToStation()):t==="asteroid"?this.currentScene=new ho(this.player,this.context,()=>this.goToStation()):this.currentScene=new yo(this.player,this.context,()=>this.goToStation())}goToTakeOffOrUndock(){var t;const e=(t=N(this.player.destinationId))==null?void 0:t.locationType;e==="surface"?this.currentScene=new po(this.player,this.context,()=>this.goToShip()):e==="asteroid"?this.currentScene=new fo(this.player,this.context,()=>this.goToShip()):this.currentScene=new bo(this.player,this.context,()=>this.goToShip())}goToTrader(){const e=this.player.destinationId,t=N(e);let i=0;if(t.owningFactionId){const o=Ut(t.owningFactionId);if(o&&de(o)){const s=P(),a=this.player.getFactionReputation(t.owningFactionId);i=Ae(a,s)}}const r=this.getOrCreateTraderStock(e,i);this.currentScene=new lr(this.input,this.context,this.player,e,r,(o,s,a)=>this.onBuy(o,s,a,r),(o,s,a)=>this.onSell(o,s,a,r),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToMissionBoard(){const e=this.player.destinationId,t=this.player.getDestinationMissions(e);this.currentScene=new me(this.input,this.context,this.player,e,t,i=>this.goToMissionDetail(i,e),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToMissionDetail(e,t){this.currentScene=new ur(this.input,this.context,this.player,e,i=>this.onMissionAccepted(e,i,t),()=>this.goToMissionBoard(),()=>this.goToStation(),()=>this.goToTakeOffOrUndock())}onMissionAccepted(e,t,i){const r=this.player.getDestinationMissions(i),o=r.findIndex(s=>s.id===e.id);o>=0&&(r.splice(o,1),this.player.refreshDestinationMissions(i,r)),this.player.acceptMission(e,t),this.goToMissionBoard()}goToShip(){this.currentScene=new Wr(this.input,this.context,this.player,()=>this.goToTravelMenu(),()=>this.goToLandOrDock(),()=>this.goToCargo(),()=>this.goToGlobalMenu())}goToCargo(){this.currentScene=new Yr(this.input,this.context,this.player,()=>this.goToShip(),()=>this.goToGlobalMenu())}buildMenuEntries(){return[{label:"MISSIONS",action:()=>this.goToMissionLog()},{label:"GALAXY MAP",action:()=>this.goToGalaxyMapFromMenu()},{label:"REPUTATION",action:()=>this.goToReputation()}]}goToMissionLog(){this.currentScene=new Zi(this.input,this.context,this.player,()=>this.goToGlobalMenuFromSubScene(),()=>this.returnFromMenu())}goToReputation(){this.currentScene=new rr(this.input,this.context,this.player,()=>this.goToGlobalMenuFromSubScene(),()=>this.returnFromMenu())}goToGlobalMenuFromSubScene(){this.currentScene=new Gn(this.input,this.context,this.player,this.buildMenuEntries(),()=>this.returnFromMenu())}goToGlobalMenu(){this.sceneBeforeMenu=this.currentScene,"suspend"in this.currentScene&&this.currentScene.suspend(),this.currentScene=new Gn(this.input,this.context,this.player,this.buildMenuEntries(),()=>this.returnFromMenu())}returnFromMenu(){const e=this.sceneBeforeMenu;this.sceneBeforeMenu=null,e!==null?("resume"in e&&e.resume(),this.currentScene=e):this.goToShip()}goToTravelMenu(){this.currentScene=new it(this.input,this.context,this.player,e=>this.onDestinationSelected(e),e=>this.onJumpSelected(e),()=>this.goToFlyIntoSpace(),()=>this.goToShip(),()=>this.goToGalaxyMap(),()=>this.goToGlobalMenu(),()=>this.goToEmergencyRescue())}goToArrival(){this.currentScene=new it(this.input,this.context,this.player,e=>this.onDestinationSelected(e),e=>this.onJumpSelected(e),()=>this.goToFlyIntoSpace(),()=>this.goToShip(),()=>this.goToGalaxyMap(),()=>this.goToGlobalMenu(),()=>this.goToEmergencyRescue())}goToGalaxyMap(){this.currentScene=new lt(this.input,this.context,this.player,()=>this.goToTravelMenu(),()=>this.goToGlobalMenu())}goToGalaxyMapFromMenu(){this.currentScene=new lt(this.input,this.context,this.player,()=>this.goToGlobalMenu(),()=>this.goToGlobalMenu(),()=>this.returnFromMenu())}goToFlyIntoSpace(){const e=this.player.getInSystemHopCost();this.player.consumeFuel(e),this.player.undock(),this.currentScene=new mn(this.player,this.context,()=>this.goToShip(),"OPEN SPACE")}onDestinationSelected(e){const t=this.player.getInSystemHopCost();this.player.consumeFuel(t),this.player.dock(e),this.currentScene=new mn(this.player,this.context,()=>this.goToShip())}onJumpSelected(e){const t=Ke(this.player.systemId,e),i=Bt(this.player.driveId),r=Math.ceil(P().fuel.consumptionPerLy*t.distance*i.fuelEfficiency);this.player.consumeFuel(r),this.player.jumpTo(e),this.currentScene=new oo(this.player,this.context,()=>this.goToArrival())}goToEmergencyRescue(){this.currentScene=new Kr(this.input,this.context,this.player,e=>this.onEmergencyTow(e),()=>this.onEmergencyFuelDrop(),()=>this.goToTravelMenu())}onEmergencyTow(e){const t=P();this.player.spendCredits(t.emergencyRescue.towFee),this.player.dock(e),this.currentScene=new mn(this.player,this.context,()=>this.goToShip())}onEmergencyFuelDrop(){const e=P();this.player.spendCredits(e.emergencyRescue.fuelDropFee),this.player.addFuel(e.emergencyRescue.fuelDropLitres),this.goToTravelMenu()}}const Go=`---
commodities:
...
Long range engines for faster than light travel between systems.`,Ts=`---
id: freighter
...
`+t)),i};var js=An,vt=Le,qs=["kind","resolve","construct","instanceOf","predicate","represent","defaultStyle","styleAliases"],Vs=["scalar","sequence","mapping"];function zs(n){var e={};return n!==null&&Object.keys(n).forEach(function(t){n[t].forEach(function(i){e[String(i)]=t})}),e}function Xs(n,e){if(e=e||{},Object.keys(e).forEach(function(t){if(qs.indexOf(t)===-1)throw new vt('Unknown option "'+t+'" is met in definition of "'+n+'" YAML type.')}),this.tag=n,this.kind=e.kind||null,this.resolve=e.resolve||function(){return!0},this.construct=e.construct||function(t){return t},this.instanceOf=e.instanceOf||null,this.predicate=e.predicate||null,this.represent=e.represent||null,this.defaultStyle=e.defaultStyle||null,this.styleAliases=zs(e.styleAliases||null),Vs.indexOf(this.kind)===-1)throw new vt('Unknown kind "'+this.kind+'" is specified for "'+n+'" YAML type.')}var U=Xs,wt=q,je=Le,Qs=U;function vn(n,e,t){var i=[];return n.include.forEach(function(r){t=vn(r,e,t)}),n[e].forEach(function(r){t.forEach(function(o,s){o.tag===r.tag&&o.kind===r.kind&&i.push(s)}),t.push(r)}),t.filter(function(r,o){return i.indexOf(o)===-1})}function Js(){var n={scalar:{},sequence:{},mapping:{},fallback:{}},e,t;function i(r){n[r.kind][r.tag]=n.fallback[r.tag]=r}for(e=0,t=arguments.length;e<t;e+=1)arguments[e].forEach(i);return n}function fe(n){this.include=n.include||[],this.implicit=n.implicit||[],this.explicit=n.explicit||[],this.implicit.forEach(function(e){if(e.loadKind&&e.loadKind!=="scalar")throw new je("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.")}),this.compiledImplicit=vn(this,"implicit",[]),this.compiledExplicit=vn(this,"explicit",[]),this.compiledTypeMap=Js(this.compiledImplicit,this.compiledExplicit)}fe.DEFAULT=null;fe.create=function(){var e,t;switch(arguments.length){case 1:e=fe.DEFAULT,t=arguments[0];break;case 2:e=arguments[0],t=arguments[1];break;default:throw new je("Wrong number of arguments for Schema.create function")}if(e=wt.toArray(e),t=wt.toArray(t),!e.every(function(i){return i instanceof fe}))throw new je("Specified list of super schemas (or a single Schema object) contains a non-Schema object.");if(!t.every(function(i){return i instanceof Qs}))throw new je("Specified list of YAML types (or a single Type object) contains a non-Type object.");return new fe({include:e,explicit:t})};var ve=fe,Zs=U,ea=new Zs("tag:yaml.org,2002:str",{kind:"scalar",construct:function(n){return n!==null?n:""}}),na=U,ta=new na("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(n){return n!==null?n:[]}}),ia=U,ra=new ia("tag:yaml.org,2002:map",{kind:"mapping",construct:function(n){return n!==null?n:{}}}),oa=ve,Sn=new oa({explicit:[ea,ta,ra]}),sa=U;function aa(n){if(n===null)return!0;var e=n.length;return e===1&&n==="~"||e===4&&(n==="null"||n==="Null"||n==="NULL")}function la(){return null}function ca(n){return n===null}var ha=new sa("tag:yaml.org,2002:null",{kind:"scalar",resolve:aa,construct:la,predicate:ca,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"}},defaultStyle:"lowercase"}),da=U;function ua(n){if(n===null)return!1;var e=n.length;return e===4&&(n==="true"||n==="True"||n==="TRUE")||e===5&&(n==="false"||n==="False"||n==="FALSE")}function pa(n){return n==="true"||n==="True"||n==="TRUE"}function ma(n){return Object.prototype.toString.call(n)==="[object Boolean]"}var fa=new da("tag:yaml.org,2002:bool",{kind:"scalar",resolve:ua,construct:pa,predicate:ma,represent:{lowercase:function(n){return n?"true":"false"},uppercase:function(n){return n?"TRUE":"FALSE"},camelcase:function(n){return n?"True":"False"}},defaultStyle:"lowercase"}),ga=q,ya=U;function _a(n){return 48<=n&&n<=57||65<=n&&n<=70||97<=n&&n<=102}function ba(n){return 48<=n&&n<=55}function va(n){return 48<=n&&n<=57}function wa(n){if(n===null)return!1;var e=n.length,t=0,i=!1,r;if(!e)return!1;if(r=n[t],(r==="-"||r==="+")&&(r=n[++t]),r==="0"){if(t+1===e)return!0;if(r=n[++t],r==="b"){for(t++;t<e;t++)if(r=n[t],r!=="_"){if(r!=="0"&&r!=="1")return!1;i=!0}return i&&r!=="_"}if(r==="x"){for(t++;t<e;t++)if(r=n[t],r!=="_"){if(!_a(n.charCodeAt(t)))return!1;i=!0}return i&&r!=="_"}for(;t<e;t++)if(r=n[t],r!=="_"){if(!ba(n.charCodeAt(t)))return!1;i=!0}return i&&r!=="_"}if(r==="_")return!1;for(;t<e;t++)if(r=n[t],r!=="_"){if(r===":")break;if(!va(n.charCodeAt(t)))return!1;i=!0}return!i||r==="_"?!1:r!==":"?!0:/^(:[0-5]?[0-9])+$/.test(n.slice(t))}function ka(n){var e=n,t=1,i,r,o=[];return e.indexOf("_")!==-1&&(e=e.replace(/_/g,"")),i=e[0],(i==="-"||i==="+")&&(i==="-"&&(t=-1),e=e.slice(1),i=e[0]),e==="0"?0:i==="0"?e[1]==="b"?t*parseInt(e.slice(2),2):e[1]==="x"?t*parseInt(e,16):t*parseInt(e,8):e.indexOf(":")!==-1?(e.split(":").forEach(function(s){o.unshift(parseInt(s,10))}),e=0,r=1,o.forEach(function(s){e+=s*r,r*=60}),t*e):t*parseInt(e,10)}function xa(n){return Object.prototype.toString.call(n)==="[object Number]"&&n%1===0&&!ga.isNegativeZero(n)}var Ca=new ya("tag:yaml.org,2002:int",{kind:"scalar",resolve:wa,construct:ka,predicate:xa,represent:{binary:function(n){return n>=0?"0b"+n.toString(2):"-0b"+n.toString(2).slice(1)},octal:function(n){return n>=0?"0"+n.toString(8):"-0"+n.toString(8).slice(1)},decimal:function(n){return n.toString(10)},hexadecimal:function(n){return n>=0?"0x"+n.toString(16).toUpperCase():"-0x"+n.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),Yt=q,Ta=U,Ma=new RegExp("^(?:[-+]?(?:0|[1-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function Ia(n){return!(n===null||!Ma.test(n)||n[n.length-1]==="_")}function Aa(n){var e,t,i,r;return e=n.replace(/_/g,"").toLowerCase(),t=e[0]==="-"?-1:1,r=[],"+-".indexOf(e[0])>=0&&(e=e.slice(1)),e===".inf"?t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:e===".nan"?NaN:e.indexOf(":")>=0?(e.split(":").forEach(function(o){r.unshift(parseFloat(o,10))}),e=0,i=1,r.forEach(function(o){e+=o*i,i*=60}),t*e):t*parseFloat(e,10)}var Sa=/^[-+]?[0-9]+e/;function Ea(n,e){var t;if(isNaN(n))switch(e){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===n)switch(e){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===n)switch(e){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(Yt.isNegativeZero(n))return"-0.0";return t=n.toString(10),Sa.test(t)?t.replace("e",".e"):t}function Ra(n){return Object.prototype.toString.call(n)==="[object Number]"&&(n%1!==0||Yt.isNegativeZero(n))}var La=new Ta("tag:yaml.org,2002:float",{kind:"scalar",resolve:Ia,construct:Aa,predicate:Ra,represent:Ea,defaultStyle:"lowercase"}),Fa=ve,Kt=new Fa({include:[Sn],implicit:[ha,fa,Ca,La]}),Da=ve,jt=new Da({include:[Kt]}),Na=U,qt=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),Vt=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Oa(n){return n===null?!1:qt.exec(n)!==null||Vt.exec(n)!==null}function Pa(n){var e,t,i,r,o,s,a,l=0,c=null,h,d,p;if(e=qt.exec(n),e===null&&(e=Vt.exec(n)),e===null)throw new Error("Date resolve error");if(t=+e[1],i=+e[2]-1,r=+e[3],!e[4])return new Date(Date.UTC(t,i,r));if(o=+e[4],s=+e[5],a=+e[6],e[7]){for(l=e[7].slice(0,3);l.length<3;)l+="0";l=+l}return e[9]&&(h=+e[10],d=+(e[11]||0),c=(h*60+d)*6e4,e[9]==="-"&&(c=-c)),p=new Date(Date.UTC(t,i,r,o,s,a,l)),c&&p.setTime(p.getTime()-c),p}function Ba(n){return n.toISOString()}var Ha=new Na("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Oa,construct:Pa,instanceOf:Date,represent:Ba}),Ua=U;function Ga(n){return n==="<<"||n===null}var $a=new Ua("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Ga});function zt(n){throw new Error('Could not dynamically require "'+n+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var oe;try{var Wa=zt;oe=Wa("buffer").Buffer}catch{}var Ya=U,En=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function Ka(n){if(n===null)return!1;var e,t,i=0,r=n.length,o=En;for(t=0;t<r;t++)if(e=o.indexOf(n.charAt(t)),!(e>64)){if(e<0)return!1;i+=6}return i%8===0}function ja(n){var e,t,i=n.replace(/[\r\n=]/g,""),r=i.length,o=En,s=0,a=[];for(e=0;e<r;e++)e%4===0&&e&&(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)),s=s<<6|o.indexOf(i.charAt(e));return t=r%4*6,t===0?(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)):t===18?(a.push(s>>10&255),a.push(s>>2&255)):t===12&&a.push(s>>4&255),oe?oe.from?oe.from(a):new oe(a):a}function qa(n){var e="",t=0,i,r,o=n.length,s=En;for(i=0;i<o;i++)i%3===0&&i&&(e+=s[t>>18&63],e+=s[t>>12&63],e+=s[t>>6&63],e+=s[t&63]),t=(t<<8)+n[i];return r=o%3,r===0?(e+=s[t>>18&63],e+=s[t>>12&63],e+=s[t>>6&63],e+=s[t&63]):r===2?(e+=s[t>>10&63],e+=s[t>>4&63],e+=s[t<<2&63],e+=s[64]):r===1&&(e+=s[t>>2&63],e+=s[t<<4&63],e+=s[64],e+=s[64]),e}function Va(n){return oe&&oe.isBuffer(n)}var za=new Ya("tag:yaml.org,2002:binary",{kind:"scalar",resolve:Ka,construct:ja,predicate:Va,represent:qa}),Xa=U,Qa=Object.prototype.hasOwnProperty,Ja=Object.prototype.toString;function Za(n){if(n===null)return!0;var e=[],t,i,r,o,s,a=n;for(t=0,i=a.length;t<i;t+=1){if(r=a[t],s=!1,Ja.call(r)!=="[object Object]")return!1;for(o in r)if(Qa.call(r,o))if(!s)s=!0;else return!1;if(!s)return!1;if(e.indexOf(o)===-1)e.push(o);else return!1}return!0}function el(n){return n!==null?n:[]}var nl=new Xa("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Za,construct:el}),tl=U,il=Object.prototype.toString;function rl(n){if(n===null)return!0;var e,t,i,r,o,s=n;for(o=new Array(s.length),e=0,t=s.length;e<t;e+=1){if(i=s[e],il.call(i)!=="[object Object]"||(r=Object.keys(i),r.length!==1))return!1;o[e]=[r[0],i[r[0]]]}return!0}function ol(n){if(n===null)return[];var e,t,i,r,o,s=n;for(o=new Array(s.length),e=0,t=s.length;e<t;e+=1)i=s[e],r=Object.keys(i),o[e]=[r[0],i[r[0]]];return o}var sl=new tl("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:rl,construct:ol}),al=U,ll=Object.prototype.hasOwnProperty;function cl(n){if(n===null)return!0;var e,t=n;for(e in t)if(ll.call(t,e)&&t[e]!==null)return!1;return!0}function hl(n){return n!==null?n:{}}var dl=new al("tag:yaml.org,2002:set",{kind:"mapping",resolve:cl,construct:hl}),ul=ve,Fe=new ul({include:[jt],implicit:[Ha,$a],explicit:[za,nl,sl,dl]}),pl=U;function ml(){return!0}function fl(){}function gl(){return""}function yl(n){return typeof n>"u"}var _l=new pl("tag:yaml.org,2002:js/undefined",{kind:"scalar",resolve:ml,construct:fl,predicate:yl,represent:gl}),bl=U;function vl(n){if(n===null||n.length===0)return!1;var e=n,t=/\/([gim]*)$/.exec(n),i="";return!(e[0]==="/"&&(t&&(i=t[1]),i.length>3||e[e.length-i.length-1]!=="/"))}function wl(n){var e=n,t=/\/([gim]*)$/.exec(n),i="";return e[0]==="/"&&(t&&(i=t[1]),e=e.slice(1,e.length-i.length-1)),new RegExp(e,i)}function kl(n){var e="/"+n.source+"/";return n.global&&(e+="g"),n.multiline&&(e+="m"),n.ignoreCase&&(e+="i"),e}function xl(n){return Object.prototype.toString.call(n)==="[object RegExp]"}var Cl=new bl("tag:yaml.org,2002:js/regexp",{kind:"scalar",resolve:vl,construct:wl,predicate:xl,represent:kl}),ze;try{var Tl=zt;ze=Tl("esprima")}catch{typeof window<"u"&&(ze=window.esprima)}var Ml=U;function Il(n){if(n===null)return!1;try{var e="("+n+")",t=ze.parse(e,{range:!0});return!(t.type!=="Program"||t.body.length!==1||t.body[0].type!=="ExpressionStatement"||t.body[0].expression.type!=="ArrowFunctionExpression"&&t.body[0].expression.type!=="FunctionExpression")}catch{return!1}}function Al(n){var e="("+n+")",t=ze.parse(e,{range:!0}),i=[],r;if(t.type!=="Program"||t.body.length!==1||t.body[0].type!=="ExpressionStatement"||t.body[0].expression.type!=="ArrowFunctionExpression"&&t.body[0].expression.type!=="FunctionExpression")throw new Error("Failed to resolve function");return t.body[0].expression.params.forEach(function(o){i.push(o.name)}),r=t.body[0].expression.body.range,t.body[0].expression.body.type==="BlockStatement"?new Function(i,e.slice(r[0]+1,r[1]-1)):new Function(i,"return "+e.slice(r[0],r[1]))}function Sl(n){return n.toString()}function El(n){return Object.prototype.toString.call(n)==="[object Function]"}var Rl=new Ml("tag:yaml.org,2002:js/function",{kind:"scalar",resolve:Il,construct:Al,predicate:El,represent:Sl}),kt=ve,en=kt.DEFAULT=new kt({include:[Fe],explicit:[_l,Cl,Rl]}),Z=q,Xt=Le,Ll=js,Qt=Fe,Fl=en,te=Object.prototype.hasOwnProperty,Xe=1,Jt=2,Zt=3,Qe=4,fn=1,Dl=2,xt=3,Nl=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Ol=/[\x85\u2028\u2029]/,Pl=/[,\[\]\{\}]/,ei=/^(?:!|!!|![a-z\-]+!)$/i,ni=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Ct(n){return Object.prototype.toString.call(n)}function z(n){return n===10||n===13}function se(n){return n===9||n===32}function j(n){return n===9||n===32||n===10||n===13}function ge(n){return n===44||n===91||n===93||n===123||n===125}function Bl(n){var e;return 48<=n&&n<=57?n-48:(e=n|32,97<=e&&e<=102?e-97+10:-1)}function Hl(n){return n===120?2:n===117?4:n===85?8:0}function Ul(n){return 48<=n&&n<=57?n-48:-1}function Tt(n){return n===48?"\0":n===97?"\x07":n===98?"\b":n===116||n===9?"	":n===110?`
`:n===118?"\v":n===102?"\f":n===114?"\r":n===101?"\x1B":n===32?" ":n===34?'"':n===47?"/":n===92?"\\":n===78?"":n===95?" ":n===76?"\u2028":n===80?"\u2029":""}function Gl(n){return n<=65535?String.fromCharCode(n):String.fromCharCode((n-65536>>10)+55296,(n-65536&1023)+56320)}function ti(n,e,t){e==="__proto__"?Object.defineProperty(n,e,{configurable:!0,enumerable:!0,writable:!0,value:t}):n[e]=t}var ii=new Array(256),ri=new Array(256);for(var ue=0;ue<256;ue++)ii[ue]=Tt(ue)?1:0,ri[ue]=Tt(ue);function $l(n,e){this.input=n,this.filename=e.filename||null,this.schema=e.schema||Fl,this.onWarning=e.onWarning||null,this.legacy=e.legacy||!1,this.json=e.json||!1,this.listener=e.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=n.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.documents=[]}function oi(n,e){return new Xt(e,new Ll(n.filename,n.input,n.position,n.line,n.position-n.lineStart))}function I(n,e){throw oi(n,e)}function Je(n,e){n.onWarning&&n.onWarning.call(null,oi(n,e))}var Mt={YAML:function(e,t,i){var r,o,s;e.version!==null&&I(e,"duplication of %YAML directive"),i.length!==1&&I(e,"YAML directive accepts exactly one argument"),r=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),r===null&&I(e,"ill-formed argument of the YAML directive"),o=parseInt(r[1],10),s=parseInt(r[2],10),o!==1&&I(e,"unacceptable YAML version of the document"),e.version=i[0],e.checkLineBreaks=s<2,s!==1&&s!==2&&Je(e,"unsupported YAML version of the document")},TAG:function(e,t,i){var r,o;i.length!==2&&I(e,"TAG directive accepts exactly two arguments"),r=i[0],o=i[1],ei.test(r)||I(e,"ill-formed tag handle (first argument) of the TAG directive"),te.call(e.tagMap,r)&&I(e,'there is a previously declared suffix for "'+r+'" tag handle'),ni.test(o)||I(e,"ill-formed tag prefix (second argument) of the TAG directive"),e.tagMap[r]=o}};function ne(n,e,t,i){var r,o,s,a;if(e<t){if(a=n.input.slice(e,t),i)for(r=0,o=a.length;r<o;r+=1)s=a.charCodeAt(r),s===9||32<=s&&s<=1114111||I(n,"expected valid JSON character");else Nl.test(a)&&I(n,"the stream contains non-printable characters");n.result+=a}}function It(n,e,t,i){var r,o,s,a;for(Z.isObject(t)||I(n,"cannot merge mappings; the provided source object is unacceptable"),r=Object.keys(t),s=0,a=r.length;s<a;s+=1)o=r[s],te.call(e,o)||(ti(e,o,t[o]),i[o]=!0)}function ye(n,e,t,i,r,o,s,a){var l,c;if(Array.isArray(r))for(r=Array.prototype.slice.call(r),l=0,c=r.length;l<c;l+=1)Array.isArray(r[l])&&I(n,"nested arrays are not supported inside keys"),typeof r=="object"&&Ct(r[l])==="[object Object]"&&(r[l]="[object Object]");if(typeof r=="object"&&Ct(r)==="[object Object]"&&(r="[object Object]"),r=String(r),e===null&&(e={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(o))for(l=0,c=o.length;l<c;l+=1)It(n,e,o[l],t);else It(n,e,o,t);else!n.json&&!te.call(t,r)&&te.call(e,r)&&(n.line=s||n.line,n.position=a||n.position,I(n,"duplicated mapping key")),ti(e,r,o),delete t[r];return e}function Rn(n){var e;e=n.input.charCodeAt(n.position),e===10?n.position++:e===13?(n.position++,n.input.charCodeAt(n.position)===10&&n.position++):I(n,"a line break is expected"),n.line+=1,n.lineStart=n.position}function H(n,e,t){for(var i=0,r=n.input.charCodeAt(n.position);r!==0;){for(;se(r);)r=n.input.charCodeAt(++n.position);if(e&&r===35)do r=n.input.charCodeAt(++n.position);while(r!==10&&r!==13&&r!==0);if(z(r))for(Rn(n),r=n.input.charCodeAt(n.position),i++,n.lineIndent=0;r===32;)n.lineIndent++,r=n.input.charCodeAt(++n.position);else break}return t!==-1&&i!==0&&n.lineIndent<t&&Je(n,"deficient indentation"),i}function nn(n){var e=n.position,t;return t=n.input.charCodeAt(e),!!((t===45||t===46)&&t===n.input.charCodeAt(e+1)&&t===n.input.charCodeAt(e+2)&&(e+=3,t=n.input.charCodeAt(e),t===0||j(t)))}function Ln(n,e){e===1?n.result+=" ":e>1&&(n.result+=Z.repeat(`
`,e-1))}function Wl(n,e,t){var i,r,o,s,a,l,c,h,d=n.kind,p=n.result,u;if(u=n.input.charCodeAt(n.position),j(u)||ge(u)||u===35||u===38||u===42||u===33||u===124||u===62||u===39||u===34||u===37||u===64||u===96||(u===63||u===45)&&(r=n.input.charCodeAt(n.position+1),j(r)||t&&ge(r)))return!1;for(n.kind="scalar",n.result="",o=s=n.position,a=!1;u!==0;){if(u===58){if(r=n.input.charCodeAt(n.position+1),j(r)||t&&ge(r))break}else if(u===35){if(i=n.input.charCodeAt(n.position-1),j(i))break}else{if(n.position===n.lineStart&&nn(n)||t&&ge(u))break;if(z(u))if(l=n.line,c=n.lineStart,h=n.lineIndent,H(n,!1,-1),n.lineIndent>=e){a=!0,u=n.input.charCodeAt(n.position);continue}else{n.position=s,n.line=l,n.lineStart=c,n.lineIndent=h;break}}a&&(ne(n,o,s,!1),Ln(n,n.line-l),o=s=n.position,a=!1),se(u)||(s=n.position+1),u=n.input.charCodeAt(++n.position)}return ne(n,o,s,!1),n.result?!0:(n.kind=d,n.result=p,!1)}function Yl(n,e){var t,i,r;if(t=n.input.charCodeAt(n.position),t!==39)return!1;for(n.kind="scalar",n.result="",n.position++,i=r=n.position;(t=n.input.charCodeAt(n.position))!==0;)if(t===39)if(ne(n,i,n.position,!0),t=n.input.charCodeAt(++n.position),t===39)i=n.position,n.position++,r=n.position;else return!0;else z(t)?(ne(n,i,r,!0),Ln(n,H(n,!1,e)),i=r=n.position):n.position===n.lineStart&&nn(n)?I(n,"unexpected end of the document within a single quoted scalar"):(n.position++,r=n.position);I(n,"unexpected end of the stream within a single quoted scalar")}function Kl(n,e){var t,i,r,o,s,a;if(a=n.input.charCodeAt(n.position),a!==34)return!1;for(n.kind="scalar",n.result="",n.position++,t=i=n.position;(a=n.input.charCodeAt(n.position))!==0;){if(a===34)return ne(n,t,n.position,!0),n.position++,!0;if(a===92){if(ne(n,t,n.position,!0),a=n.input.charCodeAt(++n.position),z(a))H(n,!1,e);else if(a<256&&ii[a])n.result+=ri[a],n.position++;else if((s=Hl(a))>0){for(r=s,o=0;r>0;r--)a=n.input.charCodeAt(++n.position),(s=Bl(a))>=0?o=(o<<4)+s:I(n,"expected hexadecimal character");n.result+=Gl(o),n.position++}else I(n,"unknown escape sequence");t=i=n.position}else z(a)?(ne(n,t,i,!0),Ln(n,H(n,!1,e)),t=i=n.position):n.position===n.lineStart&&nn(n)?I(n,"unexpected end of the document within a double quoted scalar"):(n.position++,i=n.position)}I(n,"unexpected end of the stream within a double quoted scalar")}function jl(n,e){var t=!0,i,r=n.tag,o,s=n.anchor,a,l,c,h,d,p={},u,m,g,y;if(y=n.input.charCodeAt(n.position),y===91)l=93,d=!1,o=[];else if(y===123)l=125,d=!0,o={};else return!1;for(n.anchor!==null&&(n.anchorMap[n.anchor]=o),y=n.input.charCodeAt(++n.position);y!==0;){if(H(n,!0,e),y=n.input.charCodeAt(n.position),y===l)return n.position++,n.tag=r,n.anchor=s,n.kind=d?"mapping":"sequence",n.result=o,!0;t||I(n,"missed comma between flow collection entries"),m=u=g=null,c=h=!1,y===63&&(a=n.input.charCodeAt(n.position+1),j(a)&&(c=h=!0,n.position++,H(n,!0,e))),i=n.line,_e(n,e,Xe,!1,!0),m=n.tag,u=n.result,H(n,!0,e),y=n.input.charCodeAt(n.position),(h||n.line===i)&&y===58&&(c=!0,y=n.input.charCodeAt(++n.position),H(n,!0,e),_e(n,e,Xe,!1,!0),g=n.result),d?ye(n,o,p,m,u,g):c?o.push(ye(n,null,p,m,u,g)):o.push(u),H(n,!0,e),y=n.input.charCodeAt(n.position),y===44?(t=!0,y=n.input.charCodeAt(++n.position)):t=!1}I(n,"unexpected end of the stream within a flow collection")}function ql(n,e){var t,i,r=fn,o=!1,s=!1,a=e,l=0,c=!1,h,d;if(d=n.input.charCodeAt(n.position),d===124)i=!1;else if(d===62)i=!0;else return!1;for(n.kind="scalar",n.result="";d!==0;)if(d=n.input.charCodeAt(++n.position),d===43||d===45)fn===r?r=d===43?xt:Dl:I(n,"repeat of a chomping mode identifier");else if((h=Ul(d))>=0)h===0?I(n,"bad explicit indentation width of a block scalar; it cannot be less than one"):s?I(n,"repeat of an indentation width identifier"):(a=e+h-1,s=!0);else break;if(se(d)){do d=n.input.charCodeAt(++n.position);while(se(d));if(d===35)do d=n.input.charCodeAt(++n.position);while(!z(d)&&d!==0)}for(;d!==0;){for(Rn(n),n.lineIndent=0,d=n.input.charCodeAt(n.position);(!s||n.lineIndent<a)&&d===32;)n.lineIndent++,d=n.input.charCodeAt(++n.position);if(!s&&n.lineIndent>a&&(a=n.lineIndent),z(d)){l++;continue}if(n.lineIndent<a){r===xt?n.result+=Z.repeat(`
`,o?1+l:l):r===fn&&o&&(n.result+=`
`);break}for(i?se(d)?(c=!0,n.result+=Z.repeat(`
`,o?1+l:l)):c?(c=!1,n.result+=Z.repeat(`
`,l+1)):l===0?o&&(n.result+=" "):n.result+=Z.repeat(`
`,l):n.result+=Z.repeat(`
`,o?1+l:l),o=!0,s=!0,l=0,t=n.position;!z(d)&&d!==0;)d=n.input.charCodeAt(++n.position);ne(n,t,n.position,!1)}return!0}function At(n,e){var t,i=n.tag,r=n.anchor,o=[],s,a=!1,l;for(n.anchor!==null&&(n.anchorMap[n.anchor]=o),l=n.input.charCodeAt(n.position);l!==0&&!(l!==45||(s=n.input.charCodeAt(n.position+1),!j(s)));){if(a=!0,n.position++,H(n,!0,-1)&&n.lineIndent<=e){o.push(null),l=n.input.charCodeAt(n.position);continue}if(t=n.line,_e(n,e,Zt,!1,!0),o.push(n.result),H(n,!0,-1),l=n.input.charCodeAt(n.position),(n.line===t||n.lineIndent>e)&&l!==0)I(n,"bad indentation of a sequence entry");else if(n.lineIndent<e)break}return a?(n.tag=i,n.anchor=r,n.kind="sequence",n.result=o,!0):!1}function Vl(n,e,t){var i,r,o,s,a=n.tag,l=n.anchor,c={},h={},d=null,p=null,u=null,m=!1,g=!1,y;for(n.anchor!==null&&(n.anchorMap[n.anchor]=c),y=n.input.charCodeAt(n.position);y!==0;){if(i=n.input.charCodeAt(n.position+1),o=n.line,s=n.position,(y===63||y===58)&&j(i))y===63?(m&&(ye(n,c,h,d,p,null),d=p=u=null),g=!0,m=!0,r=!0):m?(m=!1,r=!0):I(n,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),n.position+=1,y=i;else if(_e(n,t,Jt,!1,!0))if(n.line===o){for(y=n.input.charCodeAt(n.position);se(y);)y=n.input.charCodeAt(++n.position);if(y===58)y=n.input.charCodeAt(++n.position),j(y)||I(n,"a whitespace character is expected after the key-value separator within a block mapping"),m&&(ye(n,c,h,d,p,null),d=p=u=null),g=!0,m=!1,r=!1,d=n.tag,p=n.result;else if(g)I(n,"can not read an implicit mapping pair; a colon is missed");else return n.tag=a,n.anchor=l,!0}else if(g)I(n,"can not read a block mapping entry; a multiline key may not be an implicit key");else return n.tag=a,n.anchor=l,!0;else break;if((n.line===o||n.lineIndent>e)&&(_e(n,e,Qe,!0,r)&&(m?p=n.result:u=n.result),m||(ye(n,c,h,d,p,u,o,s),d=p=u=null),H(n,!0,-1),y=n.input.charCodeAt(n.position)),n.lineIndent>e&&y!==0)I(n,"bad indentation of a mapping entry");else if(n.lineIndent<e)break}return m&&ye(n,c,h,d,p,null),g&&(n.tag=a,n.anchor=l,n.kind="mapping",n.result=c),g}function zl(n){var e,t=!1,i=!1,r,o,s;if(s=n.input.charCodeAt(n.position),s!==33)return!1;if(n.tag!==null&&I(n,"duplication of a tag property"),s=n.input.charCodeAt(++n.position),s===60?(t=!0,s=n.input.charCodeAt(++n.position)):s===33?(i=!0,r="!!",s=n.input.charCodeAt(++n.position)):r="!",e=n.position,t){do s=n.input.charCodeAt(++n.position);while(s!==0&&s!==62);n.position<n.length?(o=n.input.slice(e,n.position),s=n.input.charCodeAt(++n.position)):I(n,"unexpected end of the stream within a verbatim tag")}else{for(;s!==0&&!j(s);)s===33&&(i?I(n,"tag suffix cannot contain exclamation marks"):(r=n.input.slice(e-1,n.position+1),ei.test(r)||I(n,"named tag handle cannot contain such characters"),i=!0,e=n.position+1)),s=n.input.charCodeAt(++n.position);o=n.input.slice(e,n.position),Pl.test(o)&&I(n,"tag suffix cannot contain flow indicator characters")}return o&&!ni.test(o)&&I(n,"tag name cannot contain such characters: "+o),t?n.tag=o:te.call(n.tagMap,r)?n.tag=n.tagMap[r]+o:r==="!"?n.tag="!"+o:r==="!!"?n.tag="tag:yaml.org,2002:"+o:I(n,'undeclared tag handle "'+r+'"'),!0}function Xl(n){var e,t;if(t=n.input.charCodeAt(n.position),t!==38)return!1;for(n.anchor!==null&&I(n,"duplication of an anchor property"),t=n.input.charCodeAt(++n.position),e=n.position;t!==0&&!j(t)&&!ge(t);)t=n.input.charCodeAt(++n.position);return n.position===e&&I(n,"name of an anchor node must contain at least one character"),n.anchor=n.input.slice(e,n.position),!0}function Ql(n){var e,t,i;if(i=n.input.charCodeAt(n.position),i!==42)return!1;for(i=n.input.charCodeAt(++n.position),e=n.position;i!==0&&!j(i)&&!ge(i);)i=n.input.charCodeAt(++n.position);return n.position===e&&I(n,"name of an alias node must contain at least one character"),t=n.input.slice(e,n.position),te.call(n.anchorMap,t)||I(n,'unidentified alias "'+t+'"'),n.result=n.anchorMap[t],H(n,!0,-1),!0}function _e(n,e,t,i,r){var o,s,a,l=1,c=!1,h=!1,d,p,u,m,g;if(n.listener!==null&&n.listener("open",n),n.tag=null,n.anchor=null,n.kind=null,n.result=null,o=s=a=Qe===t||Zt===t,i&&H(n,!0,-1)&&(c=!0,n.lineIndent>e?l=1:n.lineIndent===e?l=0:n.lineIndent<e&&(l=-1)),l===1)for(;zl(n)||Xl(n);)H(n,!0,-1)?(c=!0,a=o,n.lineIndent>e?l=1:n.lineIndent===e?l=0:n.lineIndent<e&&(l=-1)):a=!1;if(a&&(a=c||r),(l===1||Qe===t)&&(Xe===t||Jt===t?m=e:m=e+1,g=n.position-n.lineStart,l===1?a&&(At(n,g)||Vl(n,g,m))||jl(n,m)?h=!0:(s&&ql(n,m)||Yl(n,m)||Kl(n,m)?h=!0:Ql(n)?(h=!0,(n.tag!==null||n.anchor!==null)&&I(n,"alias node should not have any properties")):Wl(n,m,Xe===t)&&(h=!0,n.tag===null&&(n.tag="?")),n.anchor!==null&&(n.anchorMap[n.anchor]=n.result)):l===0&&(h=a&&At(n,g))),n.tag!==null&&n.tag!=="!")if(n.tag==="?"){for(n.result!==null&&n.kind!=="scalar"&&I(n,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+n.kind+'"'),d=0,p=n.implicitTypes.length;d<p;d+=1)if(u=n.implicitTypes[d],u.resolve(n.result)){n.result=u.construct(n.result),n.tag=u.tag,n.anchor!==null&&(n.anchorMap[n.anchor]=n.result);break}}else te.call(n.typeMap[n.kind||"fallback"],n.tag)?(u=n.typeMap[n.kind||"fallback"][n.tag],n.result!==null&&u.kind!==n.kind&&I(n,"unacceptable node kind for !<"+n.tag+'> tag; it should be "'+u.kind+'", not "'+n.kind+'"'),u.resolve(n.result)?(n.result=u.construct(n.result),n.anchor!==null&&(n.anchorMap[n.anchor]=n.result)):I(n,"cannot resolve a node with !<"+n.tag+"> explicit tag")):I(n,"unknown tag !<"+n.tag+">");return n.listener!==null&&n.listener("close",n),n.tag!==null||n.anchor!==null||h}function Jl(n){var e=n.position,t,i,r,o=!1,s;for(n.version=null,n.checkLineBreaks=n.legacy,n.tagMap={},n.anchorMap={};(s=n.input.charCodeAt(n.position))!==0&&(H(n,!0,-1),s=n.input.charCodeAt(n.position),!(n.lineIndent>0||s!==37));){for(o=!0,s=n.input.charCodeAt(++n.position),t=n.position;s!==0&&!j(s);)s=n.input.charCodeAt(++n.position);for(i=n.input.slice(t,n.position),r=[],i.length<1&&I(n,"directive name must not be less than one character in length");s!==0;){for(;se(s);)s=n.input.charCodeAt(++n.position);if(s===35){do s=n.input.charCodeAt(++n.position);while(s!==0&&!z(s));break}if(z(s))break;for(t=n.position;s!==0&&!j(s);)s=n.input.charCodeAt(++n.position);r.push(n.input.slice(t,n.position))}s!==0&&Rn(n),te.call(Mt,i)?Mt[i](n,i,r):Je(n,'unknown document directive "'+i+'"')}if(H(n,!0,-1),n.lineIndent===0&&n.input.charCodeAt(n.position)===45&&n.input.charCodeAt(n.position+1)===45&&n.input.charCodeAt(n.position+2)===45?(n.position+=3,H(n,!0,-1)):o&&I(n,"directives end mark is expected"),_e(n,n.lineIndent-1,Qe,!1,!0),H(n,!0,-1),n.checkLineBreaks&&Ol.test(n.input.slice(e,n.position))&&Je(n,"non-ASCII line breaks are interpreted as content"),n.documents.push(n.result),n.position===n.lineStart&&nn(n)){n.input.charCodeAt(n.position)===46&&(n.position+=3,H(n,!0,-1));return}if(n.position<n.length-1)I(n,"end of the stream or a document separator is expected");else return}function si(n,e){n=String(n),e=e||{},n.length!==0&&(n.charCodeAt(n.length-1)!==10&&n.charCodeAt(n.length-1)!==13&&(n+=`
`),n.charCodeAt(0)===65279&&(n=n.slice(1)));var t=new $l(n,e),i=n.indexOf("\0");for(i!==-1&&(t.position=i,I(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)Jl(t);return t.documents}function ai(n,e,t){e!==null&&typeof e=="object"&&typeof t>"u"&&(t=e,e=null);var i=si(n,t);if(typeof e!="function")return i;for(var r=0,o=i.length;r<o;r+=1)e(i[r])}function li(n,e){var t=si(n,e);if(t.length!==0){if(t.length===1)return t[0];throw new Xt("expected a single document in the stream, but found more")}}function Zl(n,e,t){return typeof e=="object"&&e!==null&&typeof t>"u"&&(t=e,e=null),ai(n,e,Z.extend({schema:Qt},t))}function ec(n,e){return li(n,Z.extend({schema:Qt},e))}Re.loadAll=ai;Re.load=li;Re.safeLoadAll=Zl;Re.safeLoad=ec;var Fn={},De=q,Ne=Le,nc=en,tc=Fe,ci=Object.prototype.toString,hi=Object.prototype.hasOwnProperty,ic=9,Ee=10,rc=13,oc=32,sc=33,ac=34,di=35,lc=37,cc=38,hc=39,dc=42,ui=44,uc=45,pi=58,pc=61,mc=62,fc=63,gc=64,mi=91,fi=93,yc=96,gi=123,_c=124,yi=125,$={};$[0]="\\0";$[7]="\\a";$[8]="\\b";$[9]="\\t";$[10]="\\n";$[11]="\\v";$[12]="\\f";$[13]="\\r";$[27]="\\e";$[34]='\\"';$[92]="\\\\";$[133]="\\N";$[160]="\\_";$[8232]="\\L";$[8233]="\\P";var bc=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"];function vc(n,e){var t,i,r,o,s,a,l;if(e===null)return{};for(t={},i=Object.keys(e),r=0,o=i.length;r<o;r+=1)s=i[r],a=String(e[s]),s.slice(0,2)==="!!"&&(s="tag:yaml.org,2002:"+s.slice(2)),l=n.compiledTypeMap.fallback[s],l&&hi.call(l.styleAliases,a)&&(a=l.styleAliases[a]),t[s]=a;return t}function St(n){var e,t,i;if(e=n.toString(16).toUpperCase(),n<=255)t="x",i=2;else if(n<=65535)t="u",i=4;else if(n<=4294967295)t="U",i=8;else throw new Ne("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+De.repeat("0",i-e.length)+e}function wc(n){this.schema=n.schema||nc,this.indent=Math.max(1,n.indent||2),this.noArrayIndent=n.noArrayIndent||!1,this.skipInvalid=n.skipInvalid||!1,this.flowLevel=De.isNothing(n.flowLevel)?-1:n.flowLevel,this.styleMap=vc(this.schema,n.styles||null),this.sortKeys=n.sortKeys||!1,this.lineWidth=n.lineWidth||80,this.noRefs=n.noRefs||!1,this.noCompatMode=n.noCompatMode||!1,this.condenseFlow=n.condenseFlow||!1,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Et(n,e){for(var t=De.repeat(" ",e),i=0,r=-1,o="",s,a=n.length;i<a;)r=n.indexOf(`
`,i),r===-1?(s=n.slice(i),i=a):(s=n.slice(i,r+1),i=r+1),s.length&&s!==`
`&&(o+=t),o+=s;return o}function wn(n,e){return`
`+De.repeat(" ",n.indent*e)}function kc(n,e){var t,i,r;for(t=0,i=n.implicitTypes.length;t<i;t+=1)if(r=n.implicitTypes[t],r.resolve(e))return!0;return!1}function Dn(n){return n===oc||n===ic}function be(n){return 32<=n&&n<=126||161<=n&&n<=55295&&n!==8232&&n!==8233||57344<=n&&n<=65533&&n!==65279||65536<=n&&n<=1114111}function xc(n){return be(n)&&!Dn(n)&&n!==65279&&n!==rc&&n!==Ee}function Rt(n,e){return be(n)&&n!==65279&&n!==ui&&n!==mi&&n!==fi&&n!==gi&&n!==yi&&n!==pi&&(n!==di||e&&xc(e))}function Cc(n){return be(n)&&n!==65279&&!Dn(n)&&n!==uc&&n!==fc&&n!==pi&&n!==ui&&n!==mi&&n!==fi&&n!==gi&&n!==yi&&n!==di&&n!==cc&&n!==dc&&n!==sc&&n!==_c&&n!==pc&&n!==mc&&n!==hc&&n!==ac&&n!==lc&&n!==gc&&n!==yc}function _i(n){var e=/^\n* /;return e.test(n)}var bi=1,vi=2,wi=3,ki=4,qe=5;function Tc(n,e,t,i,r){var o,s,a,l=!1,c=!1,h=i!==-1,d=-1,p=Cc(n.charCodeAt(0))&&!Dn(n.charCodeAt(n.length-1));if(e)for(o=0;o<n.length;o++){if(s=n.charCodeAt(o),!be(s))return qe;a=o>0?n.charCodeAt(o-1):null,p=p&&Rt(s,a)}else{for(o=0;o<n.length;o++){if(s=n.charCodeAt(o),s===Ee)l=!0,h&&(c=c||o-d-1>i&&n[d+1]!==" ",d=o);else if(!be(s))return qe;a=o>0?n.charCodeAt(o-1):null,p=p&&Rt(s,a)}c=c||h&&o-d-1>i&&n[d+1]!==" "}return!l&&!c?p&&!r(n)?bi:vi:t>9&&_i(n)?qe:c?ki:wi}function Mc(n,e,t,i){n.dump=function(){if(e.length===0)return"''";if(!n.noCompatMode&&bc.indexOf(e)!==-1)return"'"+e+"'";var r=n.indent*Math.max(1,t),o=n.lineWidth===-1?-1:Math.max(Math.min(n.lineWidth,40),n.lineWidth-r),s=i||n.flowLevel>-1&&t>=n.flowLevel;function a(l){return kc(n,l)}switch(Tc(e,s,n.indent,o,a)){case bi:return e;case vi:return"'"+e.replace(/'/g,"''")+"'";case wi:return"|"+Lt(e,n.indent)+Ft(Et(e,r));case ki:return">"+Lt(e,n.indent)+Ft(Et(Ic(e,o),r));case qe:return'"'+Ac(e)+'"';default:throw new Ne("impossible error: invalid scalar style")}}()}function Lt(n,e){var t=_i(n)?String(e):"",i=n[n.length-1]===`
`,r=i&&(n[n.length-2]===`
`||n===`
`),o=r?"+":i?"":"-";return t+o+`
...
`:"")+Dt(l,e),r=o}return i}function Dt(n,e){if(n===""||n[0]===" ")return n;for(var t=/ [^ ]/g,i,r=0,o,s=0,a=0,l="";i=t.exec(n);)a=i.index,a-r>e&&(o=s>r?s:a,l+=`
`+n.slice(r,o),r=o+1),s=a;return l+=`
`,n.length-r>e&&s>r?l+=n.slice(r,s)+`
`+n.slice(s+1):l+=n.slice(r),l.slice(1)}function Ac(n){for(var e="",t,i,r,o=0;o<n.length;o++){if(t=n.charCodeAt(o),t>=55296&&t<=56319&&(i=n.charCodeAt(o+1),i>=56320&&i<=57343)){e+=St((t-55296)*1024+i-56320+65536),o++;continue}r=$[t],e+=!r&&be(t)?n[o]:r||St(t)}return e}function Sc(n,e,t){var i="",r=n.tag,o,s;for(o=0,s=t.length;o<s;o+=1)ce(n,e,t[o],!1,!1)&&(o!==0&&(i+=","+(n.condenseFlow?"":" ")),i+=n.dump);n.tag=r,n.dump="["+i+"]"}function Ec(n,e,t,i){var r="",o=n.tag,s,a;for(s=0,a=t.length;s<a;s+=1)ce(n,e+1,t[s],!0,!0)&&((!i||s!==0)&&(r+=wn(n,e)),n.dump&&Ee===n.dump.charCodeAt(0)?r+="-":r+="- ",r+=n.dump);n.tag=o,n.dump=r||"[]"}function Rc(n,e,t){var i="",r=n.tag,o=Object.keys(t),s,a,l,c,h;for(s=0,a=o.length;s<a;s+=1)h="",s!==0&&(h+=", "),n.condenseFlow&&(h+='"'),l=o[s],c=t[l],ce(n,e,l,!1,!1)&&(n.dump.length>1024&&(h+="? "),h+=n.dump+(n.condenseFlow?'"':"")+":"+(n.condenseFlow?"":" "),ce(n,e,c,!1,!1)&&(h+=n.dump,i+=h));n.tag=r,n.dump="{"+i+"}"}function Lc(n,e,t,i){var r="",o=n.tag,s=Object.keys(t),a,l,c,h,d,p;if(n.sortKeys===!0)s.sort();else if(typeof n.sortKeys=="function")s.sort(n.sortKeys);else if(n.sortKeys)throw new Ne("sortKeys must be a boolean or a function");for(a=0,l=s.length;a<l;a+=1)p="",(!i||a!==0)&&(p+=wn(n,e)),c=s[a],h=t[c],ce(n,e+1,c,!0,!0,!0)&&(d=n.tag!==null&&n.tag!=="?"||n.dump&&n.dump.length>1024,d&&(n.dump&&Ee===n.dump.charCodeAt(0)?p+="?":p+="? "),p+=n.dump,d&&(p+=wn(n,e)),ce(n,e+1,h,!0,d)&&(n.dump&&Ee===n.dump.charCodeAt(0)?p+=":":p+=": ",p+=n.dump,r+=p));n.tag=o,n.dump=r||"{}"}function Nt(n,e,t){var i,r,o,s,a,l;for(r=t?n.explicitTypes:n.implicitTypes,o=0,s=r.length;o<s;o+=1)if(a=r[o],(a.instanceOf||a.predicate)&&(!a.instanceOf||typeof e=="object"&&e instanceof a.instanceOf)&&(!a.predicate||a.predicate(e))){if(n.tag=t?a.tag:"?",a.represent){if(l=n.styleMap[a.tag]||a.defaultStyle,ci.call(a.represent)==="[object Function]")i=a.represent(e,l);else if(hi.call(a.represent,l))i=a.represent[l](e,l);else throw new Ne("!<"+a.tag+'> tag resolver accepts not "'+l+'" style');n.dump=i}return!0}return!1}function ce(n,e,t,i,r,o){n.tag=null,n.dump=t,Nt(n,t,!1)||Nt(n,t,!0);var s=ci.call(n.dump);i&&(i=n.flowLevel<0||n.flowLevel>e);var a=s==="[object Object]"||s==="[object Array]",l,c;if(a&&(l=n.duplicates.indexOf(t),c=l!==-1),(n.tag!==null&&n.tag!=="?"||c||n.indent!==2&&e>0)&&(r=!1),c&&n.usedDuplicates[l])n.dump="*ref_"+l;else{if(a&&c&&!n.usedDuplicates[l]&&(n.usedDuplicates[l]=!0),s==="[object Object]")i&&Object.keys(n.dump).length!==0?(Lc(n,e,n.dump,r),c&&(n.dump="&ref_"+l+n.dump)):(Rc(n,e,n.dump),c&&(n.dump="&ref_"+l+" "+n.dump));else if(s==="[object Array]"){var h=n.noArrayIndent&&e>0?e-1:e;i&&n.dump.length!==0?(Ec(n,h,n.dump,r),c&&(n.dump="&ref_"+l+n.dump)):(Sc(n,h,n.dump),c&&(n.dump="&ref_"+l+" "+n.dump))}else if(s==="[object String]")n.tag!=="?"&&Mc(n,n.dump,e,o);else{if(n.skipInvalid)return!1;throw new Ne("unacceptable kind of an object to dump "+s)}n.tag!==null&&n.tag!=="?"&&(n.dump="!<"+n.tag+"> "+n.dump)}return!0}function Fc(n,e){var t=[],i=[],r,o;for(kn(n,t,i),r=0,o=i.length;r<o;r+=1)e.duplicates.push(t[i[r]]);e.usedDuplicates=new Array(o)}function kn(n,e,t){var i,r,o;if(n!==null&&typeof n=="object")if(r=e.indexOf(n),r!==-1)t.indexOf(r)===-1&&t.push(r);else if(e.push(n),Array.isArray(n))for(r=0,o=n.length;r<o;r+=1)kn(n[r],e,t);else for(i=Object.keys(n),r=0,o=i.length;r<o;r+=1)kn(n[i[r]],e,t)}function xi(n,e){e=e||{};var t=new wc(e);return t.noRefs||Fc(n,t),ce(t,0,n,!0,!0)?t.dump+`
