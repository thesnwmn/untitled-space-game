...
Long range engines for faster than light travel between systems.`,yr=`---
id: freighter
...
`;var T={},de={},N={};function jn(e){return typeof e>"u"||e===null}function Or(e){return typeof e=="object"&&e!==null}function Fr(e){return Array.isArray(e)?e:jn(e)?[]:[e]}function Nr(e,n){var t,i,r,o;if(n)for(o=Object.keys(n),t=0,i=o.length;t<i;t+=1)r=o[t],e[r]=n[r];return e}function Dr(e,n){var t="",i;for(i=0;i<n;i+=1)t+=e;return t}function Pr(e){return e===0&&Number.NEGATIVE_INFINITY===1/e}N.isNothing=jn;N.isObject=Or;N.toArray=Fr;N.repeat=Dr;N.isNegativeZero=Pr;N.extend=Nr;function le(e,n){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=n,this.message=(this.reason||"(unknown reason)")+(this.mark?" "+this.mark.toString():""),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}le.prototype=Object.create(Error.prototype);le.prototype.constructor=le;le.prototype.toString=function(n){var t=this.name+": ";return t+=this.reason||"(unknown reason)",!n&&this.mark&&(t+=" "+this.mark.toString()),t};var he=le,_n=N;function Ge(e,n,t,i,r){this.name=e,this.buffer=n,this.position=t,this.line=i,this.column=r}Ge.prototype.getSnippet=function(n,t){var i,r,o,a,s;if(!this.buffer)return null;for(n=n||4,t=t||75,i="",r=this.position;r>0&&`\0\r
\u2028\u2029`.indexOf(this.buffer.charAt(r-1))===-1;)if(r-=1,this.position-r>t/2-1){i=" ... ",r+=5;break}for(o="",a=this.position;a<this.buffer.length&&`\0\r
\u2028\u2029`.indexOf(this.buffer.charAt(a))===-1;)if(a+=1,a-this.position>t/2-1){o=" ... ",a-=5;break}return s=this.buffer.slice(r,a),_n.repeat(" ",n)+i+s+o+`
`+_n.repeat(" ",n+this.position-r+i.length)+"^"};Ge.prototype.toString=function(n){var t,i="";return this.name&&(i+='in "'+this.name+'" '),i+="at line "+(this.line+1)+", column "+(this.column+1),n||(t=this.getSnippet(),t&&(i+=`:
`+t)),i};var Ur=Ge,vn=he,Hr=["kind","resolve","construct","instanceOf","predicate","represent","defaultStyle","styleAliases"],Br=["scalar","sequence","mapping"];function $r(e){var n={};return e!==null&&Object.keys(e).forEach(function(t){e[t].forEach(function(i){n[String(i)]=t})}),n}function jr(e,n){if(n=n||{},Object.keys(n).forEach(function(t){if(Hr.indexOf(t)===-1)throw new vn('Unknown option "'+t+'" is met in definition of "'+e+'" YAML type.')}),this.tag=e,this.kind=n.kind||null,this.resolve=n.resolve||function(){return!0},this.construct=n.construct||function(t){return t},this.instanceOf=n.instanceOf||null,this.predicate=n.predicate||null,this.represent=n.represent||null,this.defaultStyle=n.defaultStyle||null,this.styleAliases=$r(n.styleAliases||null),Br.indexOf(this.kind)===-1)throw new vn('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')}var M=jr,wn=N,ve=he,Gr=M;function Be(e,n,t){var i=[];return e.include.forEach(function(r){t=Be(r,n,t)}),e[n].forEach(function(r){t.forEach(function(o,a){o.tag===r.tag&&o.kind===r.kind&&i.push(a)}),t.push(r)}),t.filter(function(r,o){return i.indexOf(o)===-1})}function Yr(){var e={scalar:{},sequence:{},mapping:{},fallback:{}},n,t;function i(r){e[r.kind][r.tag]=e.fallback[r.tag]=r}for(n=0,t=arguments.length;n<t;n+=1)arguments[n].forEach(i);return e}function Q(e){this.include=e.include||[],this.implicit=e.implicit||[],this.explicit=e.explicit||[],this.implicit.forEach(function(n){if(n.loadKind&&n.loadKind!=="scalar")throw new ve("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.")}),this.compiledImplicit=Be(this,"implicit",[]),this.compiledExplicit=Be(this,"explicit",[]),this.compiledTypeMap=Yr(this.compiledImplicit,this.compiledExplicit)}Q.DEFAULT=null;Q.create=function(){var n,t;switch(arguments.length){case 1:n=Q.DEFAULT,t=arguments[0];break;case 2:n=arguments[0],t=arguments[1];break;default:throw new ve("Wrong number of arguments for Schema.create function")}if(n=wn.toArray(n),t=wn.toArray(t),!n.every(function(i){return i instanceof Q}))throw new ve("Specified list of super schemas (or a single Schema object) contains a non-Schema object.");if(!t.every(function(i){return i instanceof Gr}))throw new ve("Specified list of YAML types (or a single Type object) contains a non-Type object.");return new Q({include:n,explicit:t})};var ie=Q,Wr=M,Kr=new Wr("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return e!==null?e:""}}),qr=M,zr=new qr("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return e!==null?e:[]}}),Vr=M,Jr=new Vr("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return e!==null?e:{}}}),Qr=ie,Ye=new Qr({explicit:[Kr,zr,Jr]}),Xr=M;function Zr(e){if(e===null)return!0;var n=e.length;return n===1&&e==="~"||n===4&&(e==="null"||e==="Null"||e==="NULL")}function eo(){return null}function no(e){return e===null}var to=new Xr("tag:yaml.org,2002:null",{kind:"scalar",resolve:Zr,construct:eo,predicate:no,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"}},defaultStyle:"lowercase"}),io=M;function ro(e){if(e===null)return!1;var n=e.length;return n===4&&(e==="true"||e==="True"||e==="TRUE")||n===5&&(e==="false"||e==="False"||e==="FALSE")}function oo(e){return e==="true"||e==="True"||e==="TRUE"}function ao(e){return Object.prototype.toString.call(e)==="[object Boolean]"}var so=new io("tag:yaml.org,2002:bool",{kind:"scalar",resolve:ro,construct:oo,predicate:ao,represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"}),lo=N,co=M;function ho(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function uo(e){return 48<=e&&e<=55}function po(e){return 48<=e&&e<=57}function fo(e){if(e===null)return!1;var n=e.length,t=0,i=!1,r;if(!n)return!1;if(r=e[t],(r==="-"||r==="+")&&(r=e[++t]),r==="0"){if(t+1===n)return!0;if(r=e[++t],r==="b"){for(t++;t<n;t++)if(r=e[t],r!=="_"){if(r!=="0"&&r!=="1")return!1;i=!0}return i&&r!=="_"}if(r==="x"){for(t++;t<n;t++)if(r=e[t],r!=="_"){if(!ho(e.charCodeAt(t)))return!1;i=!0}return i&&r!=="_"}for(;t<n;t++)if(r=e[t],r!=="_"){if(!uo(e.charCodeAt(t)))return!1;i=!0}return i&&r!=="_"}if(r==="_")return!1;for(;t<n;t++)if(r=e[t],r!=="_"){if(r===":")break;if(!po(e.charCodeAt(t)))return!1;i=!0}return!i||r==="_"?!1:r!==":"?!0:/^(:[0-5]?[0-9])+$/.test(e.slice(t))}function mo(e){var n=e,t=1,i,r,o=[];return n.indexOf("_")!==-1&&(n=n.replace(/_/g,"")),i=n[0],(i==="-"||i==="+")&&(i==="-"&&(t=-1),n=n.slice(1),i=n[0]),n==="0"?0:i==="0"?n[1]==="b"?t*parseInt(n.slice(2),2):n[1]==="x"?t*parseInt(n,16):t*parseInt(n,8):n.indexOf(":")!==-1?(n.split(":").forEach(function(a){o.unshift(parseInt(a,10))}),n=0,r=1,o.forEach(function(a){n+=a*r,r*=60}),t*n):t*parseInt(n,10)}function go(e){return Object.prototype.toString.call(e)==="[object Number]"&&e%1===0&&!lo.isNegativeZero(e)}var yo=new co("tag:yaml.org,2002:int",{kind:"scalar",resolve:fo,construct:mo,predicate:go,represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0"+e.toString(8):"-0"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),Gn=N,bo=M,_o=new RegExp("^(?:[-+]?(?:0|[1-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function vo(e){return!(e===null||!_o.test(e)||e[e.length-1]==="_")}function wo(e){var n,t,i,r;return n=e.replace(/_/g,"").toLowerCase(),t=n[0]==="-"?-1:1,r=[],"+-".indexOf(n[0])>=0&&(n=n.slice(1)),n===".inf"?t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:n===".nan"?NaN:n.indexOf(":")>=0?(n.split(":").forEach(function(o){r.unshift(parseFloat(o,10))}),n=0,i=1,r.forEach(function(o){n+=o*i,i*=60}),t*n):t*parseFloat(n,10)}var xo=/^[-+]?[0-9]+e/;function ko(e,n){var t;if(isNaN(e))switch(n){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(n){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(n){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(Gn.isNegativeZero(e))return"-0.0";return t=e.toString(10),xo.test(t)?t.replace("e",".e"):t}function Co(e){return Object.prototype.toString.call(e)==="[object Number]"&&(e%1!==0||Gn.isNegativeZero(e))}var Ao=new bo("tag:yaml.org,2002:float",{kind:"scalar",resolve:vo,construct:wo,predicate:Co,represent:ko,defaultStyle:"lowercase"}),To=ie,Yn=new To({include:[Ye],implicit:[to,so,yo,Ao]}),So=ie,Wn=new So({include:[Yn]}),Io=M,Kn=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),qn=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Eo(e){return e===null?!1:Kn.exec(e)!==null||qn.exec(e)!==null}function Mo(e){var n,t,i,r,o,a,s,l=0,c=null,h,d,p;if(n=Kn.exec(e),n===null&&(n=qn.exec(e)),n===null)throw new Error("Date resolve error");if(t=+n[1],i=+n[2]-1,r=+n[3],!n[4])return new Date(Date.UTC(t,i,r));if(o=+n[4],a=+n[5],s=+n[6],n[7]){for(l=n[7].slice(0,3);l.length<3;)l+="0";l=+l}return n[9]&&(h=+n[10],d=+(n[11]||0),c=(h*60+d)*6e4,n[9]==="-"&&(c=-c)),p=new Date(Date.UTC(t,i,r,o,a,s,l)),c&&p.setTime(p.getTime()-c),p}function Lo(e){return e.toISOString()}var Ro=new Io("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Eo,construct:Mo,instanceOf:Date,represent:Lo}),Oo=M;function Fo(e){return e==="<<"||e===null}var No=new Oo("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Fo});function zn(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var q;try{var Do=zn;q=Do("buffer").Buffer}catch{}var Po=M,We=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function Uo(e){if(e===null)return!1;var n,t,i=0,r=e.length,o=We;for(t=0;t<r;t++)if(n=o.indexOf(e.charAt(t)),!(n>64)){if(n<0)return!1;i+=6}return i%8===0}function Ho(e){var n,t,i=e.replace(/[\r\n=]/g,""),r=i.length,o=We,a=0,s=[];for(n=0;n<r;n++)n%4===0&&n&&(s.push(a>>16&255),s.push(a>>8&255),s.push(a&255)),a=a<<6|o.indexOf(i.charAt(n));return t=r%4*6,t===0?(s.push(a>>16&255),s.push(a>>8&255),s.push(a&255)):t===18?(s.push(a>>10&255),s.push(a>>2&255)):t===12&&s.push(a>>4&255),q?q.from?q.from(s):new q(s):s}function Bo(e){var n="",t=0,i,r,o=e.length,a=We;for(i=0;i<o;i++)i%3===0&&i&&(n+=a[t>>18&63],n+=a[t>>12&63],n+=a[t>>6&63],n+=a[t&63]),t=(t<<8)+e[i];return r=o%3,r===0?(n+=a[t>>18&63],n+=a[t>>12&63],n+=a[t>>6&63],n+=a[t&63]):r===2?(n+=a[t>>10&63],n+=a[t>>4&63],n+=a[t<<2&63],n+=a[64]):r===1&&(n+=a[t>>2&63],n+=a[t<<4&63],n+=a[64],n+=a[64]),n}function $o(e){return q&&q.isBuffer(e)}var jo=new Po("tag:yaml.org,2002:binary",{kind:"scalar",resolve:Uo,construct:Ho,predicate:$o,represent:Bo}),Go=M,Yo=Object.prototype.hasOwnProperty,Wo=Object.prototype.toString;function Ko(e){if(e===null)return!0;var n=[],t,i,r,o,a,s=e;for(t=0,i=s.length;t<i;t+=1){if(r=s[t],a=!1,Wo.call(r)!=="[object Object]")return!1;for(o in r)if(Yo.call(r,o))if(!a)a=!0;else return!1;if(!a)return!1;if(n.indexOf(o)===-1)n.push(o);else return!1}return!0}function qo(e){return e!==null?e:[]}var zo=new Go("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Ko,construct:qo}),Vo=M,Jo=Object.prototype.toString;function Qo(e){if(e===null)return!0;var n,t,i,r,o,a=e;for(o=new Array(a.length),n=0,t=a.length;n<t;n+=1){if(i=a[n],Jo.call(i)!=="[object Object]"||(r=Object.keys(i),r.length!==1))return!1;o[n]=[r[0],i[r[0]]]}return!0}function Xo(e){if(e===null)return[];var n,t,i,r,o,a=e;for(o=new Array(a.length),n=0,t=a.length;n<t;n+=1)i=a[n],r=Object.keys(i),o[n]=[r[0],i[r[0]]];return o}var Zo=new Vo("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Qo,construct:Xo}),ea=M,na=Object.prototype.hasOwnProperty;function ta(e){if(e===null)return!0;var n,t=e;for(n in t)if(na.call(t,n)&&t[n]!==null)return!1;return!0}function ia(e){return e!==null?e:{}}var ra=new ea("tag:yaml.org,2002:set",{kind:"mapping",resolve:ta,construct:ia}),oa=ie,ue=new oa({include:[Wn],implicit:[Ro,No],explicit:[jo,zo,Zo,ra]}),aa=M;function sa(){return!0}function la(){}function ca(){return""}function da(e){return typeof e>"u"}var ha=new aa("tag:yaml.org,2002:js/undefined",{kind:"scalar",resolve:sa,construct:la,predicate:da,represent:ca}),ua=M;function pa(e){if(e===null||e.length===0)return!1;var n=e,t=/\/([gim]*)$/.exec(e),i="";return!(n[0]==="/"&&(t&&(i=t[1]),i.length>3||n[n.length-i.length-1]!=="/"))}function fa(e){var n=e,t=/\/([gim]*)$/.exec(e),i="";return n[0]==="/"&&(t&&(i=t[1]),n=n.slice(1,n.length-i.length-1)),new RegExp(n,i)}function ma(e){var n="/"+e.source+"/";return e.global&&(n+="g"),e.multiline&&(n+="m"),e.ignoreCase&&(n+="i"),n}function ga(e){return Object.prototype.toString.call(e)==="[object RegExp]"}var ya=new ua("tag:yaml.org,2002:js/regexp",{kind:"scalar",resolve:pa,construct:fa,predicate:ga,represent:ma}),ke;try{var ba=zn;ke=ba("esprima")}catch{typeof window<"u"&&(ke=window.esprima)}var _a=M;function va(e){if(e===null)return!1;try{var n="("+e+")",t=ke.parse(n,{range:!0});return!(t.type!=="Program"||t.body.length!==1||t.body[0].type!=="ExpressionStatement"||t.body[0].expression.type!=="ArrowFunctionExpression"&&t.body[0].expression.type!=="FunctionExpression")}catch{return!1}}function wa(e){var n="("+e+")",t=ke.parse(n,{range:!0}),i=[],r;if(t.type!=="Program"||t.body.length!==1||t.body[0].type!=="ExpressionStatement"||t.body[0].expression.type!=="ArrowFunctionExpression"&&t.body[0].expression.type!=="FunctionExpression")throw new Error("Failed to resolve function");return t.body[0].expression.params.forEach(function(o){i.push(o.name)}),r=t.body[0].expression.body.range,t.body[0].expression.body.type==="BlockStatement"?new Function(i,n.slice(r[0]+1,r[1]-1)):new Function(i,"return "+n.slice(r[0],r[1]))}function xa(e){return e.toString()}function ka(e){return Object.prototype.toString.call(e)==="[object Function]"}var Ca=new _a("tag:yaml.org,2002:js/function",{kind:"scalar",resolve:va,construct:wa,predicate:ka,represent:xa}),xn=ie,Ee=xn.DEFAULT=new xn({include:[ue],explicit:[ha,ya,Ca]}),B=N,Vn=he,Aa=Ur,Jn=ue,Ta=Ee,Y=Object.prototype.hasOwnProperty,Ce=1,Qn=2,Xn=3,Ae=4,Pe=1,Sa=2,kn=3,Ia=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Ea=/[\x85\u2028\u2029]/,Ma=/[,\[\]\{\}]/,Zn=/^(?:!|!!|![a-z\-]+!)$/i,et=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Cn(e){return Object.prototype.toString.call(e)}function U(e){return e===10||e===13}function z(e){return e===9||e===32}function F(e){return e===9||e===32||e===10||e===13}function X(e){return e===44||e===91||e===93||e===123||e===125}function La(e){var n;return 48<=e&&e<=57?e-48:(n=e|32,97<=n&&n<=102?n-97+10:-1)}function Ra(e){return e===120?2:e===117?4:e===85?8:0}function Oa(e){return 48<=e&&e<=57?e-48:-1}function An(e){return e===48?"\0":e===97?"\x07":e===98?"\b":e===116||e===9?"	":e===110?`
`:e===118?"\v":e===102?"\f":e===114?"\r":e===101?"\x1B":e===32?" ":e===34?'"':e===47?"/":e===92?"\\":e===78?"":e===95?" ":e===76?"\u2028":e===80?"\u2029":""}function Fa(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function nt(e,n,t){n==="__proto__"?Object.defineProperty(e,n,{configurable:!0,enumerable:!0,writable:!0,value:t}):e[n]=t}var tt=new Array(256),it=new Array(256);for(var J=0;J<256;J++)tt[J]=An(J)?1:0,it[J]=An(J);function Na(e,n){this.input=e,this.filename=n.filename||null,this.schema=n.schema||Ta,this.onWarning=n.onWarning||null,this.legacy=n.legacy||!1,this.json=n.json||!1,this.listener=n.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.documents=[]}function rt(e,n){return new Vn(n,new Aa(e.filename,e.input,e.position,e.line,e.position-e.lineStart))}function b(e,n){throw rt(e,n)}function Te(e,n){e.onWarning&&e.onWarning.call(null,rt(e,n))}var Tn={YAML:function(n,t,i){var r,o,a;n.version!==null&&b(n,"duplication of %YAML directive"),i.length!==1&&b(n,"YAML directive accepts exactly one argument"),r=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),r===null&&b(n,"ill-formed argument of the YAML directive"),o=parseInt(r[1],10),a=parseInt(r[2],10),o!==1&&b(n,"unacceptable YAML version of the document"),n.version=i[0],n.checkLineBreaks=a<2,a!==1&&a!==2&&Te(n,"unsupported YAML version of the document")},TAG:function(n,t,i){var r,o;i.length!==2&&b(n,"TAG directive accepts exactly two arguments"),r=i[0],o=i[1],Zn.test(r)||b(n,"ill-formed tag handle (first argument) of the TAG directive"),Y.call(n.tagMap,r)&&b(n,'there is a previously declared suffix for "'+r+'" tag handle'),et.test(o)||b(n,"ill-formed tag prefix (second argument) of the TAG directive"),n.tagMap[r]=o}};function G(e,n,t,i){var r,o,a,s;if(n<t){if(s=e.input.slice(n,t),i)for(r=0,o=s.length;r<o;r+=1)a=s.charCodeAt(r),a===9||32<=a&&a<=1114111||b(e,"expected valid JSON character");else Ia.test(s)&&b(e,"the stream contains non-printable characters");e.result+=s}}function Sn(e,n,t,i){var r,o,a,s;for(B.isObject(t)||b(e,"cannot merge mappings; the provided source object is unacceptable"),r=Object.keys(t),a=0,s=r.length;a<s;a+=1)o=r[a],Y.call(n,o)||(nt(n,o,t[o]),i[o]=!0)}function Z(e,n,t,i,r,o,a,s){var l,c;if(Array.isArray(r))for(r=Array.prototype.slice.call(r),l=0,c=r.length;l<c;l+=1)Array.isArray(r[l])&&b(e,"nested arrays are not supported inside keys"),typeof r=="object"&&Cn(r[l])==="[object Object]"&&(r[l]="[object Object]");if(typeof r=="object"&&Cn(r)==="[object Object]"&&(r="[object Object]"),r=String(r),n===null&&(n={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(o))for(l=0,c=o.length;l<c;l+=1)Sn(e,n,o[l],t);else Sn(e,n,o,t);else!e.json&&!Y.call(t,r)&&Y.call(n,r)&&(e.line=a||e.line,e.position=s||e.position,b(e,"duplicated mapping key")),nt(n,r,o),delete t[r];return n}function Ke(e){var n;n=e.input.charCodeAt(e.position),n===10?e.position++:n===13?(e.position++,e.input.charCodeAt(e.position)===10&&e.position++):b(e,"a line break is expected"),e.line+=1,e.lineStart=e.position}function S(e,n,t){for(var i=0,r=e.input.charCodeAt(e.position);r!==0;){for(;z(r);)r=e.input.charCodeAt(++e.position);if(n&&r===35)do r=e.input.charCodeAt(++e.position);while(r!==10&&r!==13&&r!==0);if(U(r))for(Ke(e),r=e.input.charCodeAt(e.position),i++,e.lineIndent=0;r===32;)e.lineIndent++,r=e.input.charCodeAt(++e.position);else break}return t!==-1&&i!==0&&e.lineIndent<t&&Te(e,"deficient indentation"),i}function Me(e){var n=e.position,t;return t=e.input.charCodeAt(n),!!((t===45||t===46)&&t===e.input.charCodeAt(n+1)&&t===e.input.charCodeAt(n+2)&&(n+=3,t=e.input.charCodeAt(n),t===0||F(t)))}function qe(e,n){n===1?e.result+=" ":n>1&&(e.result+=B.repeat(`
`,n-1))}function Da(e,n,t){var i,r,o,a,s,l,c,h,d=e.kind,p=e.result,u;if(u=e.input.charCodeAt(e.position),F(u)||X(u)||u===35||u===38||u===42||u===33||u===124||u===62||u===39||u===34||u===37||u===64||u===96||(u===63||u===45)&&(r=e.input.charCodeAt(e.position+1),F(r)||t&&X(r)))return!1;for(e.kind="scalar",e.result="",o=a=e.position,s=!1;u!==0;){if(u===58){if(r=e.input.charCodeAt(e.position+1),F(r)||t&&X(r))break}else if(u===35){if(i=e.input.charCodeAt(e.position-1),F(i))break}else{if(e.position===e.lineStart&&Me(e)||t&&X(u))break;if(U(u))if(l=e.line,c=e.lineStart,h=e.lineIndent,S(e,!1,-1),e.lineIndent>=n){s=!0,u=e.input.charCodeAt(e.position);continue}else{e.position=a,e.line=l,e.lineStart=c,e.lineIndent=h;break}}s&&(G(e,o,a,!1),qe(e,e.line-l),o=a=e.position,s=!1),z(u)||(a=e.position+1),u=e.input.charCodeAt(++e.position)}return G(e,o,a,!1),e.result?!0:(e.kind=d,e.result=p,!1)}function Pa(e,n){var t,i,r;if(t=e.input.charCodeAt(e.position),t!==39)return!1;for(e.kind="scalar",e.result="",e.position++,i=r=e.position;(t=e.input.charCodeAt(e.position))!==0;)if(t===39)if(G(e,i,e.position,!0),t=e.input.charCodeAt(++e.position),t===39)i=e.position,e.position++,r=e.position;else return!0;else U(t)?(G(e,i,r,!0),qe(e,S(e,!1,n)),i=r=e.position):e.position===e.lineStart&&Me(e)?b(e,"unexpected end of the document within a single quoted scalar"):(e.position++,r=e.position);b(e,"unexpected end of the stream within a single quoted scalar")}function Ua(e,n){var t,i,r,o,a,s;if(s=e.input.charCodeAt(e.position),s!==34)return!1;for(e.kind="scalar",e.result="",e.position++,t=i=e.position;(s=e.input.charCodeAt(e.position))!==0;){if(s===34)return G(e,t,e.position,!0),e.position++,!0;if(s===92){if(G(e,t,e.position,!0),s=e.input.charCodeAt(++e.position),U(s))S(e,!1,n);else if(s<256&&tt[s])e.result+=it[s],e.position++;else if((a=Ra(s))>0){for(r=a,o=0;r>0;r--)s=e.input.charCodeAt(++e.position),(a=La(s))>=0?o=(o<<4)+a:b(e,"expected hexadecimal character");e.result+=Fa(o),e.position++}else b(e,"unknown escape sequence");t=i=e.position}else U(s)?(G(e,t,i,!0),qe(e,S(e,!1,n)),t=i=e.position):e.position===e.lineStart&&Me(e)?b(e,"unexpected end of the document within a double quoted scalar"):(e.position++,i=e.position)}b(e,"unexpected end of the stream within a double quoted scalar")}function Ha(e,n){var t=!0,i,r=e.tag,o,a=e.anchor,s,l,c,h,d,p={},u,f,w,_;if(_=e.input.charCodeAt(e.position),_===91)l=93,d=!1,o=[];else if(_===123)l=125,d=!0,o={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),_=e.input.charCodeAt(++e.position);_!==0;){if(S(e,!0,n),_=e.input.charCodeAt(e.position),_===l)return e.position++,e.tag=r,e.anchor=a,e.kind=d?"mapping":"sequence",e.result=o,!0;t||b(e,"missed comma between flow collection entries"),f=u=w=null,c=h=!1,_===63&&(s=e.input.charCodeAt(e.position+1),F(s)&&(c=h=!0,e.position++,S(e,!0,n))),i=e.line,ne(e,n,Ce,!1,!0),f=e.tag,u=e.result,S(e,!0,n),_=e.input.charCodeAt(e.position),(h||e.line===i)&&_===58&&(c=!0,_=e.input.charCodeAt(++e.position),S(e,!0,n),ne(e,n,Ce,!1,!0),w=e.result),d?Z(e,o,p,f,u,w):c?o.push(Z(e,null,p,f,u,w)):o.push(u),S(e,!0,n),_=e.input.charCodeAt(e.position),_===44?(t=!0,_=e.input.charCodeAt(++e.position)):t=!1}b(e,"unexpected end of the stream within a flow collection")}function Ba(e,n){var t,i,r=Pe,o=!1,a=!1,s=n,l=0,c=!1,h,d;if(d=e.input.charCodeAt(e.position),d===124)i=!1;else if(d===62)i=!0;else return!1;for(e.kind="scalar",e.result="";d!==0;)if(d=e.input.charCodeAt(++e.position),d===43||d===45)Pe===r?r=d===43?kn:Sa:b(e,"repeat of a chomping mode identifier");else if((h=Oa(d))>=0)h===0?b(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):a?b(e,"repeat of an indentation width identifier"):(s=n+h-1,a=!0);else break;if(z(d)){do d=e.input.charCodeAt(++e.position);while(z(d));if(d===35)do d=e.input.charCodeAt(++e.position);while(!U(d)&&d!==0)}for(;d!==0;){for(Ke(e),e.lineIndent=0,d=e.input.charCodeAt(e.position);(!a||e.lineIndent<s)&&d===32;)e.lineIndent++,d=e.input.charCodeAt(++e.position);if(!a&&e.lineIndent>s&&(s=e.lineIndent),U(d)){l++;continue}if(e.lineIndent<s){r===kn?e.result+=B.repeat(`
`,o?1+l:l):r===Pe&&o&&(e.result+=`
`);break}for(i?z(d)?(c=!0,e.result+=B.repeat(`
`,o?1+l:l)):c?(c=!1,e.result+=B.repeat(`
`,l+1)):l===0?o&&(e.result+=" "):e.result+=B.repeat(`
`,l):e.result+=B.repeat(`
`,o?1+l:l),o=!0,a=!0,l=0,t=e.position;!U(d)&&d!==0;)d=e.input.charCodeAt(++e.position);G(e,t,e.position,!1)}return!0}function In(e,n){var t,i=e.tag,r=e.anchor,o=[],a,s=!1,l;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),l=e.input.charCodeAt(e.position);l!==0&&!(l!==45||(a=e.input.charCodeAt(e.position+1),!F(a)));){if(s=!0,e.position++,S(e,!0,-1)&&e.lineIndent<=n){o.push(null),l=e.input.charCodeAt(e.position);continue}if(t=e.line,ne(e,n,Xn,!1,!0),o.push(e.result),S(e,!0,-1),l=e.input.charCodeAt(e.position),(e.line===t||e.lineIndent>n)&&l!==0)b(e,"bad indentation of a sequence entry");else if(e.lineIndent<n)break}return s?(e.tag=i,e.anchor=r,e.kind="sequence",e.result=o,!0):!1}function $a(e,n,t){var i,r,o,a,s=e.tag,l=e.anchor,c={},h={},d=null,p=null,u=null,f=!1,w=!1,_;for(e.anchor!==null&&(e.anchorMap[e.anchor]=c),_=e.input.charCodeAt(e.position);_!==0;){if(i=e.input.charCodeAt(e.position+1),o=e.line,a=e.position,(_===63||_===58)&&F(i))_===63?(f&&(Z(e,c,h,d,p,null),d=p=u=null),w=!0,f=!0,r=!0):f?(f=!1,r=!0):b(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,_=i;else if(ne(e,t,Qn,!1,!0))if(e.line===o){for(_=e.input.charCodeAt(e.position);z(_);)_=e.input.charCodeAt(++e.position);if(_===58)_=e.input.charCodeAt(++e.position),F(_)||b(e,"a whitespace character is expected after the key-value separator within a block mapping"),f&&(Z(e,c,h,d,p,null),d=p=u=null),w=!0,f=!1,r=!1,d=e.tag,p=e.result;else if(w)b(e,"can not read an implicit mapping pair; a colon is missed");else return e.tag=s,e.anchor=l,!0}else if(w)b(e,"can not read a block mapping entry; a multiline key may not be an implicit key");else return e.tag=s,e.anchor=l,!0;else break;if((e.line===o||e.lineIndent>n)&&(ne(e,n,Ae,!0,r)&&(f?p=e.result:u=e.result),f||(Z(e,c,h,d,p,u,o,a),d=p=u=null),S(e,!0,-1),_=e.input.charCodeAt(e.position)),e.lineIndent>n&&_!==0)b(e,"bad indentation of a mapping entry");else if(e.lineIndent<n)break}return f&&Z(e,c,h,d,p,null),w&&(e.tag=s,e.anchor=l,e.kind="mapping",e.result=c),w}function ja(e){var n,t=!1,i=!1,r,o,a;if(a=e.input.charCodeAt(e.position),a!==33)return!1;if(e.tag!==null&&b(e,"duplication of a tag property"),a=e.input.charCodeAt(++e.position),a===60?(t=!0,a=e.input.charCodeAt(++e.position)):a===33?(i=!0,r="!!",a=e.input.charCodeAt(++e.position)):r="!",n=e.position,t){do a=e.input.charCodeAt(++e.position);while(a!==0&&a!==62);e.position<e.length?(o=e.input.slice(n,e.position),a=e.input.charCodeAt(++e.position)):b(e,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!F(a);)a===33&&(i?b(e,"tag suffix cannot contain exclamation marks"):(r=e.input.slice(n-1,e.position+1),Zn.test(r)||b(e,"named tag handle cannot contain such characters"),i=!0,n=e.position+1)),a=e.input.charCodeAt(++e.position);o=e.input.slice(n,e.position),Ma.test(o)&&b(e,"tag suffix cannot contain flow indicator characters")}return o&&!et.test(o)&&b(e,"tag name cannot contain such characters: "+o),t?e.tag=o:Y.call(e.tagMap,r)?e.tag=e.tagMap[r]+o:r==="!"?e.tag="!"+o:r==="!!"?e.tag="tag:yaml.org,2002:"+o:b(e,'undeclared tag handle "'+r+'"'),!0}function Ga(e){var n,t;if(t=e.input.charCodeAt(e.position),t!==38)return!1;for(e.anchor!==null&&b(e,"duplication of an anchor property"),t=e.input.charCodeAt(++e.position),n=e.position;t!==0&&!F(t)&&!X(t);)t=e.input.charCodeAt(++e.position);return e.position===n&&b(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(n,e.position),!0}function Ya(e){var n,t,i;if(i=e.input.charCodeAt(e.position),i!==42)return!1;for(i=e.input.charCodeAt(++e.position),n=e.position;i!==0&&!F(i)&&!X(i);)i=e.input.charCodeAt(++e.position);return e.position===n&&b(e,"name of an alias node must contain at least one character"),t=e.input.slice(n,e.position),Y.call(e.anchorMap,t)||b(e,'unidentified alias "'+t+'"'),e.result=e.anchorMap[t],S(e,!0,-1),!0}function ne(e,n,t,i,r){var o,a,s,l=1,c=!1,h=!1,d,p,u,f,w;if(e.listener!==null&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,o=a=s=Ae===t||Xn===t,i&&S(e,!0,-1)&&(c=!0,e.lineIndent>n?l=1:e.lineIndent===n?l=0:e.lineIndent<n&&(l=-1)),l===1)for(;ja(e)||Ga(e);)S(e,!0,-1)?(c=!0,s=o,e.lineIndent>n?l=1:e.lineIndent===n?l=0:e.lineIndent<n&&(l=-1)):s=!1;if(s&&(s=c||r),(l===1||Ae===t)&&(Ce===t||Qn===t?f=n:f=n+1,w=e.position-e.lineStart,l===1?s&&(In(e,w)||$a(e,w,f))||Ha(e,f)?h=!0:(a&&Ba(e,f)||Pa(e,f)||Ua(e,f)?h=!0:Ya(e)?(h=!0,(e.tag!==null||e.anchor!==null)&&b(e,"alias node should not have any properties")):Da(e,f,Ce===t)&&(h=!0,e.tag===null&&(e.tag="?")),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):l===0&&(h=s&&In(e,w))),e.tag!==null&&e.tag!=="!")if(e.tag==="?"){for(e.result!==null&&e.kind!=="scalar"&&b(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),d=0,p=e.implicitTypes.length;d<p;d+=1)if(u=e.implicitTypes[d],u.resolve(e.result)){e.result=u.construct(e.result),e.tag=u.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else Y.call(e.typeMap[e.kind||"fallback"],e.tag)?(u=e.typeMap[e.kind||"fallback"][e.tag],e.result!==null&&u.kind!==e.kind&&b(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+u.kind+'", not "'+e.kind+'"'),u.resolve(e.result)?(e.result=u.construct(e.result),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):b(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")):b(e,"unknown tag !<"+e.tag+">");return e.listener!==null&&e.listener("close",e),e.tag!==null||e.anchor!==null||h}function Wa(e){var n=e.position,t,i,r,o=!1,a;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap={},e.anchorMap={};(a=e.input.charCodeAt(e.position))!==0&&(S(e,!0,-1),a=e.input.charCodeAt(e.position),!(e.lineIndent>0||a!==37));){for(o=!0,a=e.input.charCodeAt(++e.position),t=e.position;a!==0&&!F(a);)a=e.input.charCodeAt(++e.position);for(i=e.input.slice(t,e.position),r=[],i.length<1&&b(e,"directive name must not be less than one character in length");a!==0;){for(;z(a);)a=e.input.charCodeAt(++e.position);if(a===35){do a=e.input.charCodeAt(++e.position);while(a!==0&&!U(a));break}if(U(a))break;for(t=e.position;a!==0&&!F(a);)a=e.input.charCodeAt(++e.position);r.push(e.input.slice(t,e.position))}a!==0&&Ke(e),Y.call(Tn,i)?Tn[i](e,i,r):Te(e,'unknown document directive "'+i+'"')}if(S(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,S(e,!0,-1)):o&&b(e,"directives end mark is expected"),ne(e,e.lineIndent-1,Ae,!1,!0),S(e,!0,-1),e.checkLineBreaks&&Ea.test(e.input.slice(n,e.position))&&Te(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&Me(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,S(e,!0,-1));return}if(e.position<e.length-1)b(e,"end of the stream or a document separator is expected");else return}function ot(e,n){e=String(e),n=n||{},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var t=new Na(e,n),i=e.indexOf("\0");for(i!==-1&&(t.position=i,b(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)Wa(t);return t.documents}function at(e,n,t){n!==null&&typeof n=="object"&&typeof t>"u"&&(t=n,n=null);var i=ot(e,t);if(typeof n!="function")return i;for(var r=0,o=i.length;r<o;r+=1)n(i[r])}function st(e,n){var t=ot(e,n);if(t.length!==0){if(t.length===1)return t[0];throw new Vn("expected a single document in the stream, but found more")}}function Ka(e,n,t){return typeof n=="object"&&n!==null&&typeof t>"u"&&(t=n,n=null),at(e,n,B.extend({schema:Jn},t))}function qa(e,n){return st(e,B.extend({schema:Jn},n))}de.loadAll=at;de.load=st;de.safeLoadAll=Ka;de.safeLoad=qa;var ze={},pe=N,fe=he,za=Ee,Va=ue,lt=Object.prototype.toString,ct=Object.prototype.hasOwnProperty,Ja=9,ce=10,Qa=13,Xa=32,Za=33,es=34,dt=35,ns=37,ts=38,is=39,rs=42,ht=44,os=45,ut=58,as=61,ss=62,ls=63,cs=64,pt=91,ft=93,ds=96,mt=123,hs=124,gt=125,R={};R[0]="\\0";R[7]="\\a";R[8]="\\b";R[9]="\\t";R[10]="\\n";R[11]="\\v";R[12]="\\f";R[13]="\\r";R[27]="\\e";R[34]='\\"';R[92]="\\\\";R[133]="\\N";R[160]="\\_";R[8232]="\\L";R[8233]="\\P";var us=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"];function ps(e,n){var t,i,r,o,a,s,l;if(n===null)return{};for(t={},i=Object.keys(n),r=0,o=i.length;r<o;r+=1)a=i[r],s=String(n[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),l=e.compiledTypeMap.fallback[a],l&&ct.call(l.styleAliases,s)&&(s=l.styleAliases[s]),t[a]=s;return t}function En(e){var n,t,i;if(n=e.toString(16).toUpperCase(),e<=255)t="x",i=2;else if(e<=65535)t="u",i=4;else if(e<=4294967295)t="U",i=8;else throw new fe("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+pe.repeat("0",i-n.length)+n}function fs(e){this.schema=e.schema||za,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=pe.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=ps(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Mn(e,n){for(var t=pe.repeat(" ",n),i=0,r=-1,o="",a,s=e.length;i<s;)r=e.indexOf(`
`,i),r===-1?(a=e.slice(i),i=s):(a=e.slice(i,r+1),i=r+1),a.length&&a!==`
`&&(o+=t),o+=a;return o}function $e(e,n){return`
`+pe.repeat(" ",e.indent*n)}function ms(e,n){var t,i,r;for(t=0,i=e.implicitTypes.length;t<i;t+=1)if(r=e.implicitTypes[t],r.resolve(n))return!0;return!1}function Ve(e){return e===Xa||e===Ja}function te(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==65279||65536<=e&&e<=1114111}function gs(e){return te(e)&&!Ve(e)&&e!==65279&&e!==Qa&&e!==ce}function Ln(e,n){return te(e)&&e!==65279&&e!==ht&&e!==pt&&e!==ft&&e!==mt&&e!==gt&&e!==ut&&(e!==dt||n&&gs(n))}function ys(e){return te(e)&&e!==65279&&!Ve(e)&&e!==os&&e!==ls&&e!==ut&&e!==ht&&e!==pt&&e!==ft&&e!==mt&&e!==gt&&e!==dt&&e!==ts&&e!==rs&&e!==Za&&e!==hs&&e!==as&&e!==ss&&e!==is&&e!==es&&e!==ns&&e!==cs&&e!==ds}function yt(e){var n=/^\n* /;return n.test(e)}var bt=1,_t=2,vt=3,wt=4,we=5;function bs(e,n,t,i,r){var o,a,s,l=!1,c=!1,h=i!==-1,d=-1,p=ys(e.charCodeAt(0))&&!Ve(e.charCodeAt(e.length-1));if(n)for(o=0;o<e.length;o++){if(a=e.charCodeAt(o),!te(a))return we;s=o>0?e.charCodeAt(o-1):null,p=p&&Ln(a,s)}else{for(o=0;o<e.length;o++){if(a=e.charCodeAt(o),a===ce)l=!0,h&&(c=c||o-d-1>i&&e[d+1]!==" ",d=o);else if(!te(a))return we;s=o>0?e.charCodeAt(o-1):null,p=p&&Ln(a,s)}c=c||h&&o-d-1>i&&e[d+1]!==" "}return!l&&!c?p&&!r(e)?bt:_t:t>9&&yt(e)?we:c?wt:vt}function _s(e,n,t,i){e.dump=function(){if(n.length===0)return"''";if(!e.noCompatMode&&us.indexOf(n)!==-1)return"'"+n+"'";var r=e.indent*Math.max(1,t),o=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-r),a=i||e.flowLevel>-1&&t>=e.flowLevel;function s(l){return ms(e,l)}switch(bs(n,a,e.indent,o,s)){case bt:return n;case _t:return"'"+n.replace(/'/g,"''")+"'";case vt:return"|"+Rn(n,e.indent)+On(Mn(n,r));case wt:return">"+Rn(n,e.indent)+On(Mn(vs(n,o),r));case we:return'"'+ws(n)+'"';default:throw new fe("impossible error: invalid scalar style")}}()}function Rn(e,n){var t=yt(e)?String(n):"",i=e[e.length-1]===`
`,r=i&&(e[e.length-2]===`
`||e===`
`),o=r?"+":i?"":"-";return t+o+`
`}function On(e){return e[e.length-1]===`
`?e.slice(0,-1):e}function vs(e,n){for(var t=/(\n+)([^\n]*)/g,i=function(){var c=e.indexOf(`
`);return c=c!==-1?c:e.length,t.lastIndex=c,Fn(e.slice(0,c),n)}(),r=e[0]===`
`||e[0]===" ",o,a;a=t.exec(e);){var s=a[1],l=a[2];o=l[0]===" ",i+=s+(!r&&!o&&l!==""?`
`:"")+Fn(l,n),r=o}return i}function Fn(e,n){if(e===""||e[0]===" ")return e;for(var t=/ [^ ]/g,i,r=0,o,a=0,s=0,l="";i=t.exec(e);)s=i.index,s-r>n&&(o=a>r?a:s,l+=`
`+e.slice(r,o),r=o+1),a=s;return l+=`
`,e.length-r>n&&a>r?l+=e.slice(r,a)+`
`+e.slice(a+1):l+=e.slice(r),l.slice(1)}function ws(e){for(var n="",t,i,r,o=0;o<e.length;o++){if(t=e.charCodeAt(o),t>=55296&&t<=56319&&(i=e.charCodeAt(o+1),i>=56320&&i<=57343)){n+=En((t-55296)*1024+i-56320+65536),o++;continue}r=R[t],n+=!r&&te(t)?e[o]:r||En(t)}return n}function xs(e,n,t){var i="",r=e.tag,o,a;for(o=0,a=t.length;o<a;o+=1)V(e,n,t[o],!1,!1)&&(o!==0&&(i+=","+(e.condenseFlow?"":" ")),i+=e.dump);e.tag=r,e.dump="["+i+"]"}function ks(e,n,t,i){var r="",o=e.tag,a,s;for(a=0,s=t.length;a<s;a+=1)V(e,n+1,t[a],!0,!0)&&((!i||a!==0)&&(r+=$e(e,n)),e.dump&&ce===e.dump.charCodeAt(0)?r+="-":r+="- ",r+=e.dump);e.tag=o,e.dump=r||"[]"}function Cs(e,n,t){var i="",r=e.tag,o=Object.keys(t),a,s,l,c,h;for(a=0,s=o.length;a<s;a+=1)h="",a!==0&&(h+=", "),e.condenseFlow&&(h+='"'),l=o[a],c=t[l],V(e,n,l,!1,!1)&&(e.dump.length>1024&&(h+="? "),h+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),V(e,n,c,!1,!1)&&(h+=e.dump,i+=h));e.tag=r,e.dump="{"+i+"}"}function As(e,n,t,i){var r="",o=e.tag,a=Object.keys(t),s,l,c,h,d,p;if(e.sortKeys===!0)a.sort();else if(typeof e.sortKeys=="function")a.sort(e.sortKeys);else if(e.sortKeys)throw new fe("sortKeys must be a boolean or a function");for(s=0,l=a.length;s<l;s+=1)p="",(!i||s!==0)&&(p+=$e(e,n)),c=a[s],h=t[c],V(e,n+1,c,!0,!0,!0)&&(d=e.tag!==null&&e.tag!=="?"||e.dump&&e.dump.length>1024,d&&(e.dump&&ce===e.dump.charCodeAt(0)?p+="?":p+="? "),p+=e.dump,d&&(p+=$e(e,n)),V(e,n+1,h,!0,d)&&(e.dump&&ce===e.dump.charCodeAt(0)?p+=":":p+=": ",p+=e.dump,r+=p));e.tag=o,e.dump=r||"{}"}function Nn(e,n,t){var i,r,o,a,s,l;for(r=t?e.explicitTypes:e.implicitTypes,o=0,a=r.length;o<a;o+=1)if(s=r[o],(s.instanceOf||s.predicate)&&(!s.instanceOf||typeof n=="object"&&n instanceof s.instanceOf)&&(!s.predicate||s.predicate(n))){if(e.tag=t?s.tag:"?",s.represent){if(l=e.styleMap[s.tag]||s.defaultStyle,lt.call(s.represent)==="[object Function]")i=s.represent(n,l);else if(ct.call(s.represent,l))i=s.represent[l](n,l);else throw new fe("!<"+s.tag+'> tag resolver accepts not "'+l+'" style');e.dump=i}return!0}return!1}function V(e,n,t,i,r,o){e.tag=null,e.dump=t,Nn(e,t,!1)||Nn(e,t,!0);var a=lt.call(e.dump);i&&(i=e.flowLevel<0||e.flowLevel>n);var s=a==="[object Object]"||a==="[object Array]",l,c;if(s&&(l=e.duplicates.indexOf(t),c=l!==-1),(e.tag!==null&&e.tag!=="?"||c||e.indent!==2&&n>0)&&(r=!1),c&&e.usedDuplicates[l])e.dump="*ref_"+l;else{if(s&&c&&!e.usedDuplicates[l]&&(e.usedDuplicates[l]=!0),a==="[object Object]")i&&Object.keys(e.dump).length!==0?(As(e,n,e.dump,r),c&&(e.dump="&ref_"+l+e.dump)):(Cs(e,n,e.dump),c&&(e.dump="&ref_"+l+" "+e.dump));else if(a==="[object Array]"){var h=e.noArrayIndent&&n>0?n-1:n;i&&e.dump.length!==0?(ks(e,h,e.dump,r),c&&(e.dump="&ref_"+l+e.dump)):(xs(e,h,e.dump),c&&(e.dump="&ref_"+l+" "+e.dump))}else if(a==="[object String]")e.tag!=="?"&&_s(e,e.dump,n,o);else{if(e.skipInvalid)return!1;throw new fe("unacceptable kind of an object to dump "+a)}e.tag!==null&&e.tag!=="?"&&(e.dump="!<"+e.tag+"> "+e.dump)}return!0}function Ts(e,n){var t=[],i=[],r,o;for(je(e,t,i),r=0,o=i.length;r<o;r+=1)n.duplicates.push(t[i[r]]);n.usedDuplicates=new Array(o)}function je(e,n,t){var i,r,o;if(e!==null&&typeof e=="object")if(r=n.indexOf(e),r!==-1)t.indexOf(r)===-1&&t.push(r);else if(n.push(e),Array.isArray(e))for(r=0,o=e.length;r<o;r+=1)je(e[r],n,t);else for(i=Object.keys(e),r=0,o=i.length;r<o;r+=1)je(e[i[r]],n,t)}function xt(e,n){n=n||{};var t=new fs(n);return t.noRefs||Ts(e,t),V(t,0,e,!0,!0)?t.dump+`
`:""}function Ss(e,n){return xt(e,pe.extend({schema:Va},n))}ze.dump=xt;ze.safeDump=Ss;var Le=de,kt=ze;function Re(e){return function(){throw new Error("Function "+e+" is deprecated and cannot be used.")}}T.Type=M;T.Schema=ie;T.FAILSAFE_SCHEMA=Ye;T.JSON_SCHEMA=Yn;T.CORE_SCHEMA=Wn;T.DEFAULT_SAFE_SCHEMA=ue;T.DEFAULT_FULL_SCHEMA=Ee;T.load=Le.load;T.loadAll=Le.loadAll;T.safeLoad=Le.safeLoad;T.safeLoadAll=Le.safeLoadAll;T.dump=kt.dump;T.safeDump=kt.safeDump;T.YAMLException=he;T.MINIMAL_SCHEMA=Ye;T.SAFE_SCHEMA=ue;T.DEFAULT_SCHEMA=Ee;T.scan=Re("scan");T.parse=Re("parse");T.compose=Re("compose");T.addConstructor=Re("addConstructor");var Is=T,Es=Is;function Ms(e){if(!e.startsWith(`---
`))return{data:{},content:e};const n=e.indexOf(`
---`,4);if(n===-1)return{data:{},content:e};const t=e.slice(4,n),i=e.slice(n+4),r=i.startsWith(`
`)?i.slice(1):i;return{data:Es.safeLoad(t)??{},content:r}}function Ls(e){const n={settings:{player:{name:"Captain",startingCredits:0},startingLocation:{system:"",destination:""},startingShip:""},systems:[],destinations:[],routes:[],drives:[],ships:[],factions:[],commodities:[],storyBeats:[]};for(const[t,i]of Object.entries(e)){const r=t.split("/").pop()??"";if(r==="_template.md"||r===".gitkeep")continue;const{data:o,content:a}=Ms(i);/^systems\/[^/]+\.md$/.test(t)?n.systems.push(Rs(o,a)):/^destinations\/[^/]+\.md$/.test(t)?n.destinations.push(Os(o,a)):/^factions\/[^/]+\.md$/.test(t)?n.factions.push(Fs(o,a)):/^ships\/[^/]+\.md$/.test(t)?n.ships.push(Ns(o,a)):t==="ships/components/jump-drives.md"?n.drives=Ds(o):t==="navigation/jump-routes.md"?n.routes=Ps(o):t==="commodities.md"?n.commodities=Us(o):/^story\/[^/]+\.md$/.test(t)?n.storyBeats.push(Hs(o,a)):t==="game-settings.md"&&(n.settings=Bs(o))}return n}function Oe(e){const n=[];let t=!1;for(const i of e.split(`
`)){const r=i.trim();if(!r.startsWith("#"))if(r===""){if(t)break}else t=!0,n.push(r)}return n.join(" ")}function Rs(e,n){return{id:e.id,name:e.name,starType:e.star_type,distanceFromSol:e.distance_from_sol,zone:e.zone,security:e.security,population:e.population,dangerLevel:e.danger_level,playerKnowledge:e.player_knowledge,economy:e.economy??[],majorFactions:e.major_factions??[],destinations:e.destinations??[],tags:e.tags??[],description:Oe(n)}}function Os(e,n){const t=e.amenities??{},i={trader:t.trader??!1,missionBoard:t.mission_board??!1,shipRepair:t.ship_repair??!1,fuel:t.fuel??!1,shipDealer:t.ship_dealer??!1};return{id:e.id,name:e.name,system:e.system,locationType:e.location_type,type:e.type,amenities:i,npcs:e.npcs??{},goodsBias:e.goods_bias??[],dangerLevel:e.danger_level,tags:e.tags??[],description:Oe(n)}}function Fs(e,n){return{id:e.id,name:e.name,type:e.type,homeSystem:e.home_system,size:e.size,influence:e.influence??[],tags:e.tags??[],description:Oe(n)}}function Ns(e,n){return{id:e.id,name:e.name,class:e.class,cost:e.cost,cargoCapacityKg:e.cargo_capacity_kg,fuelCapacityL:e.fuel_capacity_l,hullPoints:e.hull_points,defaultJumpDrive:e.default_jump_drive,tags:e.tags??[],description:Oe(n)}}function Ds(e){return(e.drives??[]).map(t=>({id:t.id,name:t.name,maxDistanceLy:t.max_distance_ly,fuelEfficiency:t.fuel_efficiency,cost:t.cost}))}function Ps(e){return(e.routes??[]).map(t=>({from:t.from,to:t.to,distance:t.distance,stability:t.stability,security:t.security}))}function Us(e){return(e.commodities??[]).map(t=>({id:t.id,name:t.name,basePrice:t.base_price,category:t.category,legal:t.legal,weightKg:t.weight_kg,description:t.description??""}))}function Hs(e,n){return{id:e.id,title:e.title,trigger:e.trigger,type:e.type,location:e.location,skippable:e.skippable,playerKnowledge:e.player_knowledge,text:n.trim()}}function Bs(e){var n,t,i,r;return{player:{name:((n=e.player)==null?void 0:n.name)??"Captain",startingCredits:((t=e.player)==null?void 0:t.starting_credits)??0},startingLocation:{system:((i=e.starting_location)==null?void 0:i.system)??"",destination:((r=e.starting_location)==null?void 0:r.destination)??""},startingShip:e.starting_ship??""}}function $s(){const e=Object.assign({"/docs/world/commodities.md":Pi,"/docs/world/destinations/_template.md":Ui,"/docs/world/destinations/blackwake-yard.md":Hi,"/docs/world/destinations/ceti-landfall.md":Bi,"/docs/world/destinations/drift-market.md":$i,"/docs/world/destinations/elysium-station.md":ji,"/docs/world/destinations/eridani-anchorage.md":Gi,"/docs/world/destinations/foundries-platform.md":Yi,"/docs/world/destinations/galileo-transfer.md":Wi,"/docs/world/destinations/hestia-ring.md":Ki,"/docs/world/destinations/keelhaul-station.md":qi,"/docs/world/destinations/kepler-yard.md":zi,"/docs/world/destinations/mars-anchor.md":Vi,"/docs/world/destinations/meridian-station.md":Ji,"/docs/world/destinations/new-horizon-port.md":Qi,"/docs/world/destinations/orrery-anchorage.md":Xi,"/docs/world/destinations/redline-station.md":Zi,"/docs/world/destinations/tycho-orbital.md":er,"/docs/world/destinations/veil-station.md":nr,"/docs/world/destinations/waypoint-ceti.md":tr,"/docs/world/factions/_template.md":ir,"/docs/world/factions/centauri-trade-league.md":rr,"/docs/world/factions/eridani-colonial-council.md":or,"/docs/world/factions/free-captains.md":ar,"/docs/world/factions/grey-market-cartel.md":sr,"/docs/world/factions/helios-directorate.md":lr,"/docs/world/factions/independent-miners-guild.md":cr,"/docs/world/factions/procyon-institute.md":dr,"/docs/world/factions/terran-union.md":hr,"/docs/world/galaxy-map.md":ur,"/docs/world/game-settings.md":pr,"/docs/world/navigation/jump-routes.md":fr,"/docs/world/ships/_template.md":mr,"/docs/world/ships/components/jump-drives.md":gr,"/docs/world/ships/freighter.md":yr,"/docs/world/ships/hauler.md":br,"/docs/world/ships/scout.md":_r,"/docs/world/story/_template.md":vr,"/docs/world/story/enter-wolf-359.md":wr,"/docs/world/story/first-jump.md":xr,"/docs/world/story/opening-arrival.md":kr,"/docs/world/systems/_template.md":Cr,"/docs/world/systems/alpha-centauri.md":Ar,"/docs/world/systems/barnards-star.md":Tr,"/docs/world/systems/epsilon-eridani.md":Sr,"/docs/world/systems/procyon.md":Ir,"/docs/world/systems/sirius.md":Er,"/docs/world/systems/sol.md":Mr,"/docs/world/systems/tau-ceti.md":Lr,"/docs/world/systems/wolf-359.md":Rr}),n={};for(const[t,i]of Object.entries(e)){const r=t.replace("/docs/world/","");n[r]=i}return Ls(n)}Ht($s());const js=navigator.maxTouchPoints>0?"touch":"keyboard",Gs=new URLSearchParams(window.location.search).has("debug"),Ct={environment:"browser",primaryInput:js,debug:Gs},Ys=new Mt,At=new Ft(Ct);At.connect();const Ws=new Di(Ys,At,Ct);let Dn=0;function Tt(e){Ws.tick(e-Dn),Dn=e,requestAnimationFrame(Tt)}requestAnimationFrame(Tt);
