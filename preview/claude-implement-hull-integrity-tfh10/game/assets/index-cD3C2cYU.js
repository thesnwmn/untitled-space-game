...
You received ${k.reward} CR.${sn}`,confirmLabel:"OKAY",onConfirm:()=>{this.closeModal(),this.onHub()}}))}}}effectiveFuelPrice(){const e=B(),t=e.fuel.pricePerLitre;if(!this.eligibleFactionId)return t;const i=Se(this.player.getFactionReputation(this.eligibleFactionId),e);return Math.round(t*Gn(i,e))}activateCurrent(){const e=this.items;if(e.length===0||this.cursorIdx===-1)return;const t=e[this.cursorIdx];if(!t.disabled){if(this.fuelItemIdx!==null&&this.cursorIdx===this.fuelItemIdx){this.activated=!0;const i=this.effectiveFuelPrice(),r=this.player.fuelCapacityL-this.player.fuelL,o=Math.floor(this.player.credits/i),s=Math.min(r,o);this.openModal(new bn({title:"BUY FUEL",field:{label:"Litres",initialValue:s,min:0,max:s},derivedRows:[{label:"Cost",compute:a=>`${a*i} CR`}],confirmLabel:"BUY",onConfirm:a=>{this.closeModal(),a>0&&this.onRefuel(a*i,a)},onCancel:()=>{this.closeModal(),this.activated=!1}}));return}this.activated=!0,t.action()}}handleNavAction(e){(e==="BACK"||e==="NAV_1")&&!this.activated&&(this.activated=!0,this.onShip())}handleNavTap(e){e==="undock"&&!this.activated&&(this.activated=!0,this.onShip())}}class cr extends de{constructor(e,t,i,r,o,s,a,l,c,d){var g;const h=N(r),p=((g=h.npcs.trader)==null?void 0:g.toUpperCase())??"TRADER",u=[{label:"BUY",items:[]},{label:"SELL",items:[]}];super(p,[],[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,t,i,[],u,d),this.repGainedThisVisit=0,this.traderStock=o,this.onBuy=s,this.onSell=a,this.onHub=l,this.onUndock=c;const m=h.owningFactionId;if(m){const y=$t(m);this.eligibleFactionId=y&&he(y)?m:null}else this.eligibleFactionId=null;this.syncItems(),this.clampCursor()}buyPrice(e,t){return Math.round(e*t)}sellPrice(e,t){return Math.round(e*t)}buildBuyItems(){return this.traderStock.length===0?[{label:"NO STOCK AVAILABLE",disabled:!0,action:()=>{}}]:this.traderStock.flatMap(e=>{const t=ae(e.commodityId);if(!t)return[];const i=e.effectiveFactor??1,r=this.buyPrice(t.basePrice,i),o=this.player.credits>=r;return[{label:`${t.name} (x${e.qty})`,info:`${r} CR`,disabled:!o,action:()=>{const s=Math.floor(this.player.credits/r),a=Math.min(e.qty,s);this.openModal(new bn({title:t.name.toUpperCase(),field:{label:"Quantity",initialValue:a,min:0,max:a},derivedRows:[{label:"Total",compute:l=>`${l*r} CR`}],confirmLabel:"BUY",onConfirm:l=>{l>0&&(this.onBuy(e.commodityId,l,r),this.accrueReputation(l*r)),this.syncItems(),this.clampCursor(),this.closeModal()},onCancel:()=>this.closeModal()}))}}]})}buildSellItems(){const e=this.player.cargoHold;return e.length===0?[{label:"CARGO HOLD EMPTY",disabled:!0,action:()=>{}}]:[...e].flatMap(t=>{const i=ae(t.commodityId);if(!i)return[];const r=N(this.player.destinationId??""),o=Z(r.system),s=Ve(t.commodityId,o),a=this.sellPrice(i.basePrice,s);return[{label:`${i.name} (x${t.qty})`,info:`${a} CR`,action:()=>{this.openModal(new bn({title:i.name.toUpperCase(),field:{label:"Quantity",initialValue:t.qty,min:0,max:t.qty},derivedRows:[{label:"Total",compute:l=>`${l*a} CR`}],confirmLabel:"SELL",onConfirm:l=>{l>0&&this.onSell(t.commodityId,l,a),this.syncItems(),this.clampCursor(),this.closeModal()},onCancel:()=>this.closeModal()}))}}]})}accrueReputation(e){if(!this.eligibleFactionId)return;const t=B(),i=t.reputation.maxRepPerVisit-this.repGainedThisVisit;if(i<=0)return;const r=Math.min(i,e*t.reputation.repPerCredit);r<=0||(this.repGainedThisVisit+=r,this.player.modifyFactionReputation(this.eligibleFactionId,r,t))}syncItems(){this.tabs&&(this.tabs[0].items=this.buildBuyItems(),this.tabs[1].items=this.buildSellItems())}clampCursor(){var t;const e=this.items;(this.cursorIdx<0||this.cursorIdx>=e.length||(t=e[this.cursorIdx])!=null&&t.disabled)&&(this.cursorIdx=e.findIndex(i=>!i.disabled))}activateCurrent(){const e=this.items;if(e.length===0||this.cursorIdx<0||this.cursorIdx>=e.length)return;const t=e[this.cursorIdx];t.disabled||t.action()}handleNavAction(e){(e==="BACK"||e==="NAV_2")&&!this.activated?(this.activated=!0,this.onHub()):e==="NAV_1"&&!this.activated&&(this.activated=!0,this.onUndock())}handleNavTap(e){e==="hub"&&!this.activated?(this.activated=!0,this.onHub()):e==="undock"&&!this.activated&&(this.activated=!0,this.onUndock())}render(e){if(this.syncItems(),super.render(e),this.eligibleFactionId){const r=B(),o=this.player.getFactionReputation(this.eligibleFactionId),s=Se(o,r),l=`STANDING: ${Gt(s)}`;f(e,le+2,2,l,"bright-black","black")}const t=e.length,i=Cn(t,!0)-2;f(e,i,2,`HOLD: ${this.player.cargoWeightKg}/${this.player.cargoCapacity}KG`,"bright-black","black")}}const dr={delivery:"[D] ",supply:"[S] "};class me extends de{constructor(e,t,i,r,o,s,a,l,c){N(r);let d;o.length===0?d=[{label:"NO MISSIONS AVAILABLE",disabled:!0,action:()=>{}}]:d=me.sortMissions(o).map(p=>me.buildMenuItem(p,i,s)),super("MISSION BOARD",d,[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,t,i,[],null,c),this.onHub=a,this.onUndock=l}handleNavAction(e){(e==="BACK"||e==="NAV_2")&&!this.activated?(this.activated=!0,this.onHub()):e==="NAV_1"&&!this.activated&&(this.activated=!0,this.onUndock())}handleNavTap(e){e==="hub"&&!this.activated?(this.activated=!0,this.onHub()):e==="undock"&&!this.activated&&(this.activated=!0,this.onUndock())}static sortMissions(e){return[...e].sort((t,i)=>{var l,c;const r=((l=N(t.deliveryDestinationId))==null?void 0:l.name)??t.deliveryDestinationId,o=((c=N(i.deliveryDestinationId))==null?void 0:c.name)??i.deliveryDestinationId,s=r.localeCompare(o);if(s!==0)return s;const a={delivery:0,supply:1};return a[t.type]-a[i.type]})}static destColor(e,t){if(e===t.destinationId)return"bright-green";const i=N(e);return i&&i.system===t.systemId?"bright-yellow":"white"}static buildMenuItem(e,t,i){const r=N(e.deliveryDestinationId),o=(r==null?void 0:r.name)??e.deliveryDestinationId,s=[];if(s.push(`Dest: ${o}`),e.giverFactionId){const l=F().factions.find(c=>c.id===e.giverFactionId);l&&s.push(`For: ${l.name}`)}e.type!=="supply"&&s.push("");const a=e.type==="supply"?me.buildSupplyDetails(e,t):[];return{label:e.title,icon:dr[e.type],iconFg:"bright-yellow",info:`${e.reward} CR`,infoFg:"bright-green",details:s,detailsFg:me.destColor(e.deliveryDestinationId,t),detailsColored:a,action:()=>i(e)}}static buildSupplyDetails(e,t){if(e.type!=="supply")return[];const i=e.requirements.map(r=>{const o=F().commodities.find(d=>d.id===r.commodityId),s=(o==null?void 0:o.name)??r.commodityId,a=t.cargoHold.find(d=>d.commodityId===r.commodityId),l=(a==null?void 0:a.qty)??0,c=l>=r.qty;return{left:[{text:`${r.qty}x ${s} `,fg:"white"},{text:`(have: ${l})`,fg:c?"bright-green":"bright-black"}]}});return i.push({left:[]}),i}}class hr extends te{constructor(e,t,i,r,o,s,a){super(o,s,a,{navOptions:r,title:e}),this.cursorIdx=-1,this.lastChoicesStartRow=0,this._choices=t,this._onBack=i,this.resetCursor()}preHandleAction(e){return e==="BACK"?(this.activated=!0,this._onBack(),!0):!1}handleAction(e){e==="UP"?this.moveCursor(-1):e==="DOWN"?this.moveCursor(1):e==="SELECT"&&this.activateCurrent()}handleTap(e,t){const i=this.rowToChoiceIndex(t);i!==null&&!this._choices[i].disabled&&(this.cursorIdx=i,this.activateCurrent())}moveCursor(e){const t=this._choices,i=t.length;if(i===0)return;const r=this.cursorIdx===-1?e>0?i-1:0:this.cursorIdx;for(let o=0;o<i;o++){const s=((r+e*(o+1))%i+i)%i;if(!t[s].disabled){this.cursorIdx=s;return}}}activateCurrent(){if(this._choices.length===0||this.cursorIdx===-1)return;const e=this._choices[this.cursorIdx];e.disabled||(this.activated=!0,e.action())}resetCursor(){const e=this._choices;for(let t=0;t<e.length;t++)if(!e[t].disabled){this.cursorIdx=t;return}this.cursorIdx=-1}computeChoicesHeight(){var t;let e=0;for(const i of this._choices)e+=1+(((t=i.details)==null?void 0:t.length)??0);return e}rowToChoiceIndex(e){var i;if(e<this.lastChoicesStartRow)return null;let t=this.lastChoicesStartRow;for(let r=0;r<this._choices.length;r++){const o=1+(((i=this._choices[r].details)==null?void 0:i.length)??0);if(e>=t&&e<t+o)return r;t+=o}return null}render(e){const t=e.length,i=t>0?e[0].length:0;for(let m=0;m<t;m++)for(let g=0;g<i;g++)e[m][g]={char:" ",fg:"black",bg:"black"};const r=this.buildChromeConfig();this.chrome.render(e,r);const o=!0,s=le,a=Cn(t,o),l=this.opts.title;l!==void 0&&(f(e,s,2,l,"bright-white","black"),f(e,s+1,2,"'".repeat(l.length),"bright-black","black"));const c=s+2,d=this.computeChoicesHeight(),h=a-d-1,p=h-1;this.renderContent(e,c,p),h>=0&&h<t&&pe(e,h,i);let u=h+1;this.lastChoicesStartRow=u;for(let m=0;m<this._choices.length;m++){const g=this._choices[m],y=m===this.cursorIdx,x=y?">":" ",E=g.disabled?"bright-black":y?"bright-green":"white";if(u<t&&(f(e,u,2,x,E,"black"),f(e,u,3,g.label,E,"black")),u++,g.details)for(const b of g.details)u<t&&f(e,u,4,b.slice(0,i-4),"bright-black","black"),u++}}}const ur={delivery:"[D]",supply:"[S]"};class pr extends hr{constructor(e,t,i,r,o,s,a,l){const c=Qi(i,r),d=r.type==="delivery"&&r.pickupDestinationId===r.issuingDestinationId,h=c.ok?{label:"ACCEPT MISSION",action:()=>o(d)}:{label:"ACCEPT MISSION",disabled:!0,details:c.reason?[c.reason]:[],action:()=>{}},p={label:"BACK",action:()=>s()};super("MISSION BOARD",[h,p],s,[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,t,i),this.spec=r,this.onHub=a,this.onUndock=l}destColor(e){if(e===this.player.destinationId)return"bright-green";const t=N(e);return t&&t.system===this.player.systemId?"bright-yellow":"white"}writeDestRow(e,t,i,r,o,s){f(e,t,2,i,"white","black"),f(e,t,2+i.length,r.slice(0,s-i.length),this.destColor(o),"black")}handleAction(e){e==="NAV_1"?(this.activated=!0,this.onUndock()):e==="NAV_2"?(this.activated=!0,this.onHub()):super.handleAction(e)}handleNavTap(e){this.activated||(e==="undock"?(this.activated=!0,this.onUndock()):e==="hub"&&(this.activated=!0,this.onHub()))}renderContent(e,t,i){this.renderDetail(e,t,i)}renderDetail(e,t,i){const o=e.length>0?e[0].length:40,s=o-4;let a=t;const l=(u,m,g)=>{u<=i&&f(e,u,2,m.slice(0,s),g,"black")};l(a,`${ur[this.spec.type]} ${this.spec.title}`,"bright-yellow"),a++;const c=F(),d=this.spec.giverFactionId?c.factions.find(u=>u.id===this.spec.giverFactionId):null,h=d?` [${d.name}]`:"";if(l(a,`    ${this.spec.giverName}${h}`,"bright-black"),a++,a++,this.spec.type==="delivery"){const u=N(this.spec.pickupDestinationId),m=N(this.spec.deliveryDestinationId);if(a<=i&&this.writeDestRow(e,a,"Pickup:  ",(u==null?void 0:u.name)??this.spec.pickupDestinationId,this.spec.pickupDestinationId,s),a++,a<=i&&this.writeDestRow(e,a,"Deliver: ",(m==null?void 0:m.name)??this.spec.deliveryDestinationId,this.spec.deliveryDestinationId,s),a++,a<=i){const g=this.player.cargoCapacity-this.player.cargoWeightKg,y=this.spec.itemWeightKg,x=g>=y,E=`Weight:  ${y} kg  (Free: ${g} kg)`;f(e,a,2,E,"white","black");const b=x?"bright-green":"red",M=2+E.length+1;M<o&&f(e,a,M,x?"✓":"✗",b,"black")}a++}else{const u=N(this.spec.deliveryDestinationId);a<=i&&this.writeDestRow(e,a,"Deliver to: ",(u==null?void 0:u.name)??this.spec.deliveryDestinationId,this.spec.deliveryDestinationId,s),a++;for(const m of this.spec.requirements){if(a>i)break;const g=ae(m.commodityId);l(a,`  ${m.qty}x ${(g==null?void 0:g.name)??m.commodityId}`,"white"),a++}}a++;const p=Ze(this.spec.description,s);for(const u of p){if(a>i)break;l(a,u,"white"),a++}if(a++,!(a>i)&&(l(a,`REWARD: ${this.spec.reward} CR`,"bright-green"),a++,this.spec.type==="delivery"&&this.spec.deposit>0&&(a<=i&&l(a,`DEPOSIT: ${this.spec.deposit} CR`,"bright-yellow"),a++),this.spec.giverFactionId)){const u=c.factions.find(m=>m.id===this.spec.giverFactionId);if(u){const m=B(),g=this.spec.reward;let y;g>=m.reputation.missionTierLargeReward?y=m.reputation.missionDeltaLarge:g>=m.reputation.missionTierMediumReward?y=m.reputation.missionDeltaMedium:y=m.reputation.missionDeltaSmall;const x=Mn(u,y,c.factions),E=[];for(const[b,M]of x){const v=c.factions.find(C=>C.id===b);v&&E.push({id:b,name:v.name,delta:M})}if(E.sort((b,M)=>b.delta!==M.delta?M.delta-b.delta:b.name.localeCompare(M.name)),E.length>0){if(a++,a>i)return;const b=i-1;a<=b&&(l(a,"REPUTATION IMPACT","bright-cyan"),a++);for(const M of E){if(a>b)break;const v=Tn(M.delta),C=M.delta>0?"bright-green":"red",_=s-v.length-2,R=M.name.slice(0,_),D=" ".repeat(Math.max(0,s-R.length-v.length-2));l(a,`  ${R}${D}${v}`,C),a++}}}}}}function mr(n){if(n.length===0)return 2166136261;let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619)>>>0;return e===0?1:e}const fr=[30,10,5],gr=[".","*","+"],jn=[4e3,2e3,800],yr=[9e3,5e3,2500],_r=[null,"bright-black","white"],br=["bright-black","white","bright-white"],vr=["white","bright-white","bright-cyan"],Ue=3,Kn=25,He=2,Yn=37,qn=2*Math.PI;function wr(n){let e=n>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}class kr{constructor(e=42){this.boundsSet=!1,this.rand=wr(e),this.stars=[];for(let t=0;t<3;t++)for(let i=0;i<fr[t];i++){const r=He+Math.floor(this.rand()*(Yn-He+1)),o=Ue+Math.floor(this.rand()*(Kn-Ue+1)),s=this.rand()*qn,a=jn[t]+this.rand()*(yr[t]-jn[t]);this.stars.push({col:r,row:o,layer:t,twinklePhase:s,twinklePeriod:a})}}update(e){for(const t of this.stars)t.twinklePhase+=qn/t.twinklePeriod*e}render(e,t,i,r,o){if(!this.boundsSet){this.boundsSet=!0;const s=Kn-Ue,a=Yn-He;{const l=(i-t)/s,c=(o-r)/a;for(const d of this.stars)d.row=Math.round(t+(d.row-Ue)*l),d.col=Math.round(r+(d.col-He)*c)}}for(const s of this.stars){const{row:a,col:l,layer:c}=s;if(a<t||a>i||l<r||l>o)continue;const d=Math.sin(s.twinklePhase);let h;d>=.5?h=vr[c]:d>=-.5?h=br[c]:h=_r[c],h!==null&&(e[a][l]={char:gr[c],fg:h,bg:"black"})}}getStars(){return this.stars}}const xr=2,Cr=3,Tr=2*Math.PI/9e3,Mr=2*Math.PI/12e3,Ir=Math.PI/3;function Vn(n,e,t){return Math.max(e,Math.min(t,n))}class Sr{constructor(e,t,i,r,o,s=.5,a=.6){this.time=0,this.glyph=e,this.intRowStart=t,this.intRowEnd=i,this.intColStart=r,this.intColEnd=o,this.glyphHeight=e.rows.length,this.glyphWidth=Math.max(...e.rows.map(l=>l.length)),this.anchorRow=t+Math.floor((i-t)*s)-Math.floor(this.glyphHeight/2),this.anchorCol=r+Math.floor((o-r)*a)-Math.floor(this.glyphWidth/2)}update(e){this.time+=e}getDisplayPosition(){const e=Math.round(xr*Math.sin(this.time*Tr)),t=Math.round(Cr*Math.sin(this.time*Mr+Ir)),i=Vn(this.anchorRow+e,this.intRowStart,this.intRowEnd-this.glyphHeight+1),r=Vn(this.anchorCol+t,this.intColStart,this.intColEnd-this.glyphWidth+1);return{row:i,col:r}}render(e){const{row:t,col:i}=this.getDisplayPosition(),r=this.glyph.fg;for(let o=0;o<this.glyph.rows.length;o++){const s=this.glyph.rows[o];let a=-1,l=-1;for(let c=0;c<s.length;c++)s[c]!==" "&&(a===-1&&(a=c),l=c);if(a!==-1)for(let c=a;c<=l;c++){const d=s[c],h=t+o,p=i+c;h>=0&&h<e.length&&p>=0&&p<e[h].length&&(e[h][p]=d===" "?{char:" ",fg:"black",bg:"black"}:{char:d,fg:r,bg:"black"})}}}}const zn=[{rows:[">---<"," |*| ","  |  "],fg:"bright-white"},{rows:["/-\\","|O|","\\-/"],fg:"cyan"},{rows:["  *  ","--+--"," [H] ","  |  ","  *  "],fg:"bright-white"}],Qn=[{rows:[" /\\/\\","< ** >"," \\__/"],fg:"yellow"},{rows:["  ___"," /   \\","|  .  |"," \\___/"],fg:"yellow"},{rows:[" _/\\_","/  . \\","\\____/"],fg:"yellow"}],Xn=[{rows:["  .--."," / .. \\","| .... |"," \\ .. /","  `--'"],fg:"blue"},{rows:["  .--."," / ~~ \\","| ~~~~ |"," \\ ~~ /","  `--'"],fg:"bright-yellow"},{rows:["  .--."," /====\\","|======|"," \\====/","  `--'"],fg:"bright-cyan"}];function Ar(n,e){return n==="orbital"||n==="deep-space"?zn[e%zn.length]:n==="asteroid"?Qn[e%Qn.length]:n==="surface"?Xn[e%Xn.length]:null}const Er=6,cn=6,Rr=23,Lr=23,dn=10,Fr=0,Dr=4,Nr=18,Or=21,Pr=35,Br=39,Jn=12,Ur=11,re=13,xe=27,hn=28,Hr=12,un=40,Zn=200,pn=["> SYSTEM STATUS: ALL CLEAR","> DRIVE EFFICIENCY: 97%","> BEACON SIGNAL DETECTED ON 14.7 MHz","> TRADE ROUTE UPDATE: ELYSIUM CORRIDOR STABLE","> WARNING: DEBRIS FIELD DELTA-9 ACTIVE","> COMMS RELAY SIGNAL NOMINAL","> FUEL RESERVES OPTIMAL","> SECTOR SCAN COMPLETE — NO HOSTILES","> GRAVITATIONAL ANOMALY LOGGED AT BEARING 227","> TRANSPONDER HANDSHAKE: ACCEPTED"],$r="#",et=["green","cyan","white","yellow"],nt=["*",".","+","x"];function tt(n){return n>=.8?"bright-green":n>=.5?"yellow":"red"}function it(n){let e=n>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}function Gr(n,e,t){return{col:e,row:t,char:$r,color:et[Math.floor(n()*et.length)],phase:n()*2e4,period:1e4+n()*1e4,active:n()>.2}}function Ce(n,e,t,i){const r=[];for(const o of i)for(let s=e;s<=t;s++)r.push(Gr(n,s,o));return r}class Wr extends te{constructor(e,t,i,r,o,s,a){var u;super(e,t,i,{navOptions:[],onMenu:a}),this.cursorIdx=0,this.h=30,this.destObject=null,this.blinkPhase=0,this.msgIdx=0,this.tickerScroll=0,this.tickerAccum=0,this.tickerPause=0,this.onTravel=r,this.onDock=o,this.onCargo=s;const l=mr(i.destinationId??"");this.starfield=new kr(l),this.inSpace=i.destinationId===null;const c=i.destinationId!=null?(u=N(i.destinationId))==null?void 0:u.locationType:void 0;this.destGlyph=Ar(c,l),this.destRowFrac=.15+Math.random()*.7,this.destColFrac=.15+Math.random()*.7;const d=it(99);this.gaugeBtns=[...Ce(d,Fr,Dr,[3,4]),...Ce(d,Nr,Or,[3,4]),...Ce(d,Pr,Br,[3,4])],this.leftBtns=Ce(d,0,Ur,[0,1,2,3]),this.rightBtns=Ce(d,hn,39,[0,1,2,3]);const h=it(77),p=3+Math.floor(h()*4);this.radarContacts=Array.from({length:p},()=>({x:h()*(xe-re-1),y:h()*4,vx:(h()-.5)*2,vy:(h()-.5)*1.5,char:nt[Math.floor(h()*nt.length)]}))}navCount(){return this.inSpace?1:2}handleAction(e){e==="CARGO"?(this.activated=!0,this.onCargo()):e==="UP"?this.cursorIdx=(this.cursorIdx-1+this.navCount())%this.navCount():e==="DOWN"?this.cursorIdx=(this.cursorIdx+1)%this.navCount():e==="SELECT"&&(this.cursorIdx===0?(this.activated=!0,this.onTravel()):this.inSpace||(this.activated=!0,this.onDock()))}handleTap(e,t){const i=this.h;(t===3||t===4)&&e>=cn&&e<cn+1+dn?(this.activated=!0,this.onCargo()):t===i-3&&e<Jn?(this.activated=!0,this.onTravel()):t===i-3&&e>=hn&&!this.inSpace&&(this.activated=!0,this.onDock())}update(e){var r;this.starfield.update(e),(r=this.destObject)==null||r.update(e),this.blinkPhase=(this.blinkPhase+e)%1e3;for(const o of[...this.gaugeBtns,...this.leftBtns,...this.rightBtns])o.phase+=e,o.phase>=o.period&&(o.phase-=o.period,o.active=!o.active);const t=xe-re,i=5;for(const o of this.radarContacts)o.x+=o.vx*e/1e3,o.y+=o.vy*e/1e3,o.x<0&&(o.x=-o.x,o.vx=-o.vx),o.x>t-1&&(o.x=2*(t-1)-o.x,o.vx=-o.vx),o.y<0&&(o.y=-o.y,o.vy=-o.vy),o.y>i-1&&(o.y=2*(i-1)-o.y,o.vy=-o.vy);if(this.tickerPause>0)this.tickerPause=Math.max(0,this.tickerPause-e);else for(this.tickerAccum+=e;this.tickerAccum>=Zn;){this.tickerAccum-=Zn,this.tickerScroll++;const o=pn[this.msgIdx];if(this.tickerScroll>=o.length+un-1){this.tickerScroll=0,this.msgIdx=(this.msgIdx+1)%pn.length,this.tickerPause=500,this.tickerAccum=0;break}}}renderContent(e,t,i){var h;const r=e.length,o=r>0?e[0].length:0;this.h=r;const s=t+2,a=r-8,l=r-7,c=r-3,d=r-2;this.renderGaugeStrip(e,t),this.starfield.render(e,s,a,0,39),!this.destObject&&this.destGlyph&&(this.destObject=new Sr(this.destGlyph,s+1,a-1,0,39,this.destRowFrac,this.destColFrac)),(h=this.destObject)==null||h.render(e);for(let p=0;p<o;p++)e[s][p]={char:"-",fg:"white",bg:"black"},e[a][p]={char:"-",fg:"white",bg:"black"};this.renderHUD(e,s+1),this.renderCrosshair(e,s+1,a-1),this.renderBottomPanels(e,l,c),this.renderTicker(e,d)}renderGaugeStrip(e,t){for(const a of this.gaugeBtns){const l=t+a.row-3,c=a.active?a.color:"bright-black";l>=0&&l<e.length&&(e[l][a.col]={char:a.char,fg:c,bg:"black"})}const i=this.player.fuelL/this.player.fuelCapacityL,r=this.player.cargoWeightKg/this.player.cargoCapacity,o=this.blinkPhase<500,s=tt(this.player.hullIntegrity);this.renderGauge(e,t,Er,"F",i,"yellow",o),this.renderGauge(e,t+1,cn,"C",r,"blue",o),this.renderGauge(e,t,Rr,"S",1,"cyan",o),this.renderGauge(e,t+1,Lr,"H",this.player.hullIntegrity,s,o)}renderGauge(e,t,i,r,o,s,a){if(t<0||t>=e.length)return;e[t][i]={char:r,fg:s,bg:"black"};const l=Math.round(Math.min(1,Math.max(0,o))*dn),c=o<=.2;for(let d=0;d<dn;d++){const h=i+1+d;if(d<l){const p=c&&!a?"bright-black":s;e[t][h]={char:" ",fg:"black",bg:p}}else e[t][h]={char:" ",fg:"black",bg:"bright-black"}}}renderHUD(e,t){f(e,t,1,"VEL:----","bright-black","black"),f(e,t,16,"ATT:---°","bright-black","black"),f(e,t,30,"ROT:--°","bright-black","black");const i=Math.round(this.player.hullIntegrity*100),r=tt(this.player.hullIntegrity),o=`HULL:${i.toString().padStart(3," ")}%`;f(e,t+1,1,o,r,"black")}renderCrosshair(e,t,i){var a;const r=Math.floor((t+i)/2),o=20;e[r][o]={char:"+",fg:"bright-green",bg:"black"};const s=[[r-3,o-5],[r-3,o+5],[r+3,o-5],[r+3,o+5]];for(const[l,c]of s){const d=((a=e[0])==null?void 0:a.length)??40;l>=t&&l<=i&&c>=0&&c<d&&(e[l][c]={char:"+",fg:"bright-green",bg:"black"})}}renderBottomPanels(e,t,i){for(let c=t;c<=i;c++)for(let d=re;d<xe;d++)e[c][d]={char:" ",fg:"black",bg:"bright-black"};this.renderRadar(e,t,i-t+1);for(const c of this.leftBtns){const d=t+c.row;if(d<i){const h=c.active?c.color:"bright-black";e[d][c.col]={char:c.char,fg:h,bg:"black"}}}for(const c of this.rightBtns){const d=t+c.row;if(d<i){const h=c.active?c.color:"bright-black";e[d][c.col]={char:c.char,fg:h,bg:"black"}}}const r=this.cursorIdx===0?"bright-yellow":"yellow";f(e,i,0,this.centerPad("TRAVEL",Jn),"black",r);let o,s;this.inSpace?(o="bright-black",s="bright-black"):(o=this.cursorIdx===1?"bright-cyan":"cyan",s="black"),f(e,i,hn,this.centerPad("DOCK",Hr),s,o);const a=xe-re,l="<)) "+"-".repeat(a-4);f(e,i,re,l,"white","bright-black")}renderRadar(e,t,i){for(const r of this.radarContacts){const o=Math.min(xe-re-1,Math.max(0,Math.floor(r.x))),s=Math.min(i-1,Math.max(0,Math.floor(r.y)));e[t+s][re+o]={char:r.char,fg:"white",bg:"bright-black"}}}renderTicker(e,t){const i=pn[this.msgIdx];for(let r=0;r<un;r++){const o=this.tickerScroll-un+1+r,s=o>=0&&o<i.length?i[o]:" ";e[t][r]={char:s,fg:"white",bg:"black"}}}centerPad(e,t){if(e.length>=t)return e.slice(0,t);const i=t-e.length,r=Math.floor(i/2);return" ".repeat(r)+e+" ".repeat(i-r)}}class jr extends te{constructor(e,t,i,r,o){super(e,t,i,{title:"CARGO HOLD",tabs:["COMMODITIES","MISSION GOODS"],navOptions:[{id:"back",label:"BACK"}],onMenu:o}),this.onBack=r}handleNavTap(e){e==="back"&&(this.activated=!0,this.onBack())}handleAction(e){(e==="BACK"||e==="CARGO")&&(this.activated=!0,this.onBack())}renderContent(e,t,i){const o=e.length>0?e[0].length:0,s=this.player.cargoHold,a=this.player.missionItems,l=this.player.cargoCapacity,c=this.player.cargoWeightKg,d=i-1;this.activeTabIdx===0?this.renderCommoditiesTab(e,t,d,o,s):this.renderMissionGoodsTab(e,t,d,o,a);const h=`CARGO: ${c}/${l}KG`,p=`FUEL: ${this.player.fuelL}/${this.player.fuelCapacityL}L`;f(e,d,2,h,"bright-black","black"),f(e,d,o-p.length-2,p,"bright-black","black")}renderCommoditiesTab(e,t,i,r,o){if(o.length===0){f(e,t,2,"NO COMMODITIES","bright-black","black");return}let s=t;for(const a of o){if(s>=i-1)break;const l=ae(a.commodityId);if(!l)continue;const c=a.qty*l.weightKg,d=`  x${a.qty}  ${l.basePrice}CR  ${c}KG`,h=Math.max(6,r-4-d.length),p=l.name,u=p.length>h?p.slice(0,h):p;f(e,s,2,`${u}${d}`,"white","black"),s++}}renderMissionGoodsTab(e,t,i,r,o){if(o.length===0){f(e,t,2,"NO MISSION GOODS","bright-black","black");return}let s=t;for(const a of o){if(s>=i-1)break;const l=`  ${a.weightKg}KG`,c=Math.max(6,r-4-l.length),d=a.itemName.length>c?a.itemName.slice(0,c):a.itemName;f(e,s,2,`${d}${l}`,"white","black"),s++}}}class rt extends de{constructor(e,t,i,r,o,s,a,l,c=()=>{},d){const h=Z(i.systemId),p=Ut(i.driveId),u=i.getInSystemHopCost(),m=i.fuelL<u,g=[...h.destinations.map(b=>({label:`${N(b).name.toUpperCase()}  [${u}L]`,disabled:b===i.destinationId||m,action:()=>r(b)})),{label:`FLY INTO SPACE  [${u}L]`,disabled:i.destinationId===null||m,action:s}];m&&d&&g.push({label:"[EMERGENCY]",disabled:!1,action:d});const x=[...xn(i.systemId).map(b=>{const M=b.from===i.systemId?b.to:b.from,v=Z(M),C=Math.ceil(B().fuel.consumptionPerLy*b.distance*p.fuelEfficiency);return{label:`${v.name.toUpperCase()}  ${b.distance}LY  [${C}L]`,disabled:C>i.fuelL,action:()=>o(M)}}),{label:"GALAXY MAP...",action:l}],E=[{label:"DESTINATIONS",items:g},{label:"JUMPS",items:x}];super("TRAVEL",[],[{id:"ship",label:"SHIP"}],e,t,i,[],E,c),this.onShip=a}handleNavAction(e){(e==="BACK"||e==="NAV_1")&&!this.activated&&(this.activated=!0,this.onShip())}handleNavTap(e){e==="ship"&&!this.activated&&(this.activated=!0,this.onShip())}}class Kr extends te{constructor(e,t,i,r,o,s){super(e,t,i,{navOptions:[],title:"EMERGENCY RESCUE"}),this.cursorIdx=0,this.onBack=s;const a=Z(i.systemId),l=B();if(this.options=[],this.fuelDestId=a.destinations.find(c=>{var d;return((d=N(c))==null?void 0:d.amenities.fuel)===!0}),this.fuelDestId){const c=N(this.fuelDestId);this.options.push({label:`TOW TO ${c.name.toUpperCase()}`,fee:l.emergencyRescue.towFee,action:()=>r(this.fuelDestId)})}this.options.push({label:"EMERGENCY FUEL DROP",fee:l.emergencyRescue.fuelDropFee,action:o}),this.options.push({label:"BACK",fee:0,action:s})}preHandleAction(e){return e==="BACK"?(this.activated=!0,this.onBack(),!0):!1}handleAction(e){e==="UP"?this.cursorIdx=(this.cursorIdx-1+this.options.length)%this.options.length:e==="DOWN"?this.cursorIdx=(this.cursorIdx+1)%this.options.length:e==="SELECT"&&this.cursorIdx>=0&&this.cursorIdx<this.options.length&&(this.activated=!0,this.options[this.cursorIdx].action())}handleTap(e,t){this.cursorIdx>=0&&this.cursorIdx<this.options.length&&(this.activated=!0,this.options[this.cursorIdx].action())}renderContent(e,t,i){const r=e.length,o=r>0?e[0].length:0,s=Z(this.player.systemId);let a;this.player.destinationId===null?a=`STRANDED IN SPACE NEAR ${s.name.toUpperCase()}`:a=`STRANDED AT ${N(this.player.destinationId).name.toUpperCase()}`,f(e,t,2,a,"bright-yellow","black");const l=t+2;pe(e,l,o);let c=l+1;for(let d=0;d<this.options.length;d++){const h=this.options[d],p=d===this.cursorIdx,u=p?">":" ",m=p?"bright-green":"white";if(c<r)if(f(e,c,2,u,m,"black"),h.fee===0)f(e,c,3,h.label,m,"black");else{f(e,c,3,h.label,m,"black");const g=this.player.credits-h.fee,y=`${h.fee} CR  (BALANCE: ${g>=0?"":"-"}${Math.abs(g)} CR)`,x=g<0?"bright-red":m;c+1<r&&f(e,c+1,4,y,x,"black"),c++}c++}}}function ot(n,e){if(n===e)return[n];const t=[[n]],i=new Set([n]);for(;t.length>0;){const r=t.shift(),o=r[r.length-1];for(const s of xn(o)){const a=s.from===o?s.to:s.from;if(a===e)return[...r,a];i.has(a)||(i.add(a),t.push([...r,a]))}}return null}const Yr=0,qr=4,Vr=8,zr=9,st=10,at=15,Qr=16,Xr=2,Jr=10,Zr=12,$e=13,Ge=12,eo=25,no=26,to=10,lt=18;function io(n,e){return n.length>=e?n.slice(0,e):n+" ".repeat(e-n.length)}function Te(n,e){return"["+io(n.toUpperCase(),e-2)+"]"}class ct extends te{constructor(e,t,i,r,o=()=>{},s){const a=s?[{id:"game",label:"GAME"},{id:"menu",label:"MENU"}]:[{id:"back",label:"BACK"}];super(e,t,i,{title:"GALAXY MAP",tabs:["MAP","ROUTE"],navOptions:a,onMenu:o}),this.mapCursorIdx=0,this.routeDestIdx=0,this.searchText="",this.lastTop=le+5,this.onBack=r,this.onGame=s,this.publicSystems=Ki().sort((l,c)=>l.distanceFromSol-c.distanceFromSol),this.otherSystems=this.publicSystems.filter(l=>l.id!==i.systemId),this.mapBrowsingSystemId=i.systemId}onTabChange(e){this.searchText=""}handleCharInput(e){if(this.activeTabIdx!==0)return;const t=e.charCodeAt(0);e==="\b"||e===""?this.searchText=this.searchText.slice(0,-1):t>=32&&t<127&&(this.searchText+=e.toUpperCase(),this.mapCursorIdx=0)}handleAction(e){if(e==="BACK"){if(this.searchText.length>0){this.searchText="";return}this.activated=!0,this.onBack();return}if(e==="NAV_1"){this.onGame&&(this.activated=!0,this.onGame());return}if(e==="NAV_2"){this.onGame&&(this.searchText="",this.activated=!0,this.onBack());return}this.activeTabIdx===0?this.handleMapAction(e):this.handleRouteAction(e)}handleNavTap(e){e==="back"?(this.searchText="",this.activated=!0,this.onBack()):e==="game"&&this.onGame?(this.activated=!0,this.onGame()):e==="menu"&&(this.searchText="",this.activated=!0,this.onBack())}handleTap(e,t){const i=this.lastTop,r=i+st,o=i+at;if(this.activeTabIdx===0&&t>=r&&t<o){const s=this.getMapNeighbors(),a=t-r;a>=0&&a<s.length&&(this.mapBrowsingSystemId=s[a].id,this.mapCursorIdx=0,this.searchText="")}else if(this.activeTabIdx===1){const s=i+3,a=i+9;if(t>=s&&t<=a){const l=t-s;l>=0&&l<this.otherSystems.length&&(this.routeDestIdx=l)}}}getMapNeighbors(){const t=xn(this.mapBrowsingSystemId).map(i=>{const r=i.from===this.mapBrowsingSystemId?i.to:i.from,o=this.publicSystems.find(a=>a.id===r),s=i.distance;return o?{sys:o,dist:s}:null}).filter(i=>i!==null).sort((i,r)=>i.dist-r.dist).map(i=>i.sys);return this.searchText.length===0?t:t.filter(i=>i.name.toUpperCase().includes(this.searchText))}handleMapAction(e){const t=this.getMapNeighbors(),i=Math.min(this.mapCursorIdx,Math.max(0,t.length-1));if(e==="UP")this.mapCursorIdx=Math.max(0,i-1);else if(e==="DOWN")this.mapCursorIdx=Math.min(t.length-1,i+1);else if(e==="SELECT"){const r=t[i];if(!r)return;this.mapBrowsingSystemId=r.id,this.mapCursorIdx=0,this.searchText=""}}handleRouteAction(e){e==="UP"?this.routeDestIdx=Math.max(0,this.routeDestIdx-1):e==="DOWN"&&(this.routeDestIdx=Math.min(this.otherSystems.length-1,this.routeDestIdx+1))}computeRoute(){const e=this.otherSystems[this.routeDestIdx];return e?ot(this.player.systemId,e.id):null}renderContent(e,t,i){this.lastTop=t;const r=e.length>0?e[0].length:0;this.activeTabIdx===0?this.renderMapTab(e,t,i,r):this.renderRouteTab(e,t,i,r)}renderMapTab(e,t,i,r){const o=this.publicSystems.find(p=>p.id===this.mapBrowsingSystemId)??this.publicSystems[0];if(!o)return;const s=t+zr,a=t+st,l=t+at,c=t+Qr;this.renderChart(e,o,t),pe(e,s,r);const d=this.getMapNeighbors(),h=Math.min(this.mapCursorIdx,Math.max(0,d.length-1));this.renderNeighborList(e,r,o,d,h,a,l),pe(e,l,r),this.renderInfo(e,r,o,d[h]??null,c),this.searchText.length>0&&f(e,c+4,2,`/${this.searchText}_`,"bright-yellow","black")}renderChart(e,t,i){var d;const r=this.getMapNeighbors(),o=i+Yr,s=i+qr,a=i+Vr,l=t.id===this.player.systemId?"bright-yellow":"bright-cyan";if(f(e,s,$e,Te(t.name,Ge),l,"black"),t.id===this.player.systemId){const h=$e+Ge,p=((d=e[0])==null?void 0:d.length)??40;h<p&&(e[s][h]={char:"*",fg:"bright-yellow",bg:"black"})}const c=["left","right","top","bottom"];for(let h=0;h<Math.min(r.length,4);h++){const p=r[h],u=c[h],m=p.id===this.player.systemId?"bright-yellow":"white";if(u==="left")f(e,s,Xr,Te(p.name,Jr),m,"black"),e[s][Zr]={char:"-",fg:"bright-black",bg:"black"};else if(u==="right")f(e,s,no,Te(p.name,to),m,"black"),e[s][eo]={char:"-",fg:"bright-black",bg:"black"};else if(u==="top"){f(e,o,$e,Te(p.name,Ge),m,"black");for(let g=o+1;g<s;g++)e[g][lt]={char:"|",fg:"bright-black",bg:"black"}}else{f(e,a,$e,Te(p.name,Ge),m,"black");for(let g=s+1;g<a;g++)e[g][lt]={char:"|",fg:"bright-black",bg:"black"}}}}renderNeighborList(e,t,i,r,o,s,a){for(let l=0;l<r.length&&l<a-s;l++){const c=r[l],d=s+l,h=l===o,u=c.id===this.player.systemId?"bright-yellow":h?"bright-cyan":"white",m=h?"> ":"  ",g=Ke(i.id,c.id),y=g?`${g.distance}LY  ${g.stability}`:"",x=t-4-y.length;f(e,d,2,m+c.name.toUpperCase().slice(0,x-2),u,"black"),y&&f(e,d,t-2-y.length,y,"bright-black","black")}}renderInfo(e,t,i,r,o){const a=i.id===this.player.systemId?"* Current location":i.name.toUpperCase();if(f(e,o,2,`Zone: ${i.zone}  Sec: ${i.security}  ${a}`.slice(0,t-4),"bright-black","black"),!r)return;const l=Ke(i.id,r.id);if(!l)return;const c=ot(this.player.systemId,r.id),d=c?c.length===1?"(your location)":`${c.length-1} hop${c.length-1!==1?"s":""} from you`:"(unreachable)";f(e,o+1,2,`${r.name.toUpperCase()}  ${l.distance}LY  ${d}`.slice(0,t-4),"bright-black","black")}renderRouteTab(e,t,i,r){var x,E;const o=t,s=t+2,a=t+3,l=7,c=a+l,d=c+1,h=d+6,p=this.publicSystems.find(b=>b.id===this.player.systemId);f(e,o,2,"FROM:","bright-black","black"),f(e,o,8,(p==null?void 0:p.name.toUpperCase())??this.player.systemId.toUpperCase(),"bright-yellow","black"),f(e,s,2,"TO:","bright-black","black");const u=Math.max(0,Math.min(this.routeDestIdx,this.otherSystems.length-l));for(let b=0;b<l;b++){const M=u+b;if(M>=this.otherSystems.length)break;const v=this.otherSystems[M],C=M===this.routeDestIdx,_=C?"bright-cyan":"white",R=C?"> ":"  ";f(e,a+b,2,R+v.name.toUpperCase(),_,"black")}pe(e,c,r),pe(e,h,r);const m=this.computeRoute();if(!this.otherSystems[this.routeDestIdx])return;if(!m){f(e,d,2,"No route found","bright-red","black");return}const y=m.length-1;f(e,d,2,`Route: ${y} hop${y!==1?"s":""}`,"bright-white","black");for(let b=0;b<y;b++){const M=Ke(m[b],m[b+1]);if(!M)continue;const v=d+1+b;if(v>=h)break;const C=(((x=this.publicSystems.find(R=>R.id===m[b]))==null?void 0:x.name)??m[b]).toUpperCase().slice(0,9),_=(((E=this.publicSystems.find(R=>R.id===m[b+1]))==null?void 0:E.name)??m[b+1]).toUpperCase().slice(0,9);f(e,v,4,`${C} -> ${_}  ${M.distance}LY  ${M.stability}`.slice(0,r-6),"white","black")}}}class ie extends te{constructor(e,t,i,r){const o={onAction:()=>{}};super(o,t,e,{navOptions:[]}),this.elapsed=0,this.arrived=!1,this.duration=i,this.onComplete=r}update(e){this.arrived||(this.elapsed+=e,this.elapsed>=this.duration&&(this.arrived=!0,this.onComplete()))}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[]}}}const ro=["[. . .]","[: : :]","[* * *]"],dt=5e3;class oo extends ie{constructor(e,t,i){super(e,t,dt,i)}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[],systemLabel:"IN TRANSIT",destinationLabel:null}}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/500)%3,a=Math.ceil((dt-this.elapsed)/1e3),l=Math.max(1,Math.min(5,a)),c=Z(this.player.systemId),d=c?c.name.toUpperCase():this.player.systemId.toUpperCase();L(e,o-3,"[ JUMP DRIVE ENGAGED ]","bright-cyan","black"),L(e,o-1,"DESTINATION:","bright-black","black"),L(e,o,d,"bright-white","black"),L(e,o+2,ro[s],"bright-black","black"),L(e,o+4,`ARRIVING IN ${l}S`,"bright-black","black")}}const ht=2e3,so=["[ —   ]","[  —  ]","[   — ]"];class mn extends ie{constructor(e,t,i,r){super(e,t,ht,i),this.targetLabel=r}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[],destinationLabel:"IN TRANSIT"}}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((ht-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a)),c=this.targetLabel!==void 0?this.targetLabel.toUpperCase():(()=>{const d=this.player.destinationId?N(this.player.destinationId):null;return d?d.name.toUpperCase():"UNKNOWN"})();L(e,o-3,"[ THRUSTERS ENGAGED ]","bright-yellow","black"),L(e,o-1,"HEADING TO:","bright-black","black"),L(e,o,c,"bright-white","black"),L(e,o+2,so[s],"bright-black","black"),L(e,o+4,`ARRIVING IN ${l}S`,"bright-black","black")}}const ut=2500,ao=["v","vv","vvv"];class lo extends ie{constructor(e,t,i){super(e,t,ut,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/400)%3,a=Math.ceil((ut-this.elapsed)/1e3),l=Math.max(1,Math.min(3,a));L(e,o-3,"[ LANDING SEQUENCE ]","bright-green","black"),L(e,o+2,ao[s],"bright-black","black"),L(e,o+4,`TOUCHDOWN IN ${l}S`,"bright-black","black")}}const pt=2500,co=[">",">>",">>>"];class ho extends ie{constructor(e,t,i){super(e,t,pt,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/400)%3,a=Math.ceil((pt-this.elapsed)/1e3),l=Math.max(1,Math.min(3,a));L(e,o-3,"[ APPROACH LOCKED ]","bright-yellow","black"),L(e,o+2,co[s],"bright-black","black"),L(e,o+4,`CLAMPING IN ${l}S`,"bright-black","black")}}const mt=1500,uo=["^","^^","^^^"];class po extends ie{constructor(e,t,i){super(e,t,mt,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((mt-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));L(e,o-3,"[ LIFTOFF SEQUENCE ]","bright-green","black"),L(e,o+2,uo[s],"bright-black","black"),L(e,o+4,`CLEAR IN ${l}S`,"bright-black","black")}}const ft=1500,mo=["<","<<","<<<"];class fo extends ie{constructor(e,t,i){super(e,t,ft,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((ft-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));L(e,o-3,"[ RELEASING CLAMPS ]","bright-yellow","black"),L(e,o+2,mo[s],"bright-black","black"),L(e,o+4,`DEPARTING IN ${l}S`,"bright-black","black")}}const gt=1500,go=["→","→→","→→→"];class yo extends ie{constructor(e,t,i){super(e,t,gt,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((gt-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));L(e,o-3,"[ DOCKING SEQUENCE ]","bright-cyan","black"),L(e,o+2,go[s],"bright-black","black"),L(e,o+4,`DOCKING IN ${l}S`,"bright-black","black")}}const yt=1500,_o=["←","←←","←←←"];class bo extends ie{constructor(e,t,i){super(e,t,yt,i)}renderContent(e,t,i){const r=e.length,o=Math.floor(r/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((yt-this.elapsed)/1e3),l=Math.max(1,Math.min(2,a));L(e,o-3,"[ DEPARTING BERTH ]","bright-cyan","black"),L(e,o+2,_o[s],"bright-black","black"),L(e,o+4,`CLEAR IN ${l}S`,"bright-black","black")}}function vo(n){let e=n>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}function wo(n,e){return Math.floor(n()*e)}function Ie(n,e){return e[wo(n,e.length)]}function Wt(n,e){const{special:t,firstNames:i,lastNames:r}=e.npcNames;if(n()<B().npc.specialNameChance&&t.length>0)return{giverName:Ie(n,t)};const o=i.length>0?Ie(n,i):"Unknown",s=r.length>0?Ie(n,r):"Agent";return{giverName:`${o} ${s}`}}function ko(n,e){return e.destinations.filter(t=>t.id!==n.id)}function xo(n){return n.commodities.filter(e=>e.legal)}function Co(n,e){const t=e.reduce((r,o)=>r+o.weightKg,0);if(t===0)return e[0];let i=n()*t;for(const r of e)if(i-=r.weightKg,i<0)return r;return e[e.length-1]}function _t(n,e,t,i){var y;const r=t.deliveryItems;if(r.length===0)return null;const o=ko(e,t);if(o.length===0)return null;const s=Co(n,r),a=Ie(n,o),l=Wt(n,t),{deliveryBaseReward:c,deliveryRandomReward:d,deliveryDepositFraction:h}=B().missions,p=Math.floor(s.weightKg*1.5),u=c+p+Math.floor(n()*d),m=Math.floor(u*h),g=e.owningFactionId?(y=F().factions.find(x=>x.id===e.owningFactionId&&he(x)))==null?void 0:y.id:void 0;return{...l,giverFactionId:g,id:i,type:"delivery",title:s.name,description:`A package needs transporting. Pick up the ${s.name} from ${e.name} and deliver it to ${a.name}. Handle with care.`,reward:u,issuingDestinationId:e.id,itemName:s.name,itemWeightKg:s.weightKg,pickupDestinationId:e.id,deliveryDestinationId:a.id,deposit:m}}function bt(n,e,t,i){var $;const r=xo(t);if(r.length===0)return null;const o=Z(e.system),s=[],a=[];for(const w of r)(o?Ve(w.id,o):1)>1&&a.push(w),s.push(w);const l=a.length>0?a:r;for(const w of l)s.push(w);const{supplyRequirementsMin:c,supplyRequirementsMax:d,supplyQtyMin:h,supplyQtyMax:p}=B().missions,u=c+Math.floor(n()*(d-c+1)),m=[],g=new Set;for(let w=0;w<u;w++){let S=0;for(;S<10;){const A=Ie(n,s);if(!g.has(A.id)){g.add(A.id);const I=h+Math.floor(n()*(p-h+1));m.push({commodityId:A.id,qty:I});break}S++}}if(m.length===0)return null;const y=m.reduce((w,S)=>{const A=t.commodities.find(I=>I.id===S.commodityId);return w+((A==null?void 0:A.basePrice)??100)*S.qty},0),x=m.reduce((w,S)=>{const A=t.commodities.find(I=>I.id===S.commodityId);return w+((A==null?void 0:A.weightKg)??1)*S.qty},0),{supplyRewardMultiplierMin:E,supplyRewardMultiplierMax:b}=B().missions,M=Math.min(1,x/500),v=n(),C=v+M*(1-v)*.15,_=E+C*(b-E),R=Math.floor(y*_),D=Wt(n,t),j=m.map(w=>{const S=t.commodities.find(A=>A.id===w.commodityId);return`${w.qty}× ${(S==null?void 0:S.name)??w.commodityId}`}).join(", "),O=e.owningFactionId?($=F().factions.find(w=>w.id===e.owningFactionId&&he(w)))==null?void 0:$.id:void 0;return{...D,giverFactionId:O,id:i,type:"supply",title:e.name,description:`${e.name} needs supplies. Deliver ${j} to fulfil the contract.`,reward:R,issuingDestinationId:e.id,requirements:m,deliveryDestinationId:e.id}}function To(n){let e=0;for(let t=0;t<n.length;t++)e=(e<<5)-e^n.charCodeAt(t);return e>>>0}function Mo(n,e,t){const i=B();let r;{const c=i.missions.missionTtlMs,d=Date.now(),h=Math.floor(d/c);r=To(n.id)^h}const o=vo(r),{boardMaxCount:s,deliveryChance:a}=i.missions,l=[];for(let c=0;c<n.minMissions&&l.length<s;c++){const d=`m-${(r>>>0).toString(16)}-${l.length}`,p=o()<a?_t(o,n,e,d):bt(o,n,e,d);p&&l.push(p)}for(;l.length<s&&o()<n.missionChance;){const c=`m-${(r>>>0).toString(16)}-${l.length}`,h=o()<a?_t(o,n,e,c):bt(o,n,e,c);h&&l.push(h)}return l}const Io=100;function We(n,e,t){return Math.max(e,Math.min(t,n))}function So(n,e,t,i){const{stockCountMin:r,stockCountMax:o,stockQtyMin:s,stockQtyMax:a,stockRepCountBonusPerLevel:l,stockRepCountBonusMin:c,stockRepCountBonusMax:d,stockRepQtyBonusPerLevel:h,stockRepQtyBonusMin:p,stockRepQtyBonusMax:u}=t.trading,m=We(e*l,c,d),g=We(e*h,p,u),y=n.length,x=We(r+m,1,y),E=We(o+m,1,y),b=x+Math.floor(Math.random()*(E-x+1)),M=[];if(i)for(const w of n){const A=1/Ve(w.id,i),I=Math.ceil(A*10);for(let k=0;k<I;k++)M.push(w)}else M.push(...n);const v=[...M];for(let w=v.length-1;w>0;w--){const S=Math.floor(Math.random()*(w+1));[v[w],v[S]]=[v[S],v[w]]}const C=s+g,_=a+g,R=n.map(w=>Math.log(w.basePrice*w.weightKg)),D=Math.min(...R),O=Math.max(...R)-D,$=new Map;for(const w of v.slice(0,b)){if($.has(w.id))continue;const S=C+Math.floor(Math.random()*(_-C+1));let A=1;O>0&&(A=1.5-(Math.log(w.basePrice*w.weightKg)-D)/O);const I=i?Ve(w.id,i):1;$.set(w.id,{commodityId:w.id,qty:Math.max(1,Math.floor(S*A)),effectiveFactor:I})}return Array.from($.values())}class Ao{constructor(e,t,i){this.sceneBeforeMenu=null,this.traderStockCache=new Map,this.renderer=e,this.input=t,this.context=i;const r=Ht(),o=je(r.startingShip);this.player=new In({shipId:r.startingShip,driveId:o.defaultJumpDrive,credits:r.player.startingCredits,systemId:r.startingLocation.system,destinationId:r.startingLocation.destination}),this.currentScene=new Un(this.input,this.context,this.player,()=>this.goToStory())}tick(e){const t=Math.min(e,Io),i=this.makeBuffer();this.currentScene.update(t),this.currentScene.render(i),this.renderer.drawBuffer(i)}makeBuffer(){const e=this.renderer.getWidth(),t=this.renderer.getHeight();return Array.from({length:t},()=>Array.from({length:e},()=>({char:" ",fg:"black",bg:"black"})))}getOrCreateTraderStock(e,t){const i=Date.now(),r=this.traderStockCache.get(e),o=B();if(r&&r.repLevel===t&&i-r.generatedAt<o.trading.stockTtlMs)return r.entries;const s=N(e),a=s?Z(s.system):void 0,l=So(ji(),t,o,a);return this.traderStockCache.set(e,{entries:l,generatedAt:i,repLevel:t}),l}refreshDestinationMissions(e){const t=N(e),i=F(),r=Mo(t,i);this.player.refreshDestinationMissions(e,r)}onBuy(e,t,i,r){if(t<=0)return;const o=r.findIndex(d=>d.commodityId===e);if(o<0)return;const s=r[o];if(t>s.qty)return;const a=ae(e);if(!a)return;const l=t*i;this.player.credits<l||this.player.cargoWeightKg+t*a.weightKg>this.player.cargoCapacity||(this.player.spendCredits(l),this.player.addCargo(e,t),s.qty-=t,s.qty<=0&&r.splice(o,1))}onSell(e,t,i,r){if(t<=0)return;const o=this.player.cargoHold.find(c=>c.commodityId===e);if(!o||o.qty<t||!ae(e))return;const a=t*i;this.player.addCredits(a),this.player.removeCargo(e,t);const l=r.find(c=>c.commodityId===e);l?l.qty+=t:r.push({commodityId:e,qty:t})}goToMainMenu(){this.currentScene=new Un(this.input,this.context,this.player,()=>this.goToStory())}goToStory(){this.currentScene=new sr(this.input,this.context,this.player,()=>this.goToStation())}goToStation(){const e=this.player.destinationId;this.refreshDestinationMissions(e),this.currentScene=new lr(this.input,this.context,this.player,e,(t,i)=>{this.player.spendCredits(t),this.player.addFuel(i),this.goToStation()},()=>this.goToTrader(),()=>this.goToMissionBoard(),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToLandOrDock(){var t;const e=(t=N(this.player.destinationId))==null?void 0:t.locationType;e==="surface"?this.currentScene=new lo(this.player,this.context,()=>this.goToStation()):e==="asteroid"?this.currentScene=new ho(this.player,this.context,()=>this.goToStation()):this.currentScene=new yo(this.player,this.context,()=>this.goToStation())}goToTakeOffOrUndock(){var t;const e=(t=N(this.player.destinationId))==null?void 0:t.locationType;e==="surface"?this.currentScene=new po(this.player,this.context,()=>this.goToShip()):e==="asteroid"?this.currentScene=new fo(this.player,this.context,()=>this.goToShip()):this.currentScene=new bo(this.player,this.context,()=>this.goToShip())}goToTrader(){const e=this.player.destinationId,t=N(e);let i=0;if(t.owningFactionId){const o=$t(t.owningFactionId);if(o&&he(o)){const s=B(),a=this.player.getFactionReputation(t.owningFactionId);i=Se(a,s)}}const r=this.getOrCreateTraderStock(e,i);this.currentScene=new cr(this.input,this.context,this.player,e,r,(o,s,a)=>this.onBuy(o,s,a,r),(o,s,a)=>this.onSell(o,s,a,r),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToMissionBoard(){const e=this.player.destinationId,t=this.player.getDestinationMissions(e);this.currentScene=new me(this.input,this.context,this.player,e,t,i=>this.goToMissionDetail(i,e),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToMissionDetail(e,t){this.currentScene=new pr(this.input,this.context,this.player,e,i=>this.onMissionAccepted(e,i,t),()=>this.goToMissionBoard(),()=>this.goToStation(),()=>this.goToTakeOffOrUndock())}onMissionAccepted(e,t,i){const r=this.player.getDestinationMissions(i),o=r.findIndex(s=>s.id===e.id);o>=0&&(r.splice(o,1),this.player.refreshDestinationMissions(i,r)),this.player.acceptMission(e,t),this.goToMissionBoard()}goToShip(){this.currentScene=new Wr(this.input,this.context,this.player,()=>this.goToTravelMenu(),()=>this.goToLandOrDock(),()=>this.goToCargo(),()=>this.goToGlobalMenu())}goToCargo(){this.currentScene=new jr(this.input,this.context,this.player,()=>this.goToShip(),()=>this.goToGlobalMenu())}buildMenuEntries(){return[{label:"MISSIONS",action:()=>this.goToMissionLog()},{label:"GALAXY MAP",action:()=>this.goToGalaxyMapFromMenu()},{label:"REPUTATION",action:()=>this.goToReputation()}]}goToMissionLog(){this.currentScene=new er(this.input,this.context,this.player,()=>this.goToGlobalMenuFromSubScene(),()=>this.returnFromMenu())}goToReputation(){this.currentScene=new or(this.input,this.context,this.player,()=>this.goToGlobalMenuFromSubScene(),()=>this.returnFromMenu())}goToGlobalMenuFromSubScene(){this.currentScene=new $n(this.input,this.context,this.player,this.buildMenuEntries(),()=>this.returnFromMenu())}goToGlobalMenu(){this.sceneBeforeMenu=this.currentScene,"suspend"in this.currentScene&&this.currentScene.suspend(),this.currentScene=new $n(this.input,this.context,this.player,this.buildMenuEntries(),()=>this.returnFromMenu())}returnFromMenu(){const e=this.sceneBeforeMenu;this.sceneBeforeMenu=null,e!==null?("resume"in e&&e.resume(),this.currentScene=e):this.goToShip()}goToTravelMenu(){this.currentScene=new rt(this.input,this.context,this.player,e=>this.onDestinationSelected(e),e=>this.onJumpSelected(e),()=>this.goToFlyIntoSpace(),()=>this.goToShip(),()=>this.goToGalaxyMap(),()=>this.goToGlobalMenu(),()=>this.goToEmergencyRescue())}goToArrival(){this.currentScene=new rt(this.input,this.context,this.player,e=>this.onDestinationSelected(e),e=>this.onJumpSelected(e),()=>this.goToFlyIntoSpace(),()=>this.goToShip(),()=>this.goToGalaxyMap(),()=>this.goToGlobalMenu(),()=>this.goToEmergencyRescue())}goToGalaxyMap(){this.currentScene=new ct(this.input,this.context,this.player,()=>this.goToTravelMenu(),()=>this.goToGlobalMenu())}goToGalaxyMapFromMenu(){this.currentScene=new ct(this.input,this.context,this.player,()=>this.goToGlobalMenu(),()=>this.goToGlobalMenu(),()=>this.returnFromMenu())}goToFlyIntoSpace(){const e=this.player.getInSystemHopCost();this.player.consumeFuel(e),this.player.undock(),this.currentScene=new mn(this.player,this.context,()=>this.goToShip(),"OPEN SPACE")}onDestinationSelected(e){const t=this.player.getInSystemHopCost();this.player.consumeFuel(t),this.player.dock(e),this.currentScene=new mn(this.player,this.context,()=>this.goToShip())}onJumpSelected(e){const t=Ke(this.player.systemId,e),i=Ut(this.player.driveId),r=Math.ceil(B().fuel.consumptionPerLy*t.distance*i.fuelEfficiency);this.player.consumeFuel(r),this.player.jumpTo(e),this.currentScene=new oo(this.player,this.context,()=>this.goToArrival())}goToEmergencyRescue(){this.currentScene=new Kr(this.input,this.context,this.player,e=>this.onEmergencyTow(e),()=>this.onEmergencyFuelDrop(),()=>this.goToTravelMenu())}onEmergencyTow(e){const t=B();this.player.spendCredits(t.emergencyRescue.towFee),this.player.dock(e),this.currentScene=new mn(this.player,this.context,()=>this.goToShip())}onEmergencyFuelDrop(){const e=B();this.player.spendCredits(e.emergencyRescue.fuelDropFee),this.player.addFuel(e.emergencyRescue.fuelDropLitres),this.goToTravelMenu()}}const Eo=`---
commodities:
...
Adventure here is fraught with inconsistent communications and unreliable star charts.`,ls=`---
routes:
...
Long range engines for faster than light travel between systems.`,ms=`---
id: freighter
...
`;var P={},Re={},q={};function jt(n){return typeof n>"u"||n===null}function Es(n){return typeof n=="object"&&n!==null}function Rs(n){return Array.isArray(n)?n:jt(n)?[]:[n]}function Ls(n,e){var t,i,r,o;if(e)for(o=Object.keys(e),t=0,i=o.length;t<i;t+=1)r=o[t],n[r]=e[r];return n}function Fs(n,e){var t="",i;for(i=0;i<e;i+=1)t+=n;return t}function Ds(n){return n===0&&Number.NEGATIVE_INFINITY===1/n}q.isNothing=jt;q.isObject=Es;q.toArray=Rs;q.repeat=Fs;q.isNegativeZero=Ds;q.extend=Ls;function Ae(n,e){Error.call(this),this.name="YAMLException",this.reason=n,this.mark=e,this.message=(this.reason||"(unknown reason)")+(this.mark?" "+this.mark.toString():""),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}Ae.prototype=Object.create(Error.prototype);Ae.prototype.constructor=Ae;Ae.prototype.toString=function(e){var t=this.name+": ";return t+=this.reason||"(unknown reason)",!e&&this.mark&&(t+=" "+this.mark.toString()),t};var Le=Ae,vt=q;function Sn(n,e,t,i,r){this.name=n,this.buffer=e,this.position=t,this.line=i,this.column=r}Sn.prototype.getSnippet=function(e,t){var i,r,o,s,a;if(!this.buffer)return null;for(e=e||4,t=t||75,i="",r=this.position;r>0&&`\0\r
\u2028\u2029`.indexOf(this.buffer.charAt(r-1))===-1;)if(r-=1,this.position-r>t/2-1){i=" ... ",r+=5;break}for(o="",s=this.position;s<this.buffer.length&&`\0\r
\u2028\u2029`.indexOf(this.buffer.charAt(s))===-1;)if(s+=1,s-this.position>t/2-1){o=" ... ",s-=5;break}return a=this.buffer.slice(r,s),vt.repeat(" ",e)+i+a+o+`
`+vt.repeat(" ",e+this.position-r+i.length)+"^"};Sn.prototype.toString=function(e){var t,i="";return this.name&&(i+='in "'+this.name+'" '),i+="at line "+(this.line+1)+", column "+(this.column+1),e||(t=this.getSnippet(),t&&(i+=`:
`+t)),i};var Ns=Sn,wt=Le,Os=["kind","resolve","construct","instanceOf","predicate","represent","defaultStyle","styleAliases"],Ps=["scalar","sequence","mapping"];function Bs(n){var e={};return n!==null&&Object.keys(n).forEach(function(t){n[t].forEach(function(i){e[String(i)]=t})}),e}function Us(n,e){if(e=e||{},Object.keys(e).forEach(function(t){if(Os.indexOf(t)===-1)throw new wt('Unknown option "'+t+'" is met in definition of "'+n+'" YAML type.')}),this.tag=n,this.kind=e.kind||null,this.resolve=e.resolve||function(){return!0},this.construct=e.construct||function(t){return t},this.instanceOf=e.instanceOf||null,this.predicate=e.predicate||null,this.represent=e.represent||null,this.defaultStyle=e.defaultStyle||null,this.styleAliases=Bs(e.styleAliases||null),Ps.indexOf(this.kind)===-1)throw new wt('Unknown kind "'+this.kind+'" is specified for "'+n+'" YAML type.')}var H=Us,kt=q,Ye=Le,Hs=H;function vn(n,e,t){var i=[];return n.include.forEach(function(r){t=vn(r,e,t)}),n[e].forEach(function(r){t.forEach(function(o,s){o.tag===r.tag&&o.kind===r.kind&&i.push(s)}),t.push(r)}),t.filter(function(r,o){return i.indexOf(o)===-1})}function $s(){var n={scalar:{},sequence:{},mapping:{},fallback:{}},e,t;function i(r){n[r.kind][r.tag]=n.fallback[r.tag]=r}for(e=0,t=arguments.length;e<t;e+=1)arguments[e].forEach(i);return n}function fe(n){this.include=n.include||[],this.implicit=n.implicit||[],this.explicit=n.explicit||[],this.implicit.forEach(function(e){if(e.loadKind&&e.loadKind!=="scalar")throw new Ye("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.")}),this.compiledImplicit=vn(this,"implicit",[]),this.compiledExplicit=vn(this,"explicit",[]),this.compiledTypeMap=$s(this.compiledImplicit,this.compiledExplicit)}fe.DEFAULT=null;fe.create=function(){var e,t;switch(arguments.length){case 1:e=fe.DEFAULT,t=arguments[0];break;case 2:e=arguments[0],t=arguments[1];break;default:throw new Ye("Wrong number of arguments for Schema.create function")}if(e=kt.toArray(e),t=kt.toArray(t),!e.every(function(i){return i instanceof fe}))throw new Ye("Specified list of super schemas (or a single Schema object) contains a non-Schema object.");if(!t.every(function(i){return i instanceof Hs}))throw new Ye("Specified list of YAML types (or a single Type object) contains a non-Type object.");return new fe({include:e,explicit:t})};var ve=fe,Gs=H,Ws=new Gs("tag:yaml.org,2002:str",{kind:"scalar",construct:function(n){return n!==null?n:""}}),js=H,Ks=new js("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(n){return n!==null?n:[]}}),Ys=H,qs=new Ys("tag:yaml.org,2002:map",{kind:"mapping",construct:function(n){return n!==null?n:{}}}),Vs=ve,An=new Vs({explicit:[Ws,Ks,qs]}),zs=H;function Qs(n){if(n===null)return!0;var e=n.length;return e===1&&n==="~"||e===4&&(n==="null"||n==="Null"||n==="NULL")}function Xs(){return null}function Js(n){return n===null}var Zs=new zs("tag:yaml.org,2002:null",{kind:"scalar",resolve:Qs,construct:Xs,predicate:Js,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"}},defaultStyle:"lowercase"}),ea=H;function na(n){if(n===null)return!1;var e=n.length;return e===4&&(n==="true"||n==="True"||n==="TRUE")||e===5&&(n==="false"||n==="False"||n==="FALSE")}function ta(n){return n==="true"||n==="True"||n==="TRUE"}function ia(n){return Object.prototype.toString.call(n)==="[object Boolean]"}var ra=new ea("tag:yaml.org,2002:bool",{kind:"scalar",resolve:na,construct:ta,predicate:ia,represent:{lowercase:function(n){return n?"true":"false"},uppercase:function(n){return n?"TRUE":"FALSE"},camelcase:function(n){return n?"True":"False"}},defaultStyle:"lowercase"}),oa=q,sa=H;function aa(n){return 48<=n&&n<=57||65<=n&&n<=70||97<=n&&n<=102}function la(n){return 48<=n&&n<=55}function ca(n){return 48<=n&&n<=57}function da(n){if(n===null)return!1;var e=n.length,t=0,i=!1,r;if(!e)return!1;if(r=n[t],(r==="-"||r==="+")&&(r=n[++t]),r==="0"){if(t+1===e)return!0;if(r=n[++t],r==="b"){for(t++;t<e;t++)if(r=n[t],r!=="_"){if(r!=="0"&&r!=="1")return!1;i=!0}return i&&r!=="_"}if(r==="x"){for(t++;t<e;t++)if(r=n[t],r!=="_"){if(!aa(n.charCodeAt(t)))return!1;i=!0}return i&&r!=="_"}for(;t<e;t++)if(r=n[t],r!=="_"){if(!la(n.charCodeAt(t)))return!1;i=!0}return i&&r!=="_"}if(r==="_")return!1;for(;t<e;t++)if(r=n[t],r!=="_"){if(r===":")break;if(!ca(n.charCodeAt(t)))return!1;i=!0}return!i||r==="_"?!1:r!==":"?!0:/^(:[0-5]?[0-9])+$/.test(n.slice(t))}function ha(n){var e=n,t=1,i,r,o=[];return e.indexOf("_")!==-1&&(e=e.replace(/_/g,"")),i=e[0],(i==="-"||i==="+")&&(i==="-"&&(t=-1),e=e.slice(1),i=e[0]),e==="0"?0:i==="0"?e[1]==="b"?t*parseInt(e.slice(2),2):e[1]==="x"?t*parseInt(e,16):t*parseInt(e,8):e.indexOf(":")!==-1?(e.split(":").forEach(function(s){o.unshift(parseInt(s,10))}),e=0,r=1,o.forEach(function(s){e+=s*r,r*=60}),t*e):t*parseInt(e,10)}function ua(n){return Object.prototype.toString.call(n)==="[object Number]"&&n%1===0&&!oa.isNegativeZero(n)}var pa=new sa("tag:yaml.org,2002:int",{kind:"scalar",resolve:da,construct:ha,predicate:ua,represent:{binary:function(n){return n>=0?"0b"+n.toString(2):"-0b"+n.toString(2).slice(1)},octal:function(n){return n>=0?"0"+n.toString(8):"-0"+n.toString(8).slice(1)},decimal:function(n){return n.toString(10)},hexadecimal:function(n){return n>=0?"0x"+n.toString(16).toUpperCase():"-0x"+n.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),Kt=q,ma=H,fa=new RegExp("^(?:[-+]?(?:0|[1-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function ga(n){return!(n===null||!fa.test(n)||n[n.length-1]==="_")}function ya(n){var e,t,i,r;return e=n.replace(/_/g,"").toLowerCase(),t=e[0]==="-"?-1:1,r=[],"+-".indexOf(e[0])>=0&&(e=e.slice(1)),e===".inf"?t===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:e===".nan"?NaN:e.indexOf(":")>=0?(e.split(":").forEach(function(o){r.unshift(parseFloat(o,10))}),e=0,i=1,r.forEach(function(o){e+=o*i,i*=60}),t*e):t*parseFloat(e,10)}var _a=/^[-+]?[0-9]+e/;function ba(n,e){var t;if(isNaN(n))switch(e){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===n)switch(e){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===n)switch(e){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(Kt.isNegativeZero(n))return"-0.0";return t=n.toString(10),_a.test(t)?t.replace("e",".e"):t}function va(n){return Object.prototype.toString.call(n)==="[object Number]"&&(n%1!==0||Kt.isNegativeZero(n))}var wa=new ma("tag:yaml.org,2002:float",{kind:"scalar",resolve:ga,construct:ya,predicate:va,represent:ba,defaultStyle:"lowercase"}),ka=ve,Yt=new ka({include:[An],implicit:[Zs,ra,pa,wa]}),xa=ve,qt=new xa({include:[Yt]}),Ca=H,Vt=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),zt=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Ta(n){return n===null?!1:Vt.exec(n)!==null||zt.exec(n)!==null}function Ma(n){var e,t,i,r,o,s,a,l=0,c=null,d,h,p;if(e=Vt.exec(n),e===null&&(e=zt.exec(n)),e===null)throw new Error("Date resolve error");if(t=+e[1],i=+e[2]-1,r=+e[3],!e[4])return new Date(Date.UTC(t,i,r));if(o=+e[4],s=+e[5],a=+e[6],e[7]){for(l=e[7].slice(0,3);l.length<3;)l+="0";l=+l}return e[9]&&(d=+e[10],h=+(e[11]||0),c=(d*60+h)*6e4,e[9]==="-"&&(c=-c)),p=new Date(Date.UTC(t,i,r,o,s,a,l)),c&&p.setTime(p.getTime()-c),p}function Ia(n){return n.toISOString()}var Sa=new Ca("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Ta,construct:Ma,instanceOf:Date,represent:Ia}),Aa=H;function Ea(n){return n==="<<"||n===null}var Ra=new Aa("tag:yaml.org,2002:merge",{kind:"scalar",resolve:Ea});function Qt(n){throw new Error('Could not dynamically require "'+n+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var oe;try{var La=Qt;oe=La("buffer").Buffer}catch{}var Fa=H,En=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function Da(n){if(n===null)return!1;var e,t,i=0,r=n.length,o=En;for(t=0;t<r;t++)if(e=o.indexOf(n.charAt(t)),!(e>64)){if(e<0)return!1;i+=6}return i%8===0}function Na(n){var e,t,i=n.replace(/[\r\n=]/g,""),r=i.length,o=En,s=0,a=[];for(e=0;e<r;e++)e%4===0&&e&&(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)),s=s<<6|o.indexOf(i.charAt(e));return t=r%4*6,t===0?(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)):t===18?(a.push(s>>10&255),a.push(s>>2&255)):t===12&&a.push(s>>4&255),oe?oe.from?oe.from(a):new oe(a):a}function Oa(n){var e="",t=0,i,r,o=n.length,s=En;for(i=0;i<o;i++)i%3===0&&i&&(e+=s[t>>18&63],e+=s[t>>12&63],e+=s[t>>6&63],e+=s[t&63]),t=(t<<8)+n[i];return r=o%3,r===0?(e+=s[t>>18&63],e+=s[t>>12&63],e+=s[t>>6&63],e+=s[t&63]):r===2?(e+=s[t>>10&63],e+=s[t>>4&63],e+=s[t<<2&63],e+=s[64]):r===1&&(e+=s[t>>2&63],e+=s[t<<4&63],e+=s[64],e+=s[64]),e}function Pa(n){return oe&&oe.isBuffer(n)}var Ba=new Fa("tag:yaml.org,2002:binary",{kind:"scalar",resolve:Da,construct:Na,predicate:Pa,represent:Oa}),Ua=H,Ha=Object.prototype.hasOwnProperty,$a=Object.prototype.toString;function Ga(n){if(n===null)return!0;var e=[],t,i,r,o,s,a=n;for(t=0,i=a.length;t<i;t+=1){if(r=a[t],s=!1,$a.call(r)!=="[object Object]")return!1;for(o in r)if(Ha.call(r,o))if(!s)s=!0;else return!1;if(!s)return!1;if(e.indexOf(o)===-1)e.push(o);else return!1}return!0}function Wa(n){return n!==null?n:[]}var ja=new Ua("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Ga,construct:Wa}),Ka=H,Ya=Object.prototype.toString;function qa(n){if(n===null)return!0;var e,t,i,r,o,s=n;for(o=new Array(s.length),e=0,t=s.length;e<t;e+=1){if(i=s[e],Ya.call(i)!=="[object Object]"||(r=Object.keys(i),r.length!==1))return!1;o[e]=[r[0],i[r[0]]]}return!0}function Va(n){if(n===null)return[];var e,t,i,r,o,s=n;for(o=new Array(s.length),e=0,t=s.length;e<t;e+=1)i=s[e],r=Object.keys(i),o[e]=[r[0],i[r[0]]];return o}var za=new Ka("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:qa,construct:Va}),Qa=H,Xa=Object.prototype.hasOwnProperty;function Ja(n){if(n===null)return!0;var e,t=n;for(e in t)if(Xa.call(t,e)&&t[e]!==null)return!1;return!0}function Za(n){return n!==null?n:{}}var el=new Qa("tag:yaml.org,2002:set",{kind:"mapping",resolve:Ja,construct:Za}),nl=ve,Fe=new nl({include:[qt],implicit:[Sa,Ra],explicit:[Ba,ja,za,el]}),tl=H;function il(){return!0}function rl(){}function ol(){return""}function sl(n){return typeof n>"u"}var al=new tl("tag:yaml.org,2002:js/undefined",{kind:"scalar",resolve:il,construct:rl,predicate:sl,represent:ol}),ll=H;function cl(n){if(n===null||n.length===0)return!1;var e=n,t=/\/([gim]*)$/.exec(n),i="";return!(e[0]==="/"&&(t&&(i=t[1]),i.length>3||e[e.length-i.length-1]!=="/"))}function dl(n){var e=n,t=/\/([gim]*)$/.exec(n),i="";return e[0]==="/"&&(t&&(i=t[1]),e=e.slice(1,e.length-i.length-1)),new RegExp(e,i)}function hl(n){var e="/"+n.source+"/";return n.global&&(e+="g"),n.multiline&&(e+="m"),n.ignoreCase&&(e+="i"),e}function ul(n){return Object.prototype.toString.call(n)==="[object RegExp]"}var pl=new ll("tag:yaml.org,2002:js/regexp",{kind:"scalar",resolve:cl,construct:dl,predicate:ul,represent:hl}),ze;try{var ml=Qt;ze=ml("esprima")}catch{typeof window<"u"&&(ze=window.esprima)}var fl=H;function gl(n){if(n===null)return!1;try{var e="("+n+")",t=ze.parse(e,{range:!0});return!(t.type!=="Program"||t.body.length!==1||t.body[0].type!=="ExpressionStatement"||t.body[0].expression.type!=="ArrowFunctionExpression"&&t.body[0].expression.type!=="FunctionExpression")}catch{return!1}}function yl(n){var e="("+n+")",t=ze.parse(e,{range:!0}),i=[],r;if(t.type!=="Program"||t.body.length!==1||t.body[0].type!=="ExpressionStatement"||t.body[0].expression.type!=="ArrowFunctionExpression"&&t.body[0].expression.type!=="FunctionExpression")throw new Error("Failed to resolve function");return t.body[0].expression.params.forEach(function(o){i.push(o.name)}),r=t.body[0].expression.body.range,t.body[0].expression.body.type==="BlockStatement"?new Function(i,e.slice(r[0]+1,r[1]-1)):new Function(i,"return "+e.slice(r[0],r[1]))}function _l(n){return n.toString()}function bl(n){return Object.prototype.toString.call(n)==="[object Function]"}var vl=new fl("tag:yaml.org,2002:js/function",{kind:"scalar",resolve:gl,construct:yl,predicate:bl,represent:_l}),xt=ve,en=xt.DEFAULT=new xt({include:[Fe],explicit:[al,pl,vl]}),J=q,Xt=Le,wl=Ns,Jt=Fe,kl=en,ne=Object.prototype.hasOwnProperty,Qe=1,Zt=2,ei=3,Xe=4,fn=1,xl=2,Ct=3,Cl=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Tl=/[\x85\u2028\u2029]/,Ml=/[,\[\]\{\}]/,ni=/^(?:!|!!|![a-z\-]+!)$/i,ti=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Tt(n){return Object.prototype.toString.call(n)}function z(n){return n===10||n===13}function se(n){return n===9||n===32}function Y(n){return n===9||n===32||n===10||n===13}function ge(n){return n===44||n===91||n===93||n===123||n===125}function Il(n){var e;return 48<=n&&n<=57?n-48:(e=n|32,97<=e&&e<=102?e-97+10:-1)}function Sl(n){return n===120?2:n===117?4:n===85?8:0}function Al(n){return 48<=n&&n<=57?n-48:-1}function Mt(n){return n===48?"\0":n===97?"\x07":n===98?"\b":n===116||n===9?"	":n===110?`
`:n===118?"\v":n===102?"\f":n===114?"\r":n===101?"\x1B":n===32?" ":n===34?'"':n===47?"/":n===92?"\\":n===78?"":n===95?" ":n===76?"\u2028":n===80?"\u2029":""}function El(n){return n<=65535?String.fromCharCode(n):String.fromCharCode((n-65536>>10)+55296,(n-65536&1023)+56320)}function ii(n,e,t){e==="__proto__"?Object.defineProperty(n,e,{configurable:!0,enumerable:!0,writable:!0,value:t}):n[e]=t}var ri=new Array(256),oi=new Array(256);for(var ue=0;ue<256;ue++)ri[ue]=Mt(ue)?1:0,oi[ue]=Mt(ue);function Rl(n,e){this.input=n,this.filename=e.filename||null,this.schema=e.schema||kl,this.onWarning=e.onWarning||null,this.legacy=e.legacy||!1,this.json=e.json||!1,this.listener=e.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=n.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.documents=[]}function si(n,e){return new Xt(e,new wl(n.filename,n.input,n.position,n.line,n.position-n.lineStart))}function T(n,e){throw si(n,e)}function Je(n,e){n.onWarning&&n.onWarning.call(null,si(n,e))}var It={YAML:function(e,t,i){var r,o,s;e.version!==null&&T(e,"duplication of %YAML directive"),i.length!==1&&T(e,"YAML directive accepts exactly one argument"),r=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),r===null&&T(e,"ill-formed argument of the YAML directive"),o=parseInt(r[1],10),s=parseInt(r[2],10),o!==1&&T(e,"unacceptable YAML version of the document"),e.version=i[0],e.checkLineBreaks=s<2,s!==1&&s!==2&&Je(e,"unsupported YAML version of the document")},TAG:function(e,t,i){var r,o;i.length!==2&&T(e,"TAG directive accepts exactly two arguments"),r=i[0],o=i[1],ni.test(r)||T(e,"ill-formed tag handle (first argument) of the TAG directive"),ne.call(e.tagMap,r)&&T(e,'there is a previously declared suffix for "'+r+'" tag handle'),ti.test(o)||T(e,"ill-formed tag prefix (second argument) of the TAG directive"),e.tagMap[r]=o}};function ee(n,e,t,i){var r,o,s,a;if(e<t){if(a=n.input.slice(e,t),i)for(r=0,o=a.length;r<o;r+=1)s=a.charCodeAt(r),s===9||32<=s&&s<=1114111||T(n,"expected valid JSON character");else Cl.test(a)&&T(n,"the stream contains non-printable characters");n.result+=a}}function St(n,e,t,i){var r,o,s,a;for(J.isObject(t)||T(n,"cannot merge mappings; the provided source object is unacceptable"),r=Object.keys(t),s=0,a=r.length;s<a;s+=1)o=r[s],ne.call(e,o)||(ii(e,o,t[o]),i[o]=!0)}function ye(n,e,t,i,r,o,s,a){var l,c;if(Array.isArray(r))for(r=Array.prototype.slice.call(r),l=0,c=r.length;l<c;l+=1)Array.isArray(r[l])&&T(n,"nested arrays are not supported inside keys"),typeof r=="object"&&Tt(r[l])==="[object Object]"&&(r[l]="[object Object]");if(typeof r=="object"&&Tt(r)==="[object Object]"&&(r="[object Object]"),r=String(r),e===null&&(e={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(o))for(l=0,c=o.length;l<c;l+=1)St(n,e,o[l],t);else St(n,e,o,t);else!n.json&&!ne.call(t,r)&&ne.call(e,r)&&(n.line=s||n.line,n.position=a||n.position,T(n,"duplicated mapping key")),ii(e,r,o),delete t[r];return e}function Rn(n){var e;e=n.input.charCodeAt(n.position),e===10?n.position++:e===13?(n.position++,n.input.charCodeAt(n.position)===10&&n.position++):T(n,"a line break is expected"),n.line+=1,n.lineStart=n.position}function U(n,e,t){for(var i=0,r=n.input.charCodeAt(n.position);r!==0;){for(;se(r);)r=n.input.charCodeAt(++n.position);if(e&&r===35)do r=n.input.charCodeAt(++n.position);while(r!==10&&r!==13&&r!==0);if(z(r))for(Rn(n),r=n.input.charCodeAt(n.position),i++,n.lineIndent=0;r===32;)n.lineIndent++,r=n.input.charCodeAt(++n.position);else break}return t!==-1&&i!==0&&n.lineIndent<t&&Je(n,"deficient indentation"),i}function nn(n){var e=n.position,t;return t=n.input.charCodeAt(e),!!((t===45||t===46)&&t===n.input.charCodeAt(e+1)&&t===n.input.charCodeAt(e+2)&&(e+=3,t=n.input.charCodeAt(e),t===0||Y(t)))}function Ln(n,e){e===1?n.result+=" ":e>1&&(n.result+=J.repeat(`
`,e-1))}function Ll(n,e,t){var i,r,o,s,a,l,c,d,h=n.kind,p=n.result,u;if(u=n.input.charCodeAt(n.position),Y(u)||ge(u)||u===35||u===38||u===42||u===33||u===124||u===62||u===39||u===34||u===37||u===64||u===96||(u===63||u===45)&&(r=n.input.charCodeAt(n.position+1),Y(r)||t&&ge(r)))return!1;for(n.kind="scalar",n.result="",o=s=n.position,a=!1;u!==0;){if(u===58){if(r=n.input.charCodeAt(n.position+1),Y(r)||t&&ge(r))break}else if(u===35){if(i=n.input.charCodeAt(n.position-1),Y(i))break}else{if(n.position===n.lineStart&&nn(n)||t&&ge(u))break;if(z(u))if(l=n.line,c=n.lineStart,d=n.lineIndent,U(n,!1,-1),n.lineIndent>=e){a=!0,u=n.input.charCodeAt(n.position);continue}else{n.position=s,n.line=l,n.lineStart=c,n.lineIndent=d;break}}a&&(ee(n,o,s,!1),Ln(n,n.line-l),o=s=n.position,a=!1),se(u)||(s=n.position+1),u=n.input.charCodeAt(++n.position)}return ee(n,o,s,!1),n.result?!0:(n.kind=h,n.result=p,!1)}function Fl(n,e){var t,i,r;if(t=n.input.charCodeAt(n.position),t!==39)return!1;for(n.kind="scalar",n.result="",n.position++,i=r=n.position;(t=n.input.charCodeAt(n.position))!==0;)if(t===39)if(ee(n,i,n.position,!0),t=n.input.charCodeAt(++n.position),t===39)i=n.position,n.position++,r=n.position;else return!0;else z(t)?(ee(n,i,r,!0),Ln(n,U(n,!1,e)),i=r=n.position):n.position===n.lineStart&&nn(n)?T(n,"unexpected end of the document within a single quoted scalar"):(n.position++,r=n.position);T(n,"unexpected end of the stream within a single quoted scalar")}function Dl(n,e){var t,i,r,o,s,a;if(a=n.input.charCodeAt(n.position),a!==34)return!1;for(n.kind="scalar",n.result="",n.position++,t=i=n.position;(a=n.input.charCodeAt(n.position))!==0;){if(a===34)return ee(n,t,n.position,!0),n.position++,!0;if(a===92){if(ee(n,t,n.position,!0),a=n.input.charCodeAt(++n.position),z(a))U(n,!1,e);else if(a<256&&ri[a])n.result+=oi[a],n.position++;else if((s=Sl(a))>0){for(r=s,o=0;r>0;r--)a=n.input.charCodeAt(++n.position),(s=Il(a))>=0?o=(o<<4)+s:T(n,"expected hexadecimal character");n.result+=El(o),n.position++}else T(n,"unknown escape sequence");t=i=n.position}else z(a)?(ee(n,t,i,!0),Ln(n,U(n,!1,e)),t=i=n.position):n.position===n.lineStart&&nn(n)?T(n,"unexpected end of the document within a double quoted scalar"):(n.position++,i=n.position)}T(n,"unexpected end of the stream within a double quoted scalar")}function Nl(n,e){var t=!0,i,r=n.tag,o,s=n.anchor,a,l,c,d,h,p={},u,m,g,y;if(y=n.input.charCodeAt(n.position),y===91)l=93,h=!1,o=[];else if(y===123)l=125,h=!0,o={};else return!1;for(n.anchor!==null&&(n.anchorMap[n.anchor]=o),y=n.input.charCodeAt(++n.position);y!==0;){if(U(n,!0,e),y=n.input.charCodeAt(n.position),y===l)return n.position++,n.tag=r,n.anchor=s,n.kind=h?"mapping":"sequence",n.result=o,!0;t||T(n,"missed comma between flow collection entries"),m=u=g=null,c=d=!1,y===63&&(a=n.input.charCodeAt(n.position+1),Y(a)&&(c=d=!0,n.position++,U(n,!0,e))),i=n.line,_e(n,e,Qe,!1,!0),m=n.tag,u=n.result,U(n,!0,e),y=n.input.charCodeAt(n.position),(d||n.line===i)&&y===58&&(c=!0,y=n.input.charCodeAt(++n.position),U(n,!0,e),_e(n,e,Qe,!1,!0),g=n.result),h?ye(n,o,p,m,u,g):c?o.push(ye(n,null,p,m,u,g)):o.push(u),U(n,!0,e),y=n.input.charCodeAt(n.position),y===44?(t=!0,y=n.input.charCodeAt(++n.position)):t=!1}T(n,"unexpected end of the stream within a flow collection")}function Ol(n,e){var t,i,r=fn,o=!1,s=!1,a=e,l=0,c=!1,d,h;if(h=n.input.charCodeAt(n.position),h===124)i=!1;else if(h===62)i=!0;else return!1;for(n.kind="scalar",n.result="";h!==0;)if(h=n.input.charCodeAt(++n.position),h===43||h===45)fn===r?r=h===43?Ct:xl:T(n,"repeat of a chomping mode identifier");else if((d=Al(h))>=0)d===0?T(n,"bad explicit indentation width of a block scalar; it cannot be less than one"):s?T(n,"repeat of an indentation width identifier"):(a=e+d-1,s=!0);else break;if(se(h)){do h=n.input.charCodeAt(++n.position);while(se(h));if(h===35)do h=n.input.charCodeAt(++n.position);while(!z(h)&&h!==0)}for(;h!==0;){for(Rn(n),n.lineIndent=0,h=n.input.charCodeAt(n.position);(!s||n.lineIndent<a)&&h===32;)n.lineIndent++,h=n.input.charCodeAt(++n.position);if(!s&&n.lineIndent>a&&(a=n.lineIndent),z(h)){l++;continue}if(n.lineIndent<a){r===Ct?n.result+=J.repeat(`
...
`,l):n.result+=J.repeat(`
`,o?1+l:l),o=!0,s=!0,l=0,t=n.position;!z(h)&&h!==0;)h=n.input.charCodeAt(++n.position);ee(n,t,n.position,!1)}return!0}function At(n,e){var t,i=n.tag,r=n.anchor,o=[],s,a=!1,l;for(n.anchor!==null&&(n.anchorMap[n.anchor]=o),l=n.input.charCodeAt(n.position);l!==0&&!(l!==45||(s=n.input.charCodeAt(n.position+1),!Y(s)));){if(a=!0,n.position++,U(n,!0,-1)&&n.lineIndent<=e){o.push(null),l=n.input.charCodeAt(n.position);continue}if(t=n.line,_e(n,e,ei,!1,!0),o.push(n.result),U(n,!0,-1),l=n.input.charCodeAt(n.position),(n.line===t||n.lineIndent>e)&&l!==0)T(n,"bad indentation of a sequence entry");else if(n.lineIndent<e)break}return a?(n.tag=i,n.anchor=r,n.kind="sequence",n.result=o,!0):!1}function Pl(n,e,t){var i,r,o,s,a=n.tag,l=n.anchor,c={},d={},h=null,p=null,u=null,m=!1,g=!1,y;for(n.anchor!==null&&(n.anchorMap[n.anchor]=c),y=n.input.charCodeAt(n.position);y!==0;){if(i=n.input.charCodeAt(n.position+1),o=n.line,s=n.position,(y===63||y===58)&&Y(i))y===63?(m&&(ye(n,c,d,h,p,null),h=p=u=null),g=!0,m=!0,r=!0):m?(m=!1,r=!0):T(n,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),n.position+=1,y=i;else if(_e(n,t,Zt,!1,!0))if(n.line===o){for(y=n.input.charCodeAt(n.position);se(y);)y=n.input.charCodeAt(++n.position);if(y===58)y=n.input.charCodeAt(++n.position),Y(y)||T(n,"a whitespace character is expected after the key-value separator within a block mapping"),m&&(ye(n,c,d,h,p,null),h=p=u=null),g=!0,m=!1,r=!1,h=n.tag,p=n.result;else if(g)T(n,"can not read an implicit mapping pair; a colon is missed");else return n.tag=a,n.anchor=l,!0}else if(g)T(n,"can not read a block mapping entry; a multiline key may not be an implicit key");else return n.tag=a,n.anchor=l,!0;else break;if((n.line===o||n.lineIndent>e)&&(_e(n,e,Xe,!0,r)&&(m?p=n.result:u=n.result),m||(ye(n,c,d,h,p,u,o,s),h=p=u=null),U(n,!0,-1),y=n.input.charCodeAt(n.position)),n.lineIndent>e&&y!==0)T(n,"bad indentation of a mapping entry");else if(n.lineIndent<e)break}return m&&ye(n,c,d,h,p,null),g&&(n.tag=a,n.anchor=l,n.kind="mapping",n.result=c),g}function Bl(n){var e,t=!1,i=!1,r,o,s;if(s=n.input.charCodeAt(n.position),s!==33)return!1;if(n.tag!==null&&T(n,"duplication of a tag property"),s=n.input.charCodeAt(++n.position),s===60?(t=!0,s=n.input.charCodeAt(++n.position)):s===33?(i=!0,r="!!",s=n.input.charCodeAt(++n.position)):r="!",e=n.position,t){do s=n.input.charCodeAt(++n.position);while(s!==0&&s!==62);n.position<n.length?(o=n.input.slice(e,n.position),s=n.input.charCodeAt(++n.position)):T(n,"unexpected end of the stream within a verbatim tag")}else{for(;s!==0&&!Y(s);)s===33&&(i?T(n,"tag suffix cannot contain exclamation marks"):(r=n.input.slice(e-1,n.position+1),ni.test(r)||T(n,"named tag handle cannot contain such characters"),i=!0,e=n.position+1)),s=n.input.charCodeAt(++n.position);o=n.input.slice(e,n.position),Ml.test(o)&&T(n,"tag suffix cannot contain flow indicator characters")}return o&&!ti.test(o)&&T(n,"tag name cannot contain such characters: "+o),t?n.tag=o:ne.call(n.tagMap,r)?n.tag=n.tagMap[r]+o:r==="!"?n.tag="!"+o:r==="!!"?n.tag="tag:yaml.org,2002:"+o:T(n,'undeclared tag handle "'+r+'"'),!0}function Ul(n){var e,t;if(t=n.input.charCodeAt(n.position),t!==38)return!1;for(n.anchor!==null&&T(n,"duplication of an anchor property"),t=n.input.charCodeAt(++n.position),e=n.position;t!==0&&!Y(t)&&!ge(t);)t=n.input.charCodeAt(++n.position);return n.position===e&&T(n,"name of an anchor node must contain at least one character"),n.anchor=n.input.slice(e,n.position),!0}function Hl(n){var e,t,i;if(i=n.input.charCodeAt(n.position),i!==42)return!1;for(i=n.input.charCodeAt(++n.position),e=n.position;i!==0&&!Y(i)&&!ge(i);)i=n.input.charCodeAt(++n.position);return n.position===e&&T(n,"name of an alias node must contain at least one character"),t=n.input.slice(e,n.position),ne.call(n.anchorMap,t)||T(n,'unidentified alias "'+t+'"'),n.result=n.anchorMap[t],U(n,!0,-1),!0}function _e(n,e,t,i,r){var o,s,a,l=1,c=!1,d=!1,h,p,u,m,g;if(n.listener!==null&&n.listener("open",n),n.tag=null,n.anchor=null,n.kind=null,n.result=null,o=s=a=Xe===t||ei===t,i&&U(n,!0,-1)&&(c=!0,n.lineIndent>e?l=1:n.lineIndent===e?l=0:n.lineIndent<e&&(l=-1)),l===1)for(;Bl(n)||Ul(n);)U(n,!0,-1)?(c=!0,a=o,n.lineIndent>e?l=1:n.lineIndent===e?l=0:n.lineIndent<e&&(l=-1)):a=!1;if(a&&(a=c||r),(l===1||Xe===t)&&(Qe===t||Zt===t?m=e:m=e+1,g=n.position-n.lineStart,l===1?a&&(At(n,g)||Pl(n,g,m))||Nl(n,m)?d=!0:(s&&Ol(n,m)||Fl(n,m)||Dl(n,m)?d=!0:Hl(n)?(d=!0,(n.tag!==null||n.anchor!==null)&&T(n,"alias node should not have any properties")):Ll(n,m,Qe===t)&&(d=!0,n.tag===null&&(n.tag="?")),n.anchor!==null&&(n.anchorMap[n.anchor]=n.result)):l===0&&(d=a&&At(n,g))),n.tag!==null&&n.tag!=="!")if(n.tag==="?"){for(n.result!==null&&n.kind!=="scalar"&&T(n,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+n.kind+'"'),h=0,p=n.implicitTypes.length;h<p;h+=1)if(u=n.implicitTypes[h],u.resolve(n.result)){n.result=u.construct(n.result),n.tag=u.tag,n.anchor!==null&&(n.anchorMap[n.anchor]=n.result);break}}else ne.call(n.typeMap[n.kind||"fallback"],n.tag)?(u=n.typeMap[n.kind||"fallback"][n.tag],n.result!==null&&u.kind!==n.kind&&T(n,"unacceptable node kind for !<"+n.tag+'> tag; it should be "'+u.kind+'", not "'+n.kind+'"'),u.resolve(n.result)?(n.result=u.construct(n.result),n.anchor!==null&&(n.anchorMap[n.anchor]=n.result)):T(n,"cannot resolve a node with !<"+n.tag+"> explicit tag")):T(n,"unknown tag !<"+n.tag+">");return n.listener!==null&&n.listener("close",n),n.tag!==null||n.anchor!==null||d}function $l(n){var e=n.position,t,i,r,o=!1,s;for(n.version=null,n.checkLineBreaks=n.legacy,n.tagMap={},n.anchorMap={};(s=n.input.charCodeAt(n.position))!==0&&(U(n,!0,-1),s=n.input.charCodeAt(n.position),!(n.lineIndent>0||s!==37));){for(o=!0,s=n.input.charCodeAt(++n.position),t=n.position;s!==0&&!Y(s);)s=n.input.charCodeAt(++n.position);for(i=n.input.slice(t,n.position),r=[],i.length<1&&T(n,"directive name must not be less than one character in length");s!==0;){for(;se(s);)s=n.input.charCodeAt(++n.position);if(s===35){do s=n.input.charCodeAt(++n.position);while(s!==0&&!z(s));break}if(z(s))break;for(t=n.position;s!==0&&!Y(s);)s=n.input.charCodeAt(++n.position);r.push(n.input.slice(t,n.position))}s!==0&&Rn(n),ne.call(It,i)?It[i](n,i,r):Je(n,'unknown document directive "'+i+'"')}if(U(n,!0,-1),n.lineIndent===0&&n.input.charCodeAt(n.position)===45&&n.input.charCodeAt(n.position+1)===45&&n.input.charCodeAt(n.position+2)===45?(n.position+=3,U(n,!0,-1)):o&&T(n,"directives end mark is expected"),_e(n,n.lineIndent-1,Xe,!1,!0),U(n,!0,-1),n.checkLineBreaks&&Tl.test(n.input.slice(e,n.position))&&Je(n,"non-ASCII line breaks are interpreted as content"),n.documents.push(n.result),n.position===n.lineStart&&nn(n)){n.input.charCodeAt(n.position)===46&&(n.position+=3,U(n,!0,-1));return}if(n.position<n.length-1)T(n,"end of the stream or a document separator is expected");else return}function ai(n,e){n=String(n),e=e||{},n.length!==0&&(n.charCodeAt(n.length-1)!==10&&n.charCodeAt(n.length-1)!==13&&(n+=`
`),n.charCodeAt(0)===65279&&(n=n.slice(1)));var t=new Rl(n,e),i=n.indexOf("\0");for(i!==-1&&(t.position=i,T(t,"null byte is not allowed in input")),t.input+="\0";t.input.charCodeAt(t.position)===32;)t.lineIndent+=1,t.position+=1;for(;t.position<t.length-1;)$l(t);return t.documents}function li(n,e,t){e!==null&&typeof e=="object"&&typeof t>"u"&&(t=e,e=null);var i=ai(n,t);if(typeof e!="function")return i;for(var r=0,o=i.length;r<o;r+=1)e(i[r])}function ci(n,e){var t=ai(n,e);if(t.length!==0){if(t.length===1)return t[0];throw new Xt("expected a single document in the stream, but found more")}}function Gl(n,e,t){return typeof e=="object"&&e!==null&&typeof t>"u"&&(t=e,e=null),li(n,e,J.extend({schema:Jt},t))}function Wl(n,e){return ci(n,J.extend({schema:Jt},e))}Re.loadAll=li;Re.load=ci;Re.safeLoadAll=Gl;Re.safeLoad=Wl;var Fn={},De=q,Ne=Le,jl=en,Kl=Fe,di=Object.prototype.toString,hi=Object.prototype.hasOwnProperty,Yl=9,Ee=10,ql=13,Vl=32,zl=33,Ql=34,ui=35,Xl=37,Jl=38,Zl=39,ec=42,pi=44,nc=45,mi=58,tc=61,ic=62,rc=63,oc=64,fi=91,gi=93,sc=96,yi=123,ac=124,_i=125,G={};G[0]="\\0";G[7]="\\a";G[8]="\\b";G[9]="\\t";G[10]="\\n";G[11]="\\v";G[12]="\\f";G[13]="\\r";G[27]="\\e";G[34]='\\"';G[92]="\\\\";G[133]="\\N";G[160]="\\_";G[8232]="\\L";G[8233]="\\P";var lc=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"];function cc(n,e){var t,i,r,o,s,a,l;if(e===null)return{};for(t={},i=Object.keys(e),r=0,o=i.length;r<o;r+=1)s=i[r],a=String(e[s]),s.slice(0,2)==="!!"&&(s="tag:yaml.org,2002:"+s.slice(2)),l=n.compiledTypeMap.fallback[s],l&&hi.call(l.styleAliases,a)&&(a=l.styleAliases[a]),t[s]=a;return t}function Et(n){var e,t,i;if(e=n.toString(16).toUpperCase(),n<=255)t="x",i=2;else if(n<=65535)t="u",i=4;else if(n<=4294967295)t="U",i=8;else throw new Ne("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+t+De.repeat("0",i-e.length)+e}function dc(n){this.schema=n.schema||jl,this.indent=Math.max(1,n.indent||2),this.noArrayIndent=n.noArrayIndent||!1,this.skipInvalid=n.skipInvalid||!1,this.flowLevel=De.isNothing(n.flowLevel)?-1:n.flowLevel,this.styleMap=cc(this.schema,n.styles||null),this.sortKeys=n.sortKeys||!1,this.lineWidth=n.lineWidth||80,this.noRefs=n.noRefs||!1,this.noCompatMode=n.noCompatMode||!1,this.condenseFlow=n.condenseFlow||!1,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Rt(n,e){for(var t=De.repeat(" ",e),i=0,r=-1,o="",s,a=n.length;i<a;)r=n.indexOf(`
`,i),r===-1?(s=n.slice(i),i=a):(s=n.slice(i,r+1),i=r+1),s.length&&s!==`
`&&(o+=t),o+=s;return o}function wn(n,e){return`
`+De.repeat(" ",n.indent*e)}function hc(n,e){var t,i,r;for(t=0,i=n.implicitTypes.length;t<i;t+=1)if(r=n.implicitTypes[t],r.resolve(e))return!0;return!1}function Dn(n){return n===Vl||n===Yl}function be(n){return 32<=n&&n<=126||161<=n&&n<=55295&&n!==8232&&n!==8233||57344<=n&&n<=65533&&n!==65279||65536<=n&&n<=1114111}function uc(n){return be(n)&&!Dn(n)&&n!==65279&&n!==ql&&n!==Ee}function Lt(n,e){return be(n)&&n!==65279&&n!==pi&&n!==fi&&n!==gi&&n!==yi&&n!==_i&&n!==mi&&(n!==ui||e&&uc(e))}function pc(n){return be(n)&&n!==65279&&!Dn(n)&&n!==nc&&n!==rc&&n!==mi&&n!==pi&&n!==fi&&n!==gi&&n!==yi&&n!==_i&&n!==ui&&n!==Jl&&n!==ec&&n!==zl&&n!==ac&&n!==tc&&n!==ic&&n!==Zl&&n!==Ql&&n!==Xl&&n!==oc&&n!==sc}function bi(n){var e=/^\n* /;return e.test(n)}var vi=1,wi=2,ki=3,xi=4,qe=5;function mc(n,e,t,i,r){var o,s,a,l=!1,c=!1,d=i!==-1,h=-1,p=pc(n.charCodeAt(0))&&!Dn(n.charCodeAt(n.length-1));if(e)for(o=0;o<n.length;o++){if(s=n.charCodeAt(o),!be(s))return qe;a=o>0?n.charCodeAt(o-1):null,p=p&&Lt(s,a)}else{for(o=0;o<n.length;o++){if(s=n.charCodeAt(o),s===Ee)l=!0,d&&(c=c||o-h-1>i&&n[h+1]!==" ",h=o);else if(!be(s))return qe;a=o>0?n.charCodeAt(o-1):null,p=p&&Lt(s,a)}c=c||d&&o-h-1>i&&n[h+1]!==" "}return!l&&!c?p&&!r(n)?vi:wi:t>9&&bi(n)?qe:c?xi:ki}function fc(n,e,t,i){n.dump=function(){if(e.length===0)return"''";if(!n.noCompatMode&&lc.indexOf(e)!==-1)return"'"+e+"'";var r=n.indent*Math.max(1,t),o=n.lineWidth===-1?-1:Math.max(Math.min(n.lineWidth,40),n.lineWidth-r),s=i||n.flowLevel>-1&&t>=n.flowLevel;function a(l){return hc(n,l)}switch(mc(e,s,n.indent,o,a)){case vi:return e;case wi:return"'"+e.replace(/'/g,"''")+"'";case ki:return"|"+Ft(e,n.indent)+Dt(Rt(e,r));case xi:return">"+Ft(e,n.indent)+Dt(Rt(gc(e,o),r));case qe:return'"'+yc(e)+'"';default:throw new Ne("impossible error: invalid scalar style")}}()}function Ft(n,e){var t=bi(n)?String(e):"",i=n[n.length-1]===`
`,r=i&&(n[n.length-2]===`
`||n===`
`),o=r?"+":i?"":"-";return t+o+`
`}function Dt(n){return n[n.length-1]===`
`?n.slice(0,-1):n}function gc(n,e){for(var t=/(\n+)([^\n]*)/g,i=function(){var c=n.indexOf(`
`);return c=c!==-1?c:n.length,t.lastIndex=c,Nt(n.slice(0,c),e)}(),r=n[0]===`
`||n[0]===" ",o,s;s=t.exec(n);){var a=s[1],l=s[2];o=l[0]===" ",i+=a+(!r&&!o&&l!==""?`
`:"")+Nt(l,e),r=o}return i}function Nt(n,e){if(n===""||n[0]===" ")return n;for(var t=/ [^ ]/g,i,r=0,o,s=0,a=0,l="";i=t.exec(n);)a=i.index,a-r>e&&(o=s>r?s:a,l+=`
`+n.slice(r,o),r=o+1),s=a;return l+=`
`,n.length-r>e&&s>r?l+=n.slice(r,s)+`
`+n.slice(s+1):l+=n.slice(r),l.slice(1)}function yc(n){for(var e="",t,i,r,o=0;o<n.length;o++){if(t=n.charCodeAt(o),t>=55296&&t<=56319&&(i=n.charCodeAt(o+1),i>=56320&&i<=57343)){e+=Et((t-55296)*1024+i-56320+65536),o++;continue}r=G[t],e+=!r&&be(t)?n[o]:r||Et(t)}return e}function _c(n,e,t){var i="",r=n.tag,o,s;for(o=0,s=t.length;o<s;o+=1)ce(n,e,t[o],!1,!1)&&(o!==0&&(i+=","+(n.condenseFlow?"":" ")),i+=n.dump);n.tag=r,n.dump="["+i+"]"}function bc(n,e,t,i){var r="",o=n.tag,s,a;for(s=0,a=t.length;s<a;s+=1)ce(n,e+1,t[s],!0,!0)&&((!i||s!==0)&&(r+=wn(n,e)),n.dump&&Ee===n.dump.charCodeAt(0)?r+="-":r+="- ",r+=n.dump);n.tag=o,n.dump=r||"[]"}function vc(n,e,t){var i="",r=n.tag,o=Object.keys(t),s,a,l,c,d;for(s=0,a=o.length;s<a;s+=1)d="",s!==0&&(d+=", "),n.condenseFlow&&(d+='"'),l=o[s],c=t[l],ce(n,e,l,!1,!1)&&(n.dump.length>1024&&(d+="? "),d+=n.dump+(n.condenseFlow?'"':"")+":"+(n.condenseFlow?"":" "),ce(n,e,c,!1,!1)&&(d+=n.dump,i+=d));n.tag=r,n.dump="{"+i+"}"}function wc(n,e,t,i){var r="",o=n.tag,s=Object.keys(t),a,l,c,d,h,p;if(n.sortKeys===!0)s.sort();else if(typeof n.sortKeys=="function")s.sort(n.sortKeys);else if(n.sortKeys)throw new Ne("sortKeys must be a boolean or a function");for(a=0,l=s.length;a<l;a+=1)p="",(!i||a!==0)&&(p+=wn(n,e)),c=s[a],d=t[c],ce(n,e+1,c,!0,!0,!0)&&(h=n.tag!==null&&n.tag!=="?"||n.dump&&n.dump.length>1024,h&&(n.dump&&Ee===n.dump.charCodeAt(0)?p+="?":p+="? "),p+=n.dump,h&&(p+=wn(n,e)),ce(n,e+1,d,!0,h)&&(n.dump&&Ee===n.dump.charCodeAt(0)?p+=":":p+=": ",p+=n.dump,r+=p));n.tag=o,n.dump=r||"{}"}function Ot(n,e,t){var i,r,o,s,a,l;for(r=t?n.explicitTypes:n.implicitTypes,o=0,s=r.length;o<s;o+=1)if(a=r[o],(a.instanceOf||a.predicate)&&(!a.instanceOf||typeof e=="object"&&e instanceof a.instanceOf)&&(!a.predicate||a.predicate(e))){if(n.tag=t?a.tag:"?",a.represent){if(l=n.styleMap[a.tag]||a.defaultStyle,di.call(a.represent)==="[object Function]")i=a.represent(e,l);else if(hi.call(a.represent,l))i=a.represent[l](e,l);else throw new Ne("!<"+a.tag+'> tag resolver accepts not "'+l+'" style');n.dump=i}return!0}return!1}function ce(n,e,t,i,r,o){n.tag=null,n.dump=t,Ot(n,t,!1)||Ot(n,t,!0);var s=di.call(n.dump);i&&(i=n.flowLevel<0||n.flowLevel>e);var a=s==="[object Object]"||s==="[object Array]",l,c;if(a&&(l=n.duplicates.indexOf(t),c=l!==-1),(n.tag!==null&&n.tag!=="?"||c||n.indent!==2&&e>0)&&(r=!1),c&&n.usedDuplicates[l])n.dump="*ref_"+l;else{if(a&&c&&!n.usedDuplicates[l]&&(n.usedDuplicates[l]=!0),s==="[object Object]")i&&Object.keys(n.dump).length!==0?(wc(n,e,n.dump,r),c&&(n.dump="&ref_"+l+n.dump)):(vc(n,e,n.dump),c&&(n.dump="&ref_"+l+" "+n.dump));else if(s==="[object Array]"){var d=n.noArrayIndent&&e>0?e-1:e;i&&n.dump.length!==0?(bc(n,d,n.dump,r),c&&(n.dump="&ref_"+l+n.dump)):(_c(n,d,n.dump),c&&(n.dump="&ref_"+l+" "+n.dump))}else if(s==="[object String]")n.tag!=="?"&&fc(n,n.dump,e,o);else{if(n.skipInvalid)return!1;throw new Ne("unacceptable kind of an object to dump "+s)}n.tag!==null&&n.tag!=="?"&&(n.dump="!<"+n.tag+"> "+n.dump)}return!0}function kc(n,e){var t=[],i=[],r,o;for(kn(n,t,i),r=0,o=i.length;r<o;r+=1)e.duplicates.push(t[i[r]]);e.usedDuplicates=new Array(o)}function kn(n,e,t){var i,r,o;if(n!==null&&typeof n=="object")if(r=e.indexOf(n),r!==-1)t.indexOf(r)===-1&&t.push(r);else if(e.push(n),Array.isArray(n))for(r=0,o=n.length;r<o;r+=1)kn(n[r],e,t);else for(i=Object.keys(n),r=0,o=i.length;r<o;r+=1)kn(n[i[r]],e,t)}function Ci(n,e){e=e||{};var t=new dc(e);return t.noRefs||kc(n,t),ce(t,0,n,!0,!0)?t.dump+`
`:""}function xc(n,e){return Ci(n,De.extend({schema:Kl},e))}Fn.dump=Ci;Fn.safeDump=xc;var tn=Re,Ti=Fn;function rn(n){return function(){throw new Error("Function "+n+" is deprecated and cannot be used.")}}P.Type=H;P.Schema=ve;P.FAILSAFE_SCHEMA=An;P.JSON_SCHEMA=Yt;P.CORE_SCHEMA=qt;P.DEFAULT_SAFE_SCHEMA=Fe;P.DEFAULT_FULL_SCHEMA=en;P.load=tn.load;P.loadAll=tn.loadAll;P.safeLoad=tn.safeLoad;P.safeLoadAll=tn.safeLoadAll;P.dump=Ti.dump;P.safeDump=Ti.safeDump;P.YAMLException=Le;P.MINIMAL_SCHEMA=An;P.SAFE_SCHEMA=Fe;P.DEFAULT_SCHEMA=en;P.scan=rn("scan");P.parse=rn("parse");P.compose=rn("compose");P.addConstructor=rn("addConstructor");var Cc=P,Tc=Cc;function Mc(n){if(!n.startsWith(`---
`))return{data:{},content:n};const e=n.indexOf(`
---`,4);if(e===-1)return{data:{},content:n};const t=n.slice(4,e),i=n.slice(e+4),r=i.startsWith(`
`)?i.slice(1):i;return{data:Tc.safeLoad(t)??{},content:r}}const Mi={npc:{specialNameChance:.3},missions:{boardMaxCount:8,missionTtlMs:9e5,deliveryChance:.6,deliveryBaseReward:200,deliveryRandomReward:200,supplyRewardMultiplierMin:1.15,supplyRewardMultiplierMax:1.5,supplyRequirementsMin:1,supplyRequirementsMax:2,supplyQtyMin:3,supplyQtyMax:10,deliveryDepositFraction:.2},trading:{stockCountMin:4,stockCountMax:6,stockQtyMin:5,stockQtyMax:10,stockTtlMs:12e4,stockRepCountBonusPerLevel:1,stockRepCountBonusMin:-2,stockRepCountBonusMax:3,stockRepQtyBonusPerLevel:2,stockRepQtyBonusMin:-4,stockRepQtyBonusMax:6},fuel:{pricePerLitre:10,consumptionPerLy:5,inSystemBaseConsumptionL:4},reputation:{levelUnfriendlyMin:-300,levelNeutralMin:-100,levelFriendlyMin:100,levelLikedMin:300,levelReveredMin:600,pointsMin:-600,pointsMax:1e3,missionDeltaSmall:25,missionDeltaMedium:75,missionDeltaLarge:200,missionTierMediumReward:300,missionTierLargeReward:600,tradeModifierHated:1.2,tradeModifierUnfriendly:1.1,tradeModifierNeutral:1,tradeModifierFriendly:.92,tradeModifierLiked:.85,tradeModifierRevered:.8,repPerCredit:.01,maxRepPerVisit:10},emergencyRescue:{towFee:500,fuelDropFee:800,fuelDropLitres:15},economies:{minFactor:.75,maxFactor:1.25}};function Ic(n){const e={settings:{player:{name:"Captain",startingCredits:0},startingLocation:{system:"",destination:""},startingShip:""},balance:{...Mi},systems:[],destinations:[],routes:[],drives:[],ships:[],factions:[],commodities:[],economies:[],storyBeats:[],deliveryItems:[],npcNames:{special:[],firstNames:[],lastNames:[]}};for(const[t,i]of Object.entries(n)){const r=t.split("/").pop()??"";if(r==="_template.md"||r===".gitkeep")continue;const{data:o,content:s}=Mc(i);/^systems\/[^/]+\.md$/.test(t)?e.systems.push(Sc(o,s)):/^destinations\/[^/]+\.md$/.test(t)?e.destinations.push(Ac(o,s)):/^factions\/[^/]+\.md$/.test(t)?e.factions.push(Ec(o,s)):/^ships\/[^/]+\.md$/.test(t)?e.ships.push(Rc(o,s)):t==="ships/components/jump-drives.md"?e.drives=Lc(o):t==="navigation/jump-routes.md"?e.routes=Fc(o):t==="commodities.md"?e.commodities=Dc(o):t==="economies.md"?e.economies=Uc(o):/^story\/[^/]+\.md$/.test(t)?e.storyBeats.push(Nc(o,s)):t==="settings/new-game.md"?e.settings=Oc(o):t==="settings/balance.md"?e.balance=Hc(o):t==="delivery-items.md"?e.deliveryItems=Pc(o):t==="npc-names.md"&&(e.npcNames=Bc(o))}return e}function on(n){const e=[];let t=!1;for(const i of n.split(`
`)){const r=i.trim();if(!r.startsWith("#"))if(r===""){if(t)break}else t=!0,e.push(r)}return e.join(" ")}function Sc(n,e){return{id:n.id,name:n.name,starType:n.star_type,distanceFromSol:n.distance_from_sol,zone:n.zone,security:n.security,population:n.population,dangerLevel:n.danger_level,playerKnowledge:n.player_knowledge,economies:n.economies??[],majorFactions:n.major_factions??[],destinations:n.destinations??[],tags:n.tags??[],description:on(e)}}function Ac(n,e){const t=n.amenities??{},i={trader:t.trader??!1,shipRepair:t.ship_repair??!1,fuel:t.fuel??!1,shipDealer:t.ship_dealer??!1};return{id:n.id,name:n.name,system:n.system,locationType:n.location_type,type:n.type,amenities:i,npcs:n.npcs??{},minMissions:n.min_missions??0,missionChance:n.mission_chance??0,dangerLevel:n.danger_level,tags:n.tags??[],description:on(e),owningFactionId:n.owning_faction}}function Ec(n,e){return{id:n.id,name:n.name,type:n.type,homeSystem:n.home_system,size:n.size,influence:n.influence??[],tags:n.tags??[],description:on(e),rivals:n.rivals??[],allies:n.allies??[]}}function Rc(n,e){return{id:n.id,name:n.name,class:n.class,cost:n.cost,cargoCapacityKg:n.cargo_capacity_kg,fuelCapacityL:n.fuel_capacity_l,hullPoints:n.hull_points,defaultJumpDrive:n.default_jump_drive,fuelEfficiency:n.fuel_efficiency,tags:n.tags??[],description:on(e)}}function Lc(n){return(n.drives??[]).map(t=>({id:t.id,name:t.name,maxDistanceLy:t.max_distance_ly,fuelEfficiency:t.fuel_efficiency,cost:t.cost}))}function Fc(n){return(n.routes??[]).map(t=>({from:t.from,to:t.to,distance:t.distance,stability:t.stability,security:t.security}))}function Dc(n){return(n.commodities??[]).map(t=>({id:t.id,name:t.name,basePrice:t.base_price,category:t.category,legal:t.legal,weightKg:t.weight_kg,description:t.description??""}))}function Nc(n,e){return{id:n.id,title:n.title,trigger:n.trigger,type:n.type,location:n.location,skippable:n.skippable,playerKnowledge:n.player_knowledge,text:e.trim()}}function Oc(n){var e,t,i,r;return{player:{name:((e=n.player)==null?void 0:e.name)??"Captain",startingCredits:((t=n.player)==null?void 0:t.starting_credits)??0},startingLocation:{system:((i=n.starting_location)==null?void 0:i.system)??"",destination:((r=n.starting_location)==null?void 0:r.destination)??""},startingShip:n.starting_ship??""}}function Pc(n){return(n.delivery_items??[]).map(t=>({id:t.id,name:t.name,weightKg:t.weight_kg}))}function Bc(n){const e=n.npc_names??{};return{special:e.special??[],firstNames:e.first_names??[],lastNames:e.last_names??[]}}function Uc(n){return(n.economies??[]).map(t=>({id:t.id,summary:t.summary,commodities:(t.commodities??[]).map(i=>({id:i.id,factor:i.factor}))}))}function Hc(n){const e=Mi,t=n.npc??{},i=n.missions??{},r=n.trading??{},o=n.fuel??{},s=n.reputation??{},a=n.emergency_rescue??{},l=n.economies??{};return{npc:{specialNameChance:t.special_name_chance??e.npc.specialNameChance},missions:{boardMaxCount:i.board_max_count??e.missions.boardMaxCount,missionTtlMs:i.mission_ttl_ms??e.missions.missionTtlMs,deliveryChance:i.delivery_chance??e.missions.deliveryChance,deliveryBaseReward:i.delivery_base_reward??e.missions.deliveryBaseReward,deliveryRandomReward:i.delivery_random_reward??e.missions.deliveryRandomReward,supplyRewardMultiplierMin:i.supply_reward_multiplier_min??e.missions.supplyRewardMultiplierMin,supplyRewardMultiplierMax:i.supply_reward_multiplier_max??e.missions.supplyRewardMultiplierMax,supplyRequirementsMin:i.supply_requirements_min??e.missions.supplyRequirementsMin,supplyRequirementsMax:i.supply_requirements_max??e.missions.supplyRequirementsMax,supplyQtyMin:i.supply_qty_min??e.missions.supplyQtyMin,supplyQtyMax:i.supply_qty_max??e.missions.supplyQtyMax,deliveryDepositFraction:i.delivery_deposit_fraction??e.missions.deliveryDepositFraction},trading:{stockCountMin:r.stock_count_min??e.trading.stockCountMin,stockCountMax:r.stock_count_max??e.trading.stockCountMax,stockQtyMin:r.stock_qty_min??e.trading.stockQtyMin,stockQtyMax:r.stock_qty_max??e.trading.stockQtyMax,stockTtlMs:r.stock_ttl_ms??e.trading.stockTtlMs,stockRepCountBonusPerLevel:r.stock_rep_count_bonus_per_level??e.trading.stockRepCountBonusPerLevel,stockRepCountBonusMin:r.stock_rep_count_bonus_min??e.trading.stockRepCountBonusMin,stockRepCountBonusMax:r.stock_rep_count_bonus_max??e.trading.stockRepCountBonusMax,stockRepQtyBonusPerLevel:r.stock_rep_qty_bonus_per_level??e.trading.stockRepQtyBonusPerLevel,stockRepQtyBonusMin:r.stock_rep_qty_bonus_min??e.trading.stockRepQtyBonusMin,stockRepQtyBonusMax:r.stock_rep_qty_bonus_max??e.trading.stockRepQtyBonusMax},fuel:{pricePerLitre:o.price_per_litre??e.fuel.pricePerLitre,consumptionPerLy:o.consumption_per_ly??e.fuel.consumptionPerLy,inSystemBaseConsumptionL:o.in_system_base_consumption_l??e.fuel.inSystemBaseConsumptionL},reputation:{levelUnfriendlyMin:s.level_unfriendly_min??e.reputation.levelUnfriendlyMin,levelNeutralMin:s.level_neutral_min??e.reputation.levelNeutralMin,levelFriendlyMin:s.level_friendly_min??e.reputation.levelFriendlyMin,levelLikedMin:s.level_liked_min??e.reputation.levelLikedMin,levelReveredMin:s.level_revered_min??e.reputation.levelReveredMin,pointsMin:s.points_min??e.reputation.pointsMin,pointsMax:s.points_max??e.reputation.pointsMax,missionDeltaSmall:s.mission_delta_small??e.reputation.missionDeltaSmall,missionDeltaMedium:s.mission_delta_medium??e.reputation.missionDeltaMedium,missionDeltaLarge:s.mission_delta_large??e.reputation.missionDeltaLarge,missionTierMediumReward:s.mission_tier_medium_reward??e.reputation.missionTierMediumReward,missionTierLargeReward:s.mission_tier_large_reward??e.reputation.missionTierLargeReward,tradeModifierHated:s.trade_modifier_hated??e.reputation.tradeModifierHated,tradeModifierUnfriendly:s.trade_modifier_unfriendly??e.reputation.tradeModifierUnfriendly,tradeModifierNeutral:s.trade_modifier_neutral??e.reputation.tradeModifierNeutral,tradeModifierFriendly:s.trade_modifier_friendly??e.reputation.tradeModifierFriendly,tradeModifierLiked:s.trade_modifier_liked??e.reputation.tradeModifierLiked,tradeModifierRevered:s.trade_modifier_revered??e.reputation.tradeModifierRevered,repPerCredit:s.rep_per_credit??e.reputation.repPerCredit,maxRepPerVisit:s.max_rep_per_visit??e.reputation.maxRepPerVisit},emergencyRescue:{towFee:a.tow_fee??e.emergencyRescue.towFee,fuelDropFee:a.fuel_drop_fee??e.emergencyRescue.fuelDropFee,fuelDropLitres:a.fuel_drop_litres??e.emergencyRescue.fuelDropLitres},economies:{minFactor:l.min_factor??e.economies.minFactor,maxFactor:l.max_factor??e.economies.maxFactor}}}function $c(){const n=Object.assign({"/docs/world/commodities.md":Eo,"/docs/world/delivery-items.md":Ro,"/docs/world/destinations/_template.md":Lo,"/docs/world/destinations/blackwake-yard.md":Fo,"/docs/world/destinations/ceti-landfall.md":Do,"/docs/world/destinations/drift-market.md":No,"/docs/world/destinations/elysium-station.md":Oo,"/docs/world/destinations/eridani-anchorage.md":Po,"/docs/world/destinations/foundries-platform.md":Bo,"/docs/world/destinations/galileo-transfer.md":Uo,"/docs/world/destinations/hestia-ring.md":Ho,"/docs/world/destinations/keelhaul-station.md":$o,"/docs/world/destinations/kepler-yard.md":Go,"/docs/world/destinations/mars-anchor.md":Wo,"/docs/world/destinations/meridian-station.md":jo,"/docs/world/destinations/new-horizon-port.md":Ko,"/docs/world/destinations/orrery-anchorage.md":Yo,"/docs/world/destinations/redline-station.md":qo,"/docs/world/destinations/tycho-orbital.md":Vo,"/docs/world/destinations/veil-station.md":zo,"/docs/world/destinations/waypoint-ceti.md":Qo,"/docs/world/economies.md":Xo,"/docs/world/factions/_template.md":Jo,"/docs/world/factions/centauri-trade-league.md":Zo,"/docs/world/factions/eridani-colonial-council.md":es,"/docs/world/factions/free-captains.md":ns,"/docs/world/factions/grey-market-cartel.md":ts,"/docs/world/factions/helios-directorate.md":is,"/docs/world/factions/independent-miners-guild.md":rs,"/docs/world/factions/procyon-institute.md":os,"/docs/world/factions/terran-union.md":ss,"/docs/world/galaxy-map.md":as,"/docs/world/navigation/jump-routes.md":ls,"/docs/world/npc-names.md":cs,"/docs/world/settings/balance.md":ds,"/docs/world/settings/new-game.md":hs,"/docs/world/ships/_template.md":us,"/docs/world/ships/components/jump-drives.md":ps,"/docs/world/ships/freighter.md":ms,"/docs/world/ships/hauler.md":fs,"/docs/world/ships/scout.md":gs,"/docs/world/story/_template.md":ys,"/docs/world/story/enter-wolf-359.md":_s,"/docs/world/story/first-jump.md":bs,"/docs/world/story/opening-arrival.md":vs,"/docs/world/systems/_template.md":ws,"/docs/world/systems/alpha-centauri.md":ks,"/docs/world/systems/barnards-star.md":xs,"/docs/world/systems/epsilon-eridani.md":Cs,"/docs/world/systems/procyon.md":Ts,"/docs/world/systems/sirius.md":Ms,"/docs/world/systems/sol.md":Is,"/docs/world/systems/tau-ceti.md":Ss,"/docs/world/systems/wolf-359.md":As}),e={};for(const[t,i]of Object.entries(n)){const r=t.replace("/docs/world/","");e[r]=i}return Ic(e)}Gi($c());const Gc=navigator.maxTouchPoints>0?"touch":"keyboard",Wc=new URLSearchParams(window.location.search).has("debug"),Ii={environment:"browser",primaryInput:Gc,debug:Wc},jc=new Fi,Si=new Pi(Ii);Si.connect();const Kc=new Ao(jc,Si,Ii);let Pt=0;function Ai(n){Kc.tick(n-Pt),Pt=n,requestAnimationFrame(Ai)}requestAnimationFrame(Ai);
