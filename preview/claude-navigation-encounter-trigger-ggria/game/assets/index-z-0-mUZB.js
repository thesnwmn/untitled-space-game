...
You received ${M.reward} CR.${ht}`,confirmLabel:"OKAY",onConfirm:()=>{this.closeModal(),this.onHub()}}))}}}effectiveFuelPrice(){const e=F(),n=e.fuel.pricePerLitre;if(!this.eligibleFactionId)return n;const i=Ee(this.player.getFactionReputation(this.eligibleFactionId),e);return Math.round(n*qt(i,e))}activateCurrent(){const e=this.items;if(e.length===0||this.cursorIdx===-1)return;const n=e[this.cursorIdx];if(!n.disabled){if(this.fuelItemIdx!==null&&this.cursorIdx===this.fuelItemIdx){this.activated=!0;const i=this.effectiveFuelPrice(),o=this.player.fuelCapacityL-this.player.fuelL,r=Math.floor(this.player.credits/i),s=Math.min(o,r);this.openModal(new Tt({title:"BUY FUEL",field:{label:"Litres",initialValue:s,min:0,max:s},derivedRows:[{label:"Cost",compute:a=>`${a*i} CR`}],confirmLabel:"BUY",onConfirm:a=>{this.closeModal(),a>0&&this.onRefuel(a*i,a)},onCancel:()=>{this.closeModal(),this.activated=!1}}));return}this.activated=!0,n.action()}}handleNavAction(e){(e==="BACK"||e==="NAV_1")&&!this.activated&&(this.activated=!0,this.onShip())}handleNavTap(e){e==="undock"&&!this.activated&&(this.activated=!0,this.onShip())}}class Ro extends pe{constructor(e,n,i,o,r,s,a,c,l,h){var g;const d=N(o),p=((g=d.npcs.trader)==null?void 0:g.toUpperCase())??"TRADER",u=[{label:"BUY",items:[]},{label:"SELL",items:[]}];super(p,[],[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,n,i,[],u,h),this.repGainedThisVisit=0,this.traderStock=r,this.onBuy=s,this.onSell=a,this.onHub=c,this.onUndock=l;const m=d.owningFactionId;if(m){const y=ti(m);this.eligibleFactionId=y&&me(y)?m:null}else this.eligibleFactionId=null;this.syncItems(),this.clampCursor()}buyPrice(e,n){return Math.round(e*n)}sellPrice(e,n){return Math.round(e*n)}buildBuyItems(){return this.traderStock.length===0?[{label:"NO STOCK AVAILABLE",disabled:!0,action:()=>{}}]:this.traderStock.flatMap(e=>{const n=de(e.commodityId);if(!n)return[];const i=e.effectiveFactor??1,o=this.buyPrice(n.basePrice,i),r=this.player.credits>=o;return[{label:`${n.name} (x${e.qty})`,info:`${o} CR`,disabled:!r,action:()=>{const s=Math.floor(this.player.credits/o),a=Math.min(e.qty,s);this.openModal(new Tt({title:n.name.toUpperCase(),field:{label:"Quantity",initialValue:a,min:0,max:a},derivedRows:[{label:"Total",compute:c=>`${c*o} CR`}],confirmLabel:"BUY",onConfirm:c=>{c>0&&(this.onBuy(e.commodityId,c,o),this.accrueReputation(c*o)),this.syncItems(),this.clampCursor(),this.closeModal()},onCancel:()=>this.closeModal()}))}}]})}buildSellItems(){const e=this.player.cargoHold;return e.length===0?[{label:"CARGO HOLD EMPTY",disabled:!0,action:()=>{}}]:[...e].flatMap(n=>{const i=de(n.commodityId);if(!i)return[];const o=N(this.player.destinationId??""),r=J(o.system),s=Ze(n.commodityId,r),a=this.sellPrice(i.basePrice,s);return[{label:`${i.name} (x${n.qty})`,info:`${a} CR`,action:()=>{this.openModal(new Tt({title:i.name.toUpperCase(),field:{label:"Quantity",initialValue:n.qty,min:0,max:n.qty},derivedRows:[{label:"Total",compute:c=>`${c*a} CR`}],confirmLabel:"SELL",onConfirm:c=>{c>0&&this.onSell(n.commodityId,c,a),this.syncItems(),this.clampCursor(),this.closeModal()},onCancel:()=>this.closeModal()}))}}]})}accrueReputation(e){if(!this.eligibleFactionId)return;const n=F(),i=n.reputation.maxRepPerVisit-this.repGainedThisVisit;if(i<=0)return;const o=Math.min(i,e*n.reputation.repPerCredit);o<=0||(this.repGainedThisVisit+=o,this.player.modifyFactionReputation(this.eligibleFactionId,o,n))}syncItems(){this.tabs&&(this.tabs[0].items=this.buildBuyItems(),this.tabs[1].items=this.buildSellItems())}clampCursor(){var n;const e=this.items;(this.cursorIdx<0||this.cursorIdx>=e.length||(n=e[this.cursorIdx])!=null&&n.disabled)&&(this.cursorIdx=e.findIndex(i=>!i.disabled))}activateCurrent(){const e=this.items;if(e.length===0||this.cursorIdx<0||this.cursorIdx>=e.length)return;const n=e[this.cursorIdx];n.disabled||n.action()}handleNavAction(e){(e==="BACK"||e==="NAV_2")&&!this.activated?(this.activated=!0,this.onHub()):e==="NAV_1"&&!this.activated&&(this.activated=!0,this.onUndock())}handleNavTap(e){e==="hub"&&!this.activated?(this.activated=!0,this.onHub()):e==="undock"&&!this.activated&&(this.activated=!0,this.onUndock())}render(e){if(this.syncItems(),super.render(e),this.eligibleFactionId){const o=F(),r=this.player.getFactionReputation(this.eligibleFactionId),s=Ee(r,o),c=`STANDING: ${ni(s)}`;f(e,X+2,2,c,"bright-black","black")}const n=e.length,i=Rt(n,!0)-2;f(e,i,2,`HOLD: ${this.player.cargoWeightKg}/${this.player.cargoCapacity}KG`,"bright-black","black")}}const Eo={delivery:"[D] ",supply:"[S] "};class ye extends pe{constructor(e,n,i,o,r,s,a,c,l){N(o);let h;r.length===0?h=[{label:"NO MISSIONS AVAILABLE",disabled:!0,action:()=>{}}]:h=ye.sortMissions(r).map(p=>ye.buildMenuItem(p,i,s)),super("MISSION BOARD",h,[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,n,i,[],null,l),this.onHub=a,this.onUndock=c}handleNavAction(e){(e==="BACK"||e==="NAV_2")&&!this.activated?(this.activated=!0,this.onHub()):e==="NAV_1"&&!this.activated&&(this.activated=!0,this.onUndock())}handleNavTap(e){e==="hub"&&!this.activated?(this.activated=!0,this.onHub()):e==="undock"&&!this.activated&&(this.activated=!0,this.onUndock())}static sortMissions(e){return[...e].sort((n,i)=>{var c,l;const o=((c=N(n.deliveryDestinationId))==null?void 0:c.name)??n.deliveryDestinationId,r=((l=N(i.deliveryDestinationId))==null?void 0:l.name)??i.deliveryDestinationId,s=o.localeCompare(r);if(s!==0)return s;const a={delivery:0,supply:1};return a[n.type]-a[i.type]})}static destColor(e,n){if(e===n.destinationId)return"bright-green";const i=N(e);return i&&i.system===n.systemId?"bright-yellow":"white"}static buildMenuItem(e,n,i){const o=N(e.deliveryDestinationId),r=(o==null?void 0:o.name)??e.deliveryDestinationId,s=[];if(s.push(`Dest: ${r}`),e.giverFactionId){const c=D().factions.find(l=>l.id===e.giverFactionId);c&&s.push(`For: ${c.name}`)}e.type!=="supply"&&s.push("");const a=e.type==="supply"?ye.buildSupplyDetails(e,n):[];return{label:e.title,icon:Eo[e.type],iconFg:"bright-yellow",info:`${e.reward} CR`,infoFg:"bright-green",details:s,detailsFg:ye.destColor(e.deliveryDestinationId,n),detailsColored:a,action:()=>i(e)}}static buildSupplyDetails(e,n){if(e.type!=="supply")return[];const i=e.requirements.map(o=>{const r=D().commodities.find(h=>h.id===o.commodityId),s=(r==null?void 0:r.name)??o.commodityId,a=n.cargoHold.find(h=>h.commodityId===o.commodityId),c=(a==null?void 0:a.qty)??0,l=c>=o.qty;return{left:[{text:`${o.qty}x ${s} `,fg:"white"},{text:`(have: ${c})`,fg:l?"bright-green":"bright-black"}]}});return i.push({left:[]}),i}}class Lo extends z{constructor(e,n,i,o,r,s,a){super(r,s,a,{navOptions:o,title:e}),this.cursorIdx=-1,this.lastChoicesStartRow=0,this._choices=n,this._onBack=i,this.resetCursor()}preHandleAction(e){return e==="BACK"?(this.activated=!0,this._onBack(),!0):!1}handleAction(e){e==="UP"?this.moveCursor(-1):e==="DOWN"?this.moveCursor(1):e==="SELECT"&&this.activateCurrent()}handleTap(e,n){const i=this.rowToChoiceIndex(n);i!==null&&!this._choices[i].disabled&&(this.cursorIdx=i,this.activateCurrent())}moveCursor(e){const n=this._choices,i=n.length;if(i===0)return;const o=this.cursorIdx===-1?e>0?i-1:0:this.cursorIdx;for(let r=0;r<i;r++){const s=((o+e*(r+1))%i+i)%i;if(!n[s].disabled){this.cursorIdx=s;return}}}activateCurrent(){if(this._choices.length===0||this.cursorIdx===-1)return;const e=this._choices[this.cursorIdx];e.disabled||(this.activated=!0,e.action())}resetCursor(){const e=this._choices;for(let n=0;n<e.length;n++)if(!e[n].disabled){this.cursorIdx=n;return}this.cursorIdx=-1}computeChoicesHeight(){var n;let e=0;for(const i of this._choices)e+=1+(((n=i.details)==null?void 0:n.length)??0);return e}rowToChoiceIndex(e){var i;if(e<this.lastChoicesStartRow)return null;let n=this.lastChoicesStartRow;for(let o=0;o<this._choices.length;o++){const r=1+(((i=this._choices[o].details)==null?void 0:i.length)??0);if(e>=n&&e<n+r)return o;n+=r}return null}render(e){const n=e.length,i=n>0?e[0].length:0;for(let m=0;m<n;m++)for(let g=0;g<i;g++)e[m][g]={char:" ",fg:"black",bg:"black"};const o=this.buildChromeConfig();this.chrome.render(e,o);const r=!0,s=X,a=Rt(n,r),c=this.opts.title;c!==void 0&&(f(e,s,2,c,"bright-white","black"),f(e,s+1,2,"'".repeat(c.length),"bright-black","black"));const l=s+2,h=this.computeChoicesHeight(),d=a-h-1,p=d-1;this.renderContent(e,l,p),d>=0&&d<n&&fe(e,d,i);let u=d+1;this.lastChoicesStartRow=u;for(let m=0;m<this._choices.length;m++){const g=this._choices[m],y=m===this.cursorIdx,b=y?">":" ",x=g.disabled?"bright-black":y?"bright-green":"white";if(u<n&&(f(e,u,2,b,x,"black"),f(e,u,3,g.label,x,"black")),u++,g.details)for(const _ of g.details)u<n&&f(e,u,4,_.slice(0,i-4),"bright-black","black"),u++}}}const Fo={delivery:"[D]",supply:"[S]"};class Do extends Lo{constructor(e,n,i,o,r,s,a,c){const l=yo(i,o),h=o.type==="delivery"&&o.pickupDestinationId===o.issuingDestinationId,d=l.ok?{label:"ACCEPT MISSION",action:()=>r(h)}:{label:"ACCEPT MISSION",disabled:!0,details:l.reason?[l.reason]:[],action:()=>{}},p={label:"BACK",action:()=>s()};super("MISSION BOARD",[d,p],s,[{id:"undock",label:"UNDOCK"},{id:"hub",label:"HUB"}],e,n,i),this.spec=o,this.onHub=a,this.onUndock=c}destColor(e){if(e===this.player.destinationId)return"bright-green";const n=N(e);return n&&n.system===this.player.systemId?"bright-yellow":"white"}writeDestRow(e,n,i,o,r,s){f(e,n,2,i,"white","black"),f(e,n,2+i.length,o.slice(0,s-i.length),this.destColor(r),"black")}handleAction(e){e==="NAV_1"?(this.activated=!0,this.onUndock()):e==="NAV_2"?(this.activated=!0,this.onHub()):super.handleAction(e)}handleNavTap(e){this.activated||(e==="undock"?(this.activated=!0,this.onUndock()):e==="hub"&&(this.activated=!0,this.onHub()))}renderContent(e,n,i){this.renderDetail(e,n,i)}renderDetail(e,n,i){const r=e.length>0?e[0].length:40,s=r-4;let a=n;const c=(u,m,g)=>{u<=i&&f(e,u,2,m.slice(0,s),g,"black")};c(a,`${Fo[this.spec.type]} ${this.spec.title}`,"bright-yellow"),a++;const l=D(),h=this.spec.giverFactionId?l.factions.find(u=>u.id===this.spec.giverFactionId):null,d=h?` [${h.name}]`:"";if(c(a,`    ${this.spec.giverName}${d}`,"bright-black"),a++,a++,this.spec.type==="delivery"){const u=N(this.spec.pickupDestinationId),m=N(this.spec.deliveryDestinationId);if(a<=i&&this.writeDestRow(e,a,"Pickup:  ",(u==null?void 0:u.name)??this.spec.pickupDestinationId,this.spec.pickupDestinationId,s),a++,a<=i&&this.writeDestRow(e,a,"Deliver: ",(m==null?void 0:m.name)??this.spec.deliveryDestinationId,this.spec.deliveryDestinationId,s),a++,a<=i){const g=this.player.cargoCapacity-this.player.cargoWeightKg,y=this.spec.itemWeightKg,b=g>=y,x=`Weight:  ${y} kg  (Free: ${g} kg)`;f(e,a,2,x,"white","black");const _=b?"bright-green":"red",k=2+x.length+1;k<r&&f(e,a,k,b?"✓":"✗",_,"black")}a++}else{const u=N(this.spec.deliveryDestinationId);a<=i&&this.writeDestRow(e,a,"Deliver to: ",(u==null?void 0:u.name)??this.spec.deliveryDestinationId,this.spec.deliveryDestinationId,s),a++;for(const m of this.spec.requirements){if(a>i)break;const g=de(m.commodityId);c(a,`  ${m.qty}x ${(g==null?void 0:g.name)??m.commodityId}`,"white"),a++}}a++;const p=De(this.spec.description,s);for(const u of p){if(a>i)break;c(a,u,"white"),a++}if(a++,!(a>i)&&(c(a,`REWARD: ${this.spec.reward} CR`,"bright-green"),a++,this.spec.type==="delivery"&&this.spec.deposit>0&&(a<=i&&c(a,`DEPOSIT: ${this.spec.deposit} CR`,"bright-yellow"),a++),this.spec.giverFactionId)){const u=l.factions.find(m=>m.id===this.spec.giverFactionId);if(u){const m=F(),g=this.spec.reward;let y;g>=m.reputation.missionTierLargeReward?y=m.reputation.missionDeltaLarge:g>=m.reputation.missionTierMediumReward?y=m.reputation.missionDeltaMedium:y=m.reputation.missionDeltaSmall;const b=Lt(u,y,l.factions),x=[];for(const[_,k]of b){const v=l.factions.find(C=>C.id===_);v&&x.push({id:_,name:v.name,delta:k})}if(x.sort((_,k)=>_.delta!==k.delta?k.delta-_.delta:_.name.localeCompare(k.name)),x.length>0){if(a++,a>i)return;const _=i-1;a<=_&&(c(a,"REPUTATION IMPACT","bright-cyan"),a++);for(const k of x){if(a>_)break;const v=Et(k.delta),C=k.delta>0?"bright-green":"red",w=s-v.length-2,T=k.name.slice(0,w),O=" ".repeat(Math.max(0,s-T.length-v.length-2));c(a,`  ${T}${O}${v}`,C),a++}}}}}}function ii(t){if(t.length===0)return 2166136261;let e=2166136261;for(let n=0;n<t.length;n++)e^=t.charCodeAt(n),e=Math.imul(e,16777619)>>>0;return e===0?1:e}const Oo=[30,10,5],No=[".","*","+"],zt=[4e3,2e3,800],Po=[9e3,5e3,2500],Ho=[null,"bright-black","white"],Bo=["bright-black","white","bright-white"],Uo=["white","bright-white","bright-cyan"],We=3,Qt=25,Ke=2,Jt=37,Zt=2*Math.PI;function Go(t){let e=t>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}class oi{constructor(e=42){this.boundsSet=!1,this.rand=Go(e),this.stars=[];for(let n=0;n<3;n++)for(let i=0;i<Oo[n];i++){const o=Ke+Math.floor(this.rand()*(Jt-Ke+1)),r=We+Math.floor(this.rand()*(Qt-We+1)),s=this.rand()*Zt,a=zt[n]+this.rand()*(Po[n]-zt[n]);this.stars.push({col:o,row:r,layer:n,twinklePhase:s,twinklePeriod:a})}}update(e){for(const n of this.stars)n.twinklePhase+=Zt/n.twinklePeriod*e}render(e,n,i,o,r){if(!this.boundsSet){this.boundsSet=!0;const s=Qt-We,a=Jt-Ke;{const c=(i-n)/s,l=(r-o)/a;for(const h of this.stars)h.row=Math.round(n+(h.row-We)*c),h.col=Math.round(o+(h.col-Ke)*l)}}for(const s of this.stars){const{row:a,col:c,layer:l}=s;if(a<n||a>i||c<o||c>r)continue;const h=Math.sin(s.twinklePhase);let d;h>=.5?d=Uo[l]:h>=-.5?d=Bo[l]:d=Ho[l],d!==null&&(e[a][c]={char:No[l],fg:d,bg:"black"})}}getStars(){return this.stars}}const $o=2,Wo=3,Ko=2*Math.PI/9e3,Yo=2*Math.PI/12e3,jo=Math.PI/3;function en(t,e,n){return Math.max(e,Math.min(n,t))}class Vo{constructor(e,n,i,o,r,s=.5,a=.6){this.time=0,this.glyph=e,this.intRowStart=n,this.intRowEnd=i,this.intColStart=o,this.intColEnd=r,this.glyphHeight=e.rows.length,this.glyphWidth=Math.max(...e.rows.map(c=>c.length)),this.anchorRow=n+Math.floor((i-n)*s)-Math.floor(this.glyphHeight/2),this.anchorCol=o+Math.floor((r-o)*a)-Math.floor(this.glyphWidth/2)}update(e){this.time+=e}getDisplayPosition(){const e=Math.round($o*Math.sin(this.time*Ko)),n=Math.round(Wo*Math.sin(this.time*Yo+jo)),i=en(this.anchorRow+e,this.intRowStart,this.intRowEnd-this.glyphHeight+1),o=en(this.anchorCol+n,this.intColStart,this.intColEnd-this.glyphWidth+1);return{row:i,col:o}}render(e){const{row:n,col:i}=this.getDisplayPosition(),o=this.glyph.fg;for(let r=0;r<this.glyph.rows.length;r++){const s=this.glyph.rows[r];let a=-1,c=-1;for(let l=0;l<s.length;l++)s[l]!==" "&&(a===-1&&(a=l),c=l);if(a!==-1)for(let l=a;l<=c;l++){const h=s[l],d=n+r,p=i+l;d>=0&&d<e.length&&p>=0&&p<e[d].length&&(e[d][p]=h===" "?{char:" ",fg:"black",bg:"black"}:{char:h,fg:o,bg:"black"})}}}}const tn=[{rows:[">---<"," |*| ","  |  "],fg:"bright-white"},{rows:["/-\\","|O|","\\-/"],fg:"cyan"},{rows:["  *  ","--+--"," [H] ","  |  ","  *  "],fg:"bright-white"}],nn=[{rows:[" /\\/\\","< ** >"," \\__/"],fg:"yellow"},{rows:["  ___"," /   \\","|  .  |"," \\___/"],fg:"yellow"},{rows:[" _/\\_","/  . \\","\\____/"],fg:"yellow"}],on=[{rows:["  .--."," / .. \\","| .... |"," \\ .. /","  `--'"],fg:"blue"},{rows:["  .--."," / ~~ \\","| ~~~~ |"," \\ ~~ /","  `--'"],fg:"bright-yellow"},{rows:["  .--."," /====\\","|======|"," \\====/","  `--'"],fg:"bright-cyan"}];function qo(t,e){return t==="orbital"||t==="deep-space"?tn[e%tn.length]:t==="asteroid"?nn[e%nn.length]:t==="surface"?on[e%on.length]:null}const Xo=6,pt=6,zo=23,Qo=23,mt=10,Jo=0,Zo=4,er=18,tr=21,nr=35,ir=39,rn=12,or=11,ce=13,Se=27,gt=28,rr=12,ft=40,sn=200,yt=["> SYSTEM STATUS: ALL CLEAR","> DRIVE EFFICIENCY: 97%","> BEACON SIGNAL DETECTED ON 14.7 MHz","> TRADE ROUTE UPDATE: ELYSIUM CORRIDOR STABLE","> WARNING: DEBRIS FIELD DELTA-9 ACTIVE","> COMMS RELAY SIGNAL NOMINAL","> FUEL RESERVES OPTIMAL","> SECTOR SCAN COMPLETE — NO HOSTILES","> GRAVITATIONAL ANOMALY LOGGED AT BEARING 227","> TRANSPONDER HANDSHAKE: ACCEPTED"],sr="#",an=["green","cyan","white","yellow"],cn=["*",".","+","x"];function ar(t){return t>=.8?"bright-green":t>=.5?"yellow":"red"}function ln(t){let e=t>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}function cr(t,e,n){return{col:e,row:n,char:sr,color:an[Math.floor(t()*an.length)],phase:t()*2e4,period:1e4+t()*1e4,active:t()>.2}}function Me(t,e,n,i){const o=[];for(const r of i)for(let s=e;s<=n;s++)o.push(cr(t,s,r));return o}class lr extends z{constructor(e,n,i,o,r,s,a){var u;super(e,n,i,{navOptions:[],onMenu:a}),this.cursorIdx=0,this.h=30,this.destObject=null,this.blinkPhase=0,this.msgIdx=0,this.tickerScroll=0,this.tickerAccum=0,this.tickerPause=0,this.onTravel=o,this.onDock=r,this.onCargo=s;const c=ii(i.destinationId??"");this.starfield=new oi(c),this.inSpace=i.destinationId===null;const l=i.destinationId!=null?(u=N(i.destinationId))==null?void 0:u.locationType:void 0;this.destGlyph=qo(l,c),this.destRowFrac=.15+Math.random()*.7,this.destColFrac=.15+Math.random()*.7;const h=ln(99);this.gaugeBtns=[...Me(h,Jo,Zo,[3,4]),...Me(h,er,tr,[3,4]),...Me(h,nr,ir,[3,4])],this.leftBtns=Me(h,0,or,[0,1,2,3]),this.rightBtns=Me(h,gt,39,[0,1,2,3]);const d=ln(77),p=3+Math.floor(d()*4);this.radarContacts=Array.from({length:p},()=>({x:d()*(Se-ce-1),y:d()*4,vx:(d()-.5)*2,vy:(d()-.5)*1.5,char:cn[Math.floor(d()*cn.length)]}))}navCount(){return this.inSpace?1:2}handleAction(e){e==="CARGO"?(this.activated=!0,this.onCargo()):e==="UP"?this.cursorIdx=(this.cursorIdx-1+this.navCount())%this.navCount():e==="DOWN"?this.cursorIdx=(this.cursorIdx+1)%this.navCount():e==="SELECT"&&(this.cursorIdx===0?(this.activated=!0,this.onTravel()):this.inSpace||(this.activated=!0,this.onDock()))}handleTap(e,n){const i=this.h;(n===3||n===4)&&e>=pt&&e<pt+1+mt?(this.activated=!0,this.onCargo()):n===i-3&&e<rn?(this.activated=!0,this.onTravel()):n===i-3&&e>=gt&&!this.inSpace&&(this.activated=!0,this.onDock())}update(e){var o;this.starfield.update(e),(o=this.destObject)==null||o.update(e),this.blinkPhase=(this.blinkPhase+e)%1e3;for(const r of[...this.gaugeBtns,...this.leftBtns,...this.rightBtns])r.phase+=e,r.phase>=r.period&&(r.phase-=r.period,r.active=!r.active);const n=Se-ce,i=5;for(const r of this.radarContacts)r.x+=r.vx*e/1e3,r.y+=r.vy*e/1e3,r.x<0&&(r.x=-r.x,r.vx=-r.vx),r.x>n-1&&(r.x=2*(n-1)-r.x,r.vx=-r.vx),r.y<0&&(r.y=-r.y,r.vy=-r.vy),r.y>i-1&&(r.y=2*(i-1)-r.y,r.vy=-r.vy);if(this.tickerPause>0)this.tickerPause=Math.max(0,this.tickerPause-e);else for(this.tickerAccum+=e;this.tickerAccum>=sn;){this.tickerAccum-=sn,this.tickerScroll++;const r=yt[this.msgIdx];if(this.tickerScroll>=r.length+ft-1){this.tickerScroll=0,this.msgIdx=(this.msgIdx+1)%yt.length,this.tickerPause=500,this.tickerAccum=0;break}}}renderContent(e,n,i){var d;const o=e.length,r=o>0?e[0].length:0;this.h=o;const s=n+2,a=o-8,c=o-7,l=o-3,h=o-2;this.renderGaugeStrip(e,n),this.starfield.render(e,s,a,0,39),!this.destObject&&this.destGlyph&&(this.destObject=new Vo(this.destGlyph,s+1,a-1,0,39,this.destRowFrac,this.destColFrac)),(d=this.destObject)==null||d.render(e);for(let p=0;p<r;p++)e[s][p]={char:"-",fg:"white",bg:"black"},e[a][p]={char:"-",fg:"white",bg:"black"};this.renderHUD(e,s+1),this.renderCrosshair(e,s+1,a-1),this.renderBottomPanels(e,c,l),this.renderTicker(e,h)}renderGaugeStrip(e,n){for(const a of this.gaugeBtns){const c=n+a.row-3,l=a.active?a.color:"bright-black";c>=0&&c<e.length&&(e[c][a.col]={char:a.char,fg:l,bg:"black"})}const i=this.player.fuelL/this.player.fuelCapacityL,o=this.player.cargoWeightKg/this.player.cargoCapacity,r=this.blinkPhase<500,s=ar(this.player.hullIntegrity);this.renderGauge(e,n,Xo,"F",i,"yellow",r),this.renderGauge(e,n+1,pt,"C",o,"blue",r),this.renderGauge(e,n,zo,"S",1,"cyan",r),this.renderGauge(e,n+1,Qo,"H",this.player.hullIntegrity,s,r)}renderGauge(e,n,i,o,r,s,a){if(n<0||n>=e.length)return;e[n][i]={char:o,fg:s,bg:"black"};const c=Math.round(Math.min(1,Math.max(0,r))*mt),l=r<=.2;for(let h=0;h<mt;h++){const d=i+1+h;if(h<c){const p=l&&!a?"bright-black":s;e[n][d]={char:" ",fg:"black",bg:p}}else e[n][d]={char:" ",fg:"black",bg:"bright-black"}}}renderHUD(e,n){f(e,n,1,"VEL:----","bright-black","black"),f(e,n,16,"ATT:---°","bright-black","black"),f(e,n,30,"ROT:--°","bright-black","black")}renderCrosshair(e,n,i){var a;const o=Math.floor((n+i)/2),r=20;e[o][r]={char:"+",fg:"bright-green",bg:"black"};const s=[[o-3,r-5],[o-3,r+5],[o+3,r-5],[o+3,r+5]];for(const[c,l]of s){const h=((a=e[0])==null?void 0:a.length)??40;c>=n&&c<=i&&l>=0&&l<h&&(e[c][l]={char:"+",fg:"bright-green",bg:"black"})}}renderBottomPanels(e,n,i){for(let l=n;l<=i;l++)for(let h=ce;h<Se;h++)e[l][h]={char:" ",fg:"black",bg:"bright-black"};this.renderRadar(e,n,i-n+1);for(const l of this.leftBtns){const h=n+l.row;if(h<i){const d=l.active?l.color:"bright-black";e[h][l.col]={char:l.char,fg:d,bg:"black"}}}for(const l of this.rightBtns){const h=n+l.row;if(h<i){const d=l.active?l.color:"bright-black";e[h][l.col]={char:l.char,fg:d,bg:"black"}}}const o=this.cursorIdx===0?"bright-yellow":"yellow";f(e,i,0,this.centerPad("TRAVEL",rn),"black",o);let r,s;this.inSpace?(r="bright-black",s="bright-black"):(r=this.cursorIdx===1?"bright-cyan":"cyan",s="black"),f(e,i,gt,this.centerPad("DOCK",rr),s,r);const a=Se-ce,c="<)) "+"-".repeat(a-4);f(e,i,ce,c,"white","bright-black")}renderRadar(e,n,i){for(const o of this.radarContacts){const r=Math.min(Se-ce-1,Math.max(0,Math.floor(o.x))),s=Math.min(i-1,Math.max(0,Math.floor(o.y)));e[n+s][ce+r]={char:o.char,fg:"white",bg:"bright-black"}}}renderTicker(e,n){const i=yt[this.msgIdx];for(let o=0;o<ft;o++){const r=this.tickerScroll-ft+1+o,s=r>=0&&r<i.length?i[r]:" ";e[n][o]={char:s,fg:"white",bg:"black"}}}centerPad(e,n){if(e.length>=n)return e.slice(0,n);const i=n-e.length,o=Math.floor(i/2);return" ".repeat(o)+e+" ".repeat(i-o)}}class hr extends z{constructor(e,n,i,o,r){super(e,n,i,{title:"CARGO HOLD",tabs:["COMMODITIES","MISSION GOODS"],navOptions:[{id:"back",label:"BACK"}],onMenu:r}),this.onBack=o}handleNavTap(e){e==="back"&&(this.activated=!0,this.onBack())}handleAction(e){(e==="BACK"||e==="CARGO")&&(this.activated=!0,this.onBack())}renderContent(e,n,i){const r=e.length>0?e[0].length:0,s=this.player.cargoHold,a=this.player.missionItems,c=this.player.cargoCapacity,l=this.player.cargoWeightKg,h=i-1;this.activeTabIdx===0?this.renderCommoditiesTab(e,n,h,r,s):this.renderMissionGoodsTab(e,n,h,r,a);const d=`CARGO: ${l}/${c}KG`,p=`FUEL: ${this.player.fuelL}/${this.player.fuelCapacityL}L`;f(e,h,2,d,"bright-black","black"),f(e,h,r-p.length-2,p,"bright-black","black")}renderCommoditiesTab(e,n,i,o,r){if(r.length===0){f(e,n,2,"NO COMMODITIES","bright-black","black");return}let s=n;for(const a of r){if(s>=i-1)break;const c=de(a.commodityId);if(!c)continue;const l=a.qty*c.weightKg,h=`  x${a.qty}  ${c.basePrice}CR  ${l}KG`,d=Math.max(6,o-4-h.length),p=c.name,u=p.length>d?p.slice(0,d):p;f(e,s,2,`${u}${h}`,"white","black"),s++}}renderMissionGoodsTab(e,n,i,o,r){if(r.length===0){f(e,n,2,"NO MISSION GOODS","bright-black","black");return}let s=n;for(const a of r){if(s>=i-1)break;const c=`  ${a.weightKg}KG`,l=Math.max(6,o-4-c.length),h=a.itemName.length>l?a.itemName.slice(0,l):a.itemName;f(e,s,2,`${h}${c}`,"white","black"),s++}}}class hn extends pe{constructor(e,n,i,o,r,s,a,c,l=()=>{},h){const d=J(i.systemId),p=Zn(i.driveId),u=i.getInSystemHopCost(),m=i.fuelL<u,g=[...d.destinations.map(_=>({label:`${N(_).name.toUpperCase()}  [${u}L]`,disabled:_===i.destinationId||m,action:()=>o(_)})),{label:`FLY INTO SPACE  [${u}L]`,disabled:i.destinationId===null||m,action:s}];m&&h&&g.push({label:"[EMERGENCY]",disabled:!1,action:h});const b=[...At(i.systemId).map(_=>{const k=_.from===i.systemId?_.to:_.from,v=J(k),C=Math.ceil(F().fuel.consumptionPerLy*_.distance*p.fuelEfficiency);return{label:`${v.name.toUpperCase()}  ${_.distance}LY  [${C}L]`,disabled:C>i.fuelL,action:()=>r(k)}}),{label:"GALAXY MAP...",action:c}],x=[{label:"DESTINATIONS",items:g},{label:"JUMPS",items:b}];super("TRAVEL",[],[{id:"ship",label:"SHIP"}],e,n,i,[],x,l),this.onShip=a}handleNavAction(e){(e==="BACK"||e==="NAV_1")&&!this.activated&&(this.activated=!0,this.onShip())}handleNavTap(e){e==="ship"&&!this.activated&&(this.activated=!0,this.onShip())}}class dr extends z{constructor(e,n,i,o,r,s){super(e,n,i,{navOptions:[],title:"EMERGENCY RESCUE"}),this.cursorIdx=0,this.onBack=s;const a=J(i.systemId),c=F();if(this.options=[],this.fuelDestId=a.destinations.find(l=>{var h;return((h=N(l))==null?void 0:h.amenities.fuel)===!0}),this.fuelDestId){const l=N(this.fuelDestId);this.options.push({label:`TOW TO ${l.name.toUpperCase()}`,fee:c.emergencyRescue.towFee,action:()=>o(this.fuelDestId)})}this.options.push({label:"EMERGENCY FUEL DROP",fee:c.emergencyRescue.fuelDropFee,action:r}),this.options.push({label:"BACK",fee:0,action:s})}preHandleAction(e){return e==="BACK"?(this.activated=!0,this.onBack(),!0):!1}handleAction(e){e==="UP"?this.cursorIdx=(this.cursorIdx-1+this.options.length)%this.options.length:e==="DOWN"?this.cursorIdx=(this.cursorIdx+1)%this.options.length:e==="SELECT"&&this.cursorIdx>=0&&this.cursorIdx<this.options.length&&(this.activated=!0,this.options[this.cursorIdx].action())}handleTap(e,n){this.cursorIdx>=0&&this.cursorIdx<this.options.length&&(this.activated=!0,this.options[this.cursorIdx].action())}renderContent(e,n,i){const o=e.length,r=o>0?e[0].length:0,s=J(this.player.systemId);let a;this.player.destinationId===null?a=`STRANDED IN SPACE NEAR ${s.name.toUpperCase()}`:a=`STRANDED AT ${N(this.player.destinationId).name.toUpperCase()}`,f(e,n,2,a,"bright-yellow","black");const c=n+2;fe(e,c,r);let l=c+1;for(let h=0;h<this.options.length;h++){const d=this.options[h],p=h===this.cursorIdx,u=p?">":" ",m=p?"bright-green":"white";if(l<o)if(f(e,l,2,u,m,"black"),d.fee===0)f(e,l,3,d.label,m,"black");else{f(e,l,3,d.label,m,"black");const g=this.player.credits-d.fee,y=`${d.fee} CR  (BALANCE: ${g>=0?"":"-"}${Math.abs(g)} CR)`,b=g<0?"bright-red":m;l+1<o&&f(e,l+1,4,y,b,"black"),l++}l++}}}function dn(t,e){if(t===e)return[t];const n=[[t]],i=new Set([t]);for(;n.length>0;){const o=n.shift(),r=o[o.length-1];for(const s of At(r)){const a=s.from===r?s.to:s.from;if(a===e)return[...o,a];i.has(a)||(i.add(a),n.push([...o,a]))}}return null}const ur=0,pr=4,mr=8,gr=9,un=10,pn=15,fr=16,yr=2,_r=10,br=12,Ye=13,je=12,wr=25,vr=26,kr=10,mn=18;function xr(t,e){return t.length>=e?t.slice(0,e):t+" ".repeat(e-t.length)}function Ie(t,e){return"["+xr(t.toUpperCase(),e-2)+"]"}class gn extends z{constructor(e,n,i,o,r=()=>{},s){const a=s?[{id:"game",label:"GAME"},{id:"menu",label:"MENU"}]:[{id:"back",label:"BACK"}];super(e,n,i,{title:"GALAXY MAP",tabs:["MAP","ROUTE"],navOptions:a,onMenu:r}),this.mapCursorIdx=0,this.routeDestIdx=0,this.searchText="",this.lastTop=X+5,this.onBack=o,this.onGame=s,this.publicSystems=uo().sort((c,l)=>c.distanceFromSol-l.distanceFromSol),this.otherSystems=this.publicSystems.filter(c=>c.id!==i.systemId),this.mapBrowsingSystemId=i.systemId}onTabChange(e){this.searchText=""}handleCharInput(e){if(this.activeTabIdx!==0)return;const n=e.charCodeAt(0);e==="\b"||e===""?this.searchText=this.searchText.slice(0,-1):n>=32&&n<127&&(this.searchText+=e.toUpperCase(),this.mapCursorIdx=0)}handleAction(e){if(e==="BACK"){if(this.searchText.length>0){this.searchText="";return}this.activated=!0,this.onBack();return}if(e==="NAV_1"){this.onGame&&(this.activated=!0,this.onGame());return}if(e==="NAV_2"){this.onGame&&(this.searchText="",this.activated=!0,this.onBack());return}this.activeTabIdx===0?this.handleMapAction(e):this.handleRouteAction(e)}handleNavTap(e){e==="back"?(this.searchText="",this.activated=!0,this.onBack()):e==="game"&&this.onGame?(this.activated=!0,this.onGame()):e==="menu"&&(this.searchText="",this.activated=!0,this.onBack())}handleTap(e,n){const i=this.lastTop,o=i+un,r=i+pn;if(this.activeTabIdx===0&&n>=o&&n<r){const s=this.getMapNeighbors(),a=n-o;a>=0&&a<s.length&&(this.mapBrowsingSystemId=s[a].id,this.mapCursorIdx=0,this.searchText="")}else if(this.activeTabIdx===1){const s=i+3,a=i+9;if(n>=s&&n<=a){const c=n-s;c>=0&&c<this.otherSystems.length&&(this.routeDestIdx=c)}}}getMapNeighbors(){const n=At(this.mapBrowsingSystemId).map(i=>{const o=i.from===this.mapBrowsingSystemId?i.to:i.from,r=this.publicSystems.find(a=>a.id===o),s=i.distance;return r?{sys:r,dist:s}:null}).filter(i=>i!==null).sort((i,o)=>i.dist-o.dist).map(i=>i.sys);return this.searchText.length===0?n:n.filter(i=>i.name.toUpperCase().includes(this.searchText))}handleMapAction(e){const n=this.getMapNeighbors(),i=Math.min(this.mapCursorIdx,Math.max(0,n.length-1));if(e==="UP")this.mapCursorIdx=Math.max(0,i-1);else if(e==="DOWN")this.mapCursorIdx=Math.min(n.length-1,i+1);else if(e==="SELECT"){const o=n[i];if(!o)return;this.mapBrowsingSystemId=o.id,this.mapCursorIdx=0,this.searchText=""}}handleRouteAction(e){e==="UP"?this.routeDestIdx=Math.max(0,this.routeDestIdx-1):e==="DOWN"&&(this.routeDestIdx=Math.min(this.otherSystems.length-1,this.routeDestIdx+1))}computeRoute(){const e=this.otherSystems[this.routeDestIdx];return e?dn(this.player.systemId,e.id):null}renderContent(e,n,i){this.lastTop=n;const o=e.length>0?e[0].length:0;this.activeTabIdx===0?this.renderMapTab(e,n,i,o):this.renderRouteTab(e,n,i,o)}renderMapTab(e,n,i,o){const r=this.publicSystems.find(p=>p.id===this.mapBrowsingSystemId)??this.publicSystems[0];if(!r)return;const s=n+gr,a=n+un,c=n+pn,l=n+fr;this.renderChart(e,r,n),fe(e,s,o);const h=this.getMapNeighbors(),d=Math.min(this.mapCursorIdx,Math.max(0,h.length-1));this.renderNeighborList(e,o,r,h,d,a,c),fe(e,c,o),this.renderInfo(e,o,r,h[d]??null,l),this.searchText.length>0&&f(e,l+4,2,`/${this.searchText}_`,"bright-yellow","black")}renderChart(e,n,i){var h;const o=this.getMapNeighbors(),r=i+ur,s=i+pr,a=i+mr,c=n.id===this.player.systemId?"bright-yellow":"bright-cyan";if(f(e,s,Ye,Ie(n.name,je),c,"black"),n.id===this.player.systemId){const d=Ye+je,p=((h=e[0])==null?void 0:h.length)??40;d<p&&(e[s][d]={char:"*",fg:"bright-yellow",bg:"black"})}const l=["left","right","top","bottom"];for(let d=0;d<Math.min(o.length,4);d++){const p=o[d],u=l[d],m=p.id===this.player.systemId?"bright-yellow":"white";if(u==="left")f(e,s,yr,Ie(p.name,_r),m,"black"),e[s][br]={char:"-",fg:"bright-black",bg:"black"};else if(u==="right")f(e,s,vr,Ie(p.name,kr),m,"black"),e[s][wr]={char:"-",fg:"bright-black",bg:"black"};else if(u==="top"){f(e,r,Ye,Ie(p.name,je),m,"black");for(let g=r+1;g<s;g++)e[g][mn]={char:"|",fg:"bright-black",bg:"black"}}else{f(e,a,Ye,Ie(p.name,je),m,"black");for(let g=s+1;g<a;g++)e[g][mn]={char:"|",fg:"bright-black",bg:"black"}}}}renderNeighborList(e,n,i,o,r,s,a){for(let c=0;c<o.length&&c<a-s;c++){const l=o[c],h=s+c,d=c===r,u=l.id===this.player.systemId?"bright-yellow":d?"bright-cyan":"white",m=d?"> ":"  ",g=ze(i.id,l.id),y=g?`${g.distance}LY  ${g.stability}`:"",b=n-4-y.length;f(e,h,2,m+l.name.toUpperCase().slice(0,b-2),u,"black"),y&&f(e,h,n-2-y.length,y,"bright-black","black")}}renderInfo(e,n,i,o,r){const a=i.id===this.player.systemId?"* Current location":i.name.toUpperCase();if(f(e,r,2,`Zone: ${i.zone}  Sec: ${i.security}  ${a}`.slice(0,n-4),"bright-black","black"),!o)return;const c=ze(i.id,o.id);if(!c)return;const l=dn(this.player.systemId,o.id),h=l?l.length===1?"(your location)":`${l.length-1} hop${l.length-1!==1?"s":""} from you`:"(unreachable)";f(e,r+1,2,`${o.name.toUpperCase()}  ${c.distance}LY  ${h}`.slice(0,n-4),"bright-black","black")}renderRouteTab(e,n,i,o){var b,x;const r=n,s=n+2,a=n+3,c=7,l=a+c,h=l+1,d=h+6,p=this.publicSystems.find(_=>_.id===this.player.systemId);f(e,r,2,"FROM:","bright-black","black"),f(e,r,8,(p==null?void 0:p.name.toUpperCase())??this.player.systemId.toUpperCase(),"bright-yellow","black"),f(e,s,2,"TO:","bright-black","black");const u=Math.max(0,Math.min(this.routeDestIdx,this.otherSystems.length-c));for(let _=0;_<c;_++){const k=u+_;if(k>=this.otherSystems.length)break;const v=this.otherSystems[k],C=k===this.routeDestIdx,w=C?"bright-cyan":"white",T=C?"> ":"  ";f(e,a+_,2,T+v.name.toUpperCase(),w,"black")}fe(e,l,o),fe(e,d,o);const m=this.computeRoute();if(!this.otherSystems[this.routeDestIdx])return;if(!m){f(e,h,2,"No route found","bright-red","black");return}const y=m.length-1;f(e,h,2,`Route: ${y} hop${y!==1?"s":""}`,"bright-white","black");for(let _=0;_<y;_++){const k=ze(m[_],m[_+1]);if(!k)continue;const v=h+1+_;if(v>=d)break;const C=(((b=this.publicSystems.find(T=>T.id===m[_]))==null?void 0:b.name)??m[_]).toUpperCase().slice(0,9),w=(((x=this.publicSystems.find(T=>T.id===m[_+1]))==null?void 0:x.name)??m[_+1]).toUpperCase().slice(0,9);f(e,v,4,`${C} -> ${w}  ${k.distance}LY  ${k.stability}`.slice(0,o-6),"white","black")}}}class ae extends z{constructor(e,n,i,o){const r={onAction:()=>{}};super(r,n,e,{navOptions:[]}),this.elapsed=0,this.arrived=!1,this.duration=i,this.onComplete=o}update(e){this.arrived||(this.elapsed+=e,this.elapsed>=this.duration&&(this.arrived=!0,this.onComplete()))}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[]}}}const Cr=["[. . .]","[: : :]","[* * *]"],fn=5e3;class Tr extends ae{constructor(e,n,i){super(e,n,fn,i)}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[],systemLabel:"IN TRANSIT",destinationLabel:null}}renderContent(e,n,i){const o=e.length,r=Math.floor(o/2),s=Math.floor(this.elapsed/500)%3,a=Math.ceil((fn-this.elapsed)/1e3),c=Math.max(1,Math.min(5,a)),l=J(this.player.systemId),h=l?l.name.toUpperCase():this.player.systemId.toUpperCase();L(e,r-3,"[ JUMP DRIVE ENGAGED ]","bright-cyan","black"),L(e,r-1,"DESTINATION:","bright-black","black"),L(e,r,h,"bright-white","black"),L(e,r+2,Cr[s],"bright-black","black"),L(e,r+4,`ARRIVING IN ${c}S`,"bright-black","black")}}const yn=2e3,Sr=["[ —   ]","[  —  ]","[   — ]"];class _t extends ae{constructor(e,n,i,o){super(e,n,yn,i),this.targetLabel=o}buildChromeConfig(){return{showHeader:!0,showFooter:!0,navOptions:[],destinationLabel:"IN TRANSIT"}}renderContent(e,n,i){const o=e.length,r=Math.floor(o/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((yn-this.elapsed)/1e3),c=Math.max(1,Math.min(2,a)),l=this.targetLabel!==void 0?this.targetLabel.toUpperCase():(()=>{const h=this.player.destinationId?N(this.player.destinationId):null;return h?h.name.toUpperCase():"UNKNOWN"})();L(e,r-3,"[ THRUSTERS ENGAGED ]","bright-yellow","black"),L(e,r-1,"HEADING TO:","bright-black","black"),L(e,r,l,"bright-white","black"),L(e,r+2,Sr[s],"bright-black","black"),L(e,r+4,`ARRIVING IN ${c}S`,"bright-black","black")}}const _n=2500,Mr=["v","vv","vvv"];class Ir extends ae{constructor(e,n,i){super(e,n,_n,i)}renderContent(e,n,i){const o=e.length,r=Math.floor(o/2),s=Math.floor(this.elapsed/400)%3,a=Math.ceil((_n-this.elapsed)/1e3),c=Math.max(1,Math.min(3,a));L(e,r-3,"[ LANDING SEQUENCE ]","bright-green","black"),L(e,r+2,Mr[s],"bright-black","black"),L(e,r+4,`TOUCHDOWN IN ${c}S`,"bright-black","black")}}const bn=2500,Ar=[">",">>",">>>"];class Rr extends ae{constructor(e,n,i){super(e,n,bn,i)}renderContent(e,n,i){const o=e.length,r=Math.floor(o/2),s=Math.floor(this.elapsed/400)%3,a=Math.ceil((bn-this.elapsed)/1e3),c=Math.max(1,Math.min(3,a));L(e,r-3,"[ APPROACH LOCKED ]","bright-yellow","black"),L(e,r+2,Ar[s],"bright-black","black"),L(e,r+4,`CLAMPING IN ${c}S`,"bright-black","black")}}const wn=1500,Er=["^","^^","^^^"];class Lr extends ae{constructor(e,n,i){super(e,n,wn,i)}renderContent(e,n,i){const o=e.length,r=Math.floor(o/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((wn-this.elapsed)/1e3),c=Math.max(1,Math.min(2,a));L(e,r-3,"[ LIFTOFF SEQUENCE ]","bright-green","black"),L(e,r+2,Er[s],"bright-black","black"),L(e,r+4,`CLEAR IN ${c}S`,"bright-black","black")}}const vn=1500,Fr=["<","<<","<<<"];class Dr extends ae{constructor(e,n,i){super(e,n,vn,i)}renderContent(e,n,i){const o=e.length,r=Math.floor(o/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((vn-this.elapsed)/1e3),c=Math.max(1,Math.min(2,a));L(e,r-3,"[ RELEASING CLAMPS ]","bright-yellow","black"),L(e,r+2,Fr[s],"bright-black","black"),L(e,r+4,`DEPARTING IN ${c}S`,"bright-black","black")}}const kn=1500,Or=["→","→→","→→→"];class Nr extends ae{constructor(e,n,i){super(e,n,kn,i)}renderContent(e,n,i){const o=e.length,r=Math.floor(o/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((kn-this.elapsed)/1e3),c=Math.max(1,Math.min(2,a));L(e,r-3,"[ DOCKING SEQUENCE ]","bright-cyan","black"),L(e,r+2,Or[s],"bright-black","black"),L(e,r+4,`DOCKING IN ${c}S`,"bright-black","black")}}const xn=1500,Pr=["←","←←","←←←"];class Hr extends ae{constructor(e,n,i){super(e,n,xn,i)}renderContent(e,n,i){const o=e.length,r=Math.floor(o/2),s=Math.floor(this.elapsed/300)%3,a=Math.ceil((xn-this.elapsed)/1e3),c=Math.max(1,Math.min(2,a));L(e,r-3,"[ DEPARTING BERTH ]","bright-cyan","black"),L(e,r+2,Pr[s],"bright-black","black"),L(e,r+4,`CLEAR IN ${c}S`,"bright-black","black")}}const Br=3e3;class Cn extends z{constructor(e,n,i,o,r,s,a){super(e,i,n,{navOptions:[]}),this.outcomeLabel=o,this.score=r,this.damageFraction=s,this.onComplete=a,this.elapsed=0,this.arrived=!1,this.duration=Br,this.lastContentTop=4,this.lastContentBottom=26,this.buttonRow=0,this.buttonCol=0,e.onTap&&e.onTap((c,l)=>this.handleTapCustom(c,l)),e.onAction(c=>{!this.arrived&&c==="SELECT"&&(this.arrived=!0,this.onComplete())})}handleTapCustom(e,n){Math.abs(n-this.buttonRow)<=0&&e>=this.buttonCol&&e<this.buttonCol+"[continue]".length&&(this.arrived=!0,this.onComplete())}update(e){super.update(e),!this.arrived&&(this.elapsed+=e)}renderContent(e,n,i){var p;this.lastContentTop=n,this.lastContentBottom=i;const o=Math.floor((n+i)/2),r=((p=e[0])==null?void 0:p.length)??40,s=this.getOutcomeColor();L(e,o-2,this.outcomeLabel,s,"black"),this.score!==null&&L(e,o,`SCORE: ${this.score} / 100`,"white","black");const a=Math.round(this.damageFraction*100),c=a===0?"bright-green":"yellow";L(e,o+2,`HULL DAMAGE: ${a}%`,c,"black");const l="[continue]",h=o+5,d=Math.floor((r-l.length)/2);this.buttonRow=h,this.buttonCol=d,L(e,h,l,"bright-green","black")}getOutcomeColor(){return this.score===null||this.score<40?"red":this.score<70?"yellow":"bright-green"}}const Tn=1200,Ur=40,Gr=80,$r={asteroid_belt:"ASTEROID BELT",space_debris:"DEBRIS FIELD",space_storm:"SPACE STORM"},Wr={asteroid_belt:"DENSE ROCK FIELD DETECTED ON JUMP EXIT. BRACE FOR IMPACT.",space_debris:"COLLISION ALERT — DEBRIS FIELD ON APPROACH. REDUCE SPEED.",space_storm:"ELECTROMAGNETIC STORM DETECTED. HOLD STEADY."},Sn=0,Mn=18,In=35,Kr=13,Yr=27,jr=["_","-","=","|"];class Vr extends z{constructor(e,n,i,o,r){super(e,n,i,{navOptions:[]}),this.onBegin=r,this.phase="incoming",this.phaseAccum=0,this.charCount=0,this.wrappedText=[],this.lastInputAction=null,this.encounterType=o;const s=ii(i.destinationId||"");this.starfield=new oi(s);const a=Wr[o];this.wrappedText=De(a,38),e.onAction(c=>{this.lastInputAction=c,this.phase!=="incoming"&&(c==="SELECT"||c==="NAV_1")&&(this.phase==="typing"?(this.charCount=this.getTotalCharCount(),this.phase="complete"):this.phase==="complete"&&this.onBegin())}),e.onTap&&e.onTap(()=>{this.phase==="typing"?(this.charCount=this.getTotalCharCount(),this.phase="complete"):this.phase==="complete"&&this.onBegin()})}update(e){if(super.update(e),this.starfield.update(e),this.phaseAccum+=e,this.phase==="incoming"&&this.phaseAccum>=Tn&&(this.phase="typing"),this.phase==="typing"){const n=this.phaseAccum-Tn,i=Math.floor(n/Ur);this.charCount=Math.min(i,this.getTotalCharCount()),this.charCount>=this.getTotalCharCount()&&(this.phase="complete")}}handleAction(e){["TRAVEL","DOCK","CARGO","MENU","ESC","BACK"].includes(e)||super.handleAction(e)}renderContent(e,n,i){var s;const o=((s=e[0])==null?void 0:s.length)??40,r=e.length;this.renderShipBackground(e,n,i,o,r),this.renderSpeakerBar(e,o),(this.phase==="typing"||this.phase==="complete")&&this.renderDialogBox(e,n,i,o)}renderShipBackground(e,n,i,o,r){this.renderGauges(e,o);const s=3,a=i-6;s<a&&this.starfield.render(e,s,a,2,o-3)}renderGauges(e,n){const o="=",s=Math.round(this.player.fuelL/this.player.fuelCapacityL*100),a=Math.floor(s/100*10),c=Math.round(this.player.hullIntegrity*100),l=Math.floor(c/100*10),h=Math.round(this.player.cargoWeightKg/this.player.cargoCapacity*100),d=Math.floor(h/100*10),u=Math.floor(100/100*10);f(e,1,Sn,"FUEL","green","black");for(let m=0;m<10;m++){const g=m<a?o:" ";f(e,1,Sn+5+m,g,s>20?"green":"red","black")}f(e,1,Mn,"SHLD","cyan","black");for(let m=0;m<10;m++){const g=m<u?o:" ";f(e,1,Mn+5+m,g,"cyan","black")}f(e,1,In-4,"HULL","yellow","black");for(let m=0;m<10;m++){const g=m<l?o:" ",y=c>=80?"bright-green":c>=50?"yellow":"red";f(e,1,In+m,g,y,"black")}f(e,1,2,"CARGO","white","black");for(let m=0;m<10;m++){const g=m<d?o:" ";f(e,1,8+m,g,h>80?"yellow":"white","black")}}renderSpeakerBar(e,n){const i=e.length-2,o="<)) ",r=Kr,s=Yr;f(e,i,r,o,"cyan","black");const a=Math.floor(this.phaseAccum/Gr),c=jr;for(let l=r+o.length;l<s&&l<n;l++){const h=(l-(r+o.length)+a)%c.length,d=c[h];f(e,i,l,d,"cyan","black")}}renderDialogBox(e,n,i,o){const r=i-6,s=i,a=o,c=r+1,l=s-1;for(let h=0;h<a;h++)f(e,r,h,"+","white","black"),f(e,s-1,h,"+","white","black");for(let h=r+1;h<s-1;h++)f(e,h,0,"|","white","black"),f(e,h,a-1,"|","white","black");if(f(e,r,2,$r[this.encounterType],"bright-yellow","black"),this.phase==="typing"||this.phase==="complete"){let h=this.charCount,d=0,p=0;for(const u of this.wrappedText){const m=c+d;if(m>=l)break;const g=u.length,y=Math.min(g,Math.max(0,h-p)),b=u.substring(0,y);f(e,m,2,b,"white","black"),p+=g,d++}}if(this.phase==="complete"){const h="[ CONTINUE ]",d=l-1,p=Math.floor((a-h.length)/2);f(e,d,p,h,"bright-green","black")}}getTotalCharCount(){return this.wrappedText.reduce((e,n)=>e+n.length,0)}}class ot extends z{constructor(e,n,i,o){super(e,n,i,{navOptions:o.navOptions,title:o.title}),this._completed=!1,this._onComplete=o.onComplete,this._canvasWidth=o.canvasWidth,this._canvasHeight=o.canvasHeight}renderContent(e,n,i){var u;const o=((u=e[0])==null?void 0:u.length)??0,r=e.length,s=i-n,a=this._canvasWidth??o,c=this._canvasHeight??s;let l=Math.floor((o-a)/2),h=n+Math.floor((s-c)/2);const d=Math.max(0,o-a),p=Math.max(0,r-c);l=Math.max(0,Math.min(l,d)),h=Math.max(0,Math.min(h,p)),this.renderGame(e,{top:h,left:l,width:a,height:c})}complete(e){var n;this._completed||(this._completed=!0,(n=this._onComplete)==null||n.call(this,e))}}function qr(t){if(t.length===0)return 2166136261;let e=2166136261;for(let n=0;n<t.length;n++)e^=t.charCodeAt(n),e=Math.imul(e,16777619)>>>0;return e===0?1:e}function Xr(t){let e=t>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}const ne=1;class zr extends ot{constructor(e,n,i,o){const r=i.destinationId??"";super(e,n,i,{navOptions:[],title:"DOCKING",canvasWidth:32,canvasHeight:18,onComplete:o}),this.heldKeys=new Set,this.lastActionTime=0,this.actionTimeoutMs=200,this.canvasWidth=32,this.canvasHeight=18,this.countdownSeconds=15,this.thrustForce=8,this.maxVelocity=6,this.driftIntervalMs=3e3,this.driftMaxDistanceChars=4,this.driftSpeedCharsPerSec=.8,this.perfectRadiusChars=5,this.airlockWidth=5,this.airlockHeight=3,this.lastViewport={top:0,left:0,width:32,height:18},this._joystick=null,this._primaryInput=n.primaryInput,this.rand=Xr(qr(r));const s=(this.canvasWidth-1)/2,a=(this.canvasHeight-1)/2;this.state={shipX:s,shipY:a,shipVelX:0,shipVelY:0,airlockX:s,airlockY:a,driftTargetX:s,driftTargetY:a,driftTimer:this.driftIntervalMs*(.8+.4*this.rand()),timeRemaining:this.countdownSeconds,completed:!1},e.onTouchTrack&&e.onTouchTrack({start:(c,l,h)=>{l<X||(this._joystick={centerCol:c,centerRow:l,currentCol:c,currentRow:l,id:h})},move:(c,l,h)=>{!this._joystick||this._joystick.id!==h||(this._joystick.currentCol=c,this._joystick.currentRow=l)},end:c=>{var l;((l=this._joystick)==null?void 0:l.id)===c&&(this._joystick=null,this.heldKeys.clear())}})}renderContent(e,n,i){var u;const o=((u=e[0])==null?void 0:u.length)??0,r=e.length,s=i-n,a=this.canvasWidth,c=this._primaryInput==="touch"?this.canvasHeight:this.canvasHeight+3;let l=Math.floor((o-a)/2),h=n+Math.floor((s-c)/2);const d=Math.max(0,o-this.canvasWidth),p=Math.max(0,r-this.canvasHeight);l=Math.max(0,Math.min(l,d)),h=Math.max(0,Math.min(h,p)),this.renderGame(e,{top:h,left:l,width:this.canvasWidth,height:this.canvasHeight})}handleAction(e){if(super.handleAction(e),e==="MENU"){this.state.completed||(this.state.completed=!0,this.complete({outcome:"skipped"}));return}(e==="UP"||e==="DOWN"||e==="LEFT"||e==="RIGHT")&&(this.heldKeys.add(e),this.lastActionTime=performance.now())}handleTap(e,n){if(this.state.completed){super.handleTap(e,n);return}if(this._primaryInput==="touch"){super.handleTap(e,n);return}const{top:i,left:o,width:r,height:s}=this.lastViewport,a=o+Math.floor(r/2),c=i+s,l=c+1,h=c+3,d=a-5,p=a+3,u=a;n===l&&e>=u-1&&e<=u+1?this.handleAction("UP"):n===h&&e>=u-1&&e<=u+1?this.handleAction("DOWN"):e>=d&&e<=d+2&&n===l+1?this.handleAction("LEFT"):e>=p&&e<=p+2&&n===l+1?this.handleAction("RIGHT"):super.handleTap(e,n)}update(e){super.update(e);const n=e/1e3;if(!this.state.completed){if(this._joystick){const i=this._joystick.currentCol-this._joystick.centerCol,o=this._joystick.currentRow-this._joystick.centerRow;this.heldKeys.clear(),o<-ne&&this.heldKeys.add("UP"),o>ne&&this.heldKeys.add("DOWN"),i<-ne&&this.heldKeys.add("LEFT"),i>ne&&this.heldKeys.add("RIGHT")}else this.clearExpiredActions();if(this.updateMovement(n),this.updateAirlockDrift(n),this.updateCountdown(n),this.state.timeRemaining<=0){const i=Math.hypot(this.state.shipX-this.state.airlockX,this.state.shipY-this.state.airlockY),o=1.5,r=i<=o?100:Math.round(Math.max(0,Math.min(1,1/(1+(i-o)/this.perfectRadiusChars)))*100);this.state.completed=!0,this.complete({outcome:"completed",result:{score:r}})}}}updateMovement(e){const n=this.state;this.heldKeys.has("UP")&&(n.shipVelY-=this.thrustForce*e),this.heldKeys.has("DOWN")&&(n.shipVelY+=this.thrustForce*e),this.heldKeys.has("LEFT")&&(n.shipVelX-=this.thrustForce*e),this.heldKeys.has("RIGHT")&&(n.shipVelX+=this.thrustForce*e),n.shipVelX=Math.max(-this.maxVelocity,Math.min(this.maxVelocity,n.shipVelX)),n.shipVelY=Math.max(-this.maxVelocity,Math.min(this.maxVelocity,n.shipVelY)),n.shipX+=n.shipVelX*e,n.shipY+=n.shipVelY*e;const i=.5;n.shipX=Math.max(i,Math.min(this.canvasWidth-1-i,n.shipX)),n.shipY=Math.max(i,Math.min(this.canvasHeight-1-i,n.shipY))}updateAirlockDrift(e){const n=this.state,i=n.driftTargetX-n.airlockX,o=n.driftTargetY-n.airlockY,r=Math.hypot(i,o);if(r<.1){const s=this.rand()*2*Math.PI,a=this.rand()*this.driftMaxDistanceChars,c=(this.canvasWidth-1)/2,l=(this.canvasHeight-1)/2;n.driftTargetX=c+Math.cos(s)*a,n.driftTargetY=l+Math.sin(s)*a,n.driftTimer=this.driftIntervalMs*(.8+.4*this.rand())}else{const s=this.driftSpeedCharsPerSec*e,a=Math.min(1,s/r);n.airlockX+=i*a,n.airlockY+=o*a}}updateCountdown(e){this.state.timeRemaining=Math.max(0,this.state.timeRemaining-e)}clearExpiredActions(){performance.now()-this.lastActionTime>this.actionTimeoutMs&&this.heldKeys.clear()}renderGame(e,n){const{top:i,left:o,width:r,height:s}=n;this.lastViewport={top:i,left:o,width:r,height:s},this.drawBorder(e,i,o,r,s),this.drawAirlock(e,i,o),this.drawShip(e,i,o),this.drawCountdown(e,i,o,r),this.drawDistance(e,i,o,s),this._primaryInput==="touch"?this._renderJoystick(e,n):this.drawControlButtons(e,i,o,r,s)}_renderJoystick(e,n){const{top:i,left:o,width:r,height:s}=n,a=(g,y,b,x)=>{var _;g<0||g>=e.length||y<0||y>=(((_=e[g])==null?void 0:_.length)??0)||(e[g][y]={char:b,fg:x,bg:"black"})};if(!this._joystick){const g="DRAG TO DOCK",y=i+s-2,b=o+Math.floor((r-g.length)/2);f(e,y,b,g,"bright-black","black");return}const{centerCol:c,centerRow:l,currentCol:h,currentRow:d}=this._joystick,p=h-c,u=d-l,m=this.heldKeys.size>0;a(l,c,"o",m?"bright-white":"white"),u<-ne&&a(l-2,c,"^","bright-green"),u>ne&&a(l+2,c,"v","bright-green"),p<-ne&&a(l,c-2,"<","bright-green"),p>ne&&a(l,c+2,">","bright-green")}drawBorder(e,n,i,o,r){const s=i+o-1,a=n+r-1;for(let c=i;c<=s;c++)n<e.length&&c<e[n].length&&(e[n][c]={char:"+",fg:"white",bg:"black"}),a<e.length&&c<e[a].length&&(e[a][c]={char:"+",fg:"white",bg:"black"});for(let c=n+1;c<a;c++)c<e.length&&(i<e[c].length&&(e[c][i]={char:"|",fg:"white",bg:"black"}),s<e[c].length&&(e[c][s]={char:"|",fg:"white",bg:"black"}))}drawAirlock(e,n,i){const o=i+1+Math.round(this.state.airlockX),r=n+1+Math.round(this.state.airlockY),s=o-Math.floor(this.airlockWidth/2),a=r-Math.floor(this.airlockHeight/2),c=[["+","-","+","-","+"],["|"," ","+"," ","|"],["+","-","+","-","+"]];for(let l=0;l<this.airlockHeight;l++)for(let h=0;h<this.airlockWidth;h++){const d=a+l,p=s+h;if(d>=n&&d<n+this.canvasHeight&&p>=i&&p<i+this.canvasWidth&&d<e.length&&p<e[d].length){const u=c[l][h];e[d][p]={char:u,fg:"bright-yellow",bg:"black"}}}}drawShip(e,n,i){const o=i+1+Math.round(this.state.shipX),r=n+1+Math.round(this.state.shipY);o>=i&&o<i+this.canvasWidth&&r>=n&&r<n+this.canvasHeight&&(r<e.length&&o<e[r].length&&(e[r][o]={char:"(",fg:"bright-green",bg:"black"}),o+1<i+this.canvasWidth&&r<e.length&&o+1<e[r].length&&(e[r][o+1]={char:"+",fg:"bright-green",bg:"black"}),o+2<i+this.canvasWidth&&r<e.length&&o+2<e[r].length&&(e[r][o+2]={char:")",fg:"bright-green",bg:"black"}))}drawCountdown(e,n,i,o){const r=`T: ${Math.ceil(this.state.timeRemaining)}`,s=i+o-1-r.length,a=n+1;f(e,a,s,r,"white","black")}drawDistance(e,n,i,o){const s=`DIST: ${Math.hypot(this.state.shipX-this.state.airlockX,this.state.shipY-this.state.airlockY).toFixed(1)}`,a=n+o-1;f(e,a,i+2,s,"white","black")}drawControlButtons(e,n,i,o,r){const s=e.length,a=s>0?e[0].length:0,c=n+r,l=i+Math.floor(o/2),h=this.heldKeys.has("UP"),d=this.heldKeys.has("DOWN"),p=this.heldKeys.has("LEFT"),u=this.heldKeys.has("RIGHT"),m="bright-green",g="bright-black",y=C=>`[${C}]`,b=c+1,x=c+2,_=c+3,k=l-5,v=l+3;if(b<s&&l-1>=0&&l+1<a){const C=y("^"),w=l-1;for(let T=0;T<C.length;T++)w+T>=0&&w+T<a&&(e[b][w+T]={char:C[T],fg:h?m:g,bg:"black"})}if(x<s){const C=y("<");for(let T=0;T<C.length;T++)k+T>=0&&k+T<a&&(e[x][k+T]={char:C[T],fg:p?m:g,bg:"black"});const w=y(">");for(let T=0;T<w.length;T++)v+T>=0&&v+T<a&&(e[x][v+T]={char:w[T],fg:u?m:g,bg:"black"})}if(_<s&&l-1>=0&&l+1<a){const C=y("v"),w=l-1;for(let T=0;T<C.length;T++)w+T>=0&&w+T<a&&(e[_][w+T]={char:C[T],fg:d?m:g,bg:"black"})}}}function ri(t,e,n,i,o,r){let{x:s,y:a,vx:c,vy:l}=t;c*=n.airResistance**r,l+=n.gravity*r,e.up&&(l-=n.thrustForce*r),e.down&&(l+=n.thrustForce*r),e.left&&(c-=n.thrustForce*r),e.right&&(c+=n.thrustForce*r);const h=n.maxVerticalSpeed??n.thrustForce*3;return c=Math.max(-h,Math.min(h,c)),l=Math.max(-h,Math.min(h,l)),s+=c*r,a+=l*r,s=Math.max(0,Math.min(i-o,s)),{x:s,y:a,vx:c,vy:l}}function Qr(t){if(t.length===0)return 2166136261;let e=2166136261;for(let n=0;n<t.length;n++)e^=t.charCodeAt(n),e=Math.imul(e,16777619)>>>0;return e===0?1:e}function Jr(t){let e=t>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}function si(t,e,n,i,o){const r=Jr(Qr(t)),s=3,a=Math.min(5,Math.floor(n/2)),c=s+Math.floor(r()*(a-s+1)),l=n-c,h=[];for(let u=0;u<e;u++){const m=Math.floor(r()*3)-1;h.push(Math.max(l-1,Math.min(l+1,l+m)))}const d=Math.max(0,e-i),p=Math.floor(r()*(d+1));for(let u=p;u<p+i&&u<e;u++)h[u]=l;return h.map((u,m)=>({surfaceRow:u,isPad:m>=p&&m<p+i}))}function ai(t,e,n){const i=Math.floor(t),o=i+2;for(let r=i;r<=o;r++)if(!(r<0||r>=n.length)&&e>=n[r].surfaceRow)return!0;return!1}function ci(t,e,n,i,o,r){for(let s=0;s<e.length;s++){const a=e[s],c=i+s;if(c<0)continue;let l;if(a.isPad){const u=s>0&&e[s-1].isPad,m=s<e.length-1&&e[s+1].isPad;u?m?l="=":l="]":l="["}else r==="asteroid"?l="/":l="^";const h=r==="asteroid"?"*":"#",d=a.isPad?"bright-yellow":"white",p=n+a.surfaceRow;for(let u=p;u<n+o;u++){if(u<0||u>=t.length||c>=t[u].length)continue;const m=u===p;t[u][c]={char:m?l:h,fg:d,bg:"black"}}}}const bt=3,An=2,Zr=1/60,ie=1;class es extends ot{constructor(e,n,i,o){super(e,n,i,{navOptions:[],title:"LANDING",onComplete:o}),this._ship={x:0,y:0,vx:0,vy:1},this._heldKeys=new Set,this._lastActionTime=0,this._actionTimeoutMs=200,this._terrain=null,this._viewport=null,this._landed=!1,this._joystick=null,this._destId=i.destinationId??"",this._primaryInput=n.primaryInput;const{surface:r}=F().miniGames;this._gravityAccel=r.gravityAccel,this._airResistance=r.airResistance,this._thrustForce=r.thrustForce,this._maxSafeSpeed=r.maxSafeSpeed,this._crashSpeed=r.crashSpeed,this._offPadScoreMultiplier=r.offPadScoreMultiplier,this._padWidth=r.padWidth,this._maxSpeed=r.maxSpeed,e.onTouchTrack&&e.onTouchTrack({start:(s,a,c)=>{a<X||(this._joystick={centerCol:s,centerRow:a,currentCol:s,currentRow:a,id:c})},move:(s,a,c)=>{!this._joystick||this._joystick.id!==c||(this._joystick.currentCol=s,this._joystick.currentRow=a)},end:s=>{var a;((a=this._joystick)==null?void 0:a.id)===s&&(this._joystick=null,this._heldKeys.clear())}})}handleAction(e){if(super.handleAction(e),e==="MENU"){this._landed||(this._landed=!0,this.complete({outcome:"skipped"}));return}this._primaryInput!=="touch"&&(e==="UP"||e==="DOWN"||e==="LEFT"||e==="RIGHT")&&(this._heldKeys.add(e),this._lastActionTime=performance.now())}update(e){if(super.update(e),this._landed||!this._terrain||!this._viewport)return;if(this._joystick){const r=this._joystick.currentCol-this._joystick.centerCol,s=this._joystick.currentRow-this._joystick.centerRow;this._heldKeys.clear(),s<-ie&&this._heldKeys.add("UP"),s>ie&&this._heldKeys.add("DOWN"),r<-ie&&this._heldKeys.add("LEFT"),r>ie&&this._heldKeys.add("RIGHT")}else this._clearExpiredKeys();const n={gravity:this._gravityAccel,airResistance:this._airResistance,thrustForce:this._thrustForce,maxVerticalSpeed:this._maxSpeed},i={up:this._heldKeys.has("UP"),down:this._heldKeys.has("DOWN"),left:this._heldKeys.has("LEFT"),right:this._heldKeys.has("RIGHT")};let o=e/1e3;for(;o>0&&!this._landed;){const r=Math.min(o,Zr);o-=r,this._ship=ri(this._ship,i,n,this._viewport.width,bt,r);const s=this._ship.y+(An-1);if(ai(this._ship.x,s,this._terrain)){const a=Math.hypot(this._ship.vx,this._ship.vy);this._snapToSurface(),this._land(a);break}}}_snapToSurface(){if(!this._terrain)return;const e=Math.floor(this._ship.x),n=e+bt-1;let i=1/0;for(let o=e;o<=n;o++)o>=0&&o<this._terrain.length&&(i=Math.min(i,this._terrain[o].surfaceRow));i<1/0&&(this._ship={...this._ship,y:i-An,vx:0,vy:0})}_land(e){if(this._landed)return;this._landed=!0;const n=e??Math.hypot(this._ship.vx,this._ship.vy),i=Math.max(0,Math.min(1,1-(n-this._maxSafeSpeed)/(this._crashSpeed-this._maxSafeSpeed))),o=Math.floor(this._ship.x)+1,r=this._terrain,s=o>=0&&o<r.length&&r[o].isPad,a=s?1:this._offPadScoreMultiplier,c=Math.round(i*a*100);this.complete({outcome:"completed",result:{score:c,speed:n,onPad:s}})}_clearExpiredKeys(){performance.now()-this._lastActionTime>this._actionTimeoutMs&&this._heldKeys.clear()}renderGame(e,n){this._terrain||(this._terrain=si(this._destId,n.width,n.height,this._padWidth),this._ship={x:(n.width-bt)/2,y:1,vx:0,vy:1}),this._viewport=n,ci(e,this._terrain,n.top,n.left,n.height,"planet"),this._renderShip(e,n),this._renderHUD(e,n),this._renderJoystick(e,n)}_renderShip(e,n){var s;const i=n.left+Math.round(this._ship.x),o=n.top+Math.round(this._ship.y),r=[["-","v","-"],["(","+",")"]];for(let a=0;a<r.length;a++)for(let c=0;c<r[a].length;c++){const l=o+a,h=i+c;l<0||l>=e.length||h<0||h>=(((s=e[l])==null?void 0:s.length)??0)||(e[l][h]={char:r[a][c],fg:"bright-green",bg:"black"})}}_renderHUD(e,n){const i=Math.hypot(this._ship.vx,this._ship.vy),o=`SPD:${i.toFixed(1)}`,r=n.left+n.width-o.length;if(f(e,n.top+1,r,o,"white","black"),i>this._maxSafeSpeed){const s="!! FAST",a=n.left+n.width-s.length;f(e,n.top+2,a,s,"bright-yellow","black")}}_renderJoystick(e,n){if(this._primaryInput!=="touch")return;if(!this._joystick){const d="HOLD & DRAG TO THRUST",p=this._terrain?Math.min(...this._terrain.map(g=>g.surfaceRow)):n.height-2,u=n.top+Math.max(0,p-2),m=n.left+Math.floor((n.width-d.length)/2);f(e,u,m,d,"bright-black","black");return}const{centerCol:i,centerRow:o,currentCol:r,currentRow:s}=this._joystick,a=r-i,c=s-o,l=this._heldKeys.size>0,h=(d,p,u,m)=>{var g;d<0||d>=e.length||p<0||p>=(((g=e[d])==null?void 0:g.length)??0)||(e[d][p]={char:u,fg:m,bg:"black"})};h(o,i,"o",l?"bright-white":"white"),c<-ie&&h(o-2,i,"^","bright-green"),c>ie&&h(o+2,i,"v","bright-green"),a<-ie&&h(o,i-2,"<","bright-green"),a>ie&&h(o,i+2,">","bright-green")}}const wt=3,Rn=2,ts=1/60,oe=1;class ns extends ot{constructor(e,n,i,o){super(e,n,i,{navOptions:[],title:"LANDING",onComplete:o}),this._ship={x:0,y:0,vx:0,vy:1},this._heldKeys=new Set,this._lastActionTime=0,this._actionTimeoutMs=200,this._terrain=null,this._viewport=null,this._landed=!1,this._joystick=null,this._destId=i.destinationId??"",this._primaryInput=n.primaryInput;const{asteroid:r}=F().miniGames;this._thrustForce=r.thrustForce,this._maxSafeSpeed=r.maxSafeSpeed,this._crashSpeed=r.crashSpeed,this._offPadScoreMultiplier=r.offPadScoreMultiplier,this._padWidth=r.padWidth,this._initialDownwardVelocity=r.initialDownwardVelocity,this._maxSpeed=r.maxSpeed,e.onTouchTrack&&e.onTouchTrack({start:(s,a,c)=>{a<X||(this._joystick={centerCol:s,centerRow:a,currentCol:s,currentRow:a,id:c})},move:(s,a,c)=>{!this._joystick||this._joystick.id!==c||(this._joystick.currentCol=s,this._joystick.currentRow=a)},end:s=>{var a;((a=this._joystick)==null?void 0:a.id)===s&&(this._joystick=null,this._heldKeys.clear())}})}handleAction(e){if(super.handleAction(e),e==="MENU"){this._landed||(this._landed=!0,this.complete({outcome:"skipped"}));return}this._primaryInput!=="touch"&&(e==="UP"||e==="DOWN"||e==="LEFT"||e==="RIGHT")&&(this._heldKeys.add(e),this._lastActionTime=performance.now())}update(e){if(super.update(e),this._landed||!this._terrain||!this._viewport)return;if(this._joystick){const r=this._joystick.currentCol-this._joystick.centerCol,s=this._joystick.currentRow-this._joystick.centerRow;this._heldKeys.clear(),s<-oe&&this._heldKeys.add("UP"),s>oe&&this._heldKeys.add("DOWN"),r<-oe&&this._heldKeys.add("LEFT"),r>oe&&this._heldKeys.add("RIGHT")}else this._clearExpiredKeys();const n={gravity:0,airResistance:1,thrustForce:this._thrustForce,maxVerticalSpeed:this._maxSpeed},i={up:this._heldKeys.has("UP"),down:this._heldKeys.has("DOWN"),left:this._heldKeys.has("LEFT"),right:this._heldKeys.has("RIGHT")};let o=e/1e3;for(;o>0&&!this._landed;){const r=Math.min(o,ts);o-=r,this._ship=ri(this._ship,i,n,this._viewport.width,wt,r);const s=this._ship.y+(Rn-1);if(ai(this._ship.x,s,this._terrain)){const a=Math.hypot(this._ship.vx,this._ship.vy);this._snapToSurface(),this._land(a);break}}}_snapToSurface(){if(!this._terrain)return;const e=Math.floor(this._ship.x),n=e+wt-1;let i=1/0;for(let o=e;o<=n;o++)o>=0&&o<this._terrain.length&&(i=Math.min(i,this._terrain[o].surfaceRow));i<1/0&&(this._ship={...this._ship,y:i-Rn,vx:0,vy:0})}_land(e){if(this._landed)return;this._landed=!0;const n=e??Math.hypot(this._ship.vx,this._ship.vy),i=Math.max(0,Math.min(1,1-(n-this._maxSafeSpeed)/(this._crashSpeed-this._maxSafeSpeed))),o=Math.floor(this._ship.x)+1,r=this._terrain,s=o>=0&&o<r.length&&r[o].isPad,a=s?1:this._offPadScoreMultiplier,c=Math.round(i*a*100);this.complete({outcome:"completed",result:{score:c,speed:n,onPad:s}})}_clearExpiredKeys(){performance.now()-this._lastActionTime>this._actionTimeoutMs&&this._heldKeys.clear()}renderGame(e,n){this._terrain||(this._terrain=si(this._destId,n.width,n.height,this._padWidth),this._ship={x:(n.width-wt)/2,y:1,vx:0,vy:this._initialDownwardVelocity}),this._viewport=n,ci(e,this._terrain,n.top,n.left,n.height,"asteroid"),this._renderShip(e,n),this._renderHUD(e,n),this._renderJoystick(e,n)}_renderShip(e,n){var s;const i=n.left+Math.round(this._ship.x),o=n.top+Math.round(this._ship.y),r=[["-","v","-"],["(","+",")"]];for(let a=0;a<r.length;a++)for(let c=0;c<r[a].length;c++){const l=o+a,h=i+c;l<0||l>=e.length||h<0||h>=(((s=e[l])==null?void 0:s.length)??0)||(e[l][h]={char:r[a][c],fg:"bright-green",bg:"black"})}}_renderHUD(e,n){const i=Math.hypot(this._ship.vx,this._ship.vy),o=`SPD:${i.toFixed(1)}`,r=n.left+n.width-o.length;if(f(e,n.top+1,r,o,"white","black"),i>this._maxSafeSpeed){const s="!! FAST",a=n.left+n.width-s.length;f(e,n.top+2,a,s,"bright-yellow","black")}}_renderJoystick(e,n){if(this._primaryInput!=="touch")return;if(!this._joystick){const d="HOLD & DRAG TO THRUST",p=this._terrain?Math.min(...this._terrain.map(g=>g.surfaceRow)):n.height-2,u=n.top+Math.max(0,p-2),m=n.left+Math.floor((n.width-d.length)/2);f(e,u,m,d,"bright-black","black");return}const{centerCol:i,centerRow:o,currentCol:r,currentRow:s}=this._joystick,a=r-i,c=s-o,l=this._heldKeys.size>0,h=(d,p,u,m)=>{var g;d<0||d>=e.length||p<0||p>=(((g=e[d])==null?void 0:g.length)??0)||(e[d][p]={char:u,fg:m,bg:"black"})};h(o,i,"o",l?"bright-white":"white"),c<-oe&&h(o-2,i,"^","bright-green"),c>oe&&h(o+2,i,"v","bright-green"),a<-oe&&h(o,i-2,"<","bright-green"),a>oe&&h(o,i+2,">","bright-green")}}function is(t){if(t.length===0)return 2166136261;let e=2166136261;for(let n=0;n<t.length;n++)e^=t.charCodeAt(n),e=Math.imul(e,16777619)>>>0;return e===0?1:e}function os(t){let e=t>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}class rs extends ot{constructor(e,n,i,o,r){super(e,n,i,{navOptions:[],title:"NAVIGATION",onComplete:r}),this.heldKeys=new Set,this.lastViewport={top:0,left:0,width:80,height:24},this._joystick=null,this.initialized=!1,this._primaryInput=n.primaryInput;let s=null,a=null;o instanceof URLSearchParams?(s=o.get("type"),a=o.get("difficulty")):(s=o.type??null,a=o.difficulty??null),this.eventType=s??"asteroid_belt",this.difficulty=a??"normal";const c=is(i.destinationId??"");this.rand=os(c),F().miniGames.navigation.difficulties[this.difficulty].targetDistance,this.state={playerWorldX:0,playerWorldY:0,playerVelX:0,playerVelY:0,cameraScrollY:-8,obstacles:[],spawnFrontierY:0,lastEdgeSpawnFrame:0,frameCount:0,completed:!1,collisionFlashEndTime:0,outcome:"idle",lives:3,invincibilityEndTime:0},e.onTouchTrack&&e.onTouchTrack({start:(p,u,m)=>{u<X||(this._joystick={centerCol:p,centerRow:u,currentCol:p,currentRow:u,id:m})},move:(p,u,m)=>{!this._joystick||this._joystick.id!==m||(this._joystick.currentCol=p,this._joystick.currentRow=u)},end:p=>{var u;((u=this._joystick)==null?void 0:u.id)===p&&(this._joystick=null,this.heldKeys.clear())}})}handleAction(e){if(super.handleAction(e),e==="MENU"){this.state.completed||(this.state.completed=!0,this.complete({outcome:"skipped"}));return}(e==="UP"||e==="DOWN"||e==="LEFT"||e==="RIGHT")&&this.heldKeys.add(e)}update(e){if(super.update(e),this.state.completed)return;const n=e/1e3,o=F().miniGames.navigation,r=o.difficulties[this.difficulty],s=o.ship;if(this._joystick){const c=this._joystick.currentCol-this._joystick.centerCol,l=this._joystick.currentRow-this._joystick.centerRow;this.heldKeys.clear(),l<-1&&this.heldKeys.add("UP"),l>1&&this.heldKeys.add("DOWN"),c<-1&&this.heldKeys.add("LEFT"),c>1&&this.heldKeys.add("RIGHT")}this.updateInput(s),this.updatePosition(n,r),this.spawnObstacles(this.lastViewport,r,o),this.updateObstacles(n,r,this.lastViewport),this.checkCollisions(this.lastViewport),this.checkVictory(r),this.state.outcome==="collision"&&this.state.lives>0&&performance.now()>this.state.collisionFlashEndTime&&(this.state.outcome="idle"),this.state.frameCount++}updateInput(e){const n=e.accelerationImpulse,i=e.maxSpeedLateral,o=e.maxSpeedForward;this.heldKeys.has("LEFT")&&(this.state.playerVelX>0&&(this.state.playerVelX=0),this.state.playerVelX-=n),this.heldKeys.has("RIGHT")&&(this.state.playerVelX<0&&(this.state.playerVelX=0),this.state.playerVelX+=n),this.heldKeys.has("UP")&&(this.state.playerVelY<0&&(this.state.playerVelY=0),this.state.playerVelY+=n),this.heldKeys.has("DOWN")&&(this.state.playerVelY-=n);const r=.98;!this.heldKeys.has("LEFT")&&!this.heldKeys.has("RIGHT")&&(this.state.playerVelX*=r),this.state.playerVelX=Math.max(-i,Math.min(i,this.state.playerVelX)),this.state.playerVelY=Math.max(-o,Math.min(o,this.state.playerVelY)),this.heldKeys.clear()}updatePosition(e,n){const i=n.minScrollSpeed,o=Math.max(this.state.playerVelY,i),{width:r}=this.lastViewport;this.state.playerWorldX+=this.state.playerVelX*e,this.state.playerWorldX=Math.max(1,Math.min(r-2,this.state.playerWorldX)),this.state.playerWorldY+=o*e,this.state.cameraScrollY+=o*e}spawnObstacles(e,n,i){const{width:o,height:r}=e,s=n.obstacleDensity,a=n.edgeSpawnIntervalFrames,c=n.driftSpeedMax,l=i.eventTypes[this.eventType],h=r,d=this.state.spawnFrontierY,p=d+h,m=this.state.cameraScrollY+r;if(d<m){this.state.spawnFrontierY+=h;let g=0;for(const b of this.state.obstacles){const x=b.worldY+5;b.worldY<p&&x>d&&g++}const y=Math.ceil(s*h);for(;g<y;)this.spawnObstacleInBand(d,p,o,n,l,c),g++}if(this.state.frameCount-this.state.lastEdgeSpawnFrame>=a){this.state.lastEdgeSpawnFrame=this.state.frameCount;const g=this.rand()<.5?"left":"right",y=this.state.cameraScrollY+r+(this.rand()-.5)*20;this.spawnObstacleAtEdge(g,y,o,n,l,c)}}spawnObstacleInBand(e,n,i,o,r,s){const a=this.pickSize(r),c=this.createObstacle(a,o,s);c.worldY=e+this.rand()*(n-e),c.worldX=Math.max(0,Math.min(i-2,this.rand()*i)),this.state.obstacles.push(c)}spawnObstacleAtEdge(e,n,i,o,r,s){const a=this.pickSize(r),c=this.createObstacle(a,o,s);c.worldY=n,e==="left"?(c.worldX=-10,c.driftVx=s*(.3+.4*this.rand())):(c.worldX=i+5,c.driftVx=-s*(.3+.4*this.rand())),this.state.obstacles.push(c)}pickSize(e){const n=this.rand();return n<e.large_ratio?"large":n<e.large_ratio+e.medium_ratio?"medium":"small"}createObstacle(e,n,i){const o=this.getObstacleCells(e);return{worldX:0,worldY:0,driftVx:0,driftVy:-Math.max(.1,i*(.3+.7*this.rand())),cells:o,size:e}}getObstacleCells(e){if(e==="large")if(this.eventType==="asteroid_belt"){const n=Math.floor(this.rand()*4);return n===0?[{dcol:2,drow:0,char:"#",color:"white"},{dcol:3,drow:0,char:"@",color:"white"},{dcol:1,drow:1,char:"@",color:"white"},{dcol:2,drow:1,char:"O",color:"bright-white"},{dcol:3,drow:1,char:"#",color:"white"},{dcol:4,drow:1,char:"@",color:"white"},{dcol:0,drow:2,char:"#",color:"white"},{dcol:1,drow:2,char:"@",color:"white"},{dcol:2,drow:2,char:"O",color:"bright-white"},{dcol:3,drow:2,char:"#",color:"white"},{dcol:4,drow:2,char:"@",color:"white"},{dcol:1,drow:3,char:"#",color:"white"},{dcol:2,drow:3,char:"@",color:"white"},{dcol:3,drow:3,char:"O",color:"bright-white"},{dcol:4,drow:3,char:"#",color:"white"},{dcol:2,drow:4,char:"#",color:"white"},{dcol:3,drow:4,char:"@",color:"white"},{dcol:2,drow:5,char:"O",color:"bright-white"}]:n===1?[{dcol:1,drow:0,char:"O",color:"bright-white"},{dcol:2,drow:0,char:"@",color:"white"},{dcol:3,drow:0,char:"O",color:"bright-white"},{dcol:0,drow:1,char:"#",color:"white"},{dcol:1,drow:1,char:"O",color:"bright-white"},{dcol:2,drow:1,char:"O",color:"bright-white"},{dcol:3,drow:1,char:"O",color:"bright-white"},{dcol:4,drow:1,char:"@",color:"white"},{dcol:0,drow:2,char:"@",color:"white"},{dcol:1,drow:2,char:"O",color:"bright-white"},{dcol:2,drow:2,char:"#",color:"white"},{dcol:3,drow:2,char:"O",color:"bright-white"},{dcol:4,drow:2,char:"#",color:"white"},{dcol:1,drow:3,char:"@",color:"white"},{dcol:2,drow:3,char:"O",color:"bright-white"},{dcol:3,drow:3,char:"@",color:"white"},{dcol:2,drow:4,char:"#",color:"white"}]:n===2?[{dcol:0,drow:0,char:"#",color:"white"},{dcol:1,drow:0,char:"#",color:"white"},{dcol:2,drow:0,char:"#",color:"white"},{dcol:3,drow:0,char:"@",color:"white"},{dcol:0,drow:1,char:"#",color:"white"},{dcol:1,drow:1,char:"O",color:"bright-white"},{dcol:2,drow:1,char:"@",color:"white"},{dcol:3,drow:1,char:"#",color:"white"},{dcol:4,drow:1,char:"@",color:"white"},{dcol:0,drow:2,char:"@",color:"white"},{dcol:1,drow:2,char:"#",color:"white"},{dcol:2,drow:2,char:"@",color:"white"},{dcol:3,drow:2,char:"O",color:"bright-white"},{dcol:4,drow:2,char:"#",color:"white"},{dcol:1,drow:3,char:"#",color:"white"},{dcol:2,drow:3,char:"@",color:"white"},{dcol:3,drow:3,char:"#",color:"white"},{dcol:2,drow:4,char:"#",color:"white"},{dcol:3,drow:4,char:"@",color:"white"},{dcol:2,drow:5,char:"#",color:"white"}]:[{dcol:1,drow:0,char:"#",color:"white"},{dcol:2,drow:0,char:"#",color:"white"},{dcol:3,drow:0,char:"@",color:"white"},{dcol:4,drow:0,char:"#",color:"white"},{dcol:0,drow:1,char:"@",color:"white"},{dcol:1,drow:1,char:"O",color:"bright-white"},{dcol:2,drow:1,char:"O",color:"bright-white"},{dcol:3,drow:1,char:"O",color:"bright-white"},{dcol:4,drow:1,char:"#",color:"white"},{dcol:5,drow:1,char:"@",color:"white"},{dcol:0,drow:2,char:"#",color:"white"},{dcol:1,drow:2,char:"@",color:"white"},{dcol:2,drow:2,char:"#",color:"white"},{dcol:3,drow:2,char:"@",color:"white"},{dcol:4,drow:2,char:"O",color:"bright-white"},{dcol:5,drow:2,char:"#",color:"white"},{dcol:1,drow:3,char:"#",color:"white"},{dcol:2,drow:3,char:"@",color:"white"},{dcol:3,drow:3,char:"#",color:"white"},{dcol:4,drow:3,char:"@",color:"white"},{dcol:2,drow:4,char:"#",color:"white"},{dcol:3,drow:4,char:"#",color:"white"},{dcol:3,drow:5,char:"@",color:"white"}]}else if(this.eventType==="space_debris"){const n=Math.floor(this.rand()*5);return n===0?[{dcol:0,drow:0,char:"[",color:"bright-black"},{dcol:1,drow:0,char:"=",color:"bright-black"},{dcol:2,drow:0,char:"=",color:"bright-black"},{dcol:3,drow:0,char:"]",color:"bright-black"},{dcol:0,drow:1,char:"-",color:"bright-black"},{dcol:1,drow:1,char:"[",color:"bright-black"},{dcol:2,drow:1,char:"]",color:"bright-black"},{dcol:3,drow:1,char:"-",color:"bright-black"},{dcol:1,drow:2,char:"=",color:"bright-black"},{dcol:2,drow:2,char:"=",color:"bright-black"}]:n===1?[{dcol:1,drow:0,char:"/",color:"bright-black"},{dcol:3,drow:0,char:"\\",color:"bright-black"},{dcol:0,drow:1,char:"-",color:"bright-black"},{dcol:1,drow:1,char:"[",color:"bright-black"},{dcol:2,drow:1,char:"=",color:"bright-black"},{dcol:3,drow:1,char:"]",color:"bright-black"},{dcol:4,drow:1,char:"-",color:"bright-black"},{dcol:1,drow:2,char:"\\",color:"bright-black"},{dcol:3,drow:2,char:"/",color:"bright-black"}]:n===2?[{dcol:1,drow:0,char:"=",color:"bright-black"},{dcol:2,drow:0,char:"-",color:"bright-black"},{dcol:0,drow:1,char:"/",color:"bright-black"},{dcol:1,drow:1,char:"[",color:"bright-black"},{dcol:2,drow:1,char:"]",color:"bright-black"},{dcol:3,drow:1,char:"\\",color:"bright-black"},{dcol:1,drow:2,char:"-",color:"bright-black"},{dcol:2,drow:2,char:"=",color:"bright-black"}]:n===3?[{dcol:0,drow:0,char:"\\",color:"bright-black"},{dcol:2,drow:0,char:"/",color:"bright-black"},{dcol:1,drow:1,char:"=",color:"bright-black"},{dcol:0,drow:2,char:"/",color:"bright-black"},{dcol:2,drow:2,char:"\\",color:"bright-black"},{dcol:3,drow:2,char:"=",color:"bright-black"}]:[{dcol:0,drow:0,char:"+",color:"bright-black"},{dcol:1,drow:0,char:"-",color:"bright-black"},{dcol:2,drow:0,char:"+",color:"bright-black"},{dcol:0,drow:1,char:"|",color:"bright-black"},{dcol:2,drow:1,char:"|",color:"bright-black"},{dcol:0,drow:2,char:"+",color:"bright-black"},{dcol:1,drow:2,char:"-",color:"bright-black"},{dcol:2,drow:2,char:"+",color:"bright-black"}]}else{const n=Math.floor(this.rand()*4);return n===0?[{dcol:0,drow:0,char:".",color:"cyan"},{dcol:2,drow:0,char:"'",color:"cyan"},{dcol:4,drow:0,char:"`",color:"cyan"},{dcol:1,drow:1,char:"`",color:"cyan"},{dcol:3,drow:1,char:",",color:"cyan"},{dcol:0,drow:2,char:"'",color:"cyan"},{dcol:2,drow:2,char:".",color:"cyan"},{dcol:4,drow:2,char:",",color:"cyan"},{dcol:1,drow:3,char:"`",color:"bright-cyan"},{dcol:3,drow:3,char:"'",color:"cyan"}]:n===1?[{dcol:1,drow:0,char:"*",color:"bright-cyan"},{dcol:3,drow:0,char:".",color:"cyan"},{dcol:0,drow:1,char:"'",color:"cyan"},{dcol:2,drow:1,char:",",color:"bright-cyan"},{dcol:4,drow:1,char:"`",color:"cyan"},{dcol:1,drow:2,char:".",color:"cyan"},{dcol:3,drow:2,char:"*",color:"bright-cyan"},{dcol:0,drow:3,char:"`",color:"cyan"},{dcol:4,drow:3,char:"'",color:"cyan"}]:n===2?[{dcol:2,drow:0,char:"*",color:"bright-cyan"},{dcol:0,drow:1,char:".",color:"cyan"},{dcol:1,drow:1,char:"'",color:"cyan"},{dcol:3,drow:1,char:",",color:"cyan"},{dcol:4,drow:1,char:"`",color:"bright-cyan"},{dcol:2,drow:2,char:"`",color:"cyan"},{dcol:1,drow:3,char:",",color:"bright-cyan"},{dcol:3,drow:3,char:".",color:"cyan"}]:[{dcol:1,drow:0,char:".",color:"bright-cyan"},{dcol:3,drow:0,char:"'",color:"cyan"},{dcol:0,drow:1,char:"`",color:"cyan"},{dcol:2,drow:1,char:"*",color:"bright-cyan"},{dcol:4,drow:1,char:",",color:"cyan"},{dcol:1,drow:2,char:"*",color:"cyan"},{dcol:3,drow:2,char:"`",color:"bright-cyan"},{dcol:2,drow:3,char:"'",color:"cyan"}]}else if(e==="medium"){if(this.eventType==="asteroid_belt")return Math.floor(this.rand()*2)===0?[{dcol:0,drow:0,char:"@",color:"bright-white"},{dcol:1,drow:0,char:"O",color:"white"},{dcol:0,drow:1,char:"#",color:"bright-white"},{dcol:1,drow:1,char:"@",color:"white"},{dcol:1,drow:2,char:"#",color:"white"}]:[{dcol:0,drow:0,char:"#",color:"white"},{dcol:1,drow:0,char:"@",color:"bright-white"},{dcol:2,drow:0,char:"O",color:"white"},{dcol:0,drow:1,char:"O",color:"bright-white"},{dcol:1,drow:1,char:"@",color:"white"}];if(this.eventType==="space_debris"){const n=Math.floor(this.rand()*4);return n===0?[{dcol:0,drow:0,char:"[",color:"bright-black"},{dcol:1,drow:0,char:"=",color:"bright-black"},{dcol:2,drow:0,char:"=",color:"bright-black"},{dcol:0,drow:1,char:"-",color:"bright-black"},{dcol:2,drow:1,char:"]",color:"bright-black"}]:n===1?[{dcol:0,drow:0,char:"/",color:"bright-black"},{dcol:1,drow:0,char:"[",color:"bright-black"},{dcol:2,drow:0,char:"\\",color:"bright-black"},{dcol:1,drow:1,char:"=",color:"bright-black"}]:n===2?[{dcol:0,drow:0,char:"\\",color:"bright-black"},{dcol:1,drow:0,char:"-",color:"bright-black"},{dcol:2,drow:0,char:"/",color:"bright-black"},{dcol:1,drow:1,char:"[",color:"bright-black"},{dcol:0,drow:1,char:"-",color:"bright-black"}]:[{dcol:0,drow:0,char:"(",color:"bright-black"},{dcol:1,drow:0,char:"=",color:"bright-black"},{dcol:2,drow:0,char:")",color:"bright-black"},{dcol:1,drow:1,char:"-",color:"bright-black"}]}else{const n=Math.floor(this.rand()*3);return n===0?[{dcol:0,drow:0,char:".",color:"bright-cyan"},{dcol:1,drow:0,char:"'",color:"cyan"},{dcol:2,drow:0,char:".",color:"bright-cyan"},{dcol:0,drow:1,char:"`",color:"cyan"},{dcol:1,drow:1,char:",",color:"bright-cyan"}]:n===1?[{dcol:0,drow:0,char:"'",color:"bright-cyan"},{dcol:1,drow:0,char:"*",color:"cyan"},{dcol:0,drow:1,char:",",color:"cyan"},{dcol:2,drow:1,char:"`",color:"bright-cyan"}]:[{dcol:0,drow:0,char:"`",color:"cyan"},{dcol:1,drow:0,char:".",color:"bright-cyan"},{dcol:2,drow:0,char:"'",color:"cyan"},{dcol:1,drow:1,char:"*",color:"bright-cyan"}]}}else if(this.eventType==="asteroid_belt"){const n=Math.floor(this.rand()*3);return n===0?[{dcol:0,drow:0,char:"*",color:"bright-white"},{dcol:1,drow:0,char:"o",color:"white"}]:n===1?[{dcol:0,drow:0,char:"o",color:"white"},{dcol:1,drow:0,char:"*",color:"bright-white"}]:[{dcol:0,drow:0,char:"@",color:"white"},{dcol:1,drow:0,char:"*",color:"bright-white"}]}else if(this.eventType==="space_debris"){const n=Math.floor(this.rand()*4);return n===0?[{dcol:0,drow:0,char:"+",color:"bright-black"},{dcol:1,drow:0,char:"=",color:"bright-black"}]:n===1?[{dcol:0,drow:0,char:"[",color:"bright-black"},{dcol:1,drow:0,char:"]",color:"bright-black"}]:n===2?[{dcol:0,drow:0,char:"/",color:"bright-black"},{dcol:1,drow:0,char:"\\",color:"bright-black"}]:[{dcol:0,drow:0,char:"-",color:"bright-black"},{dcol:1,drow:0,char:"=",color:"bright-black"}]}else{const n=Math.floor(this.rand()*4);return n===0?[{dcol:0,drow:0,char:".",color:"cyan"},{dcol:1,drow:0,char:"'",color:"bright-cyan"}]:n===1?[{dcol:0,drow:0,char:"`",color:"bright-cyan"},{dcol:1,drow:0,char:",",color:"cyan"}]:n===2?[{dcol:0,drow:0,char:"*",color:"bright-cyan"},{dcol:1,drow:0,char:".",color:"cyan"}]:[{dcol:0,drow:0,char:"'",color:"cyan"},{dcol:1,drow:0,char:"*",color:"bright-cyan"}]}}updateObstacles(e,n,i){const{height:o}=i;for(const r of this.state.obstacles)r.worldX+=r.driftVx*e,r.worldY+=r.driftVy*e;this.state.obstacles=this.state.obstacles.filter(r=>r.worldY+5>this.state.cameraScrollY-5)}checkCollisions(e){if(this.state.completed||performance.now()<this.state.invincibilityEndTime||this.state.lives<=0&&this.state.outcome==="collision")return;const{width:n,height:i,top:o,left:r}=e,s=r+Math.round(this.state.playerWorldX)-1,a=s+1,c=o+i-1-Math.round(this.state.playerWorldY-this.state.cameraScrollY);if(!(c<=o))for(const l of this.state.obstacles)for(const h of l.cells){const d=r+Math.round(l.worldX+h.dcol),p=o+i-1-Math.round(l.worldY+h.drow-this.state.cameraScrollY);if(!(p<=o)&&(d===s||d===a)&&p===c){this.triggerCollision();return}}}triggerCollision(){this.state.completed||(this.state.lives--,this.state.invincibilityEndTime=performance.now()+2e3,this.state.lives<=0?(this.state.outcome="collision",this.state.collisionFlashEndTime=performance.now()+400):(this.state.outcome="collision",this.state.collisionFlashEndTime=performance.now()+200))}checkVictory(e){if(!this.state.completed)if(this.state.playerWorldY>=e.targetDistance&&this.state.lives>0){this.state.outcome="victory",this.state.completed=!0;const n=Math.max(1,Math.round(100*(this.state.lives/3)));setTimeout(()=>{this.complete({outcome:"completed",result:{score:n}})},500)}else this.state.outcome==="collision"&&this.state.lives<=0&&performance.now()>this.state.collisionFlashEndTime&&(this.state.completed=!0,this.complete({outcome:"completed",result:{score:0}}))}checkOutOfBounds(e){if(this.state.completed)return;const n=Math.round(this.state.playerWorldY-this.state.cameraScrollY),i=e.top+e.height-1;n>i&&this.triggerCollision()}renderGame(e,n){this.lastViewport=n;const{top:i,left:o,width:r,height:s}=n;this.initialized||(this.initialized=!0,this.state.playerWorldX=r/2,this.state.playerWorldY=s*2/3,this.state.cameraScrollY=this.state.playerWorldY-(s/3-1));for(let l=i;l<i+s;l++)if(l>=0&&l<e.length)for(let h=o;h<o+r;h++)h>=0&&h<e[l].length&&(e[l][h]={char:" ",fg:"white",bg:"black"});this.drawHud(e,n);for(const l of this.state.obstacles)for(const h of l.cells){const d=o+Math.round(l.worldX+h.dcol),p=i+s-1-Math.round(l.worldY+h.drow-this.state.cameraScrollY);p>i&&p>=i&&p<i+s&&d>=o&&d<o+r&&p<e.length&&d<e[p].length&&(e[p][d]={char:h.char,fg:h.color,bg:"black"})}const a=o+Math.round(this.state.playerWorldX)-1,c=i+s-1-Math.round(this.state.playerWorldY-this.state.cameraScrollY);if(c>=i&&c<i+s&&a>=o&&a<o+r-1){const l=this.state.outcome==="collision"&&Math.floor((performance.now()-(this.state.collisionFlashEndTime-400))/100)%2===0;if(performance.now()<this.state.invincibilityEndTime&&Math.floor(performance.now()/100)%2===0)return;const p=l?"bright-red":"bright-green";c<e.length&&a<e[c].length&&(e[c][a]={char:"/",fg:p,bg:"black"}),c<e.length&&a+1<e[c].length&&(e[c][a+1]={char:"\\",fg:p,bg:"black"})}this._primaryInput==="touch"&&this.renderJoystick(e,n)}renderJoystick(e,n){const{top:i,left:o,width:r,height:s}=n,a=(g,y,b,x)=>{var _;g<0||g>=e.length||y<0||y>=(((_=e[g])==null?void 0:_.length)??0)||(e[g][y]={char:b,fg:x,bg:"black"})};if(!this._joystick){const g="DRAG TO NAVIGATE",y=i+s-2,b=o+Math.floor((r-g.length)/2);for(let x=0;x<g.length&&b+x<o+r;x++)a(y,b+x,g[x],"bright-black");return}const{centerCol:c,centerRow:l,currentCol:h,currentRow:d}=this._joystick,p=h-c,u=d-l,m=1;a(l,c,"o","bright-white"),u<-m&&a(l-2,c,"^","bright-green"),u>m&&a(l+2,c,"v","bright-green"),p<-m&&a(l,c-2,"<","bright-green"),p>m&&a(l,c+2,">","bright-green")}drawHud(e,n){const{top:i,left:o,width:r}=n,l=F().miniGames.navigation.difficulties[this.difficulty].targetDistance,h=this.state.playerWorldY,d=Math.min(1,Math.max(0,h/l)),p=15,u=Math.round(p*d);let m="";for(let k=0;k<u;k++)m+="█";for(let k=u;k<p;k++)m+="░";const g=Math.round(h).toString(),y=`[${m}] ${g}u`;if(i<e.length){let k=o;for(const v of y)k<o+r&&k<e[i].length&&(e[i][k]={char:v,fg:"bright-yellow",bg:"black"}),k++}const b=`L:${this.state.lives}`,_=o+r-b.length-5;if(i<e.length){let k=_;for(const v of b){if(k>=o&&k<o+r&&k>=0&&k<e[i].length){const C=this.state.lives===1?"bright-red":this.state.lives===2?"bright-yellow":"bright-green";e[i][k]={char:v,fg:C,bg:"black"}}k++}}}}const Ve=[{id:"docking",name:"Docking Mini-Game",description:"Align the ship crosshair with the airlock target before countdown expires",variants:[{id:"orbital",label:"Orbital Station",params:{locationType:"orbital"}},{id:"deep-space",label:"Deep Space",params:{locationType:"deep-space"}}]},{id:"surface-landing",name:"Planet Landing",description:"Counter gravity and air resistance to land gently on the marked pad",variants:[{id:"surface",label:"Planet Surface",params:{locationType:"surface"}}]},{id:"asteroid-landing",name:"Asteroid Landing",description:"Navigate freely with no gravity to land on the marked pad",variants:[{id:"asteroid",label:"Asteroid Surface",params:{locationType:"asteroid"}}]},{id:"navigation",name:"Space Navigation",description:"Pilot your ship through obstacles with momentum controls",variants:[{id:"asteroid_belt",label:"Asteroid Belt",params:{type:"asteroid_belt",difficulty:"normal"}},{id:"space_debris",label:"Space Debris",params:{type:"space_debris",difficulty:"normal"}},{id:"space_storm",label:"Space Storm",params:{type:"space_storm",difficulty:"normal"}}]}],En=[{meta:Ve[0],factory:(t,e,n,i,o)=>new zr(t,e,n,o)},{meta:Ve[1],factory:(t,e,n,i,o)=>new es(t,e,n,o)},{meta:Ve[2],factory:(t,e,n,i,o)=>new ns(t,e,n,o)},{meta:Ve[3],factory:(t,e,n,i,o)=>new rs(t,e,n,i,o)}];function ss(t){let e=t>>>0;return()=>(e=Math.imul(e,1664525)+1013904223>>>0,e/4294967296)}function as(t,e){return Math.floor(t()*e)}function Re(t,e){return e[as(t,e.length)]}function li(t,e){const{special:n,firstNames:i,lastNames:o}=e.npcNames;if(t()<F().npc.specialNameChance&&n.length>0)return{giverName:Re(t,n)};const r=i.length>0?Re(t,i):"Unknown",s=o.length>0?Re(t,o):"Agent";return{giverName:`${r} ${s}`}}function cs(t,e){return e.destinations.filter(n=>n.id!==t.id)}function ls(t){return t.commodities.filter(e=>e.legal)}function hs(t,e){const n=e.reduce((o,r)=>o+r.weightKg,0);if(n===0)return e[0];let i=t()*n;for(const o of e)if(i-=o.weightKg,i<0)return o;return e[e.length-1]}function Ln(t,e,n,i){var y;const o=n.deliveryItems;if(o.length===0)return null;const r=cs(e,n);if(r.length===0)return null;const s=hs(t,o),a=Re(t,r),c=li(t,n),{deliveryBaseReward:l,deliveryRandomReward:h,deliveryDepositFraction:d}=F().missions,p=Math.floor(s.weightKg*1.5),u=l+p+Math.floor(t()*h),m=Math.floor(u*d),g=e.owningFactionId?(y=D().factions.find(b=>b.id===e.owningFactionId&&me(b)))==null?void 0:y.id:void 0;return{...c,giverFactionId:g,id:i,type:"delivery",title:s.name,description:`A package needs transporting. Pick up the ${s.name} from ${e.name} and deliver it to ${a.name}. Handle with care.`,reward:u,issuingDestinationId:e.id,itemName:s.name,itemWeightKg:s.weightKg,pickupDestinationId:e.id,deliveryDestinationId:a.id,deposit:m}}function Fn(t,e,n,i){var G;const o=ls(n);if(o.length===0)return null;const r=J(e.system),s=[],a=[];for(const S of o)(r?Ze(S.id,r):1)>1&&a.push(S),s.push(S);const c=a.length>0?a:o;for(const S of c)s.push(S);const{supplyRequirementsMin:l,supplyRequirementsMax:h,supplyQtyMin:d,supplyQtyMax:p}=F().missions,u=l+Math.floor(t()*(h-l+1)),m=[],g=new Set;for(let S=0;S<u;S++){let R=0;for(;R<10;){const E=Re(t,s);if(!g.has(E.id)){g.add(E.id);const A=d+Math.floor(t()*(p-d+1));m.push({commodityId:E.id,qty:A});break}R++}}if(m.length===0)return null;const y=m.reduce((S,R)=>{const E=n.commodities.find(A=>A.id===R.commodityId);return S+((E==null?void 0:E.basePrice)??100)*R.qty},0),b=m.reduce((S,R)=>{const E=n.commodities.find(A=>A.id===R.commodityId);return S+((E==null?void 0:E.weightKg)??1)*R.qty},0),{supplyRewardMultiplierMin:x,supplyRewardMultiplierMax:_}=F().missions,k=Math.min(1,b/500),v=t(),C=v+k*(1-v)*.15,w=x+C*(_-x),T=Math.floor(y*w),O=li(t,n),K=m.map(S=>{const R=n.commodities.find(E=>E.id===S.commodityId);return`${S.qty}× ${(R==null?void 0:R.name)??S.commodityId}`}).join(", "),P=e.owningFactionId?(G=D().factions.find(S=>S.id===e.owningFactionId&&me(S)))==null?void 0:G.id:void 0;return{...O,giverFactionId:P,id:i,type:"supply",title:e.name,description:`${e.name} needs supplies. Deliver ${K} to fulfil the contract.`,reward:T,issuingDestinationId:e.id,requirements:m,deliveryDestinationId:e.id}}function ds(t){let e=0;for(let n=0;n<t.length;n++)e=(e<<5)-e^t.charCodeAt(n);return e>>>0}function us(t,e,n){const i=F();let o;{const l=i.missions.missionTtlMs,h=Date.now(),d=Math.floor(h/l);o=ds(t.id)^d}const r=ss(o),{boardMaxCount:s,deliveryChance:a}=i.missions,c=[];for(let l=0;l<t.minMissions&&c.length<s;l++){const h=`m-${(o>>>0).toString(16)}-${c.length}`,p=r()<a?Ln(r,t,e,h):Fn(r,t,e,h);p&&c.push(p)}for(;c.length<s&&r()<t.missionChance;){const l=`m-${(o>>>0).toString(16)}-${c.length}`,d=r()<a?Ln(r,t,e,l):Fn(r,t,e,l);d&&c.push(d)}return c}const ps=100,ms={orbital:"docking","deep-space":"docking",surface:"surface-landing",asteroid:"asteroid-landing"};function gs(t,e,n){if(t.outcome==="skipped")return{damageFraction:n.abandonDamageFraction*e,score:null};const i=t.result.score;return i>=n.noDamageThreshold?{damageFraction:0,score:i}:{damageFraction:n.maxHullDamageFraction*(1-i/n.noDamageThreshold)*e,score:i}}function fs(t,e){const n=t==="docking";return e===null?"ABORTED":e<40?n?"COLLISION":"CRASH":e<70?n?"ROUGH DOCK":"HARD LANDING":e<90?n?"DOCKED":"LANDED":n?"PERFECT DOCK":"PERFECT LANDING"}function qe(t,e,n){return Math.max(e,Math.min(n,t))}function ys(t,e,n,i){const{stockCountMin:o,stockCountMax:r,stockQtyMin:s,stockQtyMax:a,stockRepCountBonusPerLevel:c,stockRepCountBonusMin:l,stockRepCountBonusMax:h,stockRepQtyBonusPerLevel:d,stockRepQtyBonusMin:p,stockRepQtyBonusMax:u}=n.trading,m=qe(e*c,l,h),g=qe(e*d,p,u),y=t.length,b=qe(o+m,1,y),x=qe(r+m,1,y),_=b+Math.floor(Math.random()*(x-b+1)),k=[];if(i)for(const S of t){const E=1/Ze(S.id,i),A=Math.ceil(E*10);for(let M=0;M<A;M++)k.push(S)}else k.push(...t);const v=[...k];for(let S=v.length-1;S>0;S--){const R=Math.floor(Math.random()*(S+1));[v[S],v[R]]=[v[R],v[S]]}const C=s+g,w=a+g,T=t.map(S=>Math.log(S.basePrice*S.weightKg)),O=Math.min(...T),P=Math.max(...T)-O,G=new Map;for(const S of v.slice(0,_)){if(G.has(S.id))continue;const R=C+Math.floor(Math.random()*(w-C+1));let E=1;P>0&&(E=1.5-(Math.log(S.basePrice*S.weightKg)-O)/P);const A=i?Ze(S.id,i):1;G.set(S.id,{commodityId:S.id,qty:Math.max(1,Math.floor(R*E)),effectiveFactor:A})}return Array.from(G.values())}class _s{constructor(e,n,i){this.sceneBeforeMenu=null,this.traderStockCache=new Map,this.renderer=e,this.input=n,this.context=i;const o=ei(),r=Xe(o.startingShip);this.player=new Ft({shipId:o.startingShip,driveId:r.defaultJumpDrive,credits:o.player.startingCredits,systemId:o.startingLocation.system,destinationId:o.startingLocation.destination}),this.currentScene=new Yt(this.input,this.context,this.player,()=>this.goToStory())}tick(e){const n=Math.min(e,ps),i=this.makeBuffer();this.currentScene.update(n),this.currentScene.render(i),this.renderer.drawBuffer(i)}makeBuffer(){const e=this.renderer.getWidth(),n=this.renderer.getHeight();return Array.from({length:n},()=>Array.from({length:e},()=>({char:" ",fg:"black",bg:"black"})))}getOrCreateTraderStock(e,n){const i=Date.now(),o=this.traderStockCache.get(e),r=F();if(o&&o.repLevel===n&&i-o.generatedAt<r.trading.stockTtlMs)return o.entries;const s=N(e),a=s?J(s.system):void 0,c=ys(ho(),n,r,a);return this.traderStockCache.set(e,{entries:c,generatedAt:i,repLevel:n}),c}refreshDestinationMissions(e){const n=N(e),i=D(),o=us(n,i);this.player.refreshDestinationMissions(e,o)}onBuy(e,n,i,o){if(n<=0)return;const r=o.findIndex(h=>h.commodityId===e);if(r<0)return;const s=o[r];if(n>s.qty)return;const a=de(e);if(!a)return;const c=n*i;this.player.credits<c||this.player.cargoWeightKg+n*a.weightKg>this.player.cargoCapacity||(this.player.spendCredits(c),this.player.addCargo(e,n),s.qty-=n,s.qty<=0&&o.splice(r,1))}onSell(e,n,i,o){if(n<=0)return;const r=this.player.cargoHold.find(l=>l.commodityId===e);if(!r||r.qty<n||!de(e))return;const a=n*i;this.player.addCredits(a),this.player.removeCargo(e,n);const c=o.find(l=>l.commodityId===e);c?c.qty+=n:o.push({commodityId:e,qty:n})}goToMainMenu(){this.currentScene=new Yt(this.input,this.context,this.player,()=>this.goToStory())}goToStory(){this.currentScene=new Mo(this.input,this.context,this.player,()=>this.goToStation())}goToStation(){const e=this.player.destinationId;this.refreshDestinationMissions(e),this.currentScene=new Ao(this.input,this.context,this.player,e,(n,i)=>{this.player.spendCredits(n),this.player.addFuel(i),this.goToStation()},()=>this.goToTrader(),()=>this.goToMissionBoard(),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToLandOrDock(){const e=N(this.player.destinationId),n=e==null?void 0:e.locationType,i=n?ms[n]:void 0,o=i?En.find(r=>r.meta.id===i):void 0;if(i&&o){const r=(e==null?void 0:e.difficultyMultiplier)??1,s=F();this.currentScene=o.factory(this.input,this.context,this.player,{},a=>{const{damageFraction:c,score:l}=gs(a,r,s.miniGames);c>0&&this.player.applyHullDamage(c);const h=fs(i,l);this.currentScene=new Cn(this.input,this.player,this.context,h,l,c,()=>this.goToStation())})}else n==="surface"?this.currentScene=new Ir(this.player,this.context,()=>this.goToStation()):n==="asteroid"?this.currentScene=new Rr(this.player,this.context,()=>this.goToStation()):this.currentScene=new Nr(this.player,this.context,()=>this.goToStation())}goToTakeOffOrUndock(){var n;const e=(n=N(this.player.destinationId))==null?void 0:n.locationType;e==="surface"?this.currentScene=new Lr(this.player,this.context,()=>this.goToShip()):e==="asteroid"?this.currentScene=new Dr(this.player,this.context,()=>this.goToShip()):this.currentScene=new Hr(this.player,this.context,()=>this.goToShip())}goToTrader(){const e=this.player.destinationId,n=N(e);let i=0;if(n.owningFactionId){const r=ti(n.owningFactionId);if(r&&me(r)){const s=F(),a=this.player.getFactionReputation(n.owningFactionId);i=Ee(a,s)}}const o=this.getOrCreateTraderStock(e,i);this.currentScene=new Ro(this.input,this.context,this.player,e,o,(r,s,a)=>this.onBuy(r,s,a,o),(r,s,a)=>this.onSell(r,s,a,o),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToMissionBoard(){const e=this.player.destinationId,n=this.player.getDestinationMissions(e);this.currentScene=new ye(this.input,this.context,this.player,e,n,i=>this.goToMissionDetail(i,e),()=>this.goToStation(),()=>this.goToTakeOffOrUndock(),()=>this.goToGlobalMenu())}goToMissionDetail(e,n){this.currentScene=new Do(this.input,this.context,this.player,e,i=>this.onMissionAccepted(e,i,n),()=>this.goToMissionBoard(),()=>this.goToStation(),()=>this.goToTakeOffOrUndock())}onMissionAccepted(e,n,i){const o=this.player.getDestinationMissions(i),r=o.findIndex(s=>s.id===e.id);r>=0&&(o.splice(r,1),this.player.refreshDestinationMissions(i,o)),this.player.acceptMission(e,n),this.goToMissionBoard()}goToShip(){this.currentScene=new lr(this.input,this.context,this.player,()=>this.goToTravelMenu(),()=>this.goToLandOrDock(),()=>this.goToCargo(),()=>this.goToGlobalMenu())}goToCargo(){this.currentScene=new hr(this.input,this.context,this.player,()=>this.goToShip(),()=>this.goToGlobalMenu())}buildMenuEntries(){return[{label:"MISSIONS",action:()=>this.goToMissionLog()},{label:"GALAXY MAP",action:()=>this.goToGalaxyMapFromMenu()},{label:"REPUTATION",action:()=>this.goToReputation()}]}goToMissionLog(){this.currentScene=new vo(this.input,this.context,this.player,()=>this.goToGlobalMenuFromSubScene(),()=>this.returnFromMenu())}goToReputation(){this.currentScene=new So(this.input,this.context,this.player,()=>this.goToGlobalMenuFromSubScene(),()=>this.returnFromMenu())}goToGlobalMenuFromSubScene(){this.currentScene=new Vt(this.input,this.context,this.player,this.buildMenuEntries(),()=>this.returnFromMenu())}goToGlobalMenu(){this.sceneBeforeMenu=this.currentScene,"suspend"in this.currentScene&&this.currentScene.suspend(),this.currentScene=new Vt(this.input,this.context,this.player,this.buildMenuEntries(),()=>this.returnFromMenu())}returnFromMenu(){const e=this.sceneBeforeMenu;this.sceneBeforeMenu=null,e!==null?("resume"in e&&e.resume(),this.currentScene=e):this.goToShip()}goToTravelMenu(){this.currentScene=new hn(this.input,this.context,this.player,e=>this.onDestinationSelected(e),e=>this.onJumpSelected(e),()=>this.goToFlyIntoSpace(),()=>this.goToShip(),()=>this.goToGalaxyMap(),()=>this.goToGlobalMenu(),()=>this.goToEmergencyRescue())}goToArrival(){this.currentScene=new hn(this.input,this.context,this.player,e=>this.onDestinationSelected(e),e=>this.onJumpSelected(e),()=>this.goToFlyIntoSpace(),()=>this.goToShip(),()=>this.goToGalaxyMap(),()=>this.goToGlobalMenu(),()=>this.goToEmergencyRescue())}goToGalaxyMap(){this.currentScene=new gn(this.input,this.context,this.player,()=>this.goToTravelMenu(),()=>this.goToGlobalMenu())}goToGalaxyMapFromMenu(){this.currentScene=new gn(this.input,this.context,this.player,()=>this.goToGlobalMenu(),()=>this.goToGlobalMenu(),()=>this.returnFromMenu())}goToFlyIntoSpace(){const e=this.player.getInSystemHopCost();this.player.consumeFuel(e),this.player.undock(),this.currentScene=new _t(this.player,this.context,()=>this.goToShip(),"OPEN SPACE")}onDestinationSelected(e){const n=this.player.getInSystemHopCost();this.player.consumeFuel(n),this.player.dock(e),this.currentScene=new _t(this.player,this.context,()=>this.goToShip())}onJumpSelected(e){const n=ze(this.player.systemId,e),i=Zn(this.player.driveId),o=Math.ceil(F().fuel.consumptionPerLy*n.distance*i.fuelEfficiency);this.player.consumeFuel(o),this.player.jumpTo(e),this.currentScene=new Tr(this.player,this.context,()=>this.maybeNavigationEncounter(()=>this.goToArrival()))}maybeNavigationEncounter(e){const i=F().navigationEncounter.encounterChanceOnJump;if(Math.random()>i){e();return}const o=["asteroid_belt","space_debris","space_storm"],r=o[Math.floor(Math.random()*o.length)],s=J(this.player.systemId),a=this.getDifficultyFromDangerLevel(s.dangerLevel);this.currentScene=new Vr(this.input,this.context,this.player,r,()=>this.playNavigationMiniGame(r,a,e))}getDifficultyFromDangerLevel(e){switch(e){case"none":case"low":return"easy";case"medium":return"normal";case"high":case"extreme":return"hard";default:return"normal"}}playNavigationMiniGame(e,n,i){const o={type:e,difficulty:n},r=En.find(s=>s.meta.id==="navigation");if(!r){i();return}this.currentScene=r.factory(this.input,this.context,this.player,o,s=>{this.handleNavigationMiniGameResult(s,n,i)})}handleNavigationMiniGameResult(e,n,i){const o=F(),r=n==="hard"?1.25:1;let s,a,c;if(e.outcome==="skipped")s="ABORTED",a=o.miniGames.abandonDamageFraction*r,c=null;else{const l=e.result.score||0;c=l,l>=o.miniGames.noDamageThreshold?(s="CLEAR",a=0):(s="COLLISION",a=o.miniGames.maxHullDamageFraction*(1-l/o.miniGames.noDamageThreshold)*r)}a>0&&this.player.applyHullDamage(a),this.currentScene=new Cn(this.input,this.player,this.context,s,c,a,()=>i())}goToEmergencyRescue(){this.currentScene=new dr(this.input,this.context,this.player,e=>this.onEmergencyTow(e),()=>this.onEmergencyFuelDrop(),()=>this.goToTravelMenu())}onEmergencyTow(e){const n=F();this.player.spendCredits(n.emergencyRescue.towFee),this.player.dock(e),this.currentScene=new _t(this.player,this.context,()=>this.goToShip())}onEmergencyFuelDrop(){const e=F();this.player.spendCredits(e.emergencyRescue.fuelDropFee),this.player.addFuel(e.emergencyRescue.fuelDropLitres),this.goToTravelMenu()}}const bs=`---
commodities:
...
Adventure here is fraught with inconsistent communications and unreliable star charts.`,Qs=`---
routes:
...
Long range engines for faster than light travel between systems.`,ia=`---
id: freighter
...
`;var H={},Oe={},V={};function hi(t){return typeof t>"u"||t===null}function ba(t){return typeof t=="object"&&t!==null}function wa(t){return Array.isArray(t)?t:hi(t)?[]:[t]}function va(t,e){var n,i,o,r;if(e)for(r=Object.keys(e),n=0,i=r.length;n<i;n+=1)o=r[n],t[o]=e[o];return t}function ka(t,e){var n="",i;for(i=0;i<e;i+=1)n+=t;return n}function xa(t){return t===0&&Number.NEGATIVE_INFINITY===1/t}V.isNothing=hi;V.isObject=ba;V.toArray=wa;V.repeat=ka;V.isNegativeZero=xa;V.extend=va;function Le(t,e){Error.call(this),this.name="YAMLException",this.reason=t,this.mark=e,this.message=(this.reason||"(unknown reason)")+(this.mark?" "+this.mark.toString():""),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}Le.prototype=Object.create(Error.prototype);Le.prototype.constructor=Le;Le.prototype.toString=function(e){var n=this.name+": ";return n+=this.reason||"(unknown reason)",!e&&this.mark&&(n+=" "+this.mark.toString()),n};var Ne=Le,Dn=V;function Dt(t,e,n,i,o){this.name=t,this.buffer=e,this.position=n,this.line=i,this.column=o}Dt.prototype.getSnippet=function(e,n){var i,o,r,s,a;if(!this.buffer)return null;for(e=e||4,n=n||75,i="",o=this.position;o>0&&`\0\r
\u2028\u2029`.indexOf(this.buffer.charAt(o-1))===-1;)if(o-=1,this.position-o>n/2-1){i=" ... ",o+=5;break}for(r="",s=this.position;s<this.buffer.length&&`\0\r
\u2028\u2029`.indexOf(this.buffer.charAt(s))===-1;)if(s+=1,s-this.position>n/2-1){r=" ... ",s-=5;break}return a=this.buffer.slice(o,s),Dn.repeat(" ",e)+i+a+r+`
`+Dn.repeat(" ",e+this.position-o+i.length)+"^"};Dt.prototype.toString=function(e){var n,i="";return this.name&&(i+='in "'+this.name+'" '),i+="at line "+(this.line+1)+", column "+(this.column+1),e||(n=this.getSnippet(),n&&(i+=`:
`+n)),i};var Ca=Dt,On=Ne,Ta=["kind","resolve","construct","instanceOf","predicate","represent","defaultStyle","styleAliases"],Sa=["scalar","sequence","mapping"];function Ma(t){var e={};return t!==null&&Object.keys(t).forEach(function(n){t[n].forEach(function(i){e[String(i)]=n})}),e}function Ia(t,e){if(e=e||{},Object.keys(e).forEach(function(n){if(Ta.indexOf(n)===-1)throw new On('Unknown option "'+n+'" is met in definition of "'+t+'" YAML type.')}),this.tag=t,this.kind=e.kind||null,this.resolve=e.resolve||function(){return!0},this.construct=e.construct||function(n){return n},this.instanceOf=e.instanceOf||null,this.predicate=e.predicate||null,this.represent=e.represent||null,this.defaultStyle=e.defaultStyle||null,this.styleAliases=Ma(e.styleAliases||null),Sa.indexOf(this.kind)===-1)throw new On('Unknown kind "'+this.kind+'" is specified for "'+t+'" YAML type.')}var U=Ia,Nn=V,Qe=Ne,Aa=U;function St(t,e,n){var i=[];return t.include.forEach(function(o){n=St(o,e,n)}),t[e].forEach(function(o){n.forEach(function(r,s){r.tag===o.tag&&r.kind===o.kind&&i.push(s)}),n.push(o)}),n.filter(function(o,r){return i.indexOf(r)===-1})}function Ra(){var t={scalar:{},sequence:{},mapping:{},fallback:{}},e,n;function i(o){t[o.kind][o.tag]=t.fallback[o.tag]=o}for(e=0,n=arguments.length;e<n;e+=1)arguments[e].forEach(i);return t}function _e(t){this.include=t.include||[],this.implicit=t.implicit||[],this.explicit=t.explicit||[],this.implicit.forEach(function(e){if(e.loadKind&&e.loadKind!=="scalar")throw new Qe("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.")}),this.compiledImplicit=St(this,"implicit",[]),this.compiledExplicit=St(this,"explicit",[]),this.compiledTypeMap=Ra(this.compiledImplicit,this.compiledExplicit)}_e.DEFAULT=null;_e.create=function(){var e,n;switch(arguments.length){case 1:e=_e.DEFAULT,n=arguments[0];break;case 2:e=arguments[0],n=arguments[1];break;default:throw new Qe("Wrong number of arguments for Schema.create function")}if(e=Nn.toArray(e),n=Nn.toArray(n),!e.every(function(i){return i instanceof _e}))throw new Qe("Specified list of super schemas (or a single Schema object) contains a non-Schema object.");if(!n.every(function(i){return i instanceof Aa}))throw new Qe("Specified list of YAML types (or a single Type object) contains a non-Type object.");return new _e({include:e,explicit:n})};var xe=_e,Ea=U,La=new Ea("tag:yaml.org,2002:str",{kind:"scalar",construct:function(t){return t!==null?t:""}}),Fa=U,Da=new Fa("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(t){return t!==null?t:[]}}),Oa=U,Na=new Oa("tag:yaml.org,2002:map",{kind:"mapping",construct:function(t){return t!==null?t:{}}}),Pa=xe,Ot=new Pa({explicit:[La,Da,Na]}),Ha=U;function Ba(t){if(t===null)return!0;var e=t.length;return e===1&&t==="~"||e===4&&(t==="null"||t==="Null"||t==="NULL")}function Ua(){return null}function Ga(t){return t===null}var $a=new Ha("tag:yaml.org,2002:null",{kind:"scalar",resolve:Ba,construct:Ua,predicate:Ga,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"}},defaultStyle:"lowercase"}),Wa=U;function Ka(t){if(t===null)return!1;var e=t.length;return e===4&&(t==="true"||t==="True"||t==="TRUE")||e===5&&(t==="false"||t==="False"||t==="FALSE")}function Ya(t){return t==="true"||t==="True"||t==="TRUE"}function ja(t){return Object.prototype.toString.call(t)==="[object Boolean]"}var Va=new Wa("tag:yaml.org,2002:bool",{kind:"scalar",resolve:Ka,construct:Ya,predicate:ja,represent:{lowercase:function(t){return t?"true":"false"},uppercase:function(t){return t?"TRUE":"FALSE"},camelcase:function(t){return t?"True":"False"}},defaultStyle:"lowercase"}),qa=V,Xa=U;function za(t){return 48<=t&&t<=57||65<=t&&t<=70||97<=t&&t<=102}function Qa(t){return 48<=t&&t<=55}function Ja(t){return 48<=t&&t<=57}function Za(t){if(t===null)return!1;var e=t.length,n=0,i=!1,o;if(!e)return!1;if(o=t[n],(o==="-"||o==="+")&&(o=t[++n]),o==="0"){if(n+1===e)return!0;if(o=t[++n],o==="b"){for(n++;n<e;n++)if(o=t[n],o!=="_"){if(o!=="0"&&o!=="1")return!1;i=!0}return i&&o!=="_"}if(o==="x"){for(n++;n<e;n++)if(o=t[n],o!=="_"){if(!za(t.charCodeAt(n)))return!1;i=!0}return i&&o!=="_"}for(;n<e;n++)if(o=t[n],o!=="_"){if(!Qa(t.charCodeAt(n)))return!1;i=!0}return i&&o!=="_"}if(o==="_")return!1;for(;n<e;n++)if(o=t[n],o!=="_"){if(o===":")break;if(!Ja(t.charCodeAt(n)))return!1;i=!0}return!i||o==="_"?!1:o!==":"?!0:/^(:[0-5]?[0-9])+$/.test(t.slice(n))}function ec(t){var e=t,n=1,i,o,r=[];return e.indexOf("_")!==-1&&(e=e.replace(/_/g,"")),i=e[0],(i==="-"||i==="+")&&(i==="-"&&(n=-1),e=e.slice(1),i=e[0]),e==="0"?0:i==="0"?e[1]==="b"?n*parseInt(e.slice(2),2):e[1]==="x"?n*parseInt(e,16):n*parseInt(e,8):e.indexOf(":")!==-1?(e.split(":").forEach(function(s){r.unshift(parseInt(s,10))}),e=0,o=1,r.forEach(function(s){e+=s*o,o*=60}),n*e):n*parseInt(e,10)}function tc(t){return Object.prototype.toString.call(t)==="[object Number]"&&t%1===0&&!qa.isNegativeZero(t)}var nc=new Xa("tag:yaml.org,2002:int",{kind:"scalar",resolve:Za,construct:ec,predicate:tc,represent:{binary:function(t){return t>=0?"0b"+t.toString(2):"-0b"+t.toString(2).slice(1)},octal:function(t){return t>=0?"0"+t.toString(8):"-0"+t.toString(8).slice(1)},decimal:function(t){return t.toString(10)},hexadecimal:function(t){return t>=0?"0x"+t.toString(16).toUpperCase():"-0x"+t.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),di=V,ic=U,oc=new RegExp("^(?:[-+]?(?:0|[1-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function rc(t){return!(t===null||!oc.test(t)||t[t.length-1]==="_")}function sc(t){var e,n,i,o;return e=t.replace(/_/g,"").toLowerCase(),n=e[0]==="-"?-1:1,o=[],"+-".indexOf(e[0])>=0&&(e=e.slice(1)),e===".inf"?n===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:e===".nan"?NaN:e.indexOf(":")>=0?(e.split(":").forEach(function(r){o.unshift(parseFloat(r,10))}),e=0,i=1,o.forEach(function(r){e+=r*i,i*=60}),n*e):n*parseFloat(e,10)}var ac=/^[-+]?[0-9]+e/;function cc(t,e){var n;if(isNaN(t))switch(e){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===t)switch(e){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===t)switch(e){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(di.isNegativeZero(t))return"-0.0";return n=t.toString(10),ac.test(n)?n.replace("e",".e"):n}function lc(t){return Object.prototype.toString.call(t)==="[object Number]"&&(t%1!==0||di.isNegativeZero(t))}var hc=new ic("tag:yaml.org,2002:float",{kind:"scalar",resolve:rc,construct:sc,predicate:lc,represent:cc,defaultStyle:"lowercase"}),dc=xe,ui=new dc({include:[Ot],implicit:[$a,Va,nc,hc]}),uc=xe,pi=new uc({include:[ui]}),pc=U,mi=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),gi=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function mc(t){return t===null?!1:mi.exec(t)!==null||gi.exec(t)!==null}function gc(t){var e,n,i,o,r,s,a,c=0,l=null,h,d,p;if(e=mi.exec(t),e===null&&(e=gi.exec(t)),e===null)throw new Error("Date resolve error");if(n=+e[1],i=+e[2]-1,o=+e[3],!e[4])return new Date(Date.UTC(n,i,o));if(r=+e[4],s=+e[5],a=+e[6],e[7]){for(c=e[7].slice(0,3);c.length<3;)c+="0";c=+c}return e[9]&&(h=+e[10],d=+(e[11]||0),l=(h*60+d)*6e4,e[9]==="-"&&(l=-l)),p=new Date(Date.UTC(n,i,o,r,s,a,c)),l&&p.setTime(p.getTime()-l),p}function fc(t){return t.toISOString()}var yc=new pc("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:mc,construct:gc,instanceOf:Date,represent:fc}),_c=U;function bc(t){return t==="<<"||t===null}var wc=new _c("tag:yaml.org,2002:merge",{kind:"scalar",resolve:bc});function fi(t){throw new Error('Could not dynamically require "'+t+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var le;try{var vc=fi;le=vc("buffer").Buffer}catch{}var kc=U,Nt=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function xc(t){if(t===null)return!1;var e,n,i=0,o=t.length,r=Nt;for(n=0;n<o;n++)if(e=r.indexOf(t.charAt(n)),!(e>64)){if(e<0)return!1;i+=6}return i%8===0}function Cc(t){var e,n,i=t.replace(/[\r\n=]/g,""),o=i.length,r=Nt,s=0,a=[];for(e=0;e<o;e++)e%4===0&&e&&(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)),s=s<<6|r.indexOf(i.charAt(e));return n=o%4*6,n===0?(a.push(s>>16&255),a.push(s>>8&255),a.push(s&255)):n===18?(a.push(s>>10&255),a.push(s>>2&255)):n===12&&a.push(s>>4&255),le?le.from?le.from(a):new le(a):a}function Tc(t){var e="",n=0,i,o,r=t.length,s=Nt;for(i=0;i<r;i++)i%3===0&&i&&(e+=s[n>>18&63],e+=s[n>>12&63],e+=s[n>>6&63],e+=s[n&63]),n=(n<<8)+t[i];return o=r%3,o===0?(e+=s[n>>18&63],e+=s[n>>12&63],e+=s[n>>6&63],e+=s[n&63]):o===2?(e+=s[n>>10&63],e+=s[n>>4&63],e+=s[n<<2&63],e+=s[64]):o===1&&(e+=s[n>>2&63],e+=s[n<<4&63],e+=s[64],e+=s[64]),e}function Sc(t){return le&&le.isBuffer(t)}var Mc=new kc("tag:yaml.org,2002:binary",{kind:"scalar",resolve:xc,construct:Cc,predicate:Sc,represent:Tc}),Ic=U,Ac=Object.prototype.hasOwnProperty,Rc=Object.prototype.toString;function Ec(t){if(t===null)return!0;var e=[],n,i,o,r,s,a=t;for(n=0,i=a.length;n<i;n+=1){if(o=a[n],s=!1,Rc.call(o)!=="[object Object]")return!1;for(r in o)if(Ac.call(o,r))if(!s)s=!0;else return!1;if(!s)return!1;if(e.indexOf(r)===-1)e.push(r);else return!1}return!0}function Lc(t){return t!==null?t:[]}var Fc=new Ic("tag:yaml.org,2002:omap",{kind:"sequence",resolve:Ec,construct:Lc}),Dc=U,Oc=Object.prototype.toString;function Nc(t){if(t===null)return!0;var e,n,i,o,r,s=t;for(r=new Array(s.length),e=0,n=s.length;e<n;e+=1){if(i=s[e],Oc.call(i)!=="[object Object]"||(o=Object.keys(i),o.length!==1))return!1;r[e]=[o[0],i[o[0]]]}return!0}function Pc(t){if(t===null)return[];var e,n,i,o,r,s=t;for(r=new Array(s.length),e=0,n=s.length;e<n;e+=1)i=s[e],o=Object.keys(i),r[e]=[o[0],i[o[0]]];return r}var Hc=new Dc("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:Nc,construct:Pc}),Bc=U,Uc=Object.prototype.hasOwnProperty;function Gc(t){if(t===null)return!0;var e,n=t;for(e in n)if(Uc.call(n,e)&&n[e]!==null)return!1;return!0}function $c(t){return t!==null?t:{}}var Wc=new Bc("tag:yaml.org,2002:set",{kind:"mapping",resolve:Gc,construct:$c}),Kc=xe,Pe=new Kc({include:[pi],implicit:[yc,wc],explicit:[Mc,Fc,Hc,Wc]}),Yc=U;function jc(){return!0}function Vc(){}function qc(){return""}function Xc(t){return typeof t>"u"}var zc=new Yc("tag:yaml.org,2002:js/undefined",{kind:"scalar",resolve:jc,construct:Vc,predicate:Xc,represent:qc}),Qc=U;function Jc(t){if(t===null||t.length===0)return!1;var e=t,n=/\/([gim]*)$/.exec(t),i="";return!(e[0]==="/"&&(n&&(i=n[1]),i.length>3||e[e.length-i.length-1]!=="/"))}function Zc(t){var e=t,n=/\/([gim]*)$/.exec(t),i="";return e[0]==="/"&&(n&&(i=n[1]),e=e.slice(1,e.length-i.length-1)),new RegExp(e,i)}function el(t){var e="/"+t.source+"/";return t.global&&(e+="g"),t.multiline&&(e+="m"),t.ignoreCase&&(e+="i"),e}function tl(t){return Object.prototype.toString.call(t)==="[object RegExp]"}var nl=new Qc("tag:yaml.org,2002:js/regexp",{kind:"scalar",resolve:Jc,construct:Zc,predicate:tl,represent:el}),et;try{var il=fi;et=il("esprima")}catch{typeof window<"u"&&(et=window.esprima)}var ol=U;function rl(t){if(t===null)return!1;try{var e="("+t+")",n=et.parse(e,{range:!0});return!(n.type!=="Program"||n.body.length!==1||n.body[0].type!=="ExpressionStatement"||n.body[0].expression.type!=="ArrowFunctionExpression"&&n.body[0].expression.type!=="FunctionExpression")}catch{return!1}}function sl(t){var e="("+t+")",n=et.parse(e,{range:!0}),i=[],o;if(n.type!=="Program"||n.body.length!==1||n.body[0].type!=="ExpressionStatement"||n.body[0].expression.type!=="ArrowFunctionExpression"&&n.body[0].expression.type!=="FunctionExpression")throw new Error("Failed to resolve function");return n.body[0].expression.params.forEach(function(r){i.push(r.name)}),o=n.body[0].expression.body.range,n.body[0].expression.body.type==="BlockStatement"?new Function(i,e.slice(o[0]+1,o[1]-1)):new Function(i,"return "+e.slice(o[0],o[1]))}function al(t){return t.toString()}function cl(t){return Object.prototype.toString.call(t)==="[object Function]"}var ll=new ol("tag:yaml.org,2002:js/function",{kind:"scalar",resolve:rl,construct:sl,predicate:cl,represent:al}),Pn=xe,rt=Pn.DEFAULT=new Pn({include:[Pe],explicit:[zc,nl,ll]}),te=V,yi=Ne,hl=Ca,_i=Pe,dl=rt,se=Object.prototype.hasOwnProperty,tt=1,bi=2,wi=3,nt=4,vt=1,ul=2,Hn=3,pl=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,ml=/[\x85\u2028\u2029]/,gl=/[,\[\]\{\}]/,vi=/^(?:!|!!|![a-z\-]+!)$/i,ki=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Bn(t){return Object.prototype.toString.call(t)}function Q(t){return t===10||t===13}function he(t){return t===9||t===32}function j(t){return t===9||t===32||t===10||t===13}function be(t){return t===44||t===91||t===93||t===123||t===125}function fl(t){var e;return 48<=t&&t<=57?t-48:(e=t|32,97<=e&&e<=102?e-97+10:-1)}function yl(t){return t===120?2:t===117?4:t===85?8:0}function _l(t){return 48<=t&&t<=57?t-48:-1}function Un(t){return t===48?"\0":t===97?"\x07":t===98?"\b":t===116||t===9?"	":t===110?`
`:t===118?"\v":t===102?"\f":t===114?"\r":t===101?"\x1B":t===32?" ":t===34?'"':t===47?"/":t===92?"\\":t===78?"":t===95?" ":t===76?"\u2028":t===80?"\u2029":""}function bl(t){return t<=65535?String.fromCharCode(t):String.fromCharCode((t-65536>>10)+55296,(t-65536&1023)+56320)}function xi(t,e,n){e==="__proto__"?Object.defineProperty(t,e,{configurable:!0,enumerable:!0,writable:!0,value:n}):t[e]=n}var Ci=new Array(256),Ti=new Array(256);for(var ge=0;ge<256;ge++)Ci[ge]=Un(ge)?1:0,Ti[ge]=Un(ge);function wl(t,e){this.input=t,this.filename=e.filename||null,this.schema=e.schema||dl,this.onWarning=e.onWarning||null,this.legacy=e.legacy||!1,this.json=e.json||!1,this.listener=e.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=t.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.documents=[]}function Si(t,e){return new yi(e,new hl(t.filename,t.input,t.position,t.line,t.position-t.lineStart))}function I(t,e){throw Si(t,e)}function it(t,e){t.onWarning&&t.onWarning.call(null,Si(t,e))}var Gn={YAML:function(e,n,i){var o,r,s;e.version!==null&&I(e,"duplication of %YAML directive"),i.length!==1&&I(e,"YAML directive accepts exactly one argument"),o=/^([0-9]+)\.([0-9]+)$/.exec(i[0]),o===null&&I(e,"ill-formed argument of the YAML directive"),r=parseInt(o[1],10),s=parseInt(o[2],10),r!==1&&I(e,"unacceptable YAML version of the document"),e.version=i[0],e.checkLineBreaks=s<2,s!==1&&s!==2&&it(e,"unsupported YAML version of the document")},TAG:function(e,n,i){var o,r;i.length!==2&&I(e,"TAG directive accepts exactly two arguments"),o=i[0],r=i[1],vi.test(o)||I(e,"ill-formed tag handle (first argument) of the TAG directive"),se.call(e.tagMap,o)&&I(e,'there is a previously declared suffix for "'+o+'" tag handle'),ki.test(r)||I(e,"ill-formed tag prefix (second argument) of the TAG directive"),e.tagMap[o]=r}};function re(t,e,n,i){var o,r,s,a;if(e<n){if(a=t.input.slice(e,n),i)for(o=0,r=a.length;o<r;o+=1)s=a.charCodeAt(o),s===9||32<=s&&s<=1114111||I(t,"expected valid JSON character");else pl.test(a)&&I(t,"the stream contains non-printable characters");t.result+=a}}function $n(t,e,n,i){var o,r,s,a;for(te.isObject(n)||I(t,"cannot merge mappings; the provided source object is unacceptable"),o=Object.keys(n),s=0,a=o.length;s<a;s+=1)r=o[s],se.call(e,r)||(xi(e,r,n[r]),i[r]=!0)}function we(t,e,n,i,o,r,s,a){var c,l;if(Array.isArray(o))for(o=Array.prototype.slice.call(o),c=0,l=o.length;c<l;c+=1)Array.isArray(o[c])&&I(t,"nested arrays are not supported inside keys"),typeof o=="object"&&Bn(o[c])==="[object Object]"&&(o[c]="[object Object]");if(typeof o=="object"&&Bn(o)==="[object Object]"&&(o="[object Object]"),o=String(o),e===null&&(e={}),i==="tag:yaml.org,2002:merge")if(Array.isArray(r))for(c=0,l=r.length;c<l;c+=1)$n(t,e,r[c],n);else $n(t,e,r,n);else!t.json&&!se.call(n,o)&&se.call(e,o)&&(t.line=s||t.line,t.position=a||t.position,I(t,"duplicated mapping key")),xi(e,o,r),delete n[o];return e}function Pt(t){var e;e=t.input.charCodeAt(t.position),e===10?t.position++:e===13?(t.position++,t.input.charCodeAt(t.position)===10&&t.position++):I(t,"a line break is expected"),t.line+=1,t.lineStart=t.position}function B(t,e,n){for(var i=0,o=t.input.charCodeAt(t.position);o!==0;){for(;he(o);)o=t.input.charCodeAt(++t.position);if(e&&o===35)do o=t.input.charCodeAt(++t.position);while(o!==10&&o!==13&&o!==0);if(Q(o))for(Pt(t),o=t.input.charCodeAt(t.position),i++,t.lineIndent=0;o===32;)t.lineIndent++,o=t.input.charCodeAt(++t.position);else break}return n!==-1&&i!==0&&t.lineIndent<n&&it(t,"deficient indentation"),i}function st(t){var e=t.position,n;return n=t.input.charCodeAt(e),!!((n===45||n===46)&&n===t.input.charCodeAt(e+1)&&n===t.input.charCodeAt(e+2)&&(e+=3,n=t.input.charCodeAt(e),n===0||j(n)))}function Ht(t,e){e===1?t.result+=" ":e>1&&(t.result+=te.repeat(`
`,e-1))}function vl(t,e,n){var i,o,r,s,a,c,l,h,d=t.kind,p=t.result,u;if(u=t.input.charCodeAt(t.position),j(u)||be(u)||u===35||u===38||u===42||u===33||u===124||u===62||u===39||u===34||u===37||u===64||u===96||(u===63||u===45)&&(o=t.input.charCodeAt(t.position+1),j(o)||n&&be(o)))return!1;for(t.kind="scalar",t.result="",r=s=t.position,a=!1;u!==0;){if(u===58){if(o=t.input.charCodeAt(t.position+1),j(o)||n&&be(o))break}else if(u===35){if(i=t.input.charCodeAt(t.position-1),j(i))break}else{if(t.position===t.lineStart&&st(t)||n&&be(u))break;if(Q(u))if(c=t.line,l=t.lineStart,h=t.lineIndent,B(t,!1,-1),t.lineIndent>=e){a=!0,u=t.input.charCodeAt(t.position);continue}else{t.position=s,t.line=c,t.lineStart=l,t.lineIndent=h;break}}a&&(re(t,r,s,!1),Ht(t,t.line-c),r=s=t.position,a=!1),he(u)||(s=t.position+1),u=t.input.charCodeAt(++t.position)}return re(t,r,s,!1),t.result?!0:(t.kind=d,t.result=p,!1)}function kl(t,e){var n,i,o;if(n=t.input.charCodeAt(t.position),n!==39)return!1;for(t.kind="scalar",t.result="",t.position++,i=o=t.position;(n=t.input.charCodeAt(t.position))!==0;)if(n===39)if(re(t,i,t.position,!0),n=t.input.charCodeAt(++t.position),n===39)i=t.position,t.position++,o=t.position;else return!0;else Q(n)?(re(t,i,o,!0),Ht(t,B(t,!1,e)),i=o=t.position):t.position===t.lineStart&&st(t)?I(t,"unexpected end of the document within a single quoted scalar"):(t.position++,o=t.position);I(t,"unexpected end of the stream within a single quoted scalar")}function xl(t,e){var n,i,o,r,s,a;if(a=t.input.charCodeAt(t.position),a!==34)return!1;for(t.kind="scalar",t.result="",t.position++,n=i=t.position;(a=t.input.charCodeAt(t.position))!==0;){if(a===34)return re(t,n,t.position,!0),t.position++,!0;if(a===92){if(re(t,n,t.position,!0),a=t.input.charCodeAt(++t.position),Q(a))B(t,!1,e);else if(a<256&&Ci[a])t.result+=Ti[a],t.position++;else if((s=yl(a))>0){for(o=s,r=0;o>0;o--)a=t.input.charCodeAt(++t.position),(s=fl(a))>=0?r=(r<<4)+s:I(t,"expected hexadecimal character");t.result+=bl(r),t.position++}else I(t,"unknown escape sequence");n=i=t.position}else Q(a)?(re(t,n,i,!0),Ht(t,B(t,!1,e)),n=i=t.position):t.position===t.lineStart&&st(t)?I(t,"unexpected end of the document within a double quoted scalar"):(t.position++,i=t.position)}I(t,"unexpected end of the stream within a double quoted scalar")}function Cl(t,e){var n=!0,i,o=t.tag,r,s=t.anchor,a,c,l,h,d,p={},u,m,g,y;if(y=t.input.charCodeAt(t.position),y===91)c=93,d=!1,r=[];else if(y===123)c=125,d=!0,r={};else return!1;for(t.anchor!==null&&(t.anchorMap[t.anchor]=r),y=t.input.charCodeAt(++t.position);y!==0;){if(B(t,!0,e),y=t.input.charCodeAt(t.position),y===c)return t.position++,t.tag=o,t.anchor=s,t.kind=d?"mapping":"sequence",t.result=r,!0;n||I(t,"missed comma between flow collection entries"),m=u=g=null,l=h=!1,y===63&&(a=t.input.charCodeAt(t.position+1),j(a)&&(l=h=!0,t.position++,B(t,!0,e))),i=t.line,ve(t,e,tt,!1,!0),m=t.tag,u=t.result,B(t,!0,e),y=t.input.charCodeAt(t.position),(h||t.line===i)&&y===58&&(l=!0,y=t.input.charCodeAt(++t.position),B(t,!0,e),ve(t,e,tt,!1,!0),g=t.result),d?we(t,r,p,m,u,g):l?r.push(we(t,null,p,m,u,g)):r.push(u),B(t,!0,e),y=t.input.charCodeAt(t.position),y===44?(n=!0,y=t.input.charCodeAt(++t.position)):n=!1}I(t,"unexpected end of the stream within a flow collection")}function Tl(t,e){var n,i,o=vt,r=!1,s=!1,a=e,c=0,l=!1,h,d;if(d=t.input.charCodeAt(t.position),d===124)i=!1;else if(d===62)i=!0;else return!1;for(t.kind="scalar",t.result="";d!==0;)if(d=t.input.charCodeAt(++t.position),d===43||d===45)vt===o?o=d===43?Hn:ul:I(t,"repeat of a chomping mode identifier");else if((h=_l(d))>=0)h===0?I(t,"bad explicit indentation width of a block scalar; it cannot be less than one"):s?I(t,"repeat of an indentation width identifier"):(a=e+h-1,s=!0);else break;if(he(d)){do d=t.input.charCodeAt(++t.position);while(he(d));if(d===35)do d=t.input.charCodeAt(++t.position);while(!Q(d)&&d!==0)}for(;d!==0;){for(Pt(t),t.lineIndent=0,d=t.input.charCodeAt(t.position);(!s||t.lineIndent<a)&&d===32;)t.lineIndent++,d=t.input.charCodeAt(++t.position);if(!s&&t.lineIndent>a&&(a=t.lineIndent),Q(d)){c++;continue}if(t.lineIndent<a){o===Hn?t.result+=te.repeat(`
...
`,r?1+c:c),r=!0,s=!0,c=0,n=t.position;!Q(d)&&d!==0;)d=t.input.charCodeAt(++t.position);re(t,n,t.position,!1)}return!0}function Wn(t,e){var n,i=t.tag,o=t.anchor,r=[],s,a=!1,c;for(t.anchor!==null&&(t.anchorMap[t.anchor]=r),c=t.input.charCodeAt(t.position);c!==0&&!(c!==45||(s=t.input.charCodeAt(t.position+1),!j(s)));){if(a=!0,t.position++,B(t,!0,-1)&&t.lineIndent<=e){r.push(null),c=t.input.charCodeAt(t.position);continue}if(n=t.line,ve(t,e,wi,!1,!0),r.push(t.result),B(t,!0,-1),c=t.input.charCodeAt(t.position),(t.line===n||t.lineIndent>e)&&c!==0)I(t,"bad indentation of a sequence entry");else if(t.lineIndent<e)break}return a?(t.tag=i,t.anchor=o,t.kind="sequence",t.result=r,!0):!1}function Sl(t,e,n){var i,o,r,s,a=t.tag,c=t.anchor,l={},h={},d=null,p=null,u=null,m=!1,g=!1,y;for(t.anchor!==null&&(t.anchorMap[t.anchor]=l),y=t.input.charCodeAt(t.position);y!==0;){if(i=t.input.charCodeAt(t.position+1),r=t.line,s=t.position,(y===63||y===58)&&j(i))y===63?(m&&(we(t,l,h,d,p,null),d=p=u=null),g=!0,m=!0,o=!0):m?(m=!1,o=!0):I(t,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),t.position+=1,y=i;else if(ve(t,n,bi,!1,!0))if(t.line===r){for(y=t.input.charCodeAt(t.position);he(y);)y=t.input.charCodeAt(++t.position);if(y===58)y=t.input.charCodeAt(++t.position),j(y)||I(t,"a whitespace character is expected after the key-value separator within a block mapping"),m&&(we(t,l,h,d,p,null),d=p=u=null),g=!0,m=!1,o=!1,d=t.tag,p=t.result;else if(g)I(t,"can not read an implicit mapping pair; a colon is missed");else return t.tag=a,t.anchor=c,!0}else if(g)I(t,"can not read a block mapping entry; a multiline key may not be an implicit key");else return t.tag=a,t.anchor=c,!0;else break;if((t.line===r||t.lineIndent>e)&&(ve(t,e,nt,!0,o)&&(m?p=t.result:u=t.result),m||(we(t,l,h,d,p,u,r,s),d=p=u=null),B(t,!0,-1),y=t.input.charCodeAt(t.position)),t.lineIndent>e&&y!==0)I(t,"bad indentation of a mapping entry");else if(t.lineIndent<e)break}return m&&we(t,l,h,d,p,null),g&&(t.tag=a,t.anchor=c,t.kind="mapping",t.result=l),g}function Ml(t){var e,n=!1,i=!1,o,r,s;if(s=t.input.charCodeAt(t.position),s!==33)return!1;if(t.tag!==null&&I(t,"duplication of a tag property"),s=t.input.charCodeAt(++t.position),s===60?(n=!0,s=t.input.charCodeAt(++t.position)):s===33?(i=!0,o="!!",s=t.input.charCodeAt(++t.position)):o="!",e=t.position,n){do s=t.input.charCodeAt(++t.position);while(s!==0&&s!==62);t.position<t.length?(r=t.input.slice(e,t.position),s=t.input.charCodeAt(++t.position)):I(t,"unexpected end of the stream within a verbatim tag")}else{for(;s!==0&&!j(s);)s===33&&(i?I(t,"tag suffix cannot contain exclamation marks"):(o=t.input.slice(e-1,t.position+1),vi.test(o)||I(t,"named tag handle cannot contain such characters"),i=!0,e=t.position+1)),s=t.input.charCodeAt(++t.position);r=t.input.slice(e,t.position),gl.test(r)&&I(t,"tag suffix cannot contain flow indicator characters")}return r&&!ki.test(r)&&I(t,"tag name cannot contain such characters: "+r),n?t.tag=r:se.call(t.tagMap,o)?t.tag=t.tagMap[o]+r:o==="!"?t.tag="!"+r:o==="!!"?t.tag="tag:yaml.org,2002:"+r:I(t,'undeclared tag handle "'+o+'"'),!0}function Il(t){var e,n;if(n=t.input.charCodeAt(t.position),n!==38)return!1;for(t.anchor!==null&&I(t,"duplication of an anchor property"),n=t.input.charCodeAt(++t.position),e=t.position;n!==0&&!j(n)&&!be(n);)n=t.input.charCodeAt(++t.position);return t.position===e&&I(t,"name of an anchor node must contain at least one character"),t.anchor=t.input.slice(e,t.position),!0}function Al(t){var e,n,i;if(i=t.input.charCodeAt(t.position),i!==42)return!1;for(i=t.input.charCodeAt(++t.position),e=t.position;i!==0&&!j(i)&&!be(i);)i=t.input.charCodeAt(++t.position);return t.position===e&&I(t,"name of an alias node must contain at least one character"),n=t.input.slice(e,t.position),se.call(t.anchorMap,n)||I(t,'unidentified alias "'+n+'"'),t.result=t.anchorMap[n],B(t,!0,-1),!0}function ve(t,e,n,i,o){var r,s,a,c=1,l=!1,h=!1,d,p,u,m,g;if(t.listener!==null&&t.listener("open",t),t.tag=null,t.anchor=null,t.kind=null,t.result=null,r=s=a=nt===n||wi===n,i&&B(t,!0,-1)&&(l=!0,t.lineIndent>e?c=1:t.lineIndent===e?c=0:t.lineIndent<e&&(c=-1)),c===1)for(;Ml(t)||Il(t);)B(t,!0,-1)?(l=!0,a=r,t.lineIndent>e?c=1:t.lineIndent===e?c=0:t.lineIndent<e&&(c=-1)):a=!1;if(a&&(a=l||o),(c===1||nt===n)&&(tt===n||bi===n?m=e:m=e+1,g=t.position-t.lineStart,c===1?a&&(Wn(t,g)||Sl(t,g,m))||Cl(t,m)?h=!0:(s&&Tl(t,m)||kl(t,m)||xl(t,m)?h=!0:Al(t)?(h=!0,(t.tag!==null||t.anchor!==null)&&I(t,"alias node should not have any properties")):vl(t,m,tt===n)&&(h=!0,t.tag===null&&(t.tag="?")),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):c===0&&(h=a&&Wn(t,g))),t.tag!==null&&t.tag!=="!")if(t.tag==="?"){for(t.result!==null&&t.kind!=="scalar"&&I(t,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+t.kind+'"'),d=0,p=t.implicitTypes.length;d<p;d+=1)if(u=t.implicitTypes[d],u.resolve(t.result)){t.result=u.construct(t.result),t.tag=u.tag,t.anchor!==null&&(t.anchorMap[t.anchor]=t.result);break}}else se.call(t.typeMap[t.kind||"fallback"],t.tag)?(u=t.typeMap[t.kind||"fallback"][t.tag],t.result!==null&&u.kind!==t.kind&&I(t,"unacceptable node kind for !<"+t.tag+'> tag; it should be "'+u.kind+'", not "'+t.kind+'"'),u.resolve(t.result)?(t.result=u.construct(t.result),t.anchor!==null&&(t.anchorMap[t.anchor]=t.result)):I(t,"cannot resolve a node with !<"+t.tag+"> explicit tag")):I(t,"unknown tag !<"+t.tag+">");return t.listener!==null&&t.listener("close",t),t.tag!==null||t.anchor!==null||h}function Rl(t){var e=t.position,n,i,o,r=!1,s;for(t.version=null,t.checkLineBreaks=t.legacy,t.tagMap={},t.anchorMap={};(s=t.input.charCodeAt(t.position))!==0&&(B(t,!0,-1),s=t.input.charCodeAt(t.position),!(t.lineIndent>0||s!==37));){for(r=!0,s=t.input.charCodeAt(++t.position),n=t.position;s!==0&&!j(s);)s=t.input.charCodeAt(++t.position);for(i=t.input.slice(n,t.position),o=[],i.length<1&&I(t,"directive name must not be less than one character in length");s!==0;){for(;he(s);)s=t.input.charCodeAt(++t.position);if(s===35){do s=t.input.charCodeAt(++t.position);while(s!==0&&!Q(s));break}if(Q(s))break;for(n=t.position;s!==0&&!j(s);)s=t.input.charCodeAt(++t.position);o.push(t.input.slice(n,t.position))}s!==0&&Pt(t),se.call(Gn,i)?Gn[i](t,i,o):it(t,'unknown document directive "'+i+'"')}if(B(t,!0,-1),t.lineIndent===0&&t.input.charCodeAt(t.position)===45&&t.input.charCodeAt(t.position+1)===45&&t.input.charCodeAt(t.position+2)===45?(t.position+=3,B(t,!0,-1)):r&&I(t,"directives end mark is expected"),ve(t,t.lineIndent-1,nt,!1,!0),B(t,!0,-1),t.checkLineBreaks&&ml.test(t.input.slice(e,t.position))&&it(t,"non-ASCII line breaks are interpreted as content"),t.documents.push(t.result),t.position===t.lineStart&&st(t)){t.input.charCodeAt(t.position)===46&&(t.position+=3,B(t,!0,-1));return}if(t.position<t.length-1)I(t,"end of the stream or a document separator is expected");else return}function Mi(t,e){t=String(t),e=e||{},t.length!==0&&(t.charCodeAt(t.length-1)!==10&&t.charCodeAt(t.length-1)!==13&&(t+=`
`),t.charCodeAt(0)===65279&&(t=t.slice(1)));var n=new wl(t,e),i=t.indexOf("\0");for(i!==-1&&(n.position=i,I(n,"null byte is not allowed in input")),n.input+="\0";n.input.charCodeAt(n.position)===32;)n.lineIndent+=1,n.position+=1;for(;n.position<n.length-1;)Rl(n);return n.documents}function Ii(t,e,n){e!==null&&typeof e=="object"&&typeof n>"u"&&(n=e,e=null);var i=Mi(t,n);if(typeof e!="function")return i;for(var o=0,r=i.length;o<r;o+=1)e(i[o])}function Ai(t,e){var n=Mi(t,e);if(n.length!==0){if(n.length===1)return n[0];throw new yi("expected a single document in the stream, but found more")}}function El(t,e,n){return typeof e=="object"&&e!==null&&typeof n>"u"&&(n=e,e=null),Ii(t,e,te.extend({schema:_i},n))}function Ll(t,e){return Ai(t,te.extend({schema:_i},e))}Oe.loadAll=Ii;Oe.load=Ai;Oe.safeLoadAll=El;Oe.safeLoad=Ll;var Bt={},He=V,Be=Ne,Fl=rt,Dl=Pe,Ri=Object.prototype.toString,Ei=Object.prototype.hasOwnProperty,Ol=9,Fe=10,Nl=13,Pl=32,Hl=33,Bl=34,Li=35,Ul=37,Gl=38,$l=39,Wl=42,Fi=44,Kl=45,Di=58,Yl=61,jl=62,Vl=63,ql=64,Oi=91,Ni=93,Xl=96,Pi=123,zl=124,Hi=125,$={};$[0]="\\0";$[7]="\\a";$[8]="\\b";$[9]="\\t";$[10]="\\n";$[11]="\\v";$[12]="\\f";$[13]="\\r";$[27]="\\e";$[34]='\\"';$[92]="\\\\";$[133]="\\N";$[160]="\\_";$[8232]="\\L";$[8233]="\\P";var Ql=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"];function Jl(t,e){var n,i,o,r,s,a,c;if(e===null)return{};for(n={},i=Object.keys(e),o=0,r=i.length;o<r;o+=1)s=i[o],a=String(e[s]),s.slice(0,2)==="!!"&&(s="tag:yaml.org,2002:"+s.slice(2)),c=t.compiledTypeMap.fallback[s],c&&Ei.call(c.styleAliases,a)&&(a=c.styleAliases[a]),n[s]=a;return n}function Kn(t){var e,n,i;if(e=t.toString(16).toUpperCase(),t<=255)n="x",i=2;else if(t<=65535)n="u",i=4;else if(t<=4294967295)n="U",i=8;else throw new Be("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+n+He.repeat("0",i-e.length)+e}function Zl(t){this.schema=t.schema||Fl,this.indent=Math.max(1,t.indent||2),this.noArrayIndent=t.noArrayIndent||!1,this.skipInvalid=t.skipInvalid||!1,this.flowLevel=He.isNothing(t.flowLevel)?-1:t.flowLevel,this.styleMap=Jl(this.schema,t.styles||null),this.sortKeys=t.sortKeys||!1,this.lineWidth=t.lineWidth||80,this.noRefs=t.noRefs||!1,this.noCompatMode=t.noCompatMode||!1,this.condenseFlow=t.condenseFlow||!1,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function Yn(t,e){for(var n=He.repeat(" ",e),i=0,o=-1,r="",s,a=t.length;i<a;)o=t.indexOf(`
`,i),o===-1?(s=t.slice(i),i=a):(s=t.slice(i,o+1),i=o+1),s.length&&s!==`
`&&(r+=n),r+=s;return r}function Mt(t,e){return`
`+He.repeat(" ",t.indent*e)}function eh(t,e){var n,i,o;for(n=0,i=t.implicitTypes.length;n<i;n+=1)if(o=t.implicitTypes[n],o.resolve(e))return!0;return!1}function Ut(t){return t===Pl||t===Ol}function ke(t){return 32<=t&&t<=126||161<=t&&t<=55295&&t!==8232&&t!==8233||57344<=t&&t<=65533&&t!==65279||65536<=t&&t<=1114111}function th(t){return ke(t)&&!Ut(t)&&t!==65279&&t!==Nl&&t!==Fe}function jn(t,e){return ke(t)&&t!==65279&&t!==Fi&&t!==Oi&&t!==Ni&&t!==Pi&&t!==Hi&&t!==Di&&(t!==Li||e&&th(e))}function nh(t){return ke(t)&&t!==65279&&!Ut(t)&&t!==Kl&&t!==Vl&&t!==Di&&t!==Fi&&t!==Oi&&t!==Ni&&t!==Pi&&t!==Hi&&t!==Li&&t!==Gl&&t!==Wl&&t!==Hl&&t!==zl&&t!==Yl&&t!==jl&&t!==$l&&t!==Bl&&t!==Ul&&t!==ql&&t!==Xl}function Bi(t){var e=/^\n* /;return e.test(t)}var Ui=1,Gi=2,$i=3,Wi=4,Je=5;function ih(t,e,n,i,o){var r,s,a,c=!1,l=!1,h=i!==-1,d=-1,p=nh(t.charCodeAt(0))&&!Ut(t.charCodeAt(t.length-1));if(e)for(r=0;r<t.length;r++){if(s=t.charCodeAt(r),!ke(s))return Je;a=r>0?t.charCodeAt(r-1):null,p=p&&jn(s,a)}else{for(r=0;r<t.length;r++){if(s=t.charCodeAt(r),s===Fe)c=!0,h&&(l=l||r-d-1>i&&t[d+1]!==" ",d=r);else if(!ke(s))return Je;a=r>0?t.charCodeAt(r-1):null,p=p&&jn(s,a)}l=l||h&&r-d-1>i&&t[d+1]!==" "}return!c&&!l?p&&!o(t)?Ui:Gi:n>9&&Bi(t)?Je:l?Wi:$i}function oh(t,e,n,i){t.dump=function(){if(e.length===0)return"''";if(!t.noCompatMode&&Ql.indexOf(e)!==-1)return"'"+e+"'";var o=t.indent*Math.max(1,n),r=t.lineWidth===-1?-1:Math.max(Math.min(t.lineWidth,40),t.lineWidth-o),s=i||t.flowLevel>-1&&n>=t.flowLevel;function a(c){return eh(t,c)}switch(ih(e,s,t.indent,r,a)){case Ui:return e;case Gi:return"'"+e.replace(/'/g,"''")+"'";case $i:return"|"+Vn(e,t.indent)+qn(Yn(e,o));case Wi:return">"+Vn(e,t.indent)+qn(Yn(rh(e,r),o));case Je:return'"'+sh(e)+'"';default:throw new Be("impossible error: invalid scalar style")}}()}function Vn(t,e){var n=Bi(t)?String(e):"",i=t[t.length-1]===`
`,o=i&&(t[t.length-2]===`
`||t===`
`),r=o?"+":i?"":"-";return n+r+`
`}function qn(t){return t[t.length-1]===`
`?t.slice(0,-1):t}function rh(t,e){for(var n=/(\n+)([^\n]*)/g,i=function(){var l=t.indexOf(`
`);return l=l!==-1?l:t.length,n.lastIndex=l,Xn(t.slice(0,l),e)}(),o=t[0]===`
`||t[0]===" ",r,s;s=n.exec(t);){var a=s[1],c=s[2];r=c[0]===" ",i+=a+(!o&&!r&&c!==""?`
`:"")+Xn(c,e),o=r}return i}function Xn(t,e){if(t===""||t[0]===" ")return t;for(var n=/ [^ ]/g,i,o=0,r,s=0,a=0,c="";i=n.exec(t);)a=i.index,a-o>e&&(r=s>o?s:a,c+=`
`+t.slice(o,r),o=r+1),s=a;return c+=`
`,t.length-o>e&&s>o?c+=t.slice(o,s)+`
`+t.slice(s+1):c+=t.slice(o),c.slice(1)}function sh(t){for(var e="",n,i,o,r=0;r<t.length;r++){if(n=t.charCodeAt(r),n>=55296&&n<=56319&&(i=t.charCodeAt(r+1),i>=56320&&i<=57343)){e+=Kn((n-55296)*1024+i-56320+65536),r++;continue}o=$[n],e+=!o&&ke(n)?t[r]:o||Kn(n)}return e}function ah(t,e,n){var i="",o=t.tag,r,s;for(r=0,s=n.length;r<s;r+=1)ue(t,e,n[r],!1,!1)&&(r!==0&&(i+=","+(t.condenseFlow?"":" ")),i+=t.dump);t.tag=o,t.dump="["+i+"]"}function ch(t,e,n,i){var o="",r=t.tag,s,a;for(s=0,a=n.length;s<a;s+=1)ue(t,e+1,n[s],!0,!0)&&((!i||s!==0)&&(o+=Mt(t,e)),t.dump&&Fe===t.dump.charCodeAt(0)?o+="-":o+="- ",o+=t.dump);t.tag=r,t.dump=o||"[]"}function lh(t,e,n){var i="",o=t.tag,r=Object.keys(n),s,a,c,l,h;for(s=0,a=r.length;s<a;s+=1)h="",s!==0&&(h+=", "),t.condenseFlow&&(h+='"'),c=r[s],l=n[c],ue(t,e,c,!1,!1)&&(t.dump.length>1024&&(h+="? "),h+=t.dump+(t.condenseFlow?'"':"")+":"+(t.condenseFlow?"":" "),ue(t,e,l,!1,!1)&&(h+=t.dump,i+=h));t.tag=o,t.dump="{"+i+"}"}function hh(t,e,n,i){var o="",r=t.tag,s=Object.keys(n),a,c,l,h,d,p;if(t.sortKeys===!0)s.sort();else if(typeof t.sortKeys=="function")s.sort(t.sortKeys);else if(t.sortKeys)throw new Be("sortKeys must be a boolean or a function");for(a=0,c=s.length;a<c;a+=1)p="",(!i||a!==0)&&(p+=Mt(t,e)),l=s[a],h=n[l],ue(t,e+1,l,!0,!0,!0)&&(d=t.tag!==null&&t.tag!=="?"||t.dump&&t.dump.length>1024,d&&(t.dump&&Fe===t.dump.charCodeAt(0)?p+="?":p+="? "),p+=t.dump,d&&(p+=Mt(t,e)),ue(t,e+1,h,!0,d)&&(t.dump&&Fe===t.dump.charCodeAt(0)?p+=":":p+=": ",p+=t.dump,o+=p));t.tag=r,t.dump=o||"{}"}function zn(t,e,n){var i,o,r,s,a,c;for(o=n?t.explicitTypes:t.implicitTypes,r=0,s=o.length;r<s;r+=1)if(a=o[r],(a.instanceOf||a.predicate)&&(!a.instanceOf||typeof e=="object"&&e instanceof a.instanceOf)&&(!a.predicate||a.predicate(e))){if(t.tag=n?a.tag:"?",a.represent){if(c=t.styleMap[a.tag]||a.defaultStyle,Ri.call(a.represent)==="[object Function]")i=a.represent(e,c);else if(Ei.call(a.represent,c))i=a.represent[c](e,c);else throw new Be("!<"+a.tag+'> tag resolver accepts not "'+c+'" style');t.dump=i}return!0}return!1}function ue(t,e,n,i,o,r){t.tag=null,t.dump=n,zn(t,n,!1)||zn(t,n,!0);var s=Ri.call(t.dump);i&&(i=t.flowLevel<0||t.flowLevel>e);var a=s==="[object Object]"||s==="[object Array]",c,l;if(a&&(c=t.duplicates.indexOf(n),l=c!==-1),(t.tag!==null&&t.tag!=="?"||l||t.indent!==2&&e>0)&&(o=!1),l&&t.usedDuplicates[c])t.dump="*ref_"+c;else{if(a&&l&&!t.usedDuplicates[c]&&(t.usedDuplicates[c]=!0),s==="[object Object]")i&&Object.keys(t.dump).length!==0?(hh(t,e,t.dump,o),l&&(t.dump="&ref_"+c+t.dump)):(lh(t,e,t.dump),l&&(t.dump="&ref_"+c+" "+t.dump));else if(s==="[object Array]"){var h=t.noArrayIndent&&e>0?e-1:e;i&&t.dump.length!==0?(ch(t,h,t.dump,o),l&&(t.dump="&ref_"+c+t.dump)):(ah(t,h,t.dump),l&&(t.dump="&ref_"+c+" "+t.dump))}else if(s==="[object String]")t.tag!=="?"&&oh(t,t.dump,e,r);else{if(t.skipInvalid)return!1;throw new Be("unacceptable kind of an object to dump "+s)}t.tag!==null&&t.tag!=="?"&&(t.dump="!<"+t.tag+"> "+t.dump)}return!0}function dh(t,e){var n=[],i=[],o,r;for(It(t,n,i),o=0,r=i.length;o<r;o+=1)e.duplicates.push(n[i[o]]);e.usedDuplicates=new Array(r)}function It(t,e,n){var i,o,r;if(t!==null&&typeof t=="object")if(o=e.indexOf(t),o!==-1)n.indexOf(o)===-1&&n.push(o);else if(e.push(t),Array.isArray(t))for(o=0,r=t.length;o<r;o+=1)It(t[o],e,n);else for(i=Object.keys(t),o=0,r=i.length;o<r;o+=1)It(t[i[o]],e,n)}function Ki(t,e){e=e||{};var n=new Zl(e);return n.noRefs||dh(t,n),ue(n,0,t,!0,!0)?n.dump+`
`:""}function uh(t,e){return Ki(t,He.extend({schema:Dl},e))}Bt.dump=Ki;Bt.safeDump=uh;var at=Oe,Yi=Bt;function ct(t){return function(){throw new Error("Function "+t+" is deprecated and cannot be used.")}}H.Type=U;H.Schema=xe;H.FAILSAFE_SCHEMA=Ot;H.JSON_SCHEMA=ui;H.CORE_SCHEMA=pi;H.DEFAULT_SAFE_SCHEMA=Pe;H.DEFAULT_FULL_SCHEMA=rt;H.load=at.load;H.loadAll=at.loadAll;H.safeLoad=at.safeLoad;H.safeLoadAll=at.safeLoadAll;H.dump=Yi.dump;H.safeDump=Yi.safeDump;H.YAMLException=Ne;H.MINIMAL_SCHEMA=Ot;H.SAFE_SCHEMA=Pe;H.DEFAULT_SCHEMA=rt;H.scan=ct("scan");H.parse=ct("parse");H.compose=ct("compose");H.addConstructor=ct("addConstructor");var ph=H,mh=ph;function gh(t){if(!t.startsWith(`---
`))return{data:{},content:t};const e=t.indexOf(`
---`,4);if(e===-1)return{data:{},content:t};const n=t.slice(4,e),i=t.slice(e+4),o=i.startsWith(`
`)?i.slice(1):i;return{data:mh.safeLoad(n)??{},content:o}}const ji={npc:{specialNameChance:.3},missions:{boardMaxCount:8,missionTtlMs:9e5,deliveryChance:.6,deliveryBaseReward:200,deliveryRandomReward:200,supplyRewardMultiplierMin:1.15,supplyRewardMultiplierMax:1.5,supplyRequirementsMin:1,supplyRequirementsMax:2,supplyQtyMin:3,supplyQtyMax:10,deliveryDepositFraction:.2},trading:{stockCountMin:4,stockCountMax:6,stockQtyMin:5,stockQtyMax:10,stockTtlMs:12e4,stockRepCountBonusPerLevel:1,stockRepCountBonusMin:-2,stockRepCountBonusMax:3,stockRepQtyBonusPerLevel:2,stockRepQtyBonusMin:-4,stockRepQtyBonusMax:6},fuel:{pricePerLitre:10,consumptionPerLy:5,inSystemBaseConsumptionL:4},reputation:{levelUnfriendlyMin:-300,levelNeutralMin:-100,levelFriendlyMin:100,levelLikedMin:300,levelReveredMin:600,pointsMin:-600,pointsMax:1e3,missionDeltaSmall:25,missionDeltaMedium:75,missionDeltaLarge:200,missionTierMediumReward:300,missionTierLargeReward:600,tradeModifierHated:1.2,tradeModifierUnfriendly:1.1,tradeModifierNeutral:1,tradeModifierFriendly:.92,tradeModifierLiked:.85,tradeModifierRevered:.8,repPerCredit:.01,maxRepPerVisit:10},emergencyRescue:{towFee:500,fuelDropFee:800,fuelDropLitres:15},economies:{minFactor:.75,maxFactor:1.25},miniGames:{maxHullDamageFraction:.05,abandonDamageFraction:.05,noDamageThreshold:90,surface:{gravityAccel:3,airResistance:.5,thrustForce:8,maxSafeSpeed:3,crashSpeed:10,offPadScoreMultiplier:.5,padWidth:6,maxSpeed:15},asteroid:{thrustForce:8,maxSafeSpeed:4,crashSpeed:12,offPadScoreMultiplier:.5,padWidth:6,initialDownwardVelocity:2,maxSpeed:15},navigation:{ship:{accelerationImpulse:.8,maxSpeedLateral:4,maxSpeedForward:6,playerRowPreference:.67,topBufferRows:4},difficulties:{easy:{baseScrollSpeed:.3,minScrollSpeed:.2,obstacleDensity:.5,edgeSpawnIntervalFrames:120,driftSpeedMax:.2,targetDistance:150},normal:{baseScrollSpeed:.5,minScrollSpeed:.35,obstacleDensity:.8,edgeSpawnIntervalFrames:80,driftSpeedMax:.4,targetDistance:200},hard:{baseScrollSpeed:.8,minScrollSpeed:.55,obstacleDensity:1.3,edgeSpawnIntervalFrames:50,driftSpeedMax:.7,targetDistance:250}},eventTypes:{asteroid_belt:{largeRatio:.25,mediumRatio:.4,smallRatio:.35},space_debris:{largeRatio:.08,mediumRatio:.25,smallRatio:.67},space_storm:{largeRatio:0,mediumRatio:.1,smallRatio:.9}}}},navigationEncounter:{encounterChanceOnJump:.3}};function fh(t){const e={settings:{player:{name:"Captain",startingCredits:0},startingLocation:{system:"",destination:""},startingShip:""},balance:{...ji},systems:[],destinations:[],routes:[],drives:[],ships:[],factions:[],commodities:[],economies:[],storyBeats:[],deliveryItems:[],npcNames:{special:[],firstNames:[],lastNames:[]}};for(const[n,i]of Object.entries(t)){const o=n.split("/").pop()??"";if(o==="_template.md"||o===".gitkeep")continue;const{data:r,content:s}=gh(i);/^systems\/[^/]+\.md$/.test(n)?e.systems.push(yh(r,s)):/^destinations\/[^/]+\.md$/.test(n)?e.destinations.push(_h(r,s)):/^factions\/[^/]+\.md$/.test(n)?e.factions.push(bh(r,s)):/^ships\/[^/]+\.md$/.test(n)?e.ships.push(wh(r,s)):n==="ships/components/jump-drives.md"?e.drives=vh(r):n==="navigation/jump-routes.md"?e.routes=kh(r):n==="commodities.md"?e.commodities=xh(r):n==="economies.md"?e.economies=Ih(r):/^story\/[^/]+\.md$/.test(n)?e.storyBeats.push(Ch(r,s)):n==="settings/new-game.md"?e.settings=Th(r):n==="settings/balance.md"?e.balance=Lh(r):n==="delivery-items.md"?e.deliveryItems=Sh(r):n==="npc-names.md"&&(e.npcNames=Mh(r))}return e}function lt(t){const e=[];let n=!1;for(const i of t.split(`
`)){const o=i.trim();if(!o.startsWith("#"))if(o===""){if(n)break}else n=!0,e.push(o)}return e.join(" ")}function yh(t,e){return{id:t.id,name:t.name,starType:t.star_type,distanceFromSol:t.distance_from_sol,zone:t.zone,security:t.security,population:t.population,dangerLevel:t.danger_level,playerKnowledge:t.player_knowledge,economies:t.economies??[],majorFactions:t.major_factions??[],destinations:t.destinations??[],tags:t.tags??[],description:lt(e)}}function _h(t,e){const n=t.amenities??{},i={trader:n.trader??!1,shipRepair:n.ship_repair??!1,fuel:n.fuel??!1,shipDealer:n.ship_dealer??!1};return{id:t.id,name:t.name,system:t.system,locationType:t.location_type,type:t.type,amenities:i,npcs:t.npcs??{},minMissions:t.min_missions??0,missionChance:t.mission_chance??0,dangerLevel:t.danger_level,tags:t.tags??[],description:lt(e),owningFactionId:t.owning_faction,difficultyMultiplier:t.difficulty_multiplier!==void 0?parseFloat(t.difficulty_multiplier):void 0}}function bh(t,e){return{id:t.id,name:t.name,type:t.type,homeSystem:t.home_system,size:t.size,influence:t.influence??[],tags:t.tags??[],description:lt(e),rivals:t.rivals??[],allies:t.allies??[]}}function wh(t,e){return{id:t.id,name:t.name,class:t.class,cost:t.cost,cargoCapacityKg:t.cargo_capacity_kg,fuelCapacityL:t.fuel_capacity_l,hullPoints:t.hull_points,defaultJumpDrive:t.default_jump_drive,fuelEfficiency:t.fuel_efficiency,tags:t.tags??[],description:lt(e)}}function vh(t){return(t.drives??[]).map(n=>({id:n.id,name:n.name,maxDistanceLy:n.max_distance_ly,fuelEfficiency:n.fuel_efficiency,cost:n.cost}))}function kh(t){return(t.routes??[]).map(n=>({from:n.from,to:n.to,distance:n.distance,stability:n.stability,security:n.security}))}function xh(t){return(t.commodities??[]).map(n=>({id:n.id,name:n.name,basePrice:n.base_price,category:n.category,legal:n.legal,weightKg:n.weight_kg,description:n.description??""}))}function Ch(t,e){return{id:t.id,title:t.title,trigger:t.trigger,type:t.type,location:t.location,skippable:t.skippable,playerKnowledge:t.player_knowledge,text:e.trim()}}function Th(t){var e,n,i,o;return{player:{name:((e=t.player)==null?void 0:e.name)??"Captain",startingCredits:((n=t.player)==null?void 0:n.starting_credits)??0},startingLocation:{system:((i=t.starting_location)==null?void 0:i.system)??"",destination:((o=t.starting_location)==null?void 0:o.destination)??""},startingShip:t.starting_ship??""}}function Sh(t){return(t.delivery_items??[]).map(n=>({id:n.id,name:n.name,weightKg:n.weight_kg}))}function Mh(t){const e=t.npc_names??{};return{special:e.special??[],firstNames:e.first_names??[],lastNames:e.last_names??[]}}function Ih(t){return(t.economies??[]).map(n=>({id:n.id,summary:n.summary,commodities:(n.commodities??[]).map(i=>({id:i.id,factor:i.factor}))}))}function Ah(t,e){return{gravityAccel:t.gravity_accel??e.gravityAccel,airResistance:t.air_resistance??e.airResistance,thrustForce:t.thrust_force??e.thrustForce,maxSafeSpeed:t.max_safe_speed??e.maxSafeSpeed,crashSpeed:t.crash_speed??e.crashSpeed,offPadScoreMultiplier:t.off_pad_score_multiplier??e.offPadScoreMultiplier,padWidth:t.pad_width??e.padWidth,maxSpeed:t.max_speed??e.maxSpeed}}function Rh(t,e){return{thrustForce:t.thrust_force??e.thrustForce,maxSafeSpeed:t.max_safe_speed??e.maxSafeSpeed,crashSpeed:t.crash_speed??e.crashSpeed,offPadScoreMultiplier:t.off_pad_score_multiplier??e.offPadScoreMultiplier,padWidth:t.pad_width??e.padWidth,initialDownwardVelocity:t.initial_downward_velocity??e.initialDownwardVelocity,maxSpeed:t.max_speed??e.maxSpeed}}function Eh(t,e){var a,c,l,h,d,p,u,m,g,y,b;const n=t.ship??{},i=t.difficulties??{},o=t.event_types??{},r=(x,_)=>({baseScrollSpeed:x.base_scroll_speed??(_==null?void 0:_.baseScrollSpeed),minScrollSpeed:x.min_scroll_speed??(_==null?void 0:_.minScrollSpeed),obstacleDensity:x.obstacle_density??(_==null?void 0:_.obstacleDensity),edgeSpawnIntervalFrames:x.edge_spawn_interval_frames??(_==null?void 0:_.edgeSpawnIntervalFrames),driftSpeedMax:x.drift_speed_max??(_==null?void 0:_.driftSpeedMax),targetDistance:x.target_distance??(_==null?void 0:_.targetDistance)}),s=(x,_)=>({largeRatio:x.large_ratio??(_==null?void 0:_.largeRatio),mediumRatio:x.medium_ratio??(_==null?void 0:_.mediumRatio),smallRatio:x.small_ratio??(_==null?void 0:_.smallRatio)});return{ship:{accelerationImpulse:n.acceleration_impulse??((a=e==null?void 0:e.ship)==null?void 0:a.accelerationImpulse)??.4,maxSpeedLateral:n.max_speed_lateral??((c=e==null?void 0:e.ship)==null?void 0:c.maxSpeedLateral)??2,maxSpeedForward:n.max_speed_forward??((l=e==null?void 0:e.ship)==null?void 0:l.maxSpeedForward)??3,playerRowPreference:n.player_row_preference??((h=e==null?void 0:e.ship)==null?void 0:h.playerRowPreference)??.67,topBufferRows:n.top_buffer_rows??((d=e==null?void 0:e.ship)==null?void 0:d.topBufferRows)??4},difficulties:{easy:r(i.easy??{},(p=e==null?void 0:e.difficulties)==null?void 0:p.easy),normal:r(i.normal??{},(u=e==null?void 0:e.difficulties)==null?void 0:u.normal),hard:r(i.hard??{},(m=e==null?void 0:e.difficulties)==null?void 0:m.hard)},eventTypes:{asteroid_belt:s(o.asteroid_belt??{},(g=e==null?void 0:e.eventTypes)==null?void 0:g.asteroid_belt),space_debris:s(o.space_debris??{},(y=e==null?void 0:e.eventTypes)==null?void 0:y.space_debris),space_storm:s(o.space_storm??{},(b=e==null?void 0:e.eventTypes)==null?void 0:b.space_storm)}}}function Lh(t){const e=ji,n=t.npc??{},i=t.missions??{},o=t.trading??{},r=t.fuel??{},s=t.reputation??{},a=t.emergency_rescue??{},c=t.economies??{},l=t.mini_games??{},h=t.navigation_encounter??{};return{npc:{specialNameChance:n.special_name_chance??e.npc.specialNameChance},missions:{boardMaxCount:i.board_max_count??e.missions.boardMaxCount,missionTtlMs:i.mission_ttl_ms??e.missions.missionTtlMs,deliveryChance:i.delivery_chance??e.missions.deliveryChance,deliveryBaseReward:i.delivery_base_reward??e.missions.deliveryBaseReward,deliveryRandomReward:i.delivery_random_reward??e.missions.deliveryRandomReward,supplyRewardMultiplierMin:i.supply_reward_multiplier_min??e.missions.supplyRewardMultiplierMin,supplyRewardMultiplierMax:i.supply_reward_multiplier_max??e.missions.supplyRewardMultiplierMax,supplyRequirementsMin:i.supply_requirements_min??e.missions.supplyRequirementsMin,supplyRequirementsMax:i.supply_requirements_max??e.missions.supplyRequirementsMax,supplyQtyMin:i.supply_qty_min??e.missions.supplyQtyMin,supplyQtyMax:i.supply_qty_max??e.missions.supplyQtyMax,deliveryDepositFraction:i.delivery_deposit_fraction??e.missions.deliveryDepositFraction},trading:{stockCountMin:o.stock_count_min??e.trading.stockCountMin,stockCountMax:o.stock_count_max??e.trading.stockCountMax,stockQtyMin:o.stock_qty_min??e.trading.stockQtyMin,stockQtyMax:o.stock_qty_max??e.trading.stockQtyMax,stockTtlMs:o.stock_ttl_ms??e.trading.stockTtlMs,stockRepCountBonusPerLevel:o.stock_rep_count_bonus_per_level??e.trading.stockRepCountBonusPerLevel,stockRepCountBonusMin:o.stock_rep_count_bonus_min??e.trading.stockRepCountBonusMin,stockRepCountBonusMax:o.stock_rep_count_bonus_max??e.trading.stockRepCountBonusMax,stockRepQtyBonusPerLevel:o.stock_rep_qty_bonus_per_level??e.trading.stockRepQtyBonusPerLevel,stockRepQtyBonusMin:o.stock_rep_qty_bonus_min??e.trading.stockRepQtyBonusMin,stockRepQtyBonusMax:o.stock_rep_qty_bonus_max??e.trading.stockRepQtyBonusMax},fuel:{pricePerLitre:r.price_per_litre??e.fuel.pricePerLitre,consumptionPerLy:r.consumption_per_ly??e.fuel.consumptionPerLy,inSystemBaseConsumptionL:r.in_system_base_consumption_l??e.fuel.inSystemBaseConsumptionL},reputation:{levelUnfriendlyMin:s.level_unfriendly_min??e.reputation.levelUnfriendlyMin,levelNeutralMin:s.level_neutral_min??e.reputation.levelNeutralMin,levelFriendlyMin:s.level_friendly_min??e.reputation.levelFriendlyMin,levelLikedMin:s.level_liked_min??e.reputation.levelLikedMin,levelReveredMin:s.level_revered_min??e.reputation.levelReveredMin,pointsMin:s.points_min??e.reputation.pointsMin,pointsMax:s.points_max??e.reputation.pointsMax,missionDeltaSmall:s.mission_delta_small??e.reputation.missionDeltaSmall,missionDeltaMedium:s.mission_delta_medium??e.reputation.missionDeltaMedium,missionDeltaLarge:s.mission_delta_large??e.reputation.missionDeltaLarge,missionTierMediumReward:s.mission_tier_medium_reward??e.reputation.missionTierMediumReward,missionTierLargeReward:s.mission_tier_large_reward??e.reputation.missionTierLargeReward,tradeModifierHated:s.trade_modifier_hated??e.reputation.tradeModifierHated,tradeModifierUnfriendly:s.trade_modifier_unfriendly??e.reputation.tradeModifierUnfriendly,tradeModifierNeutral:s.trade_modifier_neutral??e.reputation.tradeModifierNeutral,tradeModifierFriendly:s.trade_modifier_friendly??e.reputation.tradeModifierFriendly,tradeModifierLiked:s.trade_modifier_liked??e.reputation.tradeModifierLiked,tradeModifierRevered:s.trade_modifier_revered??e.reputation.tradeModifierRevered,repPerCredit:s.rep_per_credit??e.reputation.repPerCredit,maxRepPerVisit:s.max_rep_per_visit??e.reputation.maxRepPerVisit},emergencyRescue:{towFee:a.tow_fee??e.emergencyRescue.towFee,fuelDropFee:a.fuel_drop_fee??e.emergencyRescue.fuelDropFee,fuelDropLitres:a.fuel_drop_litres??e.emergencyRescue.fuelDropLitres},economies:{minFactor:c.min_factor??e.economies.minFactor,maxFactor:c.max_factor??e.economies.maxFactor},miniGames:{maxHullDamageFraction:l.max_hull_damage_fraction??e.miniGames.maxHullDamageFraction,abandonDamageFraction:l.abandon_damage_fraction??e.miniGames.abandonDamageFraction,noDamageThreshold:l.no_damage_threshold??e.miniGames.noDamageThreshold,surface:Ah(l.surface??{},e.miniGames.surface),asteroid:Rh(l.asteroid??{},e.miniGames.asteroid),navigation:Eh(l.navigation_minigame??{},e.miniGames.navigation)},navigationEncounter:{encounterChanceOnJump:h.encounter_chance_on_jump??e.navigationEncounter.encounterChanceOnJump}}}function Fh(){const t=Object.assign({"/docs/world/commodities.md":bs,"/docs/world/delivery-items.md":ws,"/docs/world/destinations/_template.md":vs,"/docs/world/destinations/blackwake-yard.md":ks,"/docs/world/destinations/ceti-landfall.md":xs,"/docs/world/destinations/drift-market.md":Cs,"/docs/world/destinations/elysium-station.md":Ts,"/docs/world/destinations/eridani-anchorage.md":Ss,"/docs/world/destinations/foundries-platform.md":Ms,"/docs/world/destinations/galileo-transfer.md":Is,"/docs/world/destinations/hestia-ring.md":As,"/docs/world/destinations/keelhaul-station.md":Rs,"/docs/world/destinations/kepler-yard.md":Es,"/docs/world/destinations/mars-anchor.md":Ls,"/docs/world/destinations/meridian-station.md":Fs,"/docs/world/destinations/new-horizon-port.md":Ds,"/docs/world/destinations/orrery-anchorage.md":Os,"/docs/world/destinations/redline-station.md":Ns,"/docs/world/destinations/tycho-orbital.md":Ps,"/docs/world/destinations/veil-station.md":Hs,"/docs/world/destinations/waypoint-ceti.md":Bs,"/docs/world/economies.md":Us,"/docs/world/factions/_template.md":Gs,"/docs/world/factions/centauri-trade-league.md":$s,"/docs/world/factions/eridani-colonial-council.md":Ws,"/docs/world/factions/free-captains.md":Ks,"/docs/world/factions/grey-market-cartel.md":Ys,"/docs/world/factions/helios-directorate.md":js,"/docs/world/factions/independent-miners-guild.md":Vs,"/docs/world/factions/procyon-institute.md":qs,"/docs/world/factions/terran-union.md":Xs,"/docs/world/galaxy-map.md":zs,"/docs/world/navigation/jump-routes.md":Qs,"/docs/world/npc-names.md":Js,"/docs/world/settings/balance.md":Zs,"/docs/world/settings/new-game.md":ea,"/docs/world/ships/_template.md":ta,"/docs/world/ships/components/jump-drives.md":na,"/docs/world/ships/freighter.md":ia,"/docs/world/ships/hauler.md":oa,"/docs/world/ships/scout.md":ra,"/docs/world/story/_template.md":sa,"/docs/world/story/enter-wolf-359.md":aa,"/docs/world/story/first-jump.md":ca,"/docs/world/story/opening-arrival.md":la,"/docs/world/systems/_template.md":ha,"/docs/world/systems/alpha-centauri.md":da,"/docs/world/systems/barnards-star.md":ua,"/docs/world/systems/epsilon-eridani.md":pa,"/docs/world/systems/procyon.md":ma,"/docs/world/systems/sirius.md":ga,"/docs/world/systems/sol.md":fa,"/docs/world/systems/tau-ceti.md":ya,"/docs/world/systems/wolf-359.md":_a}),e={};for(const[n,i]of Object.entries(t)){const o=n.replace("/docs/world/","");e[o]=i}return fh(e)}co(Fh());const Dh=navigator.maxTouchPoints>0?"touch":"keyboard",Oh=new URLSearchParams(window.location.search).has("debug"),Vi={environment:"browser",primaryInput:Dh,debug:Oh},Nh=new Zi,qi=new io(Vi);qi.connect();const Ph=new _s(Nh,qi,Vi);let Qn=0;function Xi(t){Ph.tick(t-Qn),Qn=t,requestAnimationFrame(Xi)}requestAnimationFrame(Xi);
