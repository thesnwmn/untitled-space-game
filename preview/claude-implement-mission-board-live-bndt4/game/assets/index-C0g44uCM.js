...
`;var T={},_e={},B={};function gt(e){return typeof e>"u"||e===null}function Fo(e){return typeof e=="object"&&e!==null}function Do(e){return Array.isArray(e)?e:gt(e)?[]:[e]}function Po(e,n){var t,r,i,s;if(n)for(s=Object.keys(n),t=0,r=s.length;t<r;t+=1)i=s[t],e[i]=n[i];return e}function Uo(e,n){var t="",r;for(r=0;r<n;r+=1)t+=e;return t}function Bo(e){return e===0&&Number.NEGATIVE_INFINITY===1/e}B.isNothing=gt;B.isObject=Fo;B.toArray=Do;B.repeat=Uo;B.isNegativeZero=Bo;B.extend=Po;function me(e,n){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=n,this.message=(this.reason||"(unknown reason)")+(this.mark?" "+this.mark.toString():""),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}me.prototype=Object.create(Error.prototype);me.prototype.constructor=me;me.prototype.toString=function(n){var t=this.name+": ";return t+=this.reason||"(unknown reason)",!n&&this.mark&&(t+=" "+this.mark.toString()),t};var ve=me,qn=B;function ln(e,n,t,r,i){this.name=e,this.buffer=n,this.position=t,this.line=r,this.column=i}ln.prototype.getSnippet=function(n,t){var r,i,s,o,a;if(!this.buffer)return null;for(n=n||4,t=t||75,r="",i=this.position;i>0&&`\0\r
