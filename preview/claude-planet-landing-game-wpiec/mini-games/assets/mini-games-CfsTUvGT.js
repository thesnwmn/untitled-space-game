...
`:""}function zo(e,n){return Hn(e,Z.extend({schema:yo},n))}Ie.dump=Hn;Ie.safeDump=zo;var pe=X,On=Ie;function me(e){return function(){throw new Error("Function "+e+" is deprecated and cannot be used.")}}w.Type=x;w.Schema=$;w.FAILSAFE_SCHEMA=Ae;w.JSON_SCHEMA=rn;w.CORE_SCHEMA=on;w.DEFAULT_SAFE_SCHEMA=J;w.DEFAULT_FULL_SCHEMA=ue;w.load=pe.load;w.loadAll=pe.loadAll;w.safeLoad=pe.safeLoad;w.safeLoadAll=pe.safeLoadAll;w.dump=On.dump;w.safeDump=On.safeDump;w.YAMLException=Q;w.MINIMAL_SCHEMA=Ae;w.SAFE_SCHEMA=J;w.DEFAULT_SCHEMA=ue;w.scan=me("scan");w.parse=me("parse");w.compose=me("compose");w.addConstructor=me("addConstructor");var Xo=w,Qo=Xo;function Jo(e){if(!e.startsWith(`---
