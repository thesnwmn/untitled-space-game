...
Adventure here is fraught with inconsistent communications and unreliable star charts.`,Li=`---
routes:
...
Long range engines for faster than light travel between systems.`,Bi=`---
id: freighter
...
`;var b={},X={},T={};function nn(e){return typeof e>"u"||e===null}function nt(e){return typeof e=="object"&&e!==null}function it(e){return Array.isArray(e)?e:nn(e)?[]:[e]}function tt(e,n){var i,r,t,o;if(n)for(o=Object.keys(n),i=0,r=o.length;i<r;i+=1)t=o[i],e[t]=n[t];return e}function rt(e,n){var i="",r;for(r=0;r<n;r+=1)i+=e;return i}function ot(e){return e===0&&Number.NEGATIVE_INFINITY===1/e}T.isNothing=nn;T.isObject=nt;T.toArray=it;T.repeat=rt;T.isNegativeZero=ot;T.extend=tt;function V(e,n){Error.call(this),this.name="YAMLException",this.reason=e,this.mark=n,this.message=(this.reason||"(unknown reason)")+(this.mark?" "+this.mark.toString():""),Error.captureStackTrace?Error.captureStackTrace(this,this.constructor):this.stack=new Error().stack||""}V.prototype=Object.create(Error.prototype);V.prototype.constructor=V;V.prototype.toString=function(n){var i=this.name+": ";return i+=this.reason||"(unknown reason)",!n&&this.mark&&(i+=" "+this.mark.toString()),i};var Q=V,Le=T;function Te(e,n,i,r,t){this.name=e,this.buffer=n,this.position=i,this.line=r,this.column=t}Te.prototype.getSnippet=function(n,i){var r,t,o,a,s;if(!this.buffer)return null;for(n=n||4,i=i||75,r="",t=this.position;t>0&&`\0\r
\u2028\u2029`.indexOf(this.buffer.charAt(t-1))===-1;)if(t-=1,this.position-t>i/2-1){r=" ... ",t+=5;break}for(o="",a=this.position;a<this.buffer.length&&`\0\r
\u2028\u2029`.indexOf(this.buffer.charAt(a))===-1;)if(a+=1,a-this.position>i/2-1){o=" ... ",a-=5;break}return s=this.buffer.slice(t,a),Le.repeat(" ",n)+r+s+o+`
`+Le.repeat(" ",n+this.position-t+r.length)+"^"};Te.prototype.toString=function(n){var i,r="";return this.name&&(r+='in "'+this.name+'" '),r+="at line "+(this.line+1)+", column "+(this.column+1),n||(i=this.getSnippet(),i&&(r+=`:
`+i)),r};var at=Te,De=Q,st=["kind","resolve","construct","instanceOf","predicate","represent","defaultStyle","styleAliases"],lt=["scalar","sequence","mapping"];function ct(e){var n={};return e!==null&&Object.keys(e).forEach(function(i){e[i].forEach(function(r){n[String(r)]=i})}),n}function dt(e,n){if(n=n||{},Object.keys(n).forEach(function(i){if(st.indexOf(i)===-1)throw new De('Unknown option "'+i+'" is met in definition of "'+e+'" YAML type.')}),this.tag=e,this.kind=n.kind||null,this.resolve=n.resolve||function(){return!0},this.construct=n.construct||function(i){return i},this.instanceOf=n.instanceOf||null,this.predicate=n.predicate||null,this.represent=n.represent||null,this.defaultStyle=n.defaultStyle||null,this.styleAliases=ct(n.styleAliases||null),lt.indexOf(this.kind)===-1)throw new De('Unknown kind "'+this.kind+'" is specified for "'+e+'" YAML type.')}var x=dt,Pe=T,re=Q,ut=x;function xe(e,n,i){var r=[];return e.include.forEach(function(t){i=xe(t,n,i)}),e[n].forEach(function(t){i.forEach(function(o,a){o.tag===t.tag&&o.kind===t.kind&&r.push(a)}),i.push(t)}),i.filter(function(t,o){return r.indexOf(o)===-1})}function ht(){var e={scalar:{},sequence:{},mapping:{},fallback:{}},n,i;function r(t){e[t.kind][t.tag]=e.fallback[t.tag]=t}for(n=0,i=arguments.length;n<i;n+=1)arguments[n].forEach(r);return e}function N(e){this.include=e.include||[],this.implicit=e.implicit||[],this.explicit=e.explicit||[],this.implicit.forEach(function(n){if(n.loadKind&&n.loadKind!=="scalar")throw new re("There is a non-scalar type in the implicit list of a schema. Implicit resolving of such types is not supported.")}),this.compiledImplicit=xe(this,"implicit",[]),this.compiledExplicit=xe(this,"explicit",[]),this.compiledTypeMap=ht(this.compiledImplicit,this.compiledExplicit)}N.DEFAULT=null;N.create=function(){var n,i;switch(arguments.length){case 1:n=N.DEFAULT,i=arguments[0];break;case 2:n=arguments[0],i=arguments[1];break;default:throw new re("Wrong number of arguments for Schema.create function")}if(n=Pe.toArray(n),i=Pe.toArray(i),!n.every(function(r){return r instanceof N}))throw new re("Specified list of super schemas (or a single Schema object) contains a non-Schema object.");if(!i.every(function(r){return r instanceof ut}))throw new re("Specified list of YAML types (or a single Type object) contains a non-Type object.");return new N({include:n,explicit:i})};var $=N,pt=x,mt=new pt("tag:yaml.org,2002:str",{kind:"scalar",construct:function(e){return e!==null?e:""}}),ft=x,gt=new ft("tag:yaml.org,2002:seq",{kind:"sequence",construct:function(e){return e!==null?e:[]}}),yt=x,_t=new yt("tag:yaml.org,2002:map",{kind:"mapping",construct:function(e){return e!==null?e:{}}}),vt=$,Ae=new vt({explicit:[mt,gt,_t]}),bt=x;function wt(e){if(e===null)return!0;var n=e.length;return n===1&&e==="~"||n===4&&(e==="null"||e==="Null"||e==="NULL")}function xt(){return null}function kt(e){return e===null}var Ct=new bt("tag:yaml.org,2002:null",{kind:"scalar",resolve:wt,construct:xt,predicate:kt,represent:{canonical:function(){return"~"},lowercase:function(){return"null"},uppercase:function(){return"NULL"},camelcase:function(){return"Null"}},defaultStyle:"lowercase"}),Tt=x;function At(e){if(e===null)return!1;var n=e.length;return n===4&&(e==="true"||e==="True"||e==="TRUE")||n===5&&(e==="false"||e==="False"||e==="FALSE")}function Mt(e){return e==="true"||e==="True"||e==="TRUE"}function St(e){return Object.prototype.toString.call(e)==="[object Boolean]"}var Et=new Tt("tag:yaml.org,2002:bool",{kind:"scalar",resolve:At,construct:Mt,predicate:St,represent:{lowercase:function(e){return e?"true":"false"},uppercase:function(e){return e?"TRUE":"FALSE"},camelcase:function(e){return e?"True":"False"}},defaultStyle:"lowercase"}),It=T,Ft=x;function Rt(e){return 48<=e&&e<=57||65<=e&&e<=70||97<=e&&e<=102}function Lt(e){return 48<=e&&e<=55}function Dt(e){return 48<=e&&e<=57}function Pt(e){if(e===null)return!1;var n=e.length,i=0,r=!1,t;if(!n)return!1;if(t=e[i],(t==="-"||t==="+")&&(t=e[++i]),t==="0"){if(i+1===n)return!0;if(t=e[++i],t==="b"){for(i++;i<n;i++)if(t=e[i],t!=="_"){if(t!=="0"&&t!=="1")return!1;r=!0}return r&&t!=="_"}if(t==="x"){for(i++;i<n;i++)if(t=e[i],t!=="_"){if(!Rt(e.charCodeAt(i)))return!1;r=!0}return r&&t!=="_"}for(;i<n;i++)if(t=e[i],t!=="_"){if(!Lt(e.charCodeAt(i)))return!1;r=!0}return r&&t!=="_"}if(t==="_")return!1;for(;i<n;i++)if(t=e[i],t!=="_"){if(t===":")break;if(!Dt(e.charCodeAt(i)))return!1;r=!0}return!r||t==="_"?!1:t!==":"?!0:/^(:[0-5]?[0-9])+$/.test(e.slice(i))}function Ht(e){var n=e,i=1,r,t,o=[];return n.indexOf("_")!==-1&&(n=n.replace(/_/g,"")),r=n[0],(r==="-"||r==="+")&&(r==="-"&&(i=-1),n=n.slice(1),r=n[0]),n==="0"?0:r==="0"?n[1]==="b"?i*parseInt(n.slice(2),2):n[1]==="x"?i*parseInt(n,16):i*parseInt(n,8):n.indexOf(":")!==-1?(n.split(":").forEach(function(a){o.unshift(parseInt(a,10))}),n=0,t=1,o.forEach(function(a){n+=a*t,t*=60}),i*n):i*parseInt(n,10)}function Ot(e){return Object.prototype.toString.call(e)==="[object Number]"&&e%1===0&&!It.isNegativeZero(e)}var Nt=new Ft("tag:yaml.org,2002:int",{kind:"scalar",resolve:Pt,construct:Ht,predicate:Ot,represent:{binary:function(e){return e>=0?"0b"+e.toString(2):"-0b"+e.toString(2).slice(1)},octal:function(e){return e>=0?"0"+e.toString(8):"-0"+e.toString(8).slice(1)},decimal:function(e){return e.toString(10)},hexadecimal:function(e){return e>=0?"0x"+e.toString(16).toUpperCase():"-0x"+e.toString(16).toUpperCase().slice(1)}},defaultStyle:"decimal",styleAliases:{binary:[2,"bin"],octal:[8,"oct"],decimal:[10,"dec"],hexadecimal:[16,"hex"]}}),tn=T,Bt=x,Ut=new RegExp("^(?:[-+]?(?:0|[1-9][0-9_]*)(?:\\.[0-9_]*)?(?:[eE][-+]?[0-9]+)?|\\.[0-9_]+(?:[eE][-+]?[0-9]+)?|[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\\.[0-9_]*|[-+]?\\.(?:inf|Inf|INF)|\\.(?:nan|NaN|NAN))$");function jt(e){return!(e===null||!Ut.test(e)||e[e.length-1]==="_")}function Wt(e){var n,i,r,t;return n=e.replace(/_/g,"").toLowerCase(),i=n[0]==="-"?-1:1,t=[],"+-".indexOf(n[0])>=0&&(n=n.slice(1)),n===".inf"?i===1?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY:n===".nan"?NaN:n.indexOf(":")>=0?(n.split(":").forEach(function(o){t.unshift(parseFloat(o,10))}),n=0,r=1,t.forEach(function(o){n+=o*r,r*=60}),i*n):i*parseFloat(n,10)}var Yt=/^[-+]?[0-9]+e/;function $t(e,n){var i;if(isNaN(e))switch(n){case"lowercase":return".nan";case"uppercase":return".NAN";case"camelcase":return".NaN"}else if(Number.POSITIVE_INFINITY===e)switch(n){case"lowercase":return".inf";case"uppercase":return".INF";case"camelcase":return".Inf"}else if(Number.NEGATIVE_INFINITY===e)switch(n){case"lowercase":return"-.inf";case"uppercase":return"-.INF";case"camelcase":return"-.Inf"}else if(tn.isNegativeZero(e))return"-0.0";return i=e.toString(10),Yt.test(i)?i.replace("e",".e"):i}function Gt(e){return Object.prototype.toString.call(e)==="[object Number]"&&(e%1!==0||tn.isNegativeZero(e))}var qt=new Bt("tag:yaml.org,2002:float",{kind:"scalar",resolve:jt,construct:Wt,predicate:Gt,represent:$t,defaultStyle:"lowercase"}),Kt=$,rn=new Kt({include:[Ae],implicit:[Ct,Et,Nt,qt]}),Vt=$,on=new Vt({include:[rn]}),zt=x,an=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9])-([0-9][0-9])$"),sn=new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");function Xt(e){return e===null?!1:an.exec(e)!==null||sn.exec(e)!==null}function Qt(e){var n,i,r,t,o,a,s,l=0,c=null,h,u,p;if(n=an.exec(e),n===null&&(n=sn.exec(e)),n===null)throw new Error("Date resolve error");if(i=+n[1],r=+n[2]-1,t=+n[3],!n[4])return new Date(Date.UTC(i,r,t));if(o=+n[4],a=+n[5],s=+n[6],n[7]){for(l=n[7].slice(0,3);l.length<3;)l+="0";l=+l}return n[9]&&(h=+n[10],u=+(n[11]||0),c=(h*60+u)*6e4,n[9]==="-"&&(c=-c)),p=new Date(Date.UTC(i,r,t,o,a,s,l)),c&&p.setTime(p.getTime()-c),p}function Jt(e){return e.toISOString()}var Zt=new zt("tag:yaml.org,2002:timestamp",{kind:"scalar",resolve:Xt,construct:Qt,instanceOf:Date,represent:Jt}),er=x;function nr(e){return e==="<<"||e===null}var ir=new er("tag:yaml.org,2002:merge",{kind:"scalar",resolve:nr});function ln(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var D;try{var tr=ln;D=tr("buffer").Buffer}catch{}var rr=x,Me=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=
\r`;function or(e){if(e===null)return!1;var n,i,r=0,t=e.length,o=Me;for(i=0;i<t;i++)if(n=o.indexOf(e.charAt(i)),!(n>64)){if(n<0)return!1;r+=6}return r%8===0}function ar(e){var n,i,r=e.replace(/[\r\n=]/g,""),t=r.length,o=Me,a=0,s=[];for(n=0;n<t;n++)n%4===0&&n&&(s.push(a>>16&255),s.push(a>>8&255),s.push(a&255)),a=a<<6|o.indexOf(r.charAt(n));return i=t%4*6,i===0?(s.push(a>>16&255),s.push(a>>8&255),s.push(a&255)):i===18?(s.push(a>>10&255),s.push(a>>2&255)):i===12&&s.push(a>>4&255),D?D.from?D.from(s):new D(s):s}function sr(e){var n="",i=0,r,t,o=e.length,a=Me;for(r=0;r<o;r++)r%3===0&&r&&(n+=a[i>>18&63],n+=a[i>>12&63],n+=a[i>>6&63],n+=a[i&63]),i=(i<<8)+e[r];return t=o%3,t===0?(n+=a[i>>18&63],n+=a[i>>12&63],n+=a[i>>6&63],n+=a[i&63]):t===2?(n+=a[i>>10&63],n+=a[i>>4&63],n+=a[i<<2&63],n+=a[64]):t===1&&(n+=a[i>>2&63],n+=a[i<<4&63],n+=a[64],n+=a[64]),n}function lr(e){return D&&D.isBuffer(e)}var cr=new rr("tag:yaml.org,2002:binary",{kind:"scalar",resolve:or,construct:ar,predicate:lr,represent:sr}),dr=x,ur=Object.prototype.hasOwnProperty,hr=Object.prototype.toString;function pr(e){if(e===null)return!0;var n=[],i,r,t,o,a,s=e;for(i=0,r=s.length;i<r;i+=1){if(t=s[i],a=!1,hr.call(t)!=="[object Object]")return!1;for(o in t)if(ur.call(t,o))if(!a)a=!0;else return!1;if(!a)return!1;if(n.indexOf(o)===-1)n.push(o);else return!1}return!0}function mr(e){return e!==null?e:[]}var fr=new dr("tag:yaml.org,2002:omap",{kind:"sequence",resolve:pr,construct:mr}),gr=x,yr=Object.prototype.toString;function _r(e){if(e===null)return!0;var n,i,r,t,o,a=e;for(o=new Array(a.length),n=0,i=a.length;n<i;n+=1){if(r=a[n],yr.call(r)!=="[object Object]"||(t=Object.keys(r),t.length!==1))return!1;o[n]=[t[0],r[t[0]]]}return!0}function vr(e){if(e===null)return[];var n,i,r,t,o,a=e;for(o=new Array(a.length),n=0,i=a.length;n<i;n+=1)r=a[n],t=Object.keys(r),o[n]=[t[0],r[t[0]]];return o}var br=new gr("tag:yaml.org,2002:pairs",{kind:"sequence",resolve:_r,construct:vr}),wr=x,xr=Object.prototype.hasOwnProperty;function kr(e){if(e===null)return!0;var n,i=e;for(n in i)if(xr.call(i,n)&&i[n]!==null)return!1;return!0}function Cr(e){return e!==null?e:{}}var Tr=new wr("tag:yaml.org,2002:set",{kind:"mapping",resolve:kr,construct:Cr}),Ar=$,J=new Ar({include:[on],implicit:[Zt,ir],explicit:[cr,fr,br,Tr]}),Mr=x;function Sr(){return!0}function Er(){}function Ir(){return""}function Fr(e){return typeof e>"u"}var Rr=new Mr("tag:yaml.org,2002:js/undefined",{kind:"scalar",resolve:Sr,construct:Er,predicate:Fr,represent:Ir}),Lr=x;function Dr(e){if(e===null||e.length===0)return!1;var n=e,i=/\/([gim]*)$/.exec(e),r="";return!(n[0]==="/"&&(i&&(r=i[1]),r.length>3||n[n.length-r.length-1]!=="/"))}function Pr(e){var n=e,i=/\/([gim]*)$/.exec(e),r="";return n[0]==="/"&&(i&&(r=i[1]),n=n.slice(1,n.length-r.length-1)),new RegExp(n,r)}function Hr(e){var n="/"+e.source+"/";return e.global&&(n+="g"),e.multiline&&(n+="m"),e.ignoreCase&&(n+="i"),n}function Or(e){return Object.prototype.toString.call(e)==="[object RegExp]"}var Nr=new Lr("tag:yaml.org,2002:js/regexp",{kind:"scalar",resolve:Dr,construct:Pr,predicate:Or,represent:Hr}),ae;try{var Br=ln;ae=Br("esprima")}catch{typeof window<"u"&&(ae=window.esprima)}var Ur=x;function jr(e){if(e===null)return!1;try{var n="("+e+")",i=ae.parse(n,{range:!0});return!(i.type!=="Program"||i.body.length!==1||i.body[0].type!=="ExpressionStatement"||i.body[0].expression.type!=="ArrowFunctionExpression"&&i.body[0].expression.type!=="FunctionExpression")}catch{return!1}}function Wr(e){var n="("+e+")",i=ae.parse(n,{range:!0}),r=[],t;if(i.type!=="Program"||i.body.length!==1||i.body[0].type!=="ExpressionStatement"||i.body[0].expression.type!=="ArrowFunctionExpression"&&i.body[0].expression.type!=="FunctionExpression")throw new Error("Failed to resolve function");return i.body[0].expression.params.forEach(function(o){r.push(o.name)}),t=i.body[0].expression.body.range,i.body[0].expression.body.type==="BlockStatement"?new Function(r,n.slice(t[0]+1,t[1]-1)):new Function(r,"return "+n.slice(t[0],t[1]))}function Yr(e){return e.toString()}function $r(e){return Object.prototype.toString.call(e)==="[object Function]"}var Gr=new Ur("tag:yaml.org,2002:js/function",{kind:"scalar",resolve:jr,construct:Wr,predicate:$r,represent:Yr}),He=$,ue=He.DEFAULT=new He({include:[J],explicit:[Rr,Nr,Gr]}),E=T,cn=Q,qr=at,dn=J,Kr=ue,L=Object.prototype.hasOwnProperty,se=1,un=2,hn=3,le=4,ve=1,Vr=2,Oe=3,zr=/[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,Xr=/[\x85\u2028\u2029]/,Qr=/[,\[\]\{\}]/,pn=/^(?:!|!!|![a-z\-]+!)$/i,mn=/^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;function Ne(e){return Object.prototype.toString.call(e)}function S(e){return e===10||e===13}function P(e){return e===9||e===32}function C(e){return e===9||e===32||e===10||e===13}function B(e){return e===44||e===91||e===93||e===123||e===125}function Jr(e){var n;return 48<=e&&e<=57?e-48:(n=e|32,97<=n&&n<=102?n-97+10:-1)}function Zr(e){return e===120?2:e===117?4:e===85?8:0}function eo(e){return 48<=e&&e<=57?e-48:-1}function Be(e){return e===48?"\0":e===97?"\x07":e===98?"\b":e===116||e===9?"	":e===110?`
`:e===118?"\v":e===102?"\f":e===114?"\r":e===101?"\x1B":e===32?" ":e===34?'"':e===47?"/":e===92?"\\":e===78?"":e===95?" ":e===76?"\u2028":e===80?"\u2029":""}function no(e){return e<=65535?String.fromCharCode(e):String.fromCharCode((e-65536>>10)+55296,(e-65536&1023)+56320)}function fn(e,n,i){n==="__proto__"?Object.defineProperty(e,n,{configurable:!0,enumerable:!0,writable:!0,value:i}):e[n]=i}var gn=new Array(256),yn=new Array(256);for(var O=0;O<256;O++)gn[O]=Be(O)?1:0,yn[O]=Be(O);function io(e,n){this.input=e,this.filename=n.filename||null,this.schema=n.schema||Kr,this.onWarning=n.onWarning||null,this.legacy=n.legacy||!1,this.json=n.json||!1,this.listener=n.listener||null,this.implicitTypes=this.schema.compiledImplicit,this.typeMap=this.schema.compiledTypeMap,this.length=e.length,this.position=0,this.line=0,this.lineStart=0,this.lineIndent=0,this.documents=[]}function _n(e,n){return new cn(n,new qr(e.filename,e.input,e.position,e.line,e.position-e.lineStart))}function f(e,n){throw _n(e,n)}function ce(e,n){e.onWarning&&e.onWarning.call(null,_n(e,n))}var Ue={YAML:function(n,i,r){var t,o,a;n.version!==null&&f(n,"duplication of %YAML directive"),r.length!==1&&f(n,"YAML directive accepts exactly one argument"),t=/^([0-9]+)\.([0-9]+)$/.exec(r[0]),t===null&&f(n,"ill-formed argument of the YAML directive"),o=parseInt(t[1],10),a=parseInt(t[2],10),o!==1&&f(n,"unacceptable YAML version of the document"),n.version=r[0],n.checkLineBreaks=a<2,a!==1&&a!==2&&ce(n,"unsupported YAML version of the document")},TAG:function(n,i,r){var t,o;r.length!==2&&f(n,"TAG directive accepts exactly two arguments"),t=r[0],o=r[1],pn.test(t)||f(n,"ill-formed tag handle (first argument) of the TAG directive"),L.call(n.tagMap,t)&&f(n,'there is a previously declared suffix for "'+t+'" tag handle'),mn.test(o)||f(n,"ill-formed tag prefix (second argument) of the TAG directive"),n.tagMap[t]=o}};function R(e,n,i,r){var t,o,a,s;if(n<i){if(s=e.input.slice(n,i),r)for(t=0,o=s.length;t<o;t+=1)a=s.charCodeAt(t),a===9||32<=a&&a<=1114111||f(e,"expected valid JSON character");else zr.test(s)&&f(e,"the stream contains non-printable characters");e.result+=s}}function je(e,n,i,r){var t,o,a,s;for(E.isObject(i)||f(e,"cannot merge mappings; the provided source object is unacceptable"),t=Object.keys(i),a=0,s=t.length;a<s;a+=1)o=t[a],L.call(n,o)||(fn(n,o,i[o]),r[o]=!0)}function U(e,n,i,r,t,o,a,s){var l,c;if(Array.isArray(t))for(t=Array.prototype.slice.call(t),l=0,c=t.length;l<c;l+=1)Array.isArray(t[l])&&f(e,"nested arrays are not supported inside keys"),typeof t=="object"&&Ne(t[l])==="[object Object]"&&(t[l]="[object Object]");if(typeof t=="object"&&Ne(t)==="[object Object]"&&(t="[object Object]"),t=String(t),n===null&&(n={}),r==="tag:yaml.org,2002:merge")if(Array.isArray(o))for(l=0,c=o.length;l<c;l+=1)je(e,n,o[l],i);else je(e,n,o,i);else!e.json&&!L.call(i,t)&&L.call(n,t)&&(e.line=a||e.line,e.position=s||e.position,f(e,"duplicated mapping key")),fn(n,t,o),delete i[t];return n}function Se(e){var n;n=e.input.charCodeAt(e.position),n===10?e.position++:n===13?(e.position++,e.input.charCodeAt(e.position)===10&&e.position++):f(e,"a line break is expected"),e.line+=1,e.lineStart=e.position}function w(e,n,i){for(var r=0,t=e.input.charCodeAt(e.position);t!==0;){for(;P(t);)t=e.input.charCodeAt(++e.position);if(n&&t===35)do t=e.input.charCodeAt(++e.position);while(t!==10&&t!==13&&t!==0);if(S(t))for(Se(e),t=e.input.charCodeAt(e.position),r++,e.lineIndent=0;t===32;)e.lineIndent++,t=e.input.charCodeAt(++e.position);else break}return i!==-1&&r!==0&&e.lineIndent<i&&ce(e,"deficient indentation"),r}function he(e){var n=e.position,i;return i=e.input.charCodeAt(n),!!((i===45||i===46)&&i===e.input.charCodeAt(n+1)&&i===e.input.charCodeAt(n+2)&&(n+=3,i=e.input.charCodeAt(n),i===0||C(i)))}function Ee(e,n){n===1?e.result+=" ":n>1&&(e.result+=E.repeat(`
`,n-1))}function to(e,n,i){var r,t,o,a,s,l,c,h,u=e.kind,p=e.result,d;if(d=e.input.charCodeAt(e.position),C(d)||B(d)||d===35||d===38||d===42||d===33||d===124||d===62||d===39||d===34||d===37||d===64||d===96||(d===63||d===45)&&(t=e.input.charCodeAt(e.position+1),C(t)||i&&B(t)))return!1;for(e.kind="scalar",e.result="",o=a=e.position,s=!1;d!==0;){if(d===58){if(t=e.input.charCodeAt(e.position+1),C(t)||i&&B(t))break}else if(d===35){if(r=e.input.charCodeAt(e.position-1),C(r))break}else{if(e.position===e.lineStart&&he(e)||i&&B(d))break;if(S(d))if(l=e.line,c=e.lineStart,h=e.lineIndent,w(e,!1,-1),e.lineIndent>=n){s=!0,d=e.input.charCodeAt(e.position);continue}else{e.position=a,e.line=l,e.lineStart=c,e.lineIndent=h;break}}s&&(R(e,o,a,!1),Ee(e,e.line-l),o=a=e.position,s=!1),P(d)||(a=e.position+1),d=e.input.charCodeAt(++e.position)}return R(e,o,a,!1),e.result?!0:(e.kind=u,e.result=p,!1)}function ro(e,n){var i,r,t;if(i=e.input.charCodeAt(e.position),i!==39)return!1;for(e.kind="scalar",e.result="",e.position++,r=t=e.position;(i=e.input.charCodeAt(e.position))!==0;)if(i===39)if(R(e,r,e.position,!0),i=e.input.charCodeAt(++e.position),i===39)r=e.position,e.position++,t=e.position;else return!0;else S(i)?(R(e,r,t,!0),Ee(e,w(e,!1,n)),r=t=e.position):e.position===e.lineStart&&he(e)?f(e,"unexpected end of the document within a single quoted scalar"):(e.position++,t=e.position);f(e,"unexpected end of the stream within a single quoted scalar")}function oo(e,n){var i,r,t,o,a,s;if(s=e.input.charCodeAt(e.position),s!==34)return!1;for(e.kind="scalar",e.result="",e.position++,i=r=e.position;(s=e.input.charCodeAt(e.position))!==0;){if(s===34)return R(e,i,e.position,!0),e.position++,!0;if(s===92){if(R(e,i,e.position,!0),s=e.input.charCodeAt(++e.position),S(s))w(e,!1,n);else if(s<256&&gn[s])e.result+=yn[s],e.position++;else if((a=Zr(s))>0){for(t=a,o=0;t>0;t--)s=e.input.charCodeAt(++e.position),(a=Jr(s))>=0?o=(o<<4)+a:f(e,"expected hexadecimal character");e.result+=no(o),e.position++}else f(e,"unknown escape sequence");i=r=e.position}else S(s)?(R(e,i,r,!0),Ee(e,w(e,!1,n)),i=r=e.position):e.position===e.lineStart&&he(e)?f(e,"unexpected end of the document within a double quoted scalar"):(e.position++,r=e.position)}f(e,"unexpected end of the stream within a double quoted scalar")}function ao(e,n){var i=!0,r,t=e.tag,o,a=e.anchor,s,l,c,h,u,p={},d,m,y,g;if(g=e.input.charCodeAt(e.position),g===91)l=93,u=!1,o=[];else if(g===123)l=125,u=!0,o={};else return!1;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),g=e.input.charCodeAt(++e.position);g!==0;){if(w(e,!0,n),g=e.input.charCodeAt(e.position),g===l)return e.position++,e.tag=t,e.anchor=a,e.kind=u?"mapping":"sequence",e.result=o,!0;i||f(e,"missed comma between flow collection entries"),m=d=y=null,c=h=!1,g===63&&(s=e.input.charCodeAt(e.position+1),C(s)&&(c=h=!0,e.position++,w(e,!0,n))),r=e.line,W(e,n,se,!1,!0),m=e.tag,d=e.result,w(e,!0,n),g=e.input.charCodeAt(e.position),(h||e.line===r)&&g===58&&(c=!0,g=e.input.charCodeAt(++e.position),w(e,!0,n),W(e,n,se,!1,!0),y=e.result),u?U(e,o,p,m,d,y):c?o.push(U(e,null,p,m,d,y)):o.push(d),w(e,!0,n),g=e.input.charCodeAt(e.position),g===44?(i=!0,g=e.input.charCodeAt(++e.position)):i=!1}f(e,"unexpected end of the stream within a flow collection")}function so(e,n){var i,r,t=ve,o=!1,a=!1,s=n,l=0,c=!1,h,u;if(u=e.input.charCodeAt(e.position),u===124)r=!1;else if(u===62)r=!0;else return!1;for(e.kind="scalar",e.result="";u!==0;)if(u=e.input.charCodeAt(++e.position),u===43||u===45)ve===t?t=u===43?Oe:Vr:f(e,"repeat of a chomping mode identifier");else if((h=eo(u))>=0)h===0?f(e,"bad explicit indentation width of a block scalar; it cannot be less than one"):a?f(e,"repeat of an indentation width identifier"):(s=n+h-1,a=!0);else break;if(P(u)){do u=e.input.charCodeAt(++e.position);while(P(u));if(u===35)do u=e.input.charCodeAt(++e.position);while(!S(u)&&u!==0)}for(;u!==0;){for(Se(e),e.lineIndent=0,u=e.input.charCodeAt(e.position);(!a||e.lineIndent<s)&&u===32;)e.lineIndent++,u=e.input.charCodeAt(++e.position);if(!a&&e.lineIndent>s&&(s=e.lineIndent),S(u)){l++;continue}if(e.lineIndent<s){t===Oe?e.result+=E.repeat(`
`,o?1+l:l):t===ve&&o&&(e.result+=`
`);break}for(r?P(u)?(c=!0,e.result+=E.repeat(`
`,o?1+l:l)):c?(c=!1,e.result+=E.repeat(`
`,l+1)):l===0?o&&(e.result+=" "):e.result+=E.repeat(`
`,l):e.result+=E.repeat(`
`,o?1+l:l),o=!0,a=!0,l=0,i=e.position;!S(u)&&u!==0;)u=e.input.charCodeAt(++e.position);R(e,i,e.position,!1)}return!0}function We(e,n){var i,r=e.tag,t=e.anchor,o=[],a,s=!1,l;for(e.anchor!==null&&(e.anchorMap[e.anchor]=o),l=e.input.charCodeAt(e.position);l!==0&&!(l!==45||(a=e.input.charCodeAt(e.position+1),!C(a)));){if(s=!0,e.position++,w(e,!0,-1)&&e.lineIndent<=n){o.push(null),l=e.input.charCodeAt(e.position);continue}if(i=e.line,W(e,n,hn,!1,!0),o.push(e.result),w(e,!0,-1),l=e.input.charCodeAt(e.position),(e.line===i||e.lineIndent>n)&&l!==0)f(e,"bad indentation of a sequence entry");else if(e.lineIndent<n)break}return s?(e.tag=r,e.anchor=t,e.kind="sequence",e.result=o,!0):!1}function lo(e,n,i){var r,t,o,a,s=e.tag,l=e.anchor,c={},h={},u=null,p=null,d=null,m=!1,y=!1,g;for(e.anchor!==null&&(e.anchorMap[e.anchor]=c),g=e.input.charCodeAt(e.position);g!==0;){if(r=e.input.charCodeAt(e.position+1),o=e.line,a=e.position,(g===63||g===58)&&C(r))g===63?(m&&(U(e,c,h,u,p,null),u=p=d=null),y=!0,m=!0,t=!0):m?(m=!1,t=!0):f(e,"incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"),e.position+=1,g=r;else if(W(e,i,un,!1,!0))if(e.line===o){for(g=e.input.charCodeAt(e.position);P(g);)g=e.input.charCodeAt(++e.position);if(g===58)g=e.input.charCodeAt(++e.position),C(g)||f(e,"a whitespace character is expected after the key-value separator within a block mapping"),m&&(U(e,c,h,u,p,null),u=p=d=null),y=!0,m=!1,t=!1,u=e.tag,p=e.result;else if(y)f(e,"can not read an implicit mapping pair; a colon is missed");else return e.tag=s,e.anchor=l,!0}else if(y)f(e,"can not read a block mapping entry; a multiline key may not be an implicit key");else return e.tag=s,e.anchor=l,!0;else break;if((e.line===o||e.lineIndent>n)&&(W(e,n,le,!0,t)&&(m?p=e.result:d=e.result),m||(U(e,c,h,u,p,d,o,a),u=p=d=null),w(e,!0,-1),g=e.input.charCodeAt(e.position)),e.lineIndent>n&&g!==0)f(e,"bad indentation of a mapping entry");else if(e.lineIndent<n)break}return m&&U(e,c,h,u,p,null),y&&(e.tag=s,e.anchor=l,e.kind="mapping",e.result=c),y}function co(e){var n,i=!1,r=!1,t,o,a;if(a=e.input.charCodeAt(e.position),a!==33)return!1;if(e.tag!==null&&f(e,"duplication of a tag property"),a=e.input.charCodeAt(++e.position),a===60?(i=!0,a=e.input.charCodeAt(++e.position)):a===33?(r=!0,t="!!",a=e.input.charCodeAt(++e.position)):t="!",n=e.position,i){do a=e.input.charCodeAt(++e.position);while(a!==0&&a!==62);e.position<e.length?(o=e.input.slice(n,e.position),a=e.input.charCodeAt(++e.position)):f(e,"unexpected end of the stream within a verbatim tag")}else{for(;a!==0&&!C(a);)a===33&&(r?f(e,"tag suffix cannot contain exclamation marks"):(t=e.input.slice(n-1,e.position+1),pn.test(t)||f(e,"named tag handle cannot contain such characters"),r=!0,n=e.position+1)),a=e.input.charCodeAt(++e.position);o=e.input.slice(n,e.position),Qr.test(o)&&f(e,"tag suffix cannot contain flow indicator characters")}return o&&!mn.test(o)&&f(e,"tag name cannot contain such characters: "+o),i?e.tag=o:L.call(e.tagMap,t)?e.tag=e.tagMap[t]+o:t==="!"?e.tag="!"+o:t==="!!"?e.tag="tag:yaml.org,2002:"+o:f(e,'undeclared tag handle "'+t+'"'),!0}function uo(e){var n,i;if(i=e.input.charCodeAt(e.position),i!==38)return!1;for(e.anchor!==null&&f(e,"duplication of an anchor property"),i=e.input.charCodeAt(++e.position),n=e.position;i!==0&&!C(i)&&!B(i);)i=e.input.charCodeAt(++e.position);return e.position===n&&f(e,"name of an anchor node must contain at least one character"),e.anchor=e.input.slice(n,e.position),!0}function ho(e){var n,i,r;if(r=e.input.charCodeAt(e.position),r!==42)return!1;for(r=e.input.charCodeAt(++e.position),n=e.position;r!==0&&!C(r)&&!B(r);)r=e.input.charCodeAt(++e.position);return e.position===n&&f(e,"name of an alias node must contain at least one character"),i=e.input.slice(n,e.position),L.call(e.anchorMap,i)||f(e,'unidentified alias "'+i+'"'),e.result=e.anchorMap[i],w(e,!0,-1),!0}function W(e,n,i,r,t){var o,a,s,l=1,c=!1,h=!1,u,p,d,m,y;if(e.listener!==null&&e.listener("open",e),e.tag=null,e.anchor=null,e.kind=null,e.result=null,o=a=s=le===i||hn===i,r&&w(e,!0,-1)&&(c=!0,e.lineIndent>n?l=1:e.lineIndent===n?l=0:e.lineIndent<n&&(l=-1)),l===1)for(;co(e)||uo(e);)w(e,!0,-1)?(c=!0,s=o,e.lineIndent>n?l=1:e.lineIndent===n?l=0:e.lineIndent<n&&(l=-1)):s=!1;if(s&&(s=c||t),(l===1||le===i)&&(se===i||un===i?m=n:m=n+1,y=e.position-e.lineStart,l===1?s&&(We(e,y)||lo(e,y,m))||ao(e,m)?h=!0:(a&&so(e,m)||ro(e,m)||oo(e,m)?h=!0:ho(e)?(h=!0,(e.tag!==null||e.anchor!==null)&&f(e,"alias node should not have any properties")):to(e,m,se===i)&&(h=!0,e.tag===null&&(e.tag="?")),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):l===0&&(h=s&&We(e,y))),e.tag!==null&&e.tag!=="!")if(e.tag==="?"){for(e.result!==null&&e.kind!=="scalar"&&f(e,'unacceptable node kind for !<?> tag; it should be "scalar", not "'+e.kind+'"'),u=0,p=e.implicitTypes.length;u<p;u+=1)if(d=e.implicitTypes[u],d.resolve(e.result)){e.result=d.construct(e.result),e.tag=d.tag,e.anchor!==null&&(e.anchorMap[e.anchor]=e.result);break}}else L.call(e.typeMap[e.kind||"fallback"],e.tag)?(d=e.typeMap[e.kind||"fallback"][e.tag],e.result!==null&&d.kind!==e.kind&&f(e,"unacceptable node kind for !<"+e.tag+'> tag; it should be "'+d.kind+'", not "'+e.kind+'"'),d.resolve(e.result)?(e.result=d.construct(e.result),e.anchor!==null&&(e.anchorMap[e.anchor]=e.result)):f(e,"cannot resolve a node with !<"+e.tag+"> explicit tag")):f(e,"unknown tag !<"+e.tag+">");return e.listener!==null&&e.listener("close",e),e.tag!==null||e.anchor!==null||h}function po(e){var n=e.position,i,r,t,o=!1,a;for(e.version=null,e.checkLineBreaks=e.legacy,e.tagMap={},e.anchorMap={};(a=e.input.charCodeAt(e.position))!==0&&(w(e,!0,-1),a=e.input.charCodeAt(e.position),!(e.lineIndent>0||a!==37));){for(o=!0,a=e.input.charCodeAt(++e.position),i=e.position;a!==0&&!C(a);)a=e.input.charCodeAt(++e.position);for(r=e.input.slice(i,e.position),t=[],r.length<1&&f(e,"directive name must not be less than one character in length");a!==0;){for(;P(a);)a=e.input.charCodeAt(++e.position);if(a===35){do a=e.input.charCodeAt(++e.position);while(a!==0&&!S(a));break}if(S(a))break;for(i=e.position;a!==0&&!C(a);)a=e.input.charCodeAt(++e.position);t.push(e.input.slice(i,e.position))}a!==0&&Se(e),L.call(Ue,r)?Ue[r](e,r,t):ce(e,'unknown document directive "'+r+'"')}if(w(e,!0,-1),e.lineIndent===0&&e.input.charCodeAt(e.position)===45&&e.input.charCodeAt(e.position+1)===45&&e.input.charCodeAt(e.position+2)===45?(e.position+=3,w(e,!0,-1)):o&&f(e,"directives end mark is expected"),W(e,e.lineIndent-1,le,!1,!0),w(e,!0,-1),e.checkLineBreaks&&Xr.test(e.input.slice(n,e.position))&&ce(e,"non-ASCII line breaks are interpreted as content"),e.documents.push(e.result),e.position===e.lineStart&&he(e)){e.input.charCodeAt(e.position)===46&&(e.position+=3,w(e,!0,-1));return}if(e.position<e.length-1)f(e,"end of the stream or a document separator is expected");else return}function vn(e,n){e=String(e),n=n||{},e.length!==0&&(e.charCodeAt(e.length-1)!==10&&e.charCodeAt(e.length-1)!==13&&(e+=`
`),e.charCodeAt(0)===65279&&(e=e.slice(1)));var i=new io(e,n),r=e.indexOf("\0");for(r!==-1&&(i.position=r,f(i,"null byte is not allowed in input")),i.input+="\0";i.input.charCodeAt(i.position)===32;)i.lineIndent+=1,i.position+=1;for(;i.position<i.length-1;)po(i);return i.documents}function bn(e,n,i){n!==null&&typeof n=="object"&&typeof i>"u"&&(i=n,n=null);var r=vn(e,i);if(typeof n!="function")return r;for(var t=0,o=r.length;t<o;t+=1)n(r[t])}function wn(e,n){var i=vn(e,n);if(i.length!==0){if(i.length===1)return i[0];throw new cn("expected a single document in the stream, but found more")}}function mo(e,n,i){return typeof n=="object"&&n!==null&&typeof i>"u"&&(i=n,n=null),bn(e,n,E.extend({schema:dn},i))}function fo(e,n){return wn(e,E.extend({schema:dn},n))}X.loadAll=bn;X.load=wn;X.safeLoadAll=mo;X.safeLoad=fo;var Ie={},Z=T,ee=Q,go=ue,yo=J,xn=Object.prototype.toString,kn=Object.prototype.hasOwnProperty,_o=9,z=10,vo=13,bo=32,wo=33,xo=34,Cn=35,ko=37,Co=38,To=39,Ao=42,Tn=44,Mo=45,An=58,So=61,Eo=62,Io=63,Fo=64,Mn=91,Sn=93,Ro=96,En=123,Lo=124,In=125,k={};k[0]="\\0";k[7]="\\a";k[8]="\\b";k[9]="\\t";k[10]="\\n";k[11]="\\v";k[12]="\\f";k[13]="\\r";k[27]="\\e";k[34]='\\"';k[92]="\\\\";k[133]="\\N";k[160]="\\_";k[8232]="\\L";k[8233]="\\P";var Do=["y","Y","yes","Yes","YES","on","On","ON","n","N","no","No","NO","off","Off","OFF"];function Po(e,n){var i,r,t,o,a,s,l;if(n===null)return{};for(i={},r=Object.keys(n),t=0,o=r.length;t<o;t+=1)a=r[t],s=String(n[a]),a.slice(0,2)==="!!"&&(a="tag:yaml.org,2002:"+a.slice(2)),l=e.compiledTypeMap.fallback[a],l&&kn.call(l.styleAliases,s)&&(s=l.styleAliases[s]),i[a]=s;return i}function Ye(e){var n,i,r;if(n=e.toString(16).toUpperCase(),e<=255)i="x",r=2;else if(e<=65535)i="u",r=4;else if(e<=4294967295)i="U",r=8;else throw new ee("code point within a string may not be greater than 0xFFFFFFFF");return"\\"+i+Z.repeat("0",r-n.length)+n}function Ho(e){this.schema=e.schema||go,this.indent=Math.max(1,e.indent||2),this.noArrayIndent=e.noArrayIndent||!1,this.skipInvalid=e.skipInvalid||!1,this.flowLevel=Z.isNothing(e.flowLevel)?-1:e.flowLevel,this.styleMap=Po(this.schema,e.styles||null),this.sortKeys=e.sortKeys||!1,this.lineWidth=e.lineWidth||80,this.noRefs=e.noRefs||!1,this.noCompatMode=e.noCompatMode||!1,this.condenseFlow=e.condenseFlow||!1,this.implicitTypes=this.schema.compiledImplicit,this.explicitTypes=this.schema.compiledExplicit,this.tag=null,this.result="",this.duplicates=[],this.usedDuplicates=null}function $e(e,n){for(var i=Z.repeat(" ",n),r=0,t=-1,o="",a,s=e.length;r<s;)t=e.indexOf(`
`,r),t===-1?(a=e.slice(r),r=s):(a=e.slice(r,t+1),r=t+1),a.length&&a!==`
`&&(o+=i),o+=a;return o}function ke(e,n){return`
`+Z.repeat(" ",e.indent*n)}function Oo(e,n){var i,r,t;for(i=0,r=e.implicitTypes.length;i<r;i+=1)if(t=e.implicitTypes[i],t.resolve(n))return!0;return!1}function Fe(e){return e===bo||e===_o}function Y(e){return 32<=e&&e<=126||161<=e&&e<=55295&&e!==8232&&e!==8233||57344<=e&&e<=65533&&e!==65279||65536<=e&&e<=1114111}function No(e){return Y(e)&&!Fe(e)&&e!==65279&&e!==vo&&e!==z}function Ge(e,n){return Y(e)&&e!==65279&&e!==Tn&&e!==Mn&&e!==Sn&&e!==En&&e!==In&&e!==An&&(e!==Cn||n&&No(n))}function Bo(e){return Y(e)&&e!==65279&&!Fe(e)&&e!==Mo&&e!==Io&&e!==An&&e!==Tn&&e!==Mn&&e!==Sn&&e!==En&&e!==In&&e!==Cn&&e!==Co&&e!==Ao&&e!==wo&&e!==Lo&&e!==So&&e!==Eo&&e!==To&&e!==xo&&e!==ko&&e!==Fo&&e!==Ro}function Fn(e){var n=/^\n* /;return n.test(e)}var Rn=1,Ln=2,Dn=3,Pn=4,oe=5;function Uo(e,n,i,r,t){var o,a,s,l=!1,c=!1,h=r!==-1,u=-1,p=Bo(e.charCodeAt(0))&&!Fe(e.charCodeAt(e.length-1));if(n)for(o=0;o<e.length;o++){if(a=e.charCodeAt(o),!Y(a))return oe;s=o>0?e.charCodeAt(o-1):null,p=p&&Ge(a,s)}else{for(o=0;o<e.length;o++){if(a=e.charCodeAt(o),a===z)l=!0,h&&(c=c||o-u-1>r&&e[u+1]!==" ",u=o);else if(!Y(a))return oe;s=o>0?e.charCodeAt(o-1):null,p=p&&Ge(a,s)}c=c||h&&o-u-1>r&&e[u+1]!==" "}return!l&&!c?p&&!t(e)?Rn:Ln:i>9&&Fn(e)?oe:c?Pn:Dn}function jo(e,n,i,r){e.dump=function(){if(n.length===0)return"''";if(!e.noCompatMode&&Do.indexOf(n)!==-1)return"'"+n+"'";var t=e.indent*Math.max(1,i),o=e.lineWidth===-1?-1:Math.max(Math.min(e.lineWidth,40),e.lineWidth-t),a=r||e.flowLevel>-1&&i>=e.flowLevel;function s(l){return Oo(e,l)}switch(Uo(n,a,e.indent,o,s)){case Rn:return n;case Ln:return"'"+n.replace(/'/g,"''")+"'";case Dn:return"|"+qe(n,e.indent)+Ke($e(n,t));case Pn:return">"+qe(n,e.indent)+Ke($e(Wo(n,o),t));case oe:return'"'+Yo(n)+'"';default:throw new ee("impossible error: invalid scalar style")}}()}function qe(e,n){var i=Fn(e)?String(n):"",r=e[e.length-1]===`
`,t=r&&(e[e.length-2]===`
`||e===`
`),o=t?"+":r?"":"-";return i+o+`
`}function Ke(e){return e[e.length-1]===`
`?e.slice(0,-1):e}function Wo(e,n){for(var i=/(\n+)([^\n]*)/g,r=function(){var c=e.indexOf(`
`);return c=c!==-1?c:e.length,i.lastIndex=c,Ve(e.slice(0,c),n)}(),t=e[0]===`
`||e[0]===" ",o,a;a=i.exec(e);){var s=a[1],l=a[2];o=l[0]===" ",r+=s+(!t&&!o&&l!==""?`
`:"")+Ve(l,n),t=o}return r}function Ve(e,n){if(e===""||e[0]===" ")return e;for(var i=/ [^ ]/g,r,t=0,o,a=0,s=0,l="";r=i.exec(e);)s=r.index,s-t>n&&(o=a>t?a:s,l+=`
`+e.slice(t,o),t=o+1),a=s;return l+=`
`,e.length-t>n&&a>t?l+=e.slice(t,a)+`
`+e.slice(a+1):l+=e.slice(t),l.slice(1)}function Yo(e){for(var n="",i,r,t,o=0;o<e.length;o++){if(i=e.charCodeAt(o),i>=55296&&i<=56319&&(r=e.charCodeAt(o+1),r>=56320&&r<=57343)){n+=Ye((i-55296)*1024+r-56320+65536),o++;continue}t=k[i],n+=!t&&Y(i)?e[o]:t||Ye(i)}return n}function $o(e,n,i){var r="",t=e.tag,o,a;for(o=0,a=i.length;o<a;o+=1)H(e,n,i[o],!1,!1)&&(o!==0&&(r+=","+(e.condenseFlow?"":" ")),r+=e.dump);e.tag=t,e.dump="["+r+"]"}function Go(e,n,i,r){var t="",o=e.tag,a,s;for(a=0,s=i.length;a<s;a+=1)H(e,n+1,i[a],!0,!0)&&((!r||a!==0)&&(t+=ke(e,n)),e.dump&&z===e.dump.charCodeAt(0)?t+="-":t+="- ",t+=e.dump);e.tag=o,e.dump=t||"[]"}function qo(e,n,i){var r="",t=e.tag,o=Object.keys(i),a,s,l,c,h;for(a=0,s=o.length;a<s;a+=1)h="",a!==0&&(h+=", "),e.condenseFlow&&(h+='"'),l=o[a],c=i[l],H(e,n,l,!1,!1)&&(e.dump.length>1024&&(h+="? "),h+=e.dump+(e.condenseFlow?'"':"")+":"+(e.condenseFlow?"":" "),H(e,n,c,!1,!1)&&(h+=e.dump,r+=h));e.tag=t,e.dump="{"+r+"}"}function Ko(e,n,i,r){var t="",o=e.tag,a=Object.keys(i),s,l,c,h,u,p;if(e.sortKeys===!0)a.sort();else if(typeof e.sortKeys=="function")a.sort(e.sortKeys);else if(e.sortKeys)throw new ee("sortKeys must be a boolean or a function");for(s=0,l=a.length;s<l;s+=1)p="",(!r||s!==0)&&(p+=ke(e,n)),c=a[s],h=i[c],H(e,n+1,c,!0,!0,!0)&&(u=e.tag!==null&&e.tag!=="?"||e.dump&&e.dump.length>1024,u&&(e.dump&&z===e.dump.charCodeAt(0)?p+="?":p+="? "),p+=e.dump,u&&(p+=ke(e,n)),H(e,n+1,h,!0,u)&&(e.dump&&z===e.dump.charCodeAt(0)?p+=":":p+=": ",p+=e.dump,t+=p));e.tag=o,e.dump=t||"{}"}function ze(e,n,i){var r,t,o,a,s,l;for(t=i?e.explicitTypes:e.implicitTypes,o=0,a=t.length;o<a;o+=1)if(s=t[o],(s.instanceOf||s.predicate)&&(!s.instanceOf||typeof n=="object"&&n instanceof s.instanceOf)&&(!s.predicate||s.predicate(n))){if(e.tag=i?s.tag:"?",s.represent){if(l=e.styleMap[s.tag]||s.defaultStyle,xn.call(s.represent)==="[object Function]")r=s.represent(n,l);else if(kn.call(s.represent,l))r=s.represent[l](n,l);else throw new ee("!<"+s.tag+'> tag resolver accepts not "'+l+'" style');e.dump=r}return!0}return!1}function H(e,n,i,r,t,o){e.tag=null,e.dump=i,ze(e,i,!1)||ze(e,i,!0);var a=xn.call(e.dump);r&&(r=e.flowLevel<0||e.flowLevel>n);var s=a==="[object Object]"||a==="[object Array]",l,c;if(s&&(l=e.duplicates.indexOf(i),c=l!==-1),(e.tag!==null&&e.tag!=="?"||c||e.indent!==2&&n>0)&&(t=!1),c&&e.usedDuplicates[l])e.dump="*ref_"+l;else{if(s&&c&&!e.usedDuplicates[l]&&(e.usedDuplicates[l]=!0),a==="[object Object]")r&&Object.keys(e.dump).length!==0?(Ko(e,n,e.dump,t),c&&(e.dump="&ref_"+l+e.dump)):(qo(e,n,e.dump),c&&(e.dump="&ref_"+l+" "+e.dump));else if(a==="[object Array]"){var h=e.noArrayIndent&&n>0?n-1:n;r&&e.dump.length!==0?(Go(e,h,e.dump,t),c&&(e.dump="&ref_"+l+e.dump)):($o(e,h,e.dump),c&&(e.dump="&ref_"+l+" "+e.dump))}else if(a==="[object String]")e.tag!=="?"&&jo(e,e.dump,n,o);else{if(e.skipInvalid)return!1;throw new ee("unacceptable kind of an object to dump "+a)}e.tag!==null&&e.tag!=="?"&&(e.dump="!<"+e.tag+"> "+e.dump)}return!0}function Vo(e,n){var i=[],r=[],t,o;for(Ce(e,i,r),t=0,o=r.length;t<o;t+=1)n.duplicates.push(i[r[t]]);n.usedDuplicates=new Array(o)}function Ce(e,n,i){var r,t,o;if(e!==null&&typeof e=="object")if(t=n.indexOf(e),t!==-1)i.indexOf(t)===-1&&i.push(t);else if(n.push(e),Array.isArray(e))for(t=0,o=e.length;t<o;t+=1)Ce(e[t],n,i);else for(r=Object.keys(e),t=0,o=r.length;t<o;t+=1)Ce(e[r[t]],n,i)}function Hn(e,n){n=n||{};var i=new Ho(n);return i.noRefs||Vo(e,i),H(i,0,e,!0,!0)?i.dump+`
`:""}function zo(e,n){return Hn(e,Z.extend({schema:yo},n))}Ie.dump=Hn;Ie.safeDump=zo;var pe=X,On=Ie;function me(e){return function(){throw new Error("Function "+e+" is deprecated and cannot be used.")}}b.Type=x;b.Schema=$;b.FAILSAFE_SCHEMA=Ae;b.JSON_SCHEMA=rn;b.CORE_SCHEMA=on;b.DEFAULT_SAFE_SCHEMA=J;b.DEFAULT_FULL_SCHEMA=ue;b.load=pe.load;b.loadAll=pe.loadAll;b.safeLoad=pe.safeLoad;b.safeLoadAll=pe.safeLoadAll;b.dump=On.dump;b.safeDump=On.safeDump;b.YAMLException=Q;b.MINIMAL_SCHEMA=Ae;b.SAFE_SCHEMA=J;b.DEFAULT_SCHEMA=ue;b.scan=me("scan");b.parse=me("parse");b.compose=me("compose");b.addConstructor=me("addConstructor");var Xo=b,Qo=Xo;function Jo(e){if(!e.startsWith(`---
`))return{data:{},content:e};const n=e.indexOf(`
---`,4);if(n===-1)return{data:{},content:e};const i=e.slice(4,n),r=e.slice(n+4),t=r.startsWith(`
`)?r.slice(1):r;return{data:Qo.safeLoad(i)??{},content:t}}const Nn={npc:{specialNameChance:.3},missions:{boardMaxCount:8,missionTtlMs:9e5,deliveryChance:.6,deliveryBaseReward:200,deliveryRandomReward:200,supplyRewardMultiplierMin:1.15,supplyRewardMultiplierMax:1.5,supplyRequirementsMin:1,supplyRequirementsMax:2,supplyQtyMin:3,supplyQtyMax:10,deliveryDepositFraction:.2},trading:{stockCountMin:4,stockCountMax:6,stockQtyMin:5,stockQtyMax:10,stockTtlMs:12e4,stockRepCountBonusPerLevel:1,stockRepCountBonusMin:-2,stockRepCountBonusMax:3,stockRepQtyBonusPerLevel:2,stockRepQtyBonusMin:-4,stockRepQtyBonusMax:6},fuel:{pricePerLitre:10,consumptionPerLy:5,inSystemBaseConsumptionL:4},reputation:{levelUnfriendlyMin:-300,levelNeutralMin:-100,levelFriendlyMin:100,levelLikedMin:300,levelReveredMin:600,pointsMin:-600,pointsMax:1e3,missionDeltaSmall:25,missionDeltaMedium:75,missionDeltaLarge:200,missionTierMediumReward:300,missionTierLargeReward:600,tradeModifierHated:1.2,tradeModifierUnfriendly:1.1,tradeModifierNeutral:1,tradeModifierFriendly:.92,tradeModifierLiked:.85,tradeModifierRevered:.8,repPerCredit:.01,maxRepPerVisit:10},emergencyRescue:{towFee:500,fuelDropFee:800,fuelDropLitres:15},economies:{minFactor:.75,maxFactor:1.25},miniGames:{maxHullDamageFraction:.05,abandonDamageFraction:.05,noDamageThreshold:90,surface:{gravityAccel:3,airResistance:.5,thrustForce:8,maxSafeSpeed:3,crashSpeed:10,offPadScoreMultiplier:.5,padWidth:6,maxVerticalSpeed:15}}};function Zo(e){const n={settings:{player:{name:"Captain",startingCredits:0},startingLocation:{system:"",destination:""},startingShip:""},balance:{...Nn},systems:[],destinations:[],routes:[],drives:[],ships:[],factions:[],commodities:[],economies:[],storyBeats:[],deliveryItems:[],npcNames:{special:[],firstNames:[],lastNames:[]}};for(const[i,r]of Object.entries(e)){const t=i.split("/").pop()??"";if(t==="_template.md"||t===".gitkeep")continue;const{data:o,content:a}=Jo(r);/^systems\/[^/]+\.md$/.test(i)?n.systems.push(ea(o,a)):/^destinations\/[^/]+\.md$/.test(i)?n.destinations.push(na(o,a)):/^factions\/[^/]+\.md$/.test(i)?n.factions.push(ia(o,a)):/^ships\/[^/]+\.md$/.test(i)?n.ships.push(ta(o,a)):i==="ships/components/jump-drives.md"?n.drives=ra(o):i==="navigation/jump-routes.md"?n.routes=oa(o):i==="commodities.md"?n.commodities=aa(o):i==="economies.md"?n.economies=ua(o):/^story\/[^/]+\.md$/.test(i)?n.storyBeats.push(sa(o,a)):i==="settings/new-game.md"?n.settings=la(o):i==="settings/balance.md"?n.balance=pa(o):i==="delivery-items.md"?n.deliveryItems=ca(o):i==="npc-names.md"&&(n.npcNames=da(o))}return n}function fe(e){const n=[];let i=!1;for(const r of e.split(`
`)){const t=r.trim();if(!t.startsWith("#"))if(t===""){if(i)break}else i=!0,n.push(t)}return n.join(" ")}function ea(e,n){return{id:e.id,name:e.name,starType:e.star_type,distanceFromSol:e.distance_from_sol,zone:e.zone,security:e.security,population:e.population,dangerLevel:e.danger_level,playerKnowledge:e.player_knowledge,economies:e.economies??[],majorFactions:e.major_factions??[],destinations:e.destinations??[],tags:e.tags??[],description:fe(n)}}function na(e,n){const i=e.amenities??{},r={trader:i.trader??!1,shipRepair:i.ship_repair??!1,fuel:i.fuel??!1,shipDealer:i.ship_dealer??!1};return{id:e.id,name:e.name,system:e.system,locationType:e.location_type,type:e.type,amenities:r,npcs:e.npcs??{},minMissions:e.min_missions??0,missionChance:e.mission_chance??0,dangerLevel:e.danger_level,tags:e.tags??[],description:fe(n),owningFactionId:e.owning_faction,difficultyMultiplier:e.difficulty_multiplier!==void 0?parseFloat(e.difficulty_multiplier):void 0}}function ia(e,n){return{id:e.id,name:e.name,type:e.type,homeSystem:e.home_system,size:e.size,influence:e.influence??[],tags:e.tags??[],description:fe(n),rivals:e.rivals??[],allies:e.allies??[]}}function ta(e,n){return{id:e.id,name:e.name,class:e.class,cost:e.cost,cargoCapacityKg:e.cargo_capacity_kg,fuelCapacityL:e.fuel_capacity_l,hullPoints:e.hull_points,defaultJumpDrive:e.default_jump_drive,fuelEfficiency:e.fuel_efficiency,tags:e.tags??[],description:fe(n)}}function ra(e){return(e.drives??[]).map(i=>({id:i.id,name:i.name,maxDistanceLy:i.max_distance_ly,fuelEfficiency:i.fuel_efficiency,cost:i.cost}))}function oa(e){return(e.routes??[]).map(i=>({from:i.from,to:i.to,distance:i.distance,stability:i.stability,security:i.security}))}function aa(e){return(e.commodities??[]).map(i=>({id:i.id,name:i.name,basePrice:i.base_price,category:i.category,legal:i.legal,weightKg:i.weight_kg,description:i.description??""}))}function sa(e,n){return{id:e.id,title:e.title,trigger:e.trigger,type:e.type,location:e.location,skippable:e.skippable,playerKnowledge:e.player_knowledge,text:n.trim()}}function la(e){var n,i,r,t;return{player:{name:((n=e.player)==null?void 0:n.name)??"Captain",startingCredits:((i=e.player)==null?void 0:i.starting_credits)??0},startingLocation:{system:((r=e.starting_location)==null?void 0:r.system)??"",destination:((t=e.starting_location)==null?void 0:t.destination)??""},startingShip:e.starting_ship??""}}function ca(e){return(e.delivery_items??[]).map(i=>({id:i.id,name:i.name,weightKg:i.weight_kg}))}function da(e){const n=e.npc_names??{};return{special:n.special??[],firstNames:n.first_names??[],lastNames:n.last_names??[]}}function ua(e){return(e.economies??[]).map(i=>({id:i.id,summary:i.summary,commodities:(i.commodities??[]).map(r=>({id:r.id,factor:r.factor}))}))}function ha(e,n){return{gravityAccel:e.gravity_accel??n.gravityAccel,airResistance:e.air_resistance??n.airResistance,thrustForce:e.thrust_force??n.thrustForce,maxSafeSpeed:e.max_safe_speed??n.maxSafeSpeed,crashSpeed:e.crash_speed??n.crashSpeed,offPadScoreMultiplier:e.off_pad_score_multiplier??n.offPadScoreMultiplier,padWidth:e.pad_width??n.padWidth,maxVerticalSpeed:e.max_vertical_speed??n.maxVerticalSpeed}}function pa(e){const n=Nn,i=e.npc??{},r=e.missions??{},t=e.trading??{},o=e.fuel??{},a=e.reputation??{},s=e.emergency_rescue??{},l=e.economies??{},c=e.mini_games??{};return{npc:{specialNameChance:i.special_name_chance??n.npc.specialNameChance},missions:{boardMaxCount:r.board_max_count??n.missions.boardMaxCount,missionTtlMs:r.mission_ttl_ms??n.missions.missionTtlMs,deliveryChance:r.delivery_chance??n.missions.deliveryChance,deliveryBaseReward:r.delivery_base_reward??n.missions.deliveryBaseReward,deliveryRandomReward:r.delivery_random_reward??n.missions.deliveryRandomReward,supplyRewardMultiplierMin:r.supply_reward_multiplier_min??n.missions.supplyRewardMultiplierMin,supplyRewardMultiplierMax:r.supply_reward_multiplier_max??n.missions.supplyRewardMultiplierMax,supplyRequirementsMin:r.supply_requirements_min??n.missions.supplyRequirementsMin,supplyRequirementsMax:r.supply_requirements_max??n.missions.supplyRequirementsMax,supplyQtyMin:r.supply_qty_min??n.missions.supplyQtyMin,supplyQtyMax:r.supply_qty_max??n.missions.supplyQtyMax,deliveryDepositFraction:r.delivery_deposit_fraction??n.missions.deliveryDepositFraction},trading:{stockCountMin:t.stock_count_min??n.trading.stockCountMin,stockCountMax:t.stock_count_max??n.trading.stockCountMax,stockQtyMin:t.stock_qty_min??n.trading.stockQtyMin,stockQtyMax:t.stock_qty_max??n.trading.stockQtyMax,stockTtlMs:t.stock_ttl_ms??n.trading.stockTtlMs,stockRepCountBonusPerLevel:t.stock_rep_count_bonus_per_level??n.trading.stockRepCountBonusPerLevel,stockRepCountBonusMin:t.stock_rep_count_bonus_min??n.trading.stockRepCountBonusMin,stockRepCountBonusMax:t.stock_rep_count_bonus_max??n.trading.stockRepCountBonusMax,stockRepQtyBonusPerLevel:t.stock_rep_qty_bonus_per_level??n.trading.stockRepQtyBonusPerLevel,stockRepQtyBonusMin:t.stock_rep_qty_bonus_min??n.trading.stockRepQtyBonusMin,stockRepQtyBonusMax:t.stock_rep_qty_bonus_max??n.trading.stockRepQtyBonusMax},fuel:{pricePerLitre:o.price_per_litre??n.fuel.pricePerLitre,consumptionPerLy:o.consumption_per_ly??n.fuel.consumptionPerLy,inSystemBaseConsumptionL:o.in_system_base_consumption_l??n.fuel.inSystemBaseConsumptionL},reputation:{levelUnfriendlyMin:a.level_unfriendly_min??n.reputation.levelUnfriendlyMin,levelNeutralMin:a.level_neutral_min??n.reputation.levelNeutralMin,levelFriendlyMin:a.level_friendly_min??n.reputation.levelFriendlyMin,levelLikedMin:a.level_liked_min??n.reputation.levelLikedMin,levelReveredMin:a.level_revered_min??n.reputation.levelReveredMin,pointsMin:a.points_min??n.reputation.pointsMin,pointsMax:a.points_max??n.reputation.pointsMax,missionDeltaSmall:a.mission_delta_small??n.reputation.missionDeltaSmall,missionDeltaMedium:a.mission_delta_medium??n.reputation.missionDeltaMedium,missionDeltaLarge:a.mission_delta_large??n.reputation.missionDeltaLarge,missionTierMediumReward:a.mission_tier_medium_reward??n.reputation.missionTierMediumReward,missionTierLargeReward:a.mission_tier_large_reward??n.reputation.missionTierLargeReward,tradeModifierHated:a.trade_modifier_hated??n.reputation.tradeModifierHated,tradeModifierUnfriendly:a.trade_modifier_unfriendly??n.reputation.tradeModifierUnfriendly,tradeModifierNeutral:a.trade_modifier_neutral??n.reputation.tradeModifierNeutral,tradeModifierFriendly:a.trade_modifier_friendly??n.reputation.tradeModifierFriendly,tradeModifierLiked:a.trade_modifier_liked??n.reputation.tradeModifierLiked,tradeModifierRevered:a.trade_modifier_revered??n.reputation.tradeModifierRevered,repPerCredit:a.rep_per_credit??n.reputation.repPerCredit,maxRepPerVisit:a.max_rep_per_visit??n.reputation.maxRepPerVisit},emergencyRescue:{towFee:s.tow_fee??n.emergencyRescue.towFee,fuelDropFee:s.fuel_drop_fee??n.emergencyRescue.fuelDropFee,fuelDropLitres:s.fuel_drop_litres??n.emergencyRescue.fuelDropLitres},economies:{minFactor:l.min_factor??n.economies.minFactor,maxFactor:l.max_factor??n.economies.maxFactor},miniGames:{maxHullDamageFraction:c.max_hull_damage_fraction??n.miniGames.maxHullDamageFraction,abandonDamageFraction:c.abandon_damage_fraction??n.miniGames.abandonDamageFraction,noDamageThreshold:c.no_damage_threshold??n.miniGames.noDamageThreshold,surface:ha(c.surface??{},n.miniGames.surface)}}}function ma(){const e=Object.assign({"/docs/world/commodities.md":ni,"/docs/world/delivery-items.md":ii,"/docs/world/destinations/_template.md":ti,"/docs/world/destinations/blackwake-yard.md":ri,"/docs/world/destinations/ceti-landfall.md":oi,"/docs/world/destinations/drift-market.md":ai,"/docs/world/destinations/elysium-station.md":si,"/docs/world/destinations/eridani-anchorage.md":li,"/docs/world/destinations/foundries-platform.md":ci,"/docs/world/destinations/galileo-transfer.md":di,"/docs/world/destinations/hestia-ring.md":ui,"/docs/world/destinations/keelhaul-station.md":hi,"/docs/world/destinations/kepler-yard.md":pi,"/docs/world/destinations/mars-anchor.md":mi,"/docs/world/destinations/meridian-station.md":fi,"/docs/world/destinations/new-horizon-port.md":gi,"/docs/world/destinations/orrery-anchorage.md":yi,"/docs/world/destinations/redline-station.md":_i,"/docs/world/destinations/tycho-orbital.md":vi,"/docs/world/destinations/veil-station.md":bi,"/docs/world/destinations/waypoint-ceti.md":wi,"/docs/world/economies.md":xi,"/docs/world/factions/_template.md":ki,"/docs/world/factions/centauri-trade-league.md":Ci,"/docs/world/factions/eridani-colonial-council.md":Ti,"/docs/world/factions/free-captains.md":Ai,"/docs/world/factions/grey-market-cartel.md":Mi,"/docs/world/factions/helios-directorate.md":Si,"/docs/world/factions/independent-miners-guild.md":Ei,"/docs/world/factions/procyon-institute.md":Ii,"/docs/world/factions/terran-union.md":Fi,"/docs/world/galaxy-map.md":Ri,"/docs/world/navigation/jump-routes.md":Li,"/docs/world/npc-names.md":Di,"/docs/world/settings/balance.md":Pi,"/docs/world/settings/new-game.md":Hi,"/docs/world/ships/_template.md":Oi,"/docs/world/ships/components/jump-drives.md":Ni,"/docs/world/ships/freighter.md":Bi,"/docs/world/ships/hauler.md":Ui,"/docs/world/ships/scout.md":ji,"/docs/world/story/_template.md":Wi,"/docs/world/story/enter-wolf-359.md":Yi,"/docs/world/story/first-jump.md":$i,"/docs/world/story/opening-arrival.md":Gi,"/docs/world/systems/_template.md":qi,"/docs/world/systems/alpha-centauri.md":Ki,"/docs/world/systems/barnards-star.md":Vi,"/docs/world/systems/epsilon-eridani.md":zi,"/docs/world/systems/procyon.md":Xi,"/docs/world/systems/sirius.md":Qi,"/docs/world/systems/sol.md":Ji,"/docs/world/systems/tau-ceti.md":Zi,"/docs/world/systems/wolf-359.md":et}),n={};for(const[i,r]of Object.entries(e)){const t=i.replace("/docs/world/","");n[t]=r}return Zo(n)}function fa(e){return e.size==="medium"||e.size==="large"}function ga(e,n){return e.type==="delivery"?e.pickupComplete?n.destinationId===e.deliveryDestinationId?"ready-to-deliver":"in-transit":"pending-pickup":e.requirements.every(r=>{const t=n.cargoHold.find(o=>o.commodityId===r.commodityId);return t!==void 0&&t.qty>=r.qty})?"ready-to-deliver":"needs-supplies"}class Re{constructor(n){const i=_e(n.shipId);if(!i)throw new Error(`Unknown ship: ${n.shipId}`);this.shipId=n.shipId,this.driveId=n.driveId,this.fuelCapacityL=i.fuelCapacityL,this.cargoCapacity=i.cargoCapacityKg,this._fuelL=i.fuelCapacityL,this._credits=n.credits,this._systemId=n.systemId,this._destinationId=n.destinationId,this._cargoHold=[],this._activeMissions=[],this._missionItems=[],this._hullIntegrity=1,this._factionReputation=new Map;for(const r of I().factions)fa(r)&&this._factionReputation.set(r.id,0);this._destinationMissions=new Map}static createMock(){const n=Qn(),i=_e(n.startingShip);if(!i)throw new Error(`Unknown starting ship: ${n.startingShip}`);return new Re({shipId:n.startingShip,driveId:i.defaultJumpDrive,credits:n.player.startingCredits,systemId:n.startingLocation.system,destinationId:n.startingLocation.destination})}get fuelL(){return this._fuelL}addFuel(n){this._fuelL=Math.min(this.fuelCapacityL,this._fuelL+n)}consumeFuel(n){this._fuelL=Math.max(0,this._fuelL-n)}getInSystemHopCost(){const n=_e(this.shipId),i=I().balance;return Math.ceil(i.fuel.inSystemBaseConsumptionL*n.fuelEfficiency)}get credits(){return this._credits}addCredits(n){this._credits+=n}spendCredits(n){this._credits-=n}get cargoHold(){return this._cargoHold}addCargo(n,i){const r=this._cargoHold.find(t=>t.commodityId===n);r?r.qty+=i:this._cargoHold.push({commodityId:n,qty:i})}removeCargo(n,i){const r=this._cargoHold.findIndex(t=>t.commodityId===n);r<0||(i!==void 0&&i<this._cargoHold[r].qty?this._cargoHold[r].qty-=i:this._cargoHold.splice(r,1))}get missionItemsWeightKg(){return this._missionItems.reduce((n,i)=>n+i.weightKg,0)}get cargoWeightKg(){return ei(this._cargoHold)+this.missionItemsWeightKg}get systemId(){return this._systemId}get destinationId(){return this._destinationId}dock(n){this._destinationId=n}undock(){this._destinationId=null}jumpTo(n){this._systemId=n,this._destinationId=null}get activeMissions(){return this._activeMissions}get missionItems(){return this._missionItems}acceptMission(n,i){const r={...n,acceptedAt:Date.now(),pickupComplete:!1};this._activeMissions.push(r),n.type==="delivery"&&(this._credits-=n.deposit,i&&(this._missionItems.push({missionId:n.id,itemName:n.itemName,weightKg:n.itemWeightKg}),r.pickupComplete=!0))}collectMissionItem(n){const i=this._activeMissions.find(r=>r.id===n);!i||i.type!=="delivery"||(i.pickupComplete=!0,this._missionItems.push({missionId:i.id,itemName:i.itemName,weightKg:i.itemWeightKg}))}completeMission(n){this._activeMissions=this._activeMissions.filter(i=>i.id!==n),this._missionItems=this._missionItems.filter(i=>i.missionId!==n)}cancelMission(n){this._activeMissions=this._activeMissions.filter(i=>i.id!==n),this._missionItems=this._missionItems.filter(i=>i.missionId!==n)}getMissionsForPickup(n){return this._activeMissions.filter(i=>i.type==="delivery"&&i.pickupDestinationId===n&&!i.pickupComplete)}getMissionsForDelivery(n){return this._activeMissions.filter(i=>i.deliveryDestinationId===n&&ga(i,this)==="ready-to-deliver")}get hullIntegrity(){return this._hullIntegrity}applyHullDamage(n){this._hullIntegrity=Math.max(0,this._hullIntegrity-n)}getFactionReputation(n){return this._factionReputation.get(n)??0}modifyFactionReputation(n,i,r){const t=this.getFactionReputation(n),o=Math.min(r.reputation.pointsMax,Math.max(r.reputation.pointsMin,t+i));this._factionReputation.set(n,o)}getDestinationMissions(n){const i=this._destinationMissions.get(n);return i?Date.now()-i.generatedAt>I().balance.missions.missionTtlMs?[]:i.specs:[]}refreshDestinationMissions(n,i){this._destinationMissions.set(n,{specs:i,generatedAt:Date.now()})}}function v(e,n,i,r,t,o){if(n<0||n>=e.length)return;const a=e[n];for(let s=0;s<r.length;s++){const l=i+s;l>=0&&l<a.length&&(a[l]={char:r[s],fg:t,bg:o})}}const Xe=3,Qe=0;function ya(e,n){return n?e-2:e}function _a(e){return e.toLocaleString("en-US")}class va{constructor(n,i){this.buttonRanges=null,this.footerRow=-1,this.headerWidth=-1,this.context=n,this.player=i}render(n,i){const r=n.length,t=r>0?n[0].length:0;this.footerRow=-1,this.buttonRanges=null,i.showHeader?(this.headerWidth=t,this.renderHeaderRow0(n,t,i.systemLabel),this.renderHeaderRow1(n,t,i.destinationLabel)):this.headerWidth=-1,i.showFooter&&(this.renderFooter(n,r,t,i.navOptions),this.footerRow=r-1)}renderHeaderRow0(n,i,r){const t=r!==void 0?r??"":(()=>{const c=zn(this.player.systemId);return c?c.name.toUpperCase():this.player.systemId.toUpperCase()})(),o="::";v(n,0,0,o,"bright-black","black"),v(n,0,o.length,t,"bright-cyan","black");const s=i-o.length-t.length-10;let l=o.length+t.length;for(let c=0;c<s;c++)n[0][l+c]={char:":",fg:"bright-black",bg:"black"};l+=s,v(n,0,l,"[M]","white","black"),l+=3,v(n,0,l," MENU","white","black"),l+=5,v(n,0,l,"::","bright-black","black")}renderHeaderRow1(n,i,r){const t=r!==void 0?r??"":(()=>{const h=this.player.destinationId?Xn(this.player.destinationId):null;return h?h.name.toUpperCase():"IN SPACE"})(),o=_a(this.player.credits),a=o.length+5,s="::";v(n,1,0,s,"bright-black","black"),v(n,1,s.length,t,"cyan","black");const l=i-s.length-t.length-a;let c=s.length+t.length;for(let h=0;h<l;h++)n[1][c+h]={char:":",fg:"bright-black",bg:"black"};c+=l,v(n,1,c,o,"green","black"),c+=o.length,v(n,1,c," CR","white","black"),c+=3,v(n,1,c,"::","bright-black","black")}renderFooter(n,i,r,t){const o=i-1,a=[];if(t.length===0){for(let l=0;l<r;l++)n[o][l]={char:":",fg:"bright-black",bg:"black"};this.buttonRanges=[];return}v(n,o,0,"::","bright-black","black");let s=2;for(let l=0;l<t.length;l++){l>0&&(v(n,o,s,"::","bright-black","black"),s+=2);const c=t[l],h=`[${l+1}]`,u=` ${c.label}`,p=s;v(n,o,s,h,"white","black"),s+=h.length,v(n,o,s,u,"white","black"),s+=u.length,a.push({id:c.id,startCol:p,endCol:s})}for(let l=s;l<r;l++)n[o][l]={char:":",fg:"bright-black",bg:"black"};this.buttonRanges=a}hitTestNav(n,i){if(this.footerRow<0||this.buttonRanges===null||i!==this.footerRow)return null;for(const r of this.buttonRanges)if(n>=r.startCol&&n<r.endCol)return r.id;return null}hitTestHeader(n,i){if(this.headerWidth<0||i!==0)return null;const r=this.headerWidth-10,t=this.headerWidth-2;return n>=r&&n<t?"menu":null}}class ba{constructor(n,i,r,t){this.activeTabIdx=0,this.activated=!1,this.player=r,this.chrome=new va(i,r),this.opts=t,n.onCharInput&&n.onCharInput(o=>{this.activated||this.handleCharInput(o)}),n.onAction(o=>{if(!this.activated&&!this.preHandleAction(o)){if(o==="MENU"&&t.onMenu){t.onMenu();return}if(t.tabs){if(o==="LEFT"){const a=Math.max(0,this.activeTabIdx-1);a!==this.activeTabIdx&&(this.activeTabIdx=a,this.onTabChange(a));return}if(o==="RIGHT"){const a=Math.min(t.tabs.length-1,this.activeTabIdx+1);a!==this.activeTabIdx&&(this.activeTabIdx=a,this.onTabChange(a));return}}this.handleAction(o)}}),n.onTap&&n.onTap((o,a)=>{var l;if(this.activated||this.preHandleTap(o,a))return;const s=this.chrome.hitTestNav(o,a);if(s!==null){this.handleNavTap(s);return}if(this.chrome.hitTestHeader(o,a)==="menu"&&t.onMenu){t.onMenu();return}if(t.tabs&&t.title!==void 0){const c=t.showHeader??!0?Xe:Qe,h=((l=t.summary)==null?void 0:l.length)??0,u=c+3+h;if(a===u){let p=3;for(let d=0;d<t.tabs.length;d++){const m=t.tabs[d].length+2;if(o>=p&&o<p+m){d!==this.activeTabIdx&&(this.activeTabIdx=d,this.onTabChange(d));return}p+=m+1}return}}this.handleTap(o,a)})}preHandleAction(n){return!1}preHandleTap(n,i){return!1}handleAction(n){}handleTap(n,i){}handleNavTap(n){}handleCharInput(n){}onTabChange(n){}buildChromeConfig(){return{showHeader:this.opts.showHeader??!0,showFooter:this.opts.showFooter??!0,navOptions:this.opts.navOptions}}suspend(){this.activated=!0}resume(){this.activated=!1}update(n){}render(n){var p;const i=n.length,r=i>0?n[0].length:0,t=this.opts;for(let d=0;d<i;d++)for(let m=0;m<r;m++)n[d][m]={char:" ",fg:"black",bg:"black"};const o=this.buildChromeConfig();this.chrome.render(n,o);const a=t.showHeader??!0,s=t.showFooter??!0,l=a?Xe:Qe,c=((p=t.summary)==null?void 0:p.length)??0,h=ya(i,s);let u;if(t.title!==void 0){v(n,l,2,t.title,"bright-white","black"),v(n,l+1,2,"'".repeat(t.title.length),"bright-black","black");for(let d=0;d<c;d++)v(n,l+2+d,2,t.summary[d],"bright-black","black");if(t.tabs){const d=l+3+c;let m=2;d<i&&(n[d][m]={char:"|",fg:"bright-black",bg:"black"}),m++;for(let y=0;y<t.tabs.length;y++){const g=y===this.activeTabIdx,ne=` ${t.tabs[y]} `,G=g?"black":"white",ie=g?"green":"black";for(const q of ne)d<i&&m<r&&(n[d][m]={char:q,fg:G,bg:ie}),m++;d<i&&m<r&&(n[d][m]={char:"|",fg:"bright-black",bg:"black"}),m++}u=l+5+c}else u=l+3+c}else u=l;this.renderContent(n,u,h)}}class Bn extends ba{constructor(n,i,r,t){super(n,i,r,{navOptions:t.navOptions,title:t.title}),this._completed=!1,this._onComplete=t.onComplete,this._canvasWidth=t.canvasWidth,this._canvasHeight=t.canvasHeight}renderContent(n,i,r){var d;const t=((d=n[0])==null?void 0:d.length)??0,o=n.length,a=r-i,s=this._canvasWidth??t,l=this._canvasHeight??a;let c=Math.floor((t-s)/2),h=i+Math.floor((a-l)/2);const u=Math.max(0,t-s),p=Math.max(0,o-l);c=Math.max(0,Math.min(c,u)),h=Math.max(0,Math.min(h,p)),this.renderGame(n,{top:h,left:c,width:s,height:l})}complete(n){var i;this._completed||(this._completed=!0,(i=this._onComplete)==null||i.call(this,n))}}function wa(e){if(e.length===0)return 2166136261;let n=2166136261;for(let i=0;i<e.length;i++)n^=e.charCodeAt(i),n=Math.imul(n,16777619)>>>0;return n===0?1:n}function xa(e){let n=e>>>0;return()=>(n=Math.imul(n,1664525)+1013904223>>>0,n/4294967296)}class ka extends Bn{constructor(n,i,r,t){const o=r.destinationId??"";super(n,i,r,{navOptions:[],title:"DOCKING",canvasWidth:32,canvasHeight:18,onComplete:t}),this.heldKeys=new Set,this.lastActionTime=0,this.actionTimeoutMs=200,this.canvasWidth=32,this.canvasHeight=18,this.countdownSeconds=15,this.thrustForce=8,this.maxVelocity=6,this.driftIntervalMs=3e3,this.driftMaxDistanceChars=4,this.driftSpeedCharsPerSec=.8,this.perfectRadiusChars=5,this.airlockWidth=5,this.airlockHeight=3,this.lastViewport={top:0,left:0,width:32,height:18},this.rand=xa(wa(o));const a=(this.canvasWidth-1)/2,s=(this.canvasHeight-1)/2;this.state={shipX:a,shipY:s,shipVelX:0,shipVelY:0,airlockX:a,airlockY:s,driftTargetX:a,driftTargetY:s,driftTimer:this.driftIntervalMs*(.8+.4*this.rand()),timeRemaining:this.countdownSeconds,completed:!1}}renderContent(n,i,r){var d;const t=((d=n[0])==null?void 0:d.length)??0,o=n.length,a=r-i,s=this.canvasWidth,l=this.canvasHeight+3;let c=Math.floor((t-s)/2),h=i+Math.floor((a-l)/2);const u=Math.max(0,t-this.canvasWidth),p=Math.max(0,o-this.canvasHeight);c=Math.max(0,Math.min(c,u)),h=Math.max(0,Math.min(h,p)),this.renderGame(n,{top:h,left:c,width:this.canvasWidth,height:this.canvasHeight})}handleAction(n){if(super.handleAction(n),n==="MENU"){this.state.completed||(this.state.completed=!0,this.complete({outcome:"skipped"}));return}(n==="UP"||n==="DOWN"||n==="LEFT"||n==="RIGHT")&&(this.heldKeys.add(n),this.lastActionTime=performance.now())}handleTap(n,i){if(this.state.completed){super.handleTap(n,i);return}const{top:r,left:t,width:o,height:a}=this.lastViewport,s=t+Math.floor(o/2),l=r+a,c=l+1,h=l+3,u=s-5,p=s+3,d=s;i===c&&n>=d-1&&n<=d+1?this.handleAction("UP"):i===h&&n>=d-1&&n<=d+1?this.handleAction("DOWN"):n>=u&&n<=u+2&&i===c+1?this.handleAction("LEFT"):n>=p&&n<=p+2&&i===c+1?this.handleAction("RIGHT"):super.handleTap(n,i)}update(n){super.update(n);const i=n/1e3;if(!this.state.completed&&(this.clearExpiredActions(),this.updateMovement(i),this.updateAirlockDrift(i),this.updateCountdown(i),this.state.timeRemaining<=0)){const r=Math.hypot(this.state.shipX-this.state.airlockX,this.state.shipY-this.state.airlockY),t=1.5,o=r<=t?100:Math.round(Math.max(0,Math.min(1,1/(1+(r-t)/this.perfectRadiusChars)))*100);this.state.completed=!0,this.complete({outcome:"completed",result:{score:o}})}}updateMovement(n){const i=this.state;this.heldKeys.has("UP")&&(i.shipVelY-=this.thrustForce*n),this.heldKeys.has("DOWN")&&(i.shipVelY+=this.thrustForce*n),this.heldKeys.has("LEFT")&&(i.shipVelX-=this.thrustForce*n),this.heldKeys.has("RIGHT")&&(i.shipVelX+=this.thrustForce*n),i.shipVelX=Math.max(-this.maxVelocity,Math.min(this.maxVelocity,i.shipVelX)),i.shipVelY=Math.max(-this.maxVelocity,Math.min(this.maxVelocity,i.shipVelY)),i.shipX+=i.shipVelX*n,i.shipY+=i.shipVelY*n;const r=.5;i.shipX=Math.max(r,Math.min(this.canvasWidth-1-r,i.shipX)),i.shipY=Math.max(r,Math.min(this.canvasHeight-1-r,i.shipY))}updateAirlockDrift(n){const i=this.state,r=i.driftTargetX-i.airlockX,t=i.driftTargetY-i.airlockY,o=Math.hypot(r,t);if(o<.1){const a=this.rand()*2*Math.PI,s=this.rand()*this.driftMaxDistanceChars,l=(this.canvasWidth-1)/2,c=(this.canvasHeight-1)/2;i.driftTargetX=l+Math.cos(a)*s,i.driftTargetY=c+Math.sin(a)*s,i.driftTimer=this.driftIntervalMs*(.8+.4*this.rand())}else{const a=this.driftSpeedCharsPerSec*n,s=Math.min(1,a/o);i.airlockX+=r*s,i.airlockY+=t*s}}updateCountdown(n){this.state.timeRemaining=Math.max(0,this.state.timeRemaining-n)}clearExpiredActions(){performance.now()-this.lastActionTime>this.actionTimeoutMs&&this.heldKeys.clear()}renderGame(n,i){const{top:r,left:t,width:o,height:a}=i;this.lastViewport={top:r,left:t,width:o,height:a},this.drawBorder(n,r,t,o,a),this.drawAirlock(n,r,t),this.drawShip(n,r,t),this.drawCountdown(n,r,t,o),this.drawDistance(n,r,t,a),this.drawControlButtons(n,r,t,o,a)}drawBorder(n,i,r,t,o){const a=r+t-1,s=i+o-1;for(let l=r;l<=a;l++)i<n.length&&l<n[i].length&&(n[i][l]={char:"+",fg:"white",bg:"black"}),s<n.length&&l<n[s].length&&(n[s][l]={char:"+",fg:"white",bg:"black"});for(let l=i+1;l<s;l++)l<n.length&&(r<n[l].length&&(n[l][r]={char:"|",fg:"white",bg:"black"}),a<n[l].length&&(n[l][a]={char:"|",fg:"white",bg:"black"}))}drawAirlock(n,i,r){const t=r+1+Math.round(this.state.airlockX),o=i+1+Math.round(this.state.airlockY),a=t-Math.floor(this.airlockWidth/2),s=o-Math.floor(this.airlockHeight/2),l=[["+","-","+","-","+"],["|"," ","+"," ","|"],["+","-","+","-","+"]];for(let c=0;c<this.airlockHeight;c++)for(let h=0;h<this.airlockWidth;h++){const u=s+c,p=a+h;if(u>=i&&u<i+this.canvasHeight&&p>=r&&p<r+this.canvasWidth&&u<n.length&&p<n[u].length){const d=l[c][h];n[u][p]={char:d,fg:"bright-yellow",bg:"black"}}}}drawShip(n,i,r){const t=r+1+Math.round(this.state.shipX),o=i+1+Math.round(this.state.shipY);t>=r&&t<r+this.canvasWidth&&o>=i&&o<i+this.canvasHeight&&(o<n.length&&t<n[o].length&&(n[o][t]={char:"(",fg:"bright-green",bg:"black"}),t+1<r+this.canvasWidth&&o<n.length&&t+1<n[o].length&&(n[o][t+1]={char:"+",fg:"bright-green",bg:"black"}),t+2<r+this.canvasWidth&&o<n.length&&t+2<n[o].length&&(n[o][t+2]={char:")",fg:"bright-green",bg:"black"}))}drawCountdown(n,i,r,t){const o=`T: ${Math.ceil(this.state.timeRemaining)}`,a=r+t-1-o.length,s=i+1;v(n,s,a,o,"white","black")}drawDistance(n,i,r,t){const a=`DIST: ${Math.hypot(this.state.shipX-this.state.airlockX,this.state.shipY-this.state.airlockY).toFixed(1)}`,s=i+t-1;v(n,s,r+2,a,"white","black")}drawControlButtons(n,i,r,t,o){const a=n.length,s=a>0?n[0].length:0,l=i+o,c=r+Math.floor(t/2),h=this.heldKeys.has("UP"),u=this.heldKeys.has("DOWN"),p=this.heldKeys.has("LEFT"),d=this.heldKeys.has("RIGHT"),m="bright-green",y="bright-black",g=A=>`[${A}]`,ne=l+1,G=l+2,ie=l+3,q=c-5,ge=c+3;if(ne<a&&c-1>=0&&c+1<s){const A=g("^"),M=c-1;for(let _=0;_<A.length;_++)M+_>=0&&M+_<s&&(n[ne][M+_]={char:A[_],fg:h?m:y,bg:"black"})}if(G<a){const A=g("<");for(let _=0;_<A.length;_++)q+_>=0&&q+_<s&&(n[G][q+_]={char:A[_],fg:p?m:y,bg:"black"});const M=g(">");for(let _=0;_<M.length;_++)ge+_>=0&&ge+_<s&&(n[G][ge+_]={char:M[_],fg:d?m:y,bg:"black"})}if(ie<a&&c-1>=0&&c+1<s){const A=g("v"),M=c-1;for(let _=0;_<A.length;_++)M+_>=0&&M+_<s&&(n[ie][M+_]={char:A[_],fg:u?m:y,bg:"black"})}}}function Ca(e,n,i,r,t,o){let{x:a,y:s,vx:l,vy:c}=e;l*=i.airResistance**o,c+=i.gravity*o,n.up&&(c-=i.thrustForce*o),n.down&&(c+=i.thrustForce*o),n.left&&(l-=i.thrustForce*o),n.right&&(l+=i.thrustForce*o);const h=i.thrustForce*3;l=Math.max(-h,Math.min(h,l));const u=i.maxVerticalSpeed??1/0;return c=Math.max(-u,Math.min(u,c)),a+=l*o,s+=c*o,a=Math.max(0,Math.min(r-t,a)),{x:a,y:s,vx:l,vy:c}}function Ta(e){if(e.length===0)return 2166136261;let n=2166136261;for(let i=0;i<e.length;i++)n^=e.charCodeAt(i),n=Math.imul(n,16777619)>>>0;return n===0?1:n}function Aa(e){let n=e>>>0;return()=>(n=Math.imul(n,1664525)+1013904223>>>0,n/4294967296)}function Ma(e,n,i,r,t){const o=Aa(Ta(e)),a=3,s=Math.min(5,Math.floor(i/2)),l=a+Math.floor(o()*(s-a+1)),c=i-l,h=[];for(let d=0;d<n;d++){const m=Math.floor(o()*3)-1;h.push(Math.max(c-1,Math.min(c+1,c+m)))}const u=Math.max(0,n-r),p=Math.floor(o()*(u+1));for(let d=p;d<p+r&&d<n;d++)h[d]=c;return h.map((d,m)=>({surfaceRow:d,isPad:m>=p&&m<p+r}))}function Sa(e,n,i){const r=Math.floor(e),t=r+2;for(let o=r;o<=t;o++)if(!(o<0||o>=i.length)&&n>=i[o].surfaceRow)return!0;return!1}function Ea(e,n,i,r,t,o){const a="^";for(let s=0;s<n.length;s++){const l=n[s],c=r+s;if(c<0)continue;let h;if(l.isPad){const d=s>0&&n[s-1].isPad,m=s<n.length-1&&n[s+1].isPad;d?m?h="=":h="]":h="["}else h=a;const u=l.isPad?"bright-yellow":"white",p=i+l.surfaceRow;for(let d=p;d<i+t;d++){if(d<0||d>=e.length||c>=e[d].length)continue;const m=d===p;e[d][c]={char:m?h:"#",fg:u,bg:"black"}}}}const be=3,Je=2,Ia=1/60,F=1;class Fa extends Bn{constructor(n,i,r,t){super(n,i,r,{navOptions:[],title:"LANDING",onComplete:t}),this._ship={x:0,y:0,vx:0,vy:1},this._heldKeys=new Set,this._lastActionTime=0,this._actionTimeoutMs=200,this._terrain=null,this._viewport=null,this._landed=!1,this._joystick=null,this._destId=r.destinationId??"",this._primaryInput=i.primaryInput;const{surface:o}=Jn().miniGames;this._gravityAccel=o.gravityAccel,this._airResistance=o.airResistance,this._thrustForce=o.thrustForce,this._maxSafeSpeed=o.maxSafeSpeed,this._crashSpeed=o.crashSpeed,this._offPadScoreMultiplier=o.offPadScoreMultiplier,this._padWidth=o.padWidth,this._maxVerticalSpeed=o.maxVerticalSpeed,n.onTouchTrack&&n.onTouchTrack({start:(a,s,l)=>{this._viewport&&(s<this._viewport.top||s>=this._viewport.top+this._viewport.height||(this._joystick={centerCol:a,centerRow:s,currentCol:a,currentRow:s,id:l}))},move:(a,s,l)=>{!this._joystick||this._joystick.id!==l||(this._joystick.currentCol=a,this._joystick.currentRow=s)},end:a=>{var s;((s=this._joystick)==null?void 0:s.id)===a&&(this._joystick=null,this._heldKeys.clear())}})}handleAction(n){if(super.handleAction(n),n==="MENU"){this._landed||(this._landed=!0,this.complete({outcome:"skipped"}));return}this._primaryInput!=="touch"&&(n==="UP"||n==="DOWN"||n==="LEFT"||n==="RIGHT")&&(this._heldKeys.add(n),this._lastActionTime=performance.now())}update(n){if(super.update(n),this._landed||!this._terrain||!this._viewport)return;if(this._joystick){const o=this._joystick.currentCol-this._joystick.centerCol,a=this._joystick.currentRow-this._joystick.centerRow;this._heldKeys.clear(),a<-F&&this._heldKeys.add("UP"),a>F&&this._heldKeys.add("DOWN"),o<-F&&this._heldKeys.add("LEFT"),o>F&&this._heldKeys.add("RIGHT")}else this._clearExpiredKeys();const i={gravity:this._gravityAccel,airResistance:this._airResistance,thrustForce:this._thrustForce,maxVerticalSpeed:this._maxVerticalSpeed},r={up:this._heldKeys.has("UP"),down:this._heldKeys.has("DOWN"),left:this._heldKeys.has("LEFT"),right:this._heldKeys.has("RIGHT")};let t=n/1e3;for(;t>0&&!this._landed;){const o=Math.min(t,Ia);t-=o,this._ship=Ca(this._ship,r,i,this._viewport.width,be,o);const a=this._ship.y+(Je-1);if(Sa(this._ship.x,a,this._terrain)){const s=Math.hypot(this._ship.vx,this._ship.vy);this._snapToSurface(),this._land(s);break}}}_snapToSurface(){if(!this._terrain)return;const n=Math.floor(this._ship.x),i=n+be-1;let r=1/0;for(let t=n;t<=i;t++)t>=0&&t<this._terrain.length&&(r=Math.min(r,this._terrain[t].surfaceRow));r<1/0&&(this._ship={...this._ship,y:r-Je,vx:0,vy:0})}_land(n){if(this._landed)return;this._landed=!0;const i=n??Math.hypot(this._ship.vx,this._ship.vy),r=Math.max(0,Math.min(1,1-(i-this._maxSafeSpeed)/(this._crashSpeed-this._maxSafeSpeed))),t=Math.floor(this._ship.x)+1,o=this._terrain,a=t>=0&&t<o.length&&o[t].isPad,s=a?1:this._offPadScoreMultiplier,l=Math.round(r*s*100);this.complete({outcome:"completed",result:{score:l,speed:i,onPad:a}})}_clearExpiredKeys(){performance.now()-this._lastActionTime>this._actionTimeoutMs&&this._heldKeys.clear()}renderGame(n,i){this._terrain||(this._terrain=Ma(this._destId,i.width,i.height,this._padWidth),this._ship={x:(i.width-be)/2,y:1,vx:0,vy:1}),this._viewport=i,Ea(n,this._terrain,i.top,i.left,i.height),this._renderShip(n,i),this._renderHUD(n,i),this._renderJoystick(n,i)}_renderShip(n,i){var a;const r=i.left+Math.round(this._ship.x),t=i.top+Math.round(this._ship.y),o=[["-","v","-"],["(","+",")"]];for(let s=0;s<o.length;s++)for(let l=0;l<o[s].length;l++){const c=t+s,h=r+l;c<0||c>=n.length||h<0||h>=(((a=n[c])==null?void 0:a.length)??0)||(n[c][h]={char:o[s][l],fg:"bright-green",bg:"black"})}}_renderHUD(n,i){const r=Math.hypot(this._ship.vx,this._ship.vy),t=`SPD:${r.toFixed(1)}`,o=i.left+i.width-t.length;if(v(n,i.top+1,o,t,"white","black"),r>this._maxSafeSpeed){const a="!! FAST",s=i.left+i.width-a.length;v(n,i.top+2,s,a,"bright-yellow","black")}}_renderJoystick(n,i){if(this._primaryInput!=="touch")return;if(!this._joystick){const u="HOLD & DRAG TO THRUST",p=this._terrain?Math.min(...this._terrain.map(y=>y.surfaceRow)):i.height-2,d=i.top+Math.max(0,p-2),m=i.left+Math.floor((i.width-u.length)/2);v(n,d,m,u,"bright-black","black");return}const{centerCol:r,centerRow:t,currentCol:o,currentRow:a}=this._joystick,s=o-r,l=a-t,c=this._heldKeys.size>0,h=(u,p,d,m)=>{var y;u<0||u>=n.length||p<0||p>=(((y=n[u])==null?void 0:y.length)??0)||u<i.top||u>=i.top+i.height||(n[u][p]={char:d,fg:m,bg:"black"})};h(t,r,"o",c?"bright-white":"white"),l<-F&&h(t-2,r,"^","bright-green"),l>F&&h(t+2,r,"v","bright-green"),s<-F&&h(t,r-2,"<","bright-green"),s>F&&h(t,r+2,">","bright-green")}}const de=[{id:"docking",name:"Docking Mini-Game",description:"Align the ship crosshair with the airlock target before countdown expires",variants:[{id:"orbital",label:"Orbital Station",params:{locationType:"orbital"}},{id:"deep-space",label:"Deep Space",params:{locationType:"deep-space"}}]},{id:"surface-landing",name:"Planet Landing",description:"Counter gravity and air resistance to land gently on the marked pad",variants:[{id:"surface",label:"Planet Surface",params:{locationType:"surface"}}]}],Ra=[{meta:de[0],factory:(e,n,i,r,t)=>new ka(e,n,i,t)},{meta:de[1],factory:(e,n,i,r,t)=>new Fa(e,n,i,t)}];Vn(ma());const La=navigator.maxTouchPoints>0?"touch":"keyboard",Ze={environment:"browser",primaryInput:La,debug:!1},Un=new URLSearchParams(window.location.search),en=Un.get("game");en?Pa(en,Un):Da();function Da(){const e=document.getElementById("root");if(!e)return;let n=`<div style="padding: 2em; font-family: 'Share Tech Mono', monospace; color: #aaa; background: #000; min-height: 100vh;">`;if(n+='<h1 style="color: #0f0; margin-bottom: 1em;">Mini Games</h1>',de.length===0)n+="<p>No mini games registered yet.</p>";else{n+='<ul style="list-style: none; padding: 0;">';for(const i of de){if(n+='<li style="margin-bottom: 1.5em; padding: 1em; border: 1px solid #444;">',n+=`<div style="color: #0f0; font-weight: bold; margin-bottom: 0.5em;">${j(i.name)}</div>`,n+=`<div style="color: #888; margin-bottom: 0.5em;">${j(i.description)}</div>`,n+="<div>",!i.variants||i.variants.length===0)n+=`<a href="?game=${encodeURIComponent(i.id)}" style="color: #0f0; text-decoration: none; border: 1px solid #0f0; padding: 0.5em 1em; display: inline-block;">PLAY</a>`;else for(const r of i.variants){const t=new URLSearchParams({game:i.id});for(const[o,a]of Object.entries(r.params))t.set(o,a);n+=`<a href="?${t.toString()}" style="color: #0f0; text-decoration: none; border: 1px solid #0f0; padding: 0.5em 1em; display: inline-block; margin-right: 0.5em; margin-bottom: 0.5em;">${j(r.label)}</a>`}n+="</div></li>"}n+="</ul>"}n+="</div>",e.innerHTML=n}function Pa(e,n){const i=Ra.find(p=>p.meta.id===e);if(!i){Ha(`Mini game not found: ${j(e)}`);return}const r=document.getElementById("root");if(!r)return;r.style.display="none";const t=new Yn,o=new Kn(Ze);o.connect();const a=Re.createMock(),s=i.factory(o,Ze,a,n,h);let l=0,c=!1;function h(p){var d;c=!0,(d=o.disconnect)==null||d.call(o),t.destroy(),r.style.display="",Oa(e,p)}function u(p){if(c||(l===0&&(l=p),s.update(p-l),l=p,c))return;const d=Na(t.getWidth(),t.getHeight());s.render(d),t.drawBuffer(d),requestAnimationFrame(u)}requestAnimationFrame(u)}function Ha(e){const n=document.getElementById("root");if(!n)return;let i=`<div style="padding: 2em; font-family: 'Share Tech Mono', monospace; color: #f00; background: #000; min-height: 100vh;">`;i+='<h1 style="margin-bottom: 1em;">Error</h1>',i+=`<p style="margin-bottom: 1.5em;">${e}</p>`,i+='<a href="?" style="color: #0f0; text-decoration: none; border: 1px solid #0f0; padding: 0.5em 1em; display: inline-block;">Back to Index</a>',i+="</div>",n.innerHTML=i}function Oa(e,n){const i=document.getElementById("root");if(!i)return;let r=`<div style="padding: 2em; font-family: 'Share Tech Mono', monospace; color: #aaa; background: #000; min-height: 100vh;">`;r+='<h1 style="color: #0f0; margin-bottom: 1em;">Result</h1>',r+='<div style="margin-bottom: 1.5em; padding: 1em; border: 1px solid #444;">',r+=`<div style="color: #0f0; font-weight: bold; margin-bottom: 0.5em;">Outcome: ${j(n.outcome)}</div>`,n.outcome==="completed"&&n.result&&(r+='<pre style="background: #111; padding: 1em; overflow-x: auto; color: #888;">',r+=j(JSON.stringify(n.result,null,2)),r+="</pre>"),r+="</div>",r+='<a href="?" style="color: #0f0; text-decoration: none; border: 1px solid #0f0; padding: 0.5em 1em; display: inline-block;">Back to Index</a>',r+="</div>",i.innerHTML=r}function Na(e,n){return Array.from({length:n},()=>Array.from({length:e},()=>({char:" ",fg:"black",bg:"black"})))}function j(e){const n=document.createElement("div");return n.textContent=e,n.innerHTML}
