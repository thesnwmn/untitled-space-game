# Feature · Knowledge Base — Screens

> **Number TBD** — to be assigned and sequenced by the Planner. Depends on both the Global Menu Shell feature and the Knowledge Base Discovery feature.
