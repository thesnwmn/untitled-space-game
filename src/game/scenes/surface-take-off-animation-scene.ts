...
export class SurfaceTakeOffAnimationScene extends BaseTransitionScene {
  ...
  protected override renderContent(buffer: CharBuffer, _top: number, _bottom: number): void {
    ...
    writeCentered(buffer, mid - 3, '[ LIFTOFF SEQUENCE ]', 'bright-green', 'black');
    writeCentered(buffer, mid + 2, ASCENT_FRAMES[frameIdx], 'bright-black', 'black');
