...
will fall back to the browser's system `monospace` font.

---

## Basic Latin (ASCII printable) — U+0020–007E (95 glyphs)
...
## Latin-1 Supplement — U+0080–00FF (96 glyphs)
...
## Latin Extended-A — U+0100–017F (3 glyphs)
...
## Spacing Modifier Letters — U+02B0–02FF (3 glyphs)
...
## General Punctuation — U+2000–206F (13 glyphs)
...
## Letterlike / Currency Symbols — U+20AC (1 glyph)

| Code point | Char | Name |
|---|---|---|
| `U+20AC` | € | EURO SIGN |

## Mathematical / Technical (3 glyphs)
